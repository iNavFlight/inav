...
/*
 * Setup for STMicroelectronics STM32F2-Discovery (custom) board.
 */

/*
 * Board identifier.
 */
#define BOARD_ST_STM32F2_DISCOVERY
#define BOARD_NAME                  "STMicroelectronics STM32F2-Discovery (custom)"
