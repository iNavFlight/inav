# 1 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
# 29 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
...
void DCD_SetEPStatus (USB_OTG_CORE_HANDLE *pdev ,
                      uint8_t epnum ,
                      uint32_t Status);
# 30 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c" 2
...
# 31 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c" 2
# 91 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
void DCD_Init(USB_OTG_CORE_HANDLE *pdev ,
              USB_OTG_CORE_ID_TypeDef coreID)
{
  uint32_t i;
...
# 144 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
  USB_OTG_CoreInit(pdev);


  USB_OTG_SetCurrentMode(pdev, 0);
...
# 165 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
uint32_t DCD_EP_Open(USB_OTG_CORE_HANDLE *pdev ,
                     uint8_t ep_addr,
                     uint16_t ep_mps,
                     uint8_t ep_type)
...
# 231 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
uint32_t DCD_EP_PrepareRx( USB_OTG_CORE_HANDLE *pdev,
                            uint8_t ep_addr,
                            uint8_t *pbuf,
                            uint16_t buf_len)
...
# 271 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
uint32_t DCD_EP_Tx ( USB_OTG_CORE_HANDLE *pdev,
                     uint8_t ep_addr,
                     uint8_t *pbuf,
                     uint32_t buf_len)
...
# 306 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
...
# 333 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
...
# 360 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
...
# 382 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
void DCD_EP_SetAddress (USB_OTG_CORE_HANDLE *pdev, uint8_t address)
{
  USB_OTG_DCFG_TypeDef dcfg;
  dcfg.d32 = 0;
  dcfg.b.devaddr = address;
  (*(volatile uint32_t *)((&pdev->regs.DREGS->DCFG)) = (((((*(volatile uint32_t *)(&pdev->regs.DREGS->DCFG))) & ~(0)) | (dcfg.d32))));
}
...
void DCD_DevConnect (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  dctl.b.sftdiscon = 0;
  (*(volatile uint32_t *)(&pdev->regs.DREGS->DCTL) = (dctl.d32));
...
# 433 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
...
# 460 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd.c"
