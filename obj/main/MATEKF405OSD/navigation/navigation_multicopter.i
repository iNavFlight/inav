# 1 "./src/main/navigation/navigation_multicopter.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/navigation/navigation_multicopter.c"
# 18 "./src/main/navigation/navigation_multicopter.c"
...
# 19 "./src/main/navigation/navigation_multicopter.c" 2
...
# 20 "./src/main/navigation/navigation_multicopter.c" 2
...
# 21 "./src/main/navigation/navigation_multicopter.c" 2
...
# 58 "./src/main/platform.h" 2
# 23 "./src/main/navigation/navigation_multicopter.c" 2
...
# 27 "./src/main/navigation/navigation_multicopter.c" 2
...
# 28 "./src/main/navigation/navigation_multicopter.c" 2
...
# 30 "./src/main/navigation/navigation_multicopter.c" 2
...
# 32 "./src/main/navigation/navigation_multicopter.c" 2
...
# 33 "./src/main/navigation/navigation_multicopter.c" 2
...
# 34 "./src/main/navigation/navigation_multicopter.c" 2
...
# 36 "./src/main/navigation/navigation_multicopter.c" 2
...
# 37 "./src/main/navigation/navigation_multicopter.c" 2
...
# 38 "./src/main/navigation/navigation_multicopter.c" 2
...
# 40 "./src/main/navigation/navigation_multicopter.c" 2
...
# 41 "./src/main/navigation/navigation_multicopter.c" 2
...
# 42 "./src/main/navigation/navigation_multicopter.c" 2
...
# 43 "./src/main/navigation/navigation_multicopter.c" 2
...
# 45 "./src/main/navigation/navigation_multicopter.c" 2
...
void imuInit(void);
# 46 "./src/main/navigation/navigation_multicopter.c" 2
...
# 47 "./src/main/navigation/navigation_multicopter.c" 2
...
# 48 "./src/main/navigation/navigation_multicopter.c" 2
...
# 50 "./src/main/navigation/navigation_multicopter.c" 2
...
# 51 "./src/main/navigation/navigation_multicopter.c" 2
...
static 
# 59 "./src/main/navigation/navigation_multicopter.c" 3 4
      _Bool 
# 59 "./src/main/navigation/navigation_multicopter.c"
           prepareForTakeoffOnReset = 
# 59 "./src/main/navigation/navigation_multicopter.c" 3 4
                                      0
# 59 "./src/main/navigation/navigation_multicopter.c"
                                           ;
...
static void updateAltitudeVelocityController_MC(timeDelta_t deltaMicros)
{
    ...
    if (( __extension__ ({ __typeof__(targetVel) _abs0 = (targetVel); _abs0 < 0 ? -_abs0 : _abs0; })) > ( __extension__ ({ __typeof__(posControl.desiredState.vel.z) _abs1 = (posControl.desiredState.vel.z); _abs1 < 0 ? -_abs1 : _abs1; }))) {
        const float maxVelDifference = ((deltaMicros) * 1e-6f) * (980.665f / 5.0f);
...
static void updateAltitudeThrottleController_MC(timeDelta_t deltaMicros)
{
    ...
    posControl.rcAdjustment[THROTTLE] = navPidApply2(&posControl.pids.vel[Z], posControl.desiredState.vel.z, navGetCurrentActualPositionAndVelocity()->vel.z, ((deltaMicros) * 1e-6f), thrAdjustmentMin, thrAdjustmentMax, 0);

    posControl.rcAdjustment[THROTTLE] = pt1FilterApply4(&altholdThrottleFilterState, posControl.rcAdjustment[THROTTLE], 4, ((deltaMicros) * 1e-6f));
    posControl.rcAdjustment[THROTTLE] = constrain(posControl.rcAdjustment[THROTTLE], thrAdjustmentMin, thrAdjustmentMax);
}


# 104 "./src/main/navigation/navigation_multicopter.c" 3 4
_Bool 
# 104 "./src/main/navigation/navigation_multicopter.c"
    adjustMulticopterAltitudeFromRCInput(void)
{
    if (posControl.flags.isTerrainFollowEnabled) {
        ...
        return 
# 120 "./src/main/navigation/navigation_multicopter.c" 3 4
              1
# 120 "./src/main/navigation/navigation_multicopter.c"
                  ;
    }
    else {
        ...
        if (rcThrottleAdjustment) {
            ...
            return 
# 140 "./src/main/navigation/navigation_multicopter.c" 3 4
                  1
# 140 "./src/main/navigation/navigation_multicopter.c"
                      ;
        }
        else {
            ...
            return 
# 148 "./src/main/navigation/navigation_multicopter.c" 3 4
                  0
# 148 "./src/main/navigation/navigation_multicopter.c"
                       ;
        }
    }
}
...
void setupMulticopterAltitudeController(void)
{
    ...
    if (throttleStatus == THROTTLE_LOW) {
        prepareForTakeoffOnReset = 
# 177 "./src/main/navigation/navigation_multicopter.c" 3 4
                                  1
# 177 "./src/main/navigation/navigation_multicopter.c"
                                      ;
    }
}
...
void resetMulticopterAltitudeController(void)
{
    ...
    if (prepareForTakeoffOnReset) {
        ...
        prepareForTakeoffOnReset = 
# 195 "./src/main/navigation/navigation_multicopter.c" 3 4
                                  0
# 195 "./src/main/navigation/navigation_multicopter.c"
                                       ;
    }
    else {
        posControl.desiredState.vel.z = posToUse->vel.z;
...
# 248 "./src/main/navigation/navigation_multicopter.c" 3 4
_Bool 
# 248 "./src/main/navigation/navigation_multicopter.c"
    adjustMulticopterHeadingFromRCInput(void)
{
    if (( __extension__ ({ __typeof__(rcCommand[YAW]) _abs2 = (rcCommand[YAW]); _abs2 < 0 ? -_abs2 : _abs2; })) > rcControlsConfig()->pos_hold_deadband) {

        posControl.desiredState.yaw = posControl.actualState.yaw;

        return 
# 254 "./src/main/navigation/navigation_multicopter.c" 3 4
              1
# 254 "./src/main/navigation/navigation_multicopter.c"
                  ;
    }
    else {
        return 
# 257 "./src/main/navigation/navigation_multicopter.c" 3 4
              0
# 257 "./src/main/navigation/navigation_multicopter.c"
                   ;
    }
}
...
# 279 "./src/main/navigation/navigation_multicopter.c" 3 4
_Bool 
# 279 "./src/main/navigation/navigation_multicopter.c"
    adjustMulticopterPositionFromRCInput(void)
{
    ...
    if (rcPitchAdjustment || rcRollAdjustment) {
        ...
        return 
# 299 "./src/main/navigation/navigation_multicopter.c" 3 4
              1
# 299 "./src/main/navigation/navigation_multicopter.c"
                  ;
    }
    else {
        ...
        return 
# 309 "./src/main/navigation/navigation_multicopter.c" 3 4
              0
# 309 "./src/main/navigation/navigation_multicopter.c"
                   ;
    }
}
...
static float getVelocityHeadingAttenuationFactor(void)
{
    ...
    if (navGetCurrentStateFlags() & NAV_AUTO_WP) {
        ...
        const float velScaling = cos_approx((((headingError) / 100.0f) * (3.14159265358979323846f / 180.0f)));
...
static float getVelocityExpoAttenuationFactor(float velTotal, float velMax)
{
    ...
    return 1.0f - posControl.posResponseExpo * (1.0f - (velScale * velScale));
}
...
static void updatePositionVelocityController_MC(void)
{
    ...
    float newVelTotal = sqrtf(((newVelX)*(newVelX)) + ((newVelY)*(newVelY)));
...
static void updatePositionAccelController_MC(timeDelta_t deltaMicros, float maxAccelLimit)
{
    ...
    const float velErrorMagnitude = sqrtf(((velErrorX)*(velErrorX)) + ((velErrorY)*(velErrorY)));
    ...
    const float maxAccelChange = ((deltaMicros) * 1e-6f) * 1700.0f;
    ...
    const float newAccelX = navPidApply2(&posControl.pids.vel[X], posControl.desiredState.vel.x, navGetCurrentActualPositionAndVelocity()->vel.x, ((deltaMicros) * 1e-6f), accelLimitXMin, accelLimitXMax, 0);
    const float newAccelY = navPidApply2(&posControl.pids.vel[Y], posControl.desiredState.vel.y, navGetCurrentActualPositionAndVelocity()->vel.y, ((deltaMicros) * 1e-6f), accelLimitYMin, accelLimitYMax, 0);
    ...
    const float accelN = pt1FilterApply4(&mcPosControllerAccFilterStateX, newAccelX, 2, ((deltaMicros) * 1e-6f));
    const float accelE = pt1FilterApply4(&mcPosControllerAccFilterStateY, newAccelY, 2, ((deltaMicros) * 1e-6f));
    ...
    const float desiredPitch = atan2_approx(accelForward, 980.665f);
    const float desiredRoll = atan2_approx(accelRight * cos_approx(desiredPitch), 980.665f);

    const int16_t maxBankAngle = ((navConfig()->mc.max_bank_angle) * 10);
    posControl.rcAdjustment[ROLL] = constrain((((desiredRoll) * 10.0f) / (3.14159265358979323846f / 180.0f)), -maxBankAngle, maxBankAngle);
    posControl.rcAdjustment[PITCH] = constrain((((desiredPitch) * 10.0f) / (3.14159265358979323846f / 180.0f)), -maxBankAngle, maxBankAngle);
}
...
# 435 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 435 "./src/main/navigation/navigation_multicopter.c"
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE)) {
        ...
        if (posControl.flags.horizontalPositionDataNew) {
            ...
            if (!bypassPositionController) {
                ...
                if (deltaMicrosPositionUpdate < (1000000 / (5))) {
                    ...
                    updatePositionAccelController_MC(deltaMicrosPositionUpdate, 980.0f);
                }
                else {
                    resetMulticopterPositionController();
                }
        ...
        bypassPositionController = 
# 475 "./src/main/navigation/navigation_multicopter.c" 3 4
                                  1
# 475 "./src/main/navigation/navigation_multicopter.c"
                                      ;
    }
...
# 502 "./src/main/navigation/navigation_multicopter.c" 3 4
_Bool 
# 502 "./src/main/navigation/navigation_multicopter.c"
    isMulticopterLandingDetected(void)
{
...
# 512 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 512 "./src/main/navigation/navigation_multicopter.c"
        verticalMovement = fabsf(navGetCurrentActualPositionAndVelocity()->vel.z) > 25.0f;


    
# 515 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 515 "./src/main/navigation/navigation_multicopter.c"
        horizontalMovement = posControl.actualState.velXY > 100.0f;
...
# 521 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 521 "./src/main/navigation/navigation_multicopter.c"
        isAtMinimalThrust = 
# 521 "./src/main/navigation/navigation_multicopter.c" 3 4
                            0
# 521 "./src/main/navigation/navigation_multicopter.c"
...
# 528 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 528 "./src/main/navigation/navigation_multicopter.c"
        possibleLandingDetected = isAtMinimalThrust && !verticalMovement && !horizontalMovement;

    {if (debugMode == (DEBUG_NAV_LANDING_DETECTOR)) {debug[(0)] = (isAtMinimalThrust * 100 + !verticalMovement * 10 + !horizontalMovement * 1);}};
    {if (debugMode == (DEBUG_NAV_LANDING_DETECTOR)) {debug[(1)] = ((landingThrSamples == 0) ? 0 : (rcCommandAdjustedThrottle - (landingThrSum / landingThrSamples)));}};
    {if (debugMode == (DEBUG_NAV_LANDING_DETECTOR)) {debug[(2)] = ((currentTimeUs - landingTimer) / 1000);}};
    ...
    if (!possibleLandingDetected) {
        ...
        return 
# 544 "./src/main/navigation/navigation_multicopter.c" 3 4
              0
# 544 "./src/main/navigation/navigation_multicopter.c"
                   ;
    }
    else {
        return ((currentTimeUs - landingTimer) > (navConfig()->mc.auto_disarm_delay * 1000)) ? 
# 547 "./src/main/navigation/navigation_multicopter.c" 3 4
                                                                                              1 
# 547 "./src/main/navigation/navigation_multicopter.c"
                                                                                                   : 
# 547 "./src/main/navigation/navigation_multicopter.c" 3 4
                                                                                                     0
# 547 "./src/main/navigation/navigation_multicopter.c"
...
{
    updateHeadingHoldTarget(((posControl.desiredState.yaw) / 100));
}
