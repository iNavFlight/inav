...
# 2254 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2254 "./src/main/navigation/navigation.c"
    isLandingDetected(void)
{
    
# 2256 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 2256 "./src/main/navigation/navigation.c"
        landingDetected;
...
static void resetAltitudeController(
# 2305 "./src/main/navigation/navigation.c" 3 4
                                   _Bool 
# 2305 "./src/main/navigation/navigation.c"
                                        useTerrainFollowing)
{
...
static 
# 2374 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2374 "./src/main/navigation/navigation.c"
           adjustPositionFromRCInput(void)
{
    
# 2376 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 2376 "./src/main/navigation/navigation.c"
        retValue;
...
# 2393 "./src/main/navigation/navigation.c" 3 4
                                                   0
# 2393 "./src/main/navigation/navigation.c"
                                                        ;
...
# 2490 "./src/main/navigation/navigation.c" 3 4
                                      0
# 2490 "./src/main/navigation/navigation.c"
                                           ;
    }
}
    ...
    loadNonVolatileWaypointList(void)
{
    if ((armingFlags & (ARMED)))
        return 
# 2508 "./src/main/navigation/navigation.c" 3 4
              0
# 2508 "./src/main/navigation/navigation.c"
                   ;
...
# 2529 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2529 "./src/main/navigation/navigation.c"
    saveNonVolatileWaypointList(void)
{
    if ((armingFlags & (ARMED)) || !posControl.waypointListValid)
        return 
# 2532 "./src/main/navigation/navigation.c" 3 4
              0
# 2532 "./src/main/navigation/navigation.c"
                   ;
    ...
    return 
# 2540 "./src/main/navigation/navigation.c" 3 4
          1
# 2540 "./src/main/navigation/navigation.c"
              ;
}
...
# 2577 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2577 "./src/main/navigation/navigation.c"
    isApproachingLastWaypoint(void)
{
    if (navGetStateFlags(posControl.navState) & NAV_AUTO_WP) {
        if (posControl.waypointCount == 0) {
            ...
            return 
# 2582 "./src/main/navigation/navigation.c" 3 4
                  1
# 2582 "./src/main/navigation/navigation.c"
                      ;
        }
            ...
            return 
# 2586 "./src/main/navigation/navigation.c" 3 4
                  1
# 2586 "./src/main/navigation/navigation.c"
                      ;
        }
        else {
            return 
# 2589 "./src/main/navigation/navigation.c" 3 4
                  0
# 2589 "./src/main/navigation/navigation.c"
                       ;
        }
    }
        ...
        return 
# 2594 "./src/main/navigation/navigation.c" 3 4
              1
# 2594 "./src/main/navigation/navigation.c"
                  ;
    }
    else {
        return 
...
# 2634 "./src/main/navigation/navigation.c" 3 4
                                              0
# 2634 "./src/main/navigation/navigation.c"
                                                   ;
    }
...
# 2641 "./src/main/navigation/navigation.c" 3 4
                                              0
# 2641 "./src/main/navigation/navigation.c"
                                                   ;
    }
    ...
    if ((navStateFlags & NAV_RC_YAW) && (!(flightModeFlags & (FAILSAFE_MODE)))) {
        ...
        posControl.flags.isAdjustingHeading = 
# 2648 "./src/main/navigation/navigation.c" 3 4
                                             0
# 2648 "./src/main/navigation/navigation.c"
                                                  ;
    }
}
...
# 2676 "./src/main/navigation/navigation.c" 3 4
                                             0
# 2676 "./src/main/navigation/navigation.c"
                                                  ;
        return;
    }
...
static 
# 2736 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2736 "./src/main/navigation/navigation.c"
...
# 2743 "./src/main/navigation/navigation.c"
                                          ;
    static 
# 2744 "./src/main/navigation/navigation.c" 3 4
          _Bool 
# 2744 "./src/main/navigation/navigation.c"
...
# 2755 "./src/main/navigation/navigation.c" 3 4
       _Bool 
# 2755 "./src/main/navigation/navigation.c"
            canActivatePosHold = canActivatePosHoldMode();
        
# 2756 "./src/main/navigation/navigation.c" 3 4
       _Bool 
# 2756 "./src/main/navigation/navigation.c"
        ...
        if ((stateFlags & (FIXED_WING))) {
            if (isNavLaunchEnabled()) {
                if (canActivateLaunchMode) {
                    canActivateLaunchMode = 
# 2762 "./src/main/navigation/navigation.c" 3 4
                                           0
# 2762 "./src/main/navigation/navigation.c"
                                                ;
        ...
        if (posControl.flags.forcedRTHActivated || (IS_RC_MODE_ACTIVE(BOXNAVRTH) && canActivatePosHold && canActivateNavigation && canActivateAltHold && (stateFlags & (GPS_FIX_HOME)))) {
            ...
            canActivateWaypoint = 
# 2786 "./src/main/navigation/navigation.c" 3 4
                                 0
# 2786 "./src/main/navigation/navigation.c"
                                      ;
        ...
        if (IS_RC_MODE_ACTIVE(BOXMANUAL)) {
            canActivateWaypoint = 
# 2792 "./src/main/navigation/navigation.c" 3 4
                                 0
# 2792 "./src/main/navigation/navigation.c"
                                      ;
            return NAV_FSM_EVENT_SWITCH_TO_IDLE;
        }
        ...
        if (IS_RC_MODE_ACTIVE(BOXNAVWP)) {
            ...
            canActivateWaypoint = 
# 2802 "./src/main/navigation/navigation.c" 3 4
                                 1
# 2802 "./src/main/navigation/navigation.c"
                                     ;
        }
        ...
        canActivateWaypoint = 
# 2828 "./src/main/navigation/navigation.c" 3 4
                             0
# 2828 "./src/main/navigation/navigation.c"
                                  ;
...
# 2840 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2840 "./src/main/navigation/navigation.c"
    navigationRequiresThrottleTiltCompensation(void)
{
...
# 2848 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2848 "./src/main/navigation/navigation.c"
    navigationRequiresAngleMode(void)
{
...
# 2857 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2857 "./src/main/navigation/navigation.c"
    navigationRequiresTurnAssistance(void)
{
    const navigationFSMStateFlags_t currentState = navGetStateFlags(posControl.navState);
    if ((stateFlags & (FIXED_WING))) {
        ...
        return 
# 2865 "./src/main/navigation/navigation.c" 3 4
              0
# 2865 "./src/main/navigation/navigation.c"
                   ;
    }
}
...
# 2898 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2898 "./src/main/navigation/navigation.c"
    navigationBlockArming(void)
{
    const 
# 2900 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 2900 "./src/main/navigation/navigation.c"
    ...
    const 
# 2901 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 2901 "./src/main/navigation/navigation.c"
...
# 2902 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 2902 "./src/main/navigation/navigation.c"
        shouldBlockArming = 
# 2902 "./src/main/navigation/navigation.c" 3 4
                            0
# 2902 "./src/main/navigation/navigation.c"
...
# 2905 "./src/main/navigation/navigation.c"
    ...
    if ((isUsingNavigationModes() || failsafeMayRequireNavigationMode()) && !((posControl.flags.estPosStatus >= EST_USABLE) && (stateFlags & (GPS_FIX_HOME)))) {
        shouldBlockArming = 
# 2909 "./src/main/navigation/navigation.c" 3 4
                           1
# 2909 "./src/main/navigation/navigation.c"
                               ;
    }
...
# 2922 "./src/main/navigation/navigation.c"
        ...
        if (navWpMissionStartTooFar) {
            shouldBlockArming = 
# 2925 "./src/main/navigation/navigation.c" 3 4
                               1
# 2925 "./src/main/navigation/navigation.c"
                                   ;
        }
    }
...
# 2933 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2933 "./src/main/navigation/navigation.c"
    navigationPositionEstimateIsHealthy(void)
{
...
{
    static 
# 2943 "./src/main/navigation/navigation.c" 3 4
          _Bool 
# 2943 "./src/main/navigation/navigation.c"
               posReadyBeepDone = 
# 2943 "./src/main/navigation/navigation.c" 3 4
                                  0
# 2943 "./src/main/navigation/navigation.c"
...
void updateFlightBehaviorModifiers(void)
{
    if (posControl.flags.isGCSAssistedNavigationEnabled && !IS_RC_MODE_ACTIVE(BOXGCSNAV)) {
        posControl.flags.isGCSAssistedNavigationReset = 
# 2955 "./src/main/navigation/navigation.c" 3 4
                                                       1
# 2955 "./src/main/navigation/navigation.c"
                                                           ;
    }
...
void navigationInit(void)
{
    ...
    posControl.activeWaypointIndex = 0;
    posControl.waypointListValid = 
# 3055 "./src/main/navigation/navigation.c" 3 4
                                  0
# 3055 "./src/main/navigation/navigation.c"
                                       ;
...
{
    posControl.flags.forcedRTHActivated = 
# 3091 "./src/main/navigation/navigation.c" 3 4
                                         0
# 3091 "./src/main/navigation/navigation.c"
                                              ;
    navProcessFSMEvents(selectNavEventFromBoxModeInput());
}
...
# 3111 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3111 "./src/main/navigation/navigation.c"
    navigationIsExecutingAnEmergencyLanding(void)
{
...
# 3116 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3116 "./src/main/navigation/navigation.c"
    navigationIsControllingThrottle(void)
{
...
# 3122 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3122 "./src/main/navigation/navigation.c"
    navigationIsFlyingAutonomousMode(void)
{
    navigationFSMStateFlags_t stateFlags = navGetCurrentStateFlags();
...
# 3128 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3128 "./src/main/navigation/navigation.c"
    navigationRTHAllowsLanding(void)
{
...
# 3135 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3135 "./src/main/navigation/navigation.c"
    isNavLaunchEnabled(void)
{
...
# 3154 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3154 "./src/main/navigation/navigation.c"
    isAdjustingPosition(void) {
    return posControl.flags.isAdjustingPosition;
}


# 3158 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3158 "./src/main/navigation/navigation.c"
    isAdjustingHeading(void) {
