# 1 "./src/main/navigation/navigation_geo.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/navigation/navigation_geo.c"
# 18 "./src/main/navigation/navigation_geo.c"
...
# 19 "./src/main/navigation/navigation_geo.c" 2
...
# 20 "./src/main/navigation/navigation_geo.c" 2
...
# 21 "./src/main/navigation/navigation_geo.c" 2
...
# 58 "./src/main/platform.h" 2
# 23 "./src/main/navigation/navigation_geo.c" 2
...
# 27 "./src/main/navigation/navigation_geo.c" 2
...
# 28 "./src/main/navigation/navigation_geo.c" 2
...
# 30 "./src/main/navigation/navigation_geo.c" 2
...
# 31 "./src/main/navigation/navigation_geo.c" 2
...
# 32 "./src/main/navigation/navigation_geo.c" 2
...
# 34 "./src/main/navigation/navigation_geo.c" 2
...
# 35 "./src/main/navigation/navigation_geo.c" 2
...
# 36 "./src/main/navigation/navigation_geo.c" 2
...
# 38 "./src/main/navigation/navigation_geo.c" 2
...
void imuInit(void);
# 39 "./src/main/navigation/navigation_geo.c" 2
...
# 41 "./src/main/navigation/navigation_geo.c" 2
...
# 44 "./src/main/navigation/navigation_geo.c" 2
...
# 45 "./src/main/navigation/navigation_geo.c" 2
...
float geoCalculateMagDeclination(const gpsLocation_t * llh)
{
    ...
    int min_lat = (int)(lat / 10.0f) * 10.0f;
    int min_lon = (int)(lon / 10.0f) * 10.0f;
    ...
    if (lat >= 60.0f) {
        min_lat = (int)(lat / 10.0f) * 10.0f - 10.0f;
    }
    ...
    if (lon >= 180.0f) {
        min_lon = (int)(lon / 10.0f) * 10.0f - 10.0f;
    }


    const unsigned min_lat_index = (-(-60.0f) + min_lat) / 10.0f;
    const unsigned min_lon_index = (-(-180.0f) + min_lon) / 10.0f;
    ...
    const float declination_min = ((lon - min_lon) / 10.0f) * (declination_se - declination_sw) + declination_sw;
    const float declination_max = ((lon - min_lon) / 10.0f) * (declination_ne - declination_nw) + declination_nw;

    return ((lat - min_lat) / 10.0f) * (declination_max - declination_min) + declination_min;
}
...
void geoSetOrigin(gpsOrigin_s * origin, const gpsLocation_t * llh, geoOriginResetMode_e resetMode)
{
    if (resetMode == GEO_ORIGIN_SET) {
        origin->valid = 
# 139 "./src/main/navigation/navigation_geo.c" 3 4
                       1
# 139 "./src/main/navigation/navigation_geo.c"
                           ;
        origin->lat = llh->lat;
        origin->lon = llh->lon;
        origin->alt = llh->alt;
        origin->scale = constrainf(cos_approx((( __extension__ ({ __typeof__(origin->lat) _abs0 = (origin->lat); _abs0 < 0 ? -_abs0 : _abs0; })) / 10000000.0f) * 0.0174532925f), 0.01f, 1.0f);
    }
...
{
    if (origin->valid) {
        pos->x = (llh->lat - origin->lat) * 1.113195f;
        pos->y = (llh->lon - origin->lon) * (1.113195f * origin->scale);
...
void geoConvertLocalToGeodetic(const gpsOrigin_s * origin, const fpVector3_t * pos, gpsLocation_t * llh)
{
    ...
    llh->lat += lrintf(pos->x / 1.113195f);
    llh->lon += lrintf(pos->y / (1.113195f * scaleLonDown));
