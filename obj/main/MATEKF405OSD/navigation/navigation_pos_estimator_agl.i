# 1 "./src/main/navigation/navigation_pos_estimator_agl.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/navigation/navigation_pos_estimator_agl.c"
# 25 "./src/main/navigation/navigation_pos_estimator_agl.c"
...
# 26 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 27 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 28 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 29 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 58 "./src/main/platform.h" 2
# 31 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 33 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 34 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 38 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 39 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 40 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 42 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
# 58 "./src/main/sensors/barometer.h"
    baroIsHealthy(void);
# 43 "./src/main/navigation/navigation_pos_estimator_agl.c" 2
...
void updatePositionEstimator_SurfaceTopic(timeUs_t currentTimeUs, float newSurfaceAlt)
{
    const float dt = ((currentTimeUs - posEstimator.surface.lastUpdateTime) * 1e-6f);
    ...
    if (dt > 0.5f) {
        ...
        const float relAlpha = dt / (dt + (0.47802f));
...
# 88 "./src/main/navigation/navigation_pos_estimator_agl.c" 3 4
       _Bool 
# 88 "./src/main/navigation/navigation_pos_estimator_agl.c"
            resetSurfaceEstimate = 
# 88 "./src/main/navigation/navigation_pos_estimator_agl.c" 3 4
                                   0
# 88 "./src/main/navigation/navigation_pos_estimator_agl.c"
                                        ;
        switch (posEstimator.est.aglQual) {
            case SURFACE_QUAL_LOW:
                if (posEstimator.surface.reliability >= (0.75f)) {
                    newAglQuality = SURFACE_QUAL_HIGH;
                    resetSurfaceEstimate = 
# 93 "./src/main/navigation/navigation_pos_estimator_agl.c" 3 4
                                          1
# 93 "./src/main/navigation/navigation_pos_estimator_agl.c"
                                              ;
                }
                else if (posEstimator.surface.reliability >= (0.33f)) {
        ...
        posEstimator.est.aglAlt = posEstimator.imu.accelNEU.z * ((ctx->dt)*(ctx->dt)) * 0.5f;
        ...
        if (posEstimator.est.aglQual == SURFACE_QUAL_HIGH) {
            ...
            posEstimator.est.aglVel += surfaceResidual * positionEstimationConfig()->w_z_surface_v * ((bellCurveScaler)*(bellCurveScaler)) * ((posEstimator.surface.reliability)*(posEstimator.surface.reliability)) * ctx->dt;
    ...
    {if (debugMode == (DEBUG_AGL)) {debug[(0)] = (posEstimator.surface.reliability * 1000);}};
    {if (debugMode == (DEBUG_AGL)) {debug[(1)] = (posEstimator.est.aglQual);}};
    {if (debugMode == (DEBUG_AGL)) {debug[(2)] = (posEstimator.est.aglAlt);}};
    {if (debugMode == (DEBUG_AGL)) {debug[(3)] = (posEstimator.est.aglVel);}};
