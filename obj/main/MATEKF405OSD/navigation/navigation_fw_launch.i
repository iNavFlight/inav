# 1 "./src/main/navigation/navigation_fw_launch.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/navigation/navigation_fw_launch.c"
# 18 "./src/main/navigation/navigation_fw_launch.c"
...
# 19 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 20 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 21 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 22 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 58 "./src/main/platform.h" 2
# 24 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 28 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 29 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 31 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 32 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 34 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 36 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 24 "./src/main/drivers/sensor.h" 2
...
# 37 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 38 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 40 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 41 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 58 "./src/main/sensors/barometer.h"
    baroIsHealthy(void);
# 42 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 43 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 44 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 45 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 47 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 48 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 50 "./src/main/navigation/navigation_fw_launch.c" 2
...
void imuInit(void);
# 51 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 52 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 54 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 55 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 58 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 59 "./src/main/navigation/navigation_fw_launch.c" 2
...
# 65 "./src/main/navigation/navigation_fw_launch.c" 3 4
   _Bool 
# 65 "./src/main/navigation/navigation_fw_launch.c"
        launchDetected;


    timeUs_t launchStartedTime;
    
# 69 "./src/main/navigation/navigation_fw_launch.c" 3 4
   _Bool 
# 69 "./src/main/navigation/navigation_fw_launch.c"
        launchFinished;
    
# 70 "./src/main/navigation/navigation_fw_launch.c" 3 4
   _Bool 
# 70 "./src/main/navigation/navigation_fw_launch.c"
        motorControlAllowed;
} FixedWingLaunchState_t;

static FixedWingLaunchState_t launchState;

#define COS_MAX_LAUNCH_ANGLE 0.70710678f
...
{
    const float swingVelocity = (( __extension__ ({ __typeof__(imuMeasuredRotationBF.z) _abs0 = (imuMeasuredRotationBF.z); _abs0 < 0 ? -_abs0 : _abs0; })) > ((100) * (3.14159265358979323846f / 180.0f))) ? (imuMeasuredAccelBF.y / imuMeasuredRotationBF.z) : 0;
    const 
# 80 "./src/main/navigation/navigation_fw_launch.c" 3 4
         _Bool 
# 80 "./src/main/navigation/navigation_fw_launch.c"
              isForwardAccelerationHigh = (imuMeasuredAccelBF.x > navConfig()->fw.launch_accel_thresh);
    const 
# 81 "./src/main/navigation/navigation_fw_launch.c" 3 4
         _Bool 
# 81 "./src/main/navigation/navigation_fw_launch.c"
              isAircraftAlmostLevel = (calculateCosTiltAngle() >= cos_approx(((navConfig()->fw.launch_max_angle) * (3.14159265358979323846f / 180.0f))));

    const 
# 83 "./src/main/navigation/navigation_fw_launch.c" 3 4
         _Bool 
# 83 "./src/main/navigation/navigation_fw_launch.c"
              isBungeeLaunched = isForwardAccelerationHigh && isAircraftAlmostLevel;
    const 
# 84 "./src/main/navigation/navigation_fw_launch.c" 3 4
         _Bool 
# 84 "./src/main/navigation/navigation_fw_launch.c"
              isSwingLaunched = (swingVelocity > navConfig()->fw.launch_velocity_thresh) && (imuMeasuredAccelBF.x > 0);
    ...
    if (isBungeeLaunched || isSwingLaunched) {
        ...
        if (launchState.launchDetectionTimeAccum >= (((uint32_t)navConfig()->fw.launch_time_thresh) * 1000)) {
            launchState.launchDetected = 
# 90 "./src/main/navigation/navigation_fw_launch.c" 3 4
                                        1
# 90 "./src/main/navigation/navigation_fw_launch.c"
                                            ;
        }
    }
    else {
...
void resetFixedWingLaunchController(timeUs_t currentTimeUs)
{
    ...
    launchState.launchDetected = 
# 104 "./src/main/navigation/navigation_fw_launch.c" 3 4
                                0
# 104 "./src/main/navigation/navigation_fw_launch.c"
                                     ;
    launchState.launchFinished = 
# 105 "./src/main/navigation/navigation_fw_launch.c" 3 4
                                0
# 105 "./src/main/navigation/navigation_fw_launch.c"
                                     ;
    launchState.motorControlAllowed = 
# 106 "./src/main/navigation/navigation_fw_launch.c" 3 4
                                     0
# 106 "./src/main/navigation/navigation_fw_launch.c"
                                          ;
}


# 109 "./src/main/navigation/navigation_fw_launch.c" 3 4
_Bool 
# 109 "./src/main/navigation/navigation_fw_launch.c"
    isFixedWingLaunchDetected(void)
{
...
void enableFixedWingLaunchController(timeUs_t currentTimeUs)
{
    ...
    launchState.motorControlAllowed = 
# 117 "./src/main/navigation/navigation_fw_launch.c" 3 4
                                     1
# 117 "./src/main/navigation/navigation_fw_launch.c"
                                         ;
}


# 120 "./src/main/navigation/navigation_fw_launch.c" 3 4
_Bool 
# 120 "./src/main/navigation/navigation_fw_launch.c"
    isFixedWingLaunchFinishedOrAborted(void)
{
...
static inline 
# 143 "./src/main/navigation/navigation_fw_launch.c" 3 4
             _Bool 
# 143 "./src/main/navigation/navigation_fw_launch.c"
                  isFixedWingLaunchMaxAltitudeReached(void)
{
    return (navConfig()->fw.launch_max_altitude > 0) && (getEstimatedActualPosition(Z) >= navConfig()->fw.launch_max_altitude);
}
static inline 
# 147 "./src/main/navigation/navigation_fw_launch.c" 3 4
             _Bool 
# 147 "./src/main/navigation/navigation_fw_launch.c"
                  isLaunchModeMinTimeElapsed(float timeSinceLaunchMs)
{
    return timeSinceLaunchMs > navConfig()->fw.launch_min_time;
}

static inline 
# 152 "./src/main/navigation/navigation_fw_launch.c" 3 4
             _Bool 
# 152 "./src/main/navigation/navigation_fw_launch.c"
                  isLaunchModeMaxTimeElapsed(float timeSinceLaunchMs)
{
    return timeSinceLaunchMs >= navConfig()->fw.launch_timeout;
}

static inline 
# 157 "./src/main/navigation/navigation_fw_launch.c" 3 4
             _Bool 
# 157 "./src/main/navigation/navigation_fw_launch.c"
                  isFixedWingLaunchCompleted(float timeSinceLaunchMs)
{
...
# 167 "./src/main/navigation/navigation_fw_launch.c" 3 4
       _Bool 
# 167 "./src/main/navigation/navigation_fw_launch.c"
            applyLaunchIdleLogic = 
# 167 "./src/main/navigation/navigation_fw_launch.c" 3 4
                                   1
# 167 "./src/main/navigation/navigation_fw_launch.c"
                                       ;
        ...
        if (launchState.motorControlAllowed) {
            ...
            const float timeElapsedSinceLaunchMs = ((currentTimeUs - launchState.launchStartedTime) * 1e-3f);
            ...
            if (timeElapsedSinceLaunchMs >= navConfig()->fw.launch_motor_timer) {
                ...
                applyLaunchIdleLogic = 
# 178 "./src/main/navigation/navigation_fw_launch.c" 3 4
                                      0
# 178 "./src/main/navigation/navigation_fw_launch.c"
                                           ;
                ...
                if (navConfig()->fw.launch_motor_spinup_time > 0) {
                    ...
                    const uint16_t minIdleThrottle = ( __extension__ ({ __typeof__(motorConfig()->minthrottle) _left1 = (motorConfig()->minthrottle); __typeof__(navConfig()->fw.launch_idle_throttle) _right2 = (navConfig()->fw.launch_idle_throttle); _left1 > _right2 ? _left1 : _right2; }));
    ...
    rcCommand[ROLL] = 0;
    rcCommand[PITCH] = pidAngleToRcCommand(-((navConfig()->fw.launch_climb_angle) * 10), pidProfile()->max_angle_inclination[FD_PITCH]);
    rcCommand[YAW] = 0;
}
