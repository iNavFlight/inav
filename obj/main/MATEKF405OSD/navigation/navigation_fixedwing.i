# 1 "./src/main/navigation/navigation_fixedwing.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/navigation/navigation_fixedwing.c"
# 18 "./src/main/navigation/navigation_fixedwing.c"
...
# 19 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 20 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 21 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 58 "./src/main/platform.h" 2
# 23 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 27 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 28 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 30 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 31 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 32 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 34 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 36 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 37 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 38 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 40 "./src/main/navigation/navigation_fixedwing.c" 2
...
void imuInit(void);
# 41 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 42 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 44 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 45 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 46 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 49 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 50 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 52 "./src/main/navigation/navigation_fixedwing.c" 2



#define NAV_FW_THROTTLE_SPEED_BOOST_GAIN 1.5f
#define NAV_FW_MIN_VEL_SPEED_BOOST 700.0f




static 
# 61 "./src/main/navigation/navigation_fixedwing.c" 3 4
      _Bool 
# 61 "./src/main/navigation/navigation_fixedwing.c"
           isPitchAdjustmentValid = 
# 61 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                    0
# 61 "./src/main/navigation/navigation_fixedwing.c"
                                         ;
static 
# 62 "./src/main/navigation/navigation_fixedwing.c" 3 4
      _Bool 
# 62 "./src/main/navigation/navigation_fixedwing.c"
           isRollAdjustmentValid = 
# 62 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                   0
# 62 "./src/main/navigation/navigation_fixedwing.c"
                                        ;
...
static 
# 64 "./src/main/navigation/navigation_fixedwing.c" 3 4
      _Bool 
# 64 "./src/main/navigation/navigation_fixedwing.c"
           isAutoThrottleManuallyIncreased = 
# 64 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                             0
# 64 "./src/main/navigation/navigation_fixedwing.c"
                                                  ;
...
void resetFixedWingAltitudeController(void)
{
    ...
    isPitchAdjustmentValid = 
# 80 "./src/main/navigation/navigation_fixedwing.c" 3 4
                            0
# 80 "./src/main/navigation/navigation_fixedwing.c"
                                 ;
    throttleSpeedAdjustment = 0;
}


# 84 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 84 "./src/main/navigation/navigation_fixedwing.c"
    adjustFixedWingAltitudeFromRCInput(void)
{
    ...
    if (rcAdjustment) {
        ...
        return 
# 92 "./src/main/navigation/navigation_fixedwing.c" 3 4
              1
# 92 "./src/main/navigation/navigation_fixedwing.c"
                  ;
    }
    else {
        ...
        return 
# 99 "./src/main/navigation/navigation_fixedwing.c" 3 4
              0
# 99 "./src/main/navigation/navigation_fixedwing.c"
                   ;
    }
}
...
static void updateAltitudeVelocityAndPitchController_FW(timeDelta_t deltaMicros)
{
    ...
    const float demSPE = (posControl.desiredState.pos.z / 100.0f) * 9.80665f;
    const float demSKE = 0.0f;

    const float estSPE = (navGetCurrentActualPositionAndVelocity()->pos.z / 100.0f) * 9.80665f;
    ...
    const float maxClimbDeciDeg = ((navConfig()->fw.max_climb_angle) * 10);
    const float minDiveDeciDeg = -((navConfig()->fw.max_dive_angle) * 10);


    float targetPitchAngle = navPidApply3(&posControl.pids.fw_alt, demSEB, estSEB, ((deltaMicros) * 1e-6f), minDiveDeciDeg, maxClimbDeciDeg, 0, pitchGainInv);
    targetPitchAngle = pt1FilterApply4(&velzFilterState, targetPitchAngle, 2, ((deltaMicros) * 1e-6f));
...
void applyFixedWingAltitudeAndThrottleController(timeUs_t currentTimeUs)
{
    ...
    if ((posControl.flags.estAltStatus >= EST_USABLE)) {
        if (posControl.flags.verticalPositionDataNew) {
            ...
            if (deltaMicrosPositionUpdate < (1000000 / (5))) {
        ...
        isPitchAdjustmentValid = 
# 177 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                1
# 177 "./src/main/navigation/navigation_fixedwing.c"
                                    ;
    }
    else {

        isPitchAdjustmentValid = 
# 181 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                0
# 181 "./src/main/navigation/navigation_fixedwing.c"
                                     ;
    }
}
...
# 188 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 188 "./src/main/navigation/navigation_fixedwing.c"
    adjustFixedWingHeadingFromRCInput(void)
{
    if (( __extension__ ({ __typeof__(rcCommand[YAW]) _abs0 = (rcCommand[YAW]); _abs0 < 0 ? -_abs0 : _abs0; })) > rcControlsConfig()->pos_hold_deadband) {
        return 
# 191 "./src/main/navigation/navigation_fixedwing.c" 3 4
              1
# 191 "./src/main/navigation/navigation_fixedwing.c"
                  ;
    }

    return 
# 194 "./src/main/navigation/navigation_fixedwing.c" 3 4
          0
# 194 "./src/main/navigation/navigation_fixedwing.c"
               ;
}
...
void resetFixedWingPositionController(void)
{
    ...
    isRollAdjustmentValid = 
# 211 "./src/main/navigation/navigation_fixedwing.c" 3 4
                           0
# 211 "./src/main/navigation/navigation_fixedwing.c"
                                ;
...
static void calculateVirtualPositionTarget_FW(float trackingPeriod)
{
    ...
    float distanceToActualTarget = sqrtf(((posErrorX)*(posErrorX)) + ((posErrorY)*(posErrorY)));


    float trackingDistance = trackingPeriod * ( __extension__ ({ __typeof__(posControl.actualState.velXY) _left1 = (posControl.actualState.velXY); __typeof__(100.0f) _right2 = (100.0f); _left1 > _right2 ? _left1 : _right2; }));


#define TAN_15DEG 0.26795f
    
# 228 "./src/main/navigation/navigation_fixedwing.c" 3 4
   _Bool 
# 228 "./src/main/navigation/navigation_fixedwing.c"
        needToCalculateCircularLoiter = isApproachingLastWaypoint()
                                            && (distanceToActualTarget <= (navConfig()->fw.loiter_radius / 0.26795f))
                                            && (distanceToActualTarget > 50.0f)
                                            && !(flightModeFlags & (NAV_CRUISE_MODE));


    if (needToCalculateCircularLoiter) {

        float loiterAngle = atan2_approx(-posErrorY, -posErrorX) + ((45.0f) * (3.14159265358979323846f / 180.0f));
        ...
        distanceToActualTarget = sqrtf(((posErrorX)*(posErrorX)) + ((posErrorY)*(posErrorY)));
    }
...
# 262 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                                  1
# 262 "./src/main/navigation/navigation_fixedwing.c"
                                                      ;
        }
    }
}
...
# 267 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 267 "./src/main/navigation/navigation_fixedwing.c"
    adjustFixedWingPositionFromRCInput(void)
{
    int16_t rcRollAdjustment = applyDeadband(rcCommand[ROLL], rcControlsConfig()->pos_hold_deadband);
...
static void updatePositionHeadingController_FW(timeUs_t currentTimeUs, timeDelta_t deltaMicros)
{
    ...
    static 
# 277 "./src/main/navigation/navigation_fixedwing.c" 3 4
          _Bool 
# 277 "./src/main/navigation/navigation_fixedwing.c"
               errorIsDecreasing;
    static 
# 278 "./src/main/navigation/navigation_fixedwing.c" 3 4
          _Bool 
# 278 "./src/main/navigation/navigation_fixedwing.c"
               forceTurnDirection = 
# 278 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                    0
# 278 "./src/main/navigation/navigation_fixedwing.c"
    ...
    if (( __extension__ ({ __typeof__(navHeadingError) _abs3 = (navHeadingError); _abs3 < 0 ? -_abs3 : _abs3; })) > 17000) {
        forceTurnDirection = 
# 289 "./src/main/navigation/navigation_fixedwing.c" 3 4
                            1
# 289 "./src/main/navigation/navigation_fixedwing.c"
                                ;
    }
    else if (( __extension__ ({ __typeof__(navHeadingError) _abs4 = (navHeadingError); _abs4 < 0 ? -_abs4 : _abs4; })) < 9000 && forceTurnDirection) {
        forceTurnDirection = 
# 292 "./src/main/navigation/navigation_fixedwing.c" 3 4
                            0
# 292 "./src/main/navigation/navigation_fixedwing.c"
                                 ;
    }


    if (forceTurnDirection) {
        navHeadingError = ( __extension__ ({ __typeof__(navHeadingError) _abs5 = (navHeadingError); _abs5 < 0 ? -_abs5 : _abs5; }));
    }


    if ((currentTimeUs - previousTimeMonitoringUpdate) >= (1000000 / (2))) {

        errorIsDecreasing = (( __extension__ ({ __typeof__(previousHeadingError) _abs6 = (previousHeadingError); _abs6 < 0 ? -_abs6 : _abs6; })) > ( __extension__ ({ __typeof__(navHeadingError) _abs7 = (navHeadingError); _abs7 < 0 ? -_abs7 : _abs7; })));
    ...
    float rollAdjustment = navPidApply2(&posControl.pids.fw_nav, posControl.actualState.yaw + navHeadingError, posControl.actualState.yaw, ((deltaMicros) * 1e-6f),
                                       -((navConfig()->fw.max_bank_angle) * 100),
                                        ((navConfig()->fw.max_bank_angle) * 100),
                                        pidFlags);


    rollAdjustment = pt1FilterApply4(&fwPosControllerCorrectionFilterState, rollAdjustment, 10, ((deltaMicros) * 1e-6f));


    posControl.rcAdjustment[ROLL] = ((rollAdjustment) / 10);
}
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE)) {
        ...
        if (posControl.flags.horizontalPositionDataNew) {
            ...
            if (deltaMicrosPositionUpdate < (1000000 / (5))) {
                ...
                calculateVirtualPositionTarget_FW((((1000000 / (5))) * 1e-6f) * 2);
        ...
        isRollAdjustmentValid = 
# 366 "./src/main/navigation/navigation_fixedwing.c" 3 4
                               1
# 366 "./src/main/navigation/navigation_fixedwing.c"
                                   ;
    }
    else {

        isRollAdjustmentValid = 
# 370 "./src/main/navigation/navigation_fixedwing.c" 3 4
                               0
# 370 "./src/main/navigation/navigation_fixedwing.c"
                                    ;
    }
}
...
int16_t applyFixedWingMinSpeedController(timeUs_t currentTimeUs)
{
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE)) {
        ...
        if (posControl.flags.horizontalPositionDataNew) {
            ...
            if (deltaMicrosPositionUpdate < (1000000 / (5))) {
                float velThrottleBoost = (700.0f - posControl.actualState.velXY) * 1.5f * ((deltaMicrosPositionUpdate) * 1e-6f);


                if (( __extension__ ({ __typeof__(posControl.actualState.velXY - 700.0f) _abs8 = (posControl.actualState.velXY - 700.0f); _abs8 < 0 ? -_abs8 : _abs8; })) > 50) {
...
void applyFixedWingPitchRollThrottleController(navigationFSMStateFlags_t navStateFlags, timeUs_t currentTimeUs)
{
    ...
    if (isRollAdjustmentValid && (navStateFlags & NAV_CTL_POS)) {
        ...
        int16_t rollCorrection = constrain(posControl.rcAdjustment[ROLL], -((navConfig()->fw.max_bank_angle) * 10), ((navConfig()->fw.max_bank_angle) * 10));
        rcCommand[ROLL] = pidAngleToRcCommand(rollCorrection, pidProfile()->max_angle_inclination[FD_ROLL]);
    }

    if (isPitchAdjustmentValid && (navStateFlags & NAV_CTL_ALT)) {

        int16_t pitchCorrection = constrain(posControl.rcAdjustment[PITCH], -((navConfig()->fw.max_dive_angle) * 10), ((navConfig()->fw.max_climb_angle) * 10));
        rcCommand[PITCH] = -pidAngleToRcCommand(pitchCorrection, pidProfile()->max_angle_inclination[FD_PITCH]);
        int16_t throttleCorrection = ((pitchCorrection) / 10) * navConfig()->fw.pitch_to_throttle;
        ...
        if (navConfig()->fw.allow_manual_thr_increase && !(flightModeFlags & (FAILSAFE_MODE))) {
            if (rcCommand[THROTTLE] < 1000 + (2000 - 1000) * 0.95)
                correctedThrottleValue += ( __extension__ ({ __typeof__(0) _left9 = (0); __typeof__(rcCommand[THROTTLE] - navConfig()->fw.cruise_throttle) _right10 = (rcCommand[THROTTLE] - navConfig()->fw.cruise_throttle); _left9 > _right10 ? _left9 : _right10; }));
            else
            ...
            isAutoThrottleManuallyIncreased = 
# 467 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                             0
# 467 "./src/main/navigation/navigation_fixedwing.c"
                                                  ;
        }
    ...
    if (navStateFlags & NAV_CTL_LAND) {
        if ( ((posControl.flags.estAltStatus >= EST_USABLE) && (navGetCurrentActualPositionAndVelocity()->pos.z <= navConfig()->general.land_slowdown_minalt)) ||
            ...
            rcCommand[PITCH] = pidAngleToRcCommand(((navConfig()->fw.land_dive_angle) * 10), pidProfile()->max_angle_inclination[FD_PITCH]);
        }
    }
...
# 496 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 496 "./src/main/navigation/navigation_fixedwing.c"
    isFixedWingAutoThrottleManuallyIncreased()
{
...
# 511 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 511 "./src/main/navigation/navigation_fixedwing.c"
    isFixedWingLandingDetected(void)
{
    ...
    return 
# 516 "./src/main/navigation/navigation_fixedwing.c" 3 4
          0
# 516 "./src/main/navigation/navigation_fixedwing.c"
               ;
}
...
void resetFixedWingHeadingController(void)
{
    updateHeadingHoldTarget(((posControl.actualState.yaw) / 100));
}
...
void applyFixedWingNavigationController(navigationFSMStateFlags_t navStateFlags, timeUs_t currentTimeUs)
{
    if (navStateFlags & NAV_CTL_LAUNCH) {
        ...
        if (
# 558 "./src/main/navigation/navigation_fixedwing.c" 3 4
           1
# 558 "./src/main/navigation/navigation_fixedwing.c"
               ) {
        ...
        if ((flightModeFlags & (NAV_CRUISE_MODE)) && posControl.flags.isAdjustingPosition)
