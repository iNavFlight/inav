...
static serialPort_t * tracePort = 
# 54 "./src/main/build/debug.c" 3 4
                                 ((void *)0)
# 54 "./src/main/build/debug.c"
                                     ;
static mspPort_t * mspTracePort = 
# 55 "./src/main/build/debug.c" 3 4
                                 ((void *)0)
# 55 "./src/main/build/debug.c"
                                     ;
...
# 68 "./src/main/build/debug.c" 3 4
   _Bool 
# 68 "./src/main/build/debug.c"
        tracePortIsSharedWithMSP = 
# 68 "./src/main/build/debug.c" 3 4
                                   0
# 68 "./src/main/build/debug.c"
                                        ;
    ...
    if (determinePortSharing(portConfig, FUNCTION_DEBUG_TRACE) == PORTSHARING_SHARED) {
        ...
        tracePortIsSharedWithMSP = 
# 75 "./src/main/build/debug.c" 3 4
                                  1
# 75 "./src/main/build/debug.c"
                                      ;
    }
    ...
    if (tracePortIsSharedWithMSP) {
        ...
        tracePort = openSerialPort(portConfig->identifier, FUNCTION_DEBUG_TRACE, 
# 91 "./src/main/build/debug.c" 3 4
                                                                                ((void *)0)
# 91 "./src/main/build/debug.c"
                                                                                    , 
# 91 "./src/main/build/debug.c" 3 4
                                                                                      ((void *)0)
# 91 "./src/main/build/debug.c"
                                                                                          , baudRates[BAUD_921600], MODE_TX, SERIAL_NOT_INVERTED);
        if (!tracePort) {
            return;
        }
    }
    ...
    debugTracePrintf(
# 97 "./src/main/build/debug.c" 3 4
   1
# 97 "./src/main/build/debug.c"
   , "%s/%s %s %s / %s (%s)", "INAV", targetName, "2" "." "0" "." "1", buildDate, buildTime, shortGitRevision)
...
static void debugTracePrint(
# 112 "./src/main/build/debug.c" 3 4
                           _Bool 
# 112 "./src/main/build/debug.c"
                                synchronous, const char *buf, size_t size)
{
    if (tracePort) {
        ...
        mspSerialPushPort(253, (uint8_t*)buf, size, mspTracePort, MSP_V2_NATIVE);
    }
}
...
static size_t debugTraceFormatPrefix(char *buf, const timeMs_t timeMs)
{
    ...
    return tfp_sprintf(buf, "[%6d.%03d] ", timeMs / 1000, timeMs % 1000);
}

void debugTracePrintf(
# 133 "./src/main/build/debug.c" 3 4
                     _Bool 
# 133 "./src/main/build/debug.c"
                          synchronous, const char *format, ...)
{
    char buf[128];
    char *bufPtr;
    ...
    typedef char assert_failed_MSP_PORT_OUTBUF_SIZE_not_big_enough_for_debug_trace [((4096 + 16) >= sizeof(buf)) ? 1 : -1 ] __attribute__((unused));
...
# 149 "./src/main/build/debug.c" 3 4
   __builtin_va_start(
# 149 "./src/main/build/debug.c"
   va
# 149 "./src/main/build/debug.c" 3 4
   ,
# 149 "./src/main/build/debug.c"
...
# 154 "./src/main/build/debug.c" 3 4
   __builtin_va_end(
# 154 "./src/main/build/debug.c"
   va
# 154 "./src/main/build/debug.c" 3 4
   )
# 154 "./src/main/build/debug.c"
...
void debugTracePrintBufferHex(
# 159 "./src/main/build/debug.c" 3 4
                             _Bool 
# 159 "./src/main/build/debug.c"
                                  synchronous, const void *buffer, size_t size)
{
    ...
    char buf[13 + charsPerByte * maxBytes + 1];
    size_t bufPos = 13;
