# 1 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
# 29 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
...
# 35 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_req.h" 2
...
# 30 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c" 2
...
uint16_t USBD_GetRxCount (USB_OTG_CORE_HANDLE *pdev ,
                           uint8_t epnum);
# 31 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c" 2
...
# 32 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c" 2
# 72 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
extern volatile USB_OTG_DCTL_TypeDef SET_TEST_MODE;
...
# 104 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
...
# 143 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
USBD_Status USBD_StdDevReq (USB_OTG_CORE_HANDLE *pdev, USB_SETUP_REQ *req)
{
...
# 194 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
USBD_Status USBD_StdItfReq (USB_OTG_CORE_HANDLE *pdev, USB_SETUP_REQ *req)
{
  USBD_Status ret = USBD_OK;
...
# 231 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
USBD_Status USBD_StdEPReq (USB_OTG_CORE_HANDLE *pdev, USB_SETUP_REQ *req)
{
                               ...
                               USB_SETUP_REQ *req)
{
  ...
  case 3:
    ...
    break;
  case 6:
# 462 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
      USBD_CtlError(pdev , req);
      return;


  case 7:
# 481 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
      USBD_CtlError(pdev , req);
      return;
...
# 508 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_SetAddress(USB_OTG_CORE_HANDLE *pdev,
                            USB_SETUP_REQ *req)
{
  uint8_t dev_addr;
...
# 550 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_SetConfig(USB_OTG_CORE_HANDLE *pdev,
                           USB_SETUP_REQ *req)
{
...
# 619 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_GetConfig(USB_OTG_CORE_HANDLE *pdev,
                           USB_SETUP_REQ *req)
{
...
# 659 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_GetStatus(USB_OTG_CORE_HANDLE *pdev,
                           USB_SETUP_REQ *req)
{
...
# 699 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_SetFeature(USB_OTG_CORE_HANDLE *pdev,
                            USB_SETUP_REQ *req)
{
  ...
  if (req->wValue == 1)
  {
    ...
    USBD_CtlSendStatus(pdev);
           ...
           ((req->wIndex & 0xFF) == 0))
  {
    dctl.d32 = (*(volatile uint32_t *)(&pdev->regs.DREGS->DCTL));
...
# 763 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_ClrFeature(USB_OTG_CORE_HANDLE *pdev,
                            USB_SETUP_REQ *req)
{
  switch (pdev->dev.device_status)
...
# 792 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
void USBD_ParseSetupRequest( USB_OTG_CORE_HANDLE *pdev,
                            USB_SETUP_REQ *req)
{
  req->bmRequest = *(uint8_t *) (pdev->dev.setup_packet);
  req->bRequest = *(uint8_t *) (pdev->dev.setup_packet + 1);
  req->wValue = (((uint16_t)(*((uint8_t *)(pdev->dev.setup_packet + 2)))) + (((uint16_t)(*(((uint8_t *)(pdev->dev.setup_packet + 2)) + 1))) << 8));
  req->wIndex = (((uint16_t)(*((uint8_t *)(pdev->dev.setup_packet + 4)))) + (((uint16_t)(*(((uint8_t *)(pdev->dev.setup_packet + 4)) + 1))) << 8));
  req->wLength = (((uint16_t)(*((uint8_t *)(pdev->dev.setup_packet + 6)))) + (((uint16_t)(*(((uint8_t *)(pdev->dev.setup_packet + 6)) + 1))) << 8));

  pdev->dev.in_ep[0].ctl_data_len = req->wLength ;
  pdev->dev.device_state = 1;
}
# 813 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
void USBD_CtlError( USB_OTG_CORE_HANDLE *pdev,
                            USB_SETUP_REQ *req)
{
  (void)req;
...
# 831 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_req.c"
void USBD_GetString(uint8_t *desc, uint8_t *unicode, uint16_t *len)
{
  uint8_t idx = 0;
