...
static 
# 77 "./src/main/rx/xbus.c" 3 4
      _Bool 
# 77 "./src/main/rx/xbus.c"
           xBusFrameReceived = 
# 77 "./src/main/rx/xbus.c" 3 4
                               0
# 77 "./src/main/rx/xbus.c"
...
# 232 "./src/main/rx/xbus.c"
    ...
    if (xBusDataIncoming == 
# 236 "./src/main/rx/xbus.c" 3 4
                           1
# 236 "./src/main/rx/xbus.c"
                               ) {
    ...
    if (xBusFramePosition == xBusFrameLength) {
        ...
        xBusDataIncoming = 
# 252 "./src/main/rx/xbus.c" 3 4
                          0
# 252 "./src/main/rx/xbus.c"
                               ;
        xBusFramePosition = 0;
    }
}
...
static uint8_t xBusFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    xBusFrameReceived = 
# 266 "./src/main/rx/xbus.c" 3 4
                       0
# 266 "./src/main/rx/xbus.c"
                            ;
...
# 285 "./src/main/rx/xbus.c" 3 4
_Bool 
# 285 "./src/main/rx/xbus.c"
    xBusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    uint32_t baudRate;
    ...
    case SERIALRX_XBUS_MODE_B:
        ...
        xBusFrameReceived = 
# 292 "./src/main/rx/xbus.c" 3 4
                           0
# 292 "./src/main/rx/xbus.c"
                                ;
        xBusDataIncoming = 
...
# 293 "./src/main/rx/xbus.c"
    ...
    case SERIALRX_XBUS_MODE_B_RJ01:
        rxRuntimeConfig->channelCount = 12;
        xBusFrameReceived = 
# 302 "./src/main/rx/xbus.c" 3 4
                           0
# 302 "./src/main/rx/xbus.c"
                                ;
        xBusDataIncoming = 
...
# 303 "./src/main/rx/xbus.c"
    ...
    default:
        return 
# 311 "./src/main/rx/xbus.c" 3 4
              0
# 311 "./src/main/rx/xbus.c"
                   ;
        break;
    }
    ...
    if (!portConfig) {
        return 
# 322 "./src/main/rx/xbus.c" 3 4
              0
# 322 "./src/main/rx/xbus.c"
                   ;
    }


    
# 326 "./src/main/rx/xbus.c" 3 4
   _Bool 
# 326 "./src/main/rx/xbus.c"
...
# 334 "./src/main/rx/xbus.c" 3 4
       ((void *)0)
# 334 "./src/main/rx/xbus.c"
           ,
        baudRate,
