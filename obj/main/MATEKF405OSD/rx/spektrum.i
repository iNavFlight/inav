...
# 62 "./src/main/rx/spektrum.c"
                                  ;
static 
# 63 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 63 "./src/main/rx/spektrum.c"
           spekHiRes = 
# 63 "./src/main/rx/spektrum.c" 3 4
                       0
# 63 "./src/main/rx/spektrum.c"
...
static IO_t BindPin = (IO_t)
# 78 "./src/main/rx/spektrum.c" 3 4
                     ((void *)0)
# 78 "./src/main/rx/spektrum.c"
                                   ;
...
static void spektrumDataReceive(uint16_t c, void *rxCallbackData)
{
    ...
    if (spekFramePosition < 16) {
        ...
        if (spekFramePosition == 16) {
            rcFrameComplete = 
# 106 "./src/main/rx/spektrum.c" 3 4
                             1
# 106 "./src/main/rx/spektrum.c"
                                 ;
        } else {
            rcFrameComplete = 
...
static uint8_t spektrumFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    rcFrameComplete = 
# 123 "./src/main/rx/spektrum.c" 3 4
                     0
# 123 "./src/main/rx/spektrum.c"
                          ;


    const uint16_t fade = (spekFrame[0] << 8) + spekFrame[1];
    const uint32_t current_secs = millis() / (1000 / 2);
...
# 179 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 179 "./src/main/rx/spektrum.c"
    spekShouldBind(uint8_t spektrum_sat_bind)
{
# 193 "./src/main/rx/spektrum.c"
    return !(
        isMPUSoftReset() ||
        spektrum_sat_bind == 0 ||
...
void spektrumBind(rxConfig_t *rxConfig)
{
    ...
    ledSet(1, 
# 212 "./src/main/rx/spektrum.c" 3 4
   1
# 212 "./src/main/rx/spektrum.c"
   );

    BindPin = IOGetByTag(((((0) + 1) << 4) | (3)));
    IOInit(BindPin, OWNER_RX, RESOURCE_OUTPUT, 0);
    IOConfigGPIO(BindPin, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));


    IOWrite(BindPin, 
# 219 "./src/main/rx/spektrum.c" 3 4
                    1
# 219 "./src/main/rx/spektrum.c"
                        );


    delay(60);
    ledSet(1, 
# 223 "./src/main/rx/spektrum.c" 3 4
   0
# 223 "./src/main/rx/spektrum.c"
   );

    for (i = 0; i < rxConfig->spektrum_sat_bind; i++) {

        ledSet(0, 
# 227 "./src/main/rx/spektrum.c" 3 4
       0
# 227 "./src/main/rx/spektrum.c"
       );
        do {} while (0);

        IOWrite(BindPin, 
# 230 "./src/main/rx/spektrum.c" 3 4
                        0
# 230 "./src/main/rx/spektrum.c"
                             );
        delayMicroseconds(120);

        ledSet(0, 
# 233 "./src/main/rx/spektrum.c" 3 4
       1
# 233 "./src/main/rx/spektrum.c"
       );
        do {} while (0);

        IOWrite(BindPin, 
# 236 "./src/main/rx/spektrum.c" 3 4
                        1
# 236 "./src/main/rx/spektrum.c"
                            );
        delayMicroseconds(120);
...
# 254 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 254 "./src/main/rx/spektrum.c"
    spektrumInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    case SERIALRX_SPEKTRUM2048:
        ...
        spek_chan_mask = 0x07;
        spekHiRes = 
# 263 "./src/main/rx/spektrum.c" 3 4
                   1
# 263 "./src/main/rx/spektrum.c"
                       ;
    ...
    case SERIALRX_SPEKTRUM1024:
        ...
        spek_chan_mask = 0x03;
        spekHiRes = 
# 271 "./src/main/rx/spektrum.c" 3 4
                   0
# 271 "./src/main/rx/spektrum.c"
                        ;
    ...
    if (!portConfig) {
        return 
# 282 "./src/main/rx/spektrum.c" 3 4
              0
# 282 "./src/main/rx/spektrum.c"
                   ;
    }


    
# 286 "./src/main/rx/spektrum.c" 3 4
   _Bool 
# 286 "./src/main/rx/spektrum.c"
...
# 294 "./src/main/rx/spektrum.c" 3 4
       ((void *)0)
# 294 "./src/main/rx/spektrum.c"
           ,
        115200,
    ...
    return serialPort != 
# 311 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 311 "./src/main/rx/spektrum.c"
                            ;
}
