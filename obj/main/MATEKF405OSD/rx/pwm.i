...
#define RC_PWM_50HZ_UPDATE (20 * 1000)
...
static uint8_t pwmFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (isPWMDataBeingReceived()) {
        if ((currentTimeUs - lastReceivedFrameUs) >= (20 * 1000)) {
...
void rxPwmInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    rxRuntimeConfig->rxRefreshRate = (20 * 1000);
    rxRuntimeConfig->requireFiltering = 
# 101 "./src/main/rx/pwm.c" 3 4
                                       1
# 101 "./src/main/rx/pwm.c"
                                           ;
