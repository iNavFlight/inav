...
# 22 "./src/main/blackbox/blackbox_fielddefs.h" 2
...
# 27 "./src/main/blackbox/blackbox_io.c" 2
...
# 32 "./src/main/blackbox/blackbox_io.c" 2
...
# 54 "./src/main/blackbox/blackbox_io.c" 3 4
                                               ((void *)0)
# 54 "./src/main/blackbox/blackbox_io.c"
                                                   ;
...
# 120 "./src/main/blackbox/blackbox_io.c" 3 4
                                                0
# 120 "./src/main/blackbox/blackbox_io.c"
                                                     );
        break;
...
# 174 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 174 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceFlushForce(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_SERIAL:
    ...
    default:
        return 
# 195 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 195 "./src/main/blackbox/blackbox_io.c"
                   ;
    }
}
...
# 203 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 203 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceOpen(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_SERIAL:
        {
            ...
            if (!portConfig) {
                return 
# 213 "./src/main/blackbox/blackbox_io.c" 3 4
                      0
# 213 "./src/main/blackbox/blackbox_io.c"
                           ;
            }
...
# 229 "./src/main/blackbox/blackbox_io.c" 3 4
                                                                                    ((void *)0)
# 229 "./src/main/blackbox/blackbox_io.c"
                                                                                        , 
# 229 "./src/main/blackbox/blackbox_io.c" 3 4
                                                                                          ((void *)0)
# 229 "./src/main/blackbox/blackbox_io.c"
                ...
                MODE_TX, portOptions);
# 242 "./src/main/blackbox/blackbox_io.c"
            blackboxMaxHeaderBytesPerIteration = constrain((gyro.targetLooptime * 3) / 500, 1, 64);

            return blackboxPort != 
# 244 "./src/main/blackbox/blackbox_io.c" 3 4
                                  ((void *)0)
# 244 "./src/main/blackbox/blackbox_io.c"
                                      ;
        }
        break;
    ...
    case BLACKBOX_DEVICE_FLASH:
        if (flashfsGetSize() == 0 || isBlackboxDeviceFull()) {
            return 
# 250 "./src/main/blackbox/blackbox_io.c" 3 4
                  0
# 250 "./src/main/blackbox/blackbox_io.c"
                       ;
        }
        ...
        return 
# 255 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 255 "./src/main/blackbox/blackbox_io.c"
                  ;
        break;
    ...
    case BLACKBOX_DEVICE_SDCARD:
        if (afatfs_getFilesystemState() == AFATFS_FILESYSTEM_STATE_FATAL || afatfs_getFilesystemState() == AFATFS_FILESYSTEM_STATE_UNKNOWN || afatfs_isFull()) {
            return 
# 261 "./src/main/blackbox/blackbox_io.c" 3 4
                  0
# 261 "./src/main/blackbox/blackbox_io.c"
                       ;
        }
        ...
        return 
# 266 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 266 "./src/main/blackbox/blackbox_io.c"
                  ;
        break;

    default:
        return 
# 270 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 270 "./src/main/blackbox/blackbox_io.c"
                   ;
    }
}
...
void blackboxDeviceClose(void)
{
    ...
    case BLACKBOX_DEVICE_SERIAL:
        ...
        blackboxPort = 
# 285 "./src/main/blackbox/blackbox_io.c" 3 4
                      ((void *)0)
# 285 "./src/main/blackbox/blackbox_io.c"
                          ;
...
static 
# 362 "./src/main/blackbox/blackbox_io.c" 3 4
      _Bool 
# 362 "./src/main/blackbox/blackbox_io.c"
        ...
        while (afatfs_findNext(blackboxSDCard.logDirectory, &blackboxSDCard.logDirectoryFinder, &directoryEntry) == AFATFS_OPERATION_SUCCESS) {
            if (directoryEntry && !fat_isDirectoryEntryTerminator(directoryEntry)) {
                ...
                if (
                    ...
                    blackboxSDCard.largestLogFileNumber = ( __extension__ ({ __typeof__((uint32_t) fastA2I(logSequenceNumberString)) _left0 = ((uint32_t) fastA2I(logSequenceNumberString)); __typeof__(blackboxSDCard.largestLogFileNumber) _right1 = (blackboxSDCard.largestLogFileNumber); _left0 > _right1 ? _left0 : _right1; }));
                }
            } else {
...
# 409 "./src/main/blackbox/blackbox_io.c" 3 4
                                                      ((void *)0)
# 409 "./src/main/blackbox/blackbox_io.c"
                                                          );
            blackboxSDCard.logDirectory = 
# 410 "./src/main/blackbox/blackbox_io.c" 3 4
                                         ((void *)0)
# 410 "./src/main/blackbox/blackbox_io.c"
                                             ;
    ...
    case BLACKBOX_SDCARD_READY_TO_LOG:
        return 
# 422 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 422 "./src/main/blackbox/blackbox_io.c"
                  ;
    }


    return 
# 426 "./src/main/blackbox/blackbox_io.c" 3 4
          0
# 426 "./src/main/blackbox/blackbox_io.c"
               ;
}
# 436 "./src/main/blackbox/blackbox_io.c"

# 436 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 436 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceBeginLog(void)
{
    ...
    default:
        return 
# 444 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 444 "./src/main/blackbox/blackbox_io.c"
                  ;
    }

}
# 456 "./src/main/blackbox/blackbox_io.c"

# 456 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 456 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceEndLog(
# 456 "./src/main/blackbox/blackbox_io.c" 3 4
...
# 468 "./src/main/blackbox/blackbox_io.c" 3 4
                                                                    ((void *)0)
# 468 "./src/main/blackbox/blackbox_io.c"
                                                                        ))
        ) {

            blackboxSDCard.logFile = 
# 471 "./src/main/blackbox/blackbox_io.c" 3 4
                                    ((void *)0)
# 471 "./src/main/blackbox/blackbox_io.c"
                                        ;
            blackboxSDCard.state = BLACKBOX_SDCARD_READY_TO_CREATE_LOG;
            return 
# 473 "./src/main/blackbox/blackbox_io.c" 3 4
                  1
# 473 "./src/main/blackbox/blackbox_io.c"
                      ;
        }
        return 
# 475 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 475 "./src/main/blackbox/blackbox_io.c"
                   ;
...
# 486 "./src/main/blackbox/blackbox_io.c"
    ...
    default:
        return 
# 499 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 499 "./src/main/blackbox/blackbox_io.c"
                   ;
    }
}
...
void blackboxReplenishHeaderBudget(void)
{
    ...
    blackboxHeaderBudget = ( __extension__ ({ __typeof__(( __extension__ ({ __typeof__(freeSpace) _left2 = (freeSpace); __typeof__(blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration) _right3 = (blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration); _left2 < _right3 ? _left2 : _right3; }))) _left4 = (( __extension__ ({ __typeof__(freeSpace) _left2 = (freeSpace); __typeof__(blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration) _right3 = (blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration); _left2 < _right3 ? _left2 : _right3; }))); __typeof__(256) _right5 = (256); _left4 < _right5 ? _left4 : _right5; }));
}
# 550 "./src/main/blackbox/blackbox_io.c"
blackboxBufferReserveStatus_e blackboxDeviceReserveBufferSpace(int32_t bytes)
{
