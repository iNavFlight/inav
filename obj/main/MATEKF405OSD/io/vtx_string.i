...
const char * const vtx58BandNames[5 + 1] = {
    "--------",
    "BOSCAM A",
    "BOSCAM B",
    "BOSCAM E",
...
const char vtx58BandLetter[5 + 1] = "-ABEFR";

const char * const vtx58ChannelNames[8 + 1] = {
    "-", "1", "2", "3", "4", "5", "6", "7", "8",
};
    ...
    for (band = 4 ; band >= 0 ; band--) {
        for (channel = 0 ; channel < 8 ; channel++) {
            if (vtx58frequencyTable[band][channel] == freq) {
                ...
                *pChannel = channel + 1;
                return 
# 69 "./src/main/io/vtx_string.c" 3 4
                      1
# 69 "./src/main/io/vtx_string.c"
                          ;
            }
        }
    }
    ...
    *pChannel = 0;
    ...
    return 
# 77 "./src/main/io/vtx_string.c" 3 4
          0
# 77 "./src/main/io/vtx_string.c"
               ;
}
