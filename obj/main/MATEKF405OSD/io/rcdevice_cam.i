...
# 21 "./src/main/io/rcdevice_cam.c" 2
...
# 23 "./src/main/io/rcdevice_cam.c" 2
...
# 25 "./src/main/io/rcdevice_cam.c" 2
...
# 28 "./src/main/io/rcdevice_cam.c" 2
...
# 32 "./src/main/io/rcdevice_cam.c" 2
...
# 34 "./src/main/io/rcdevice_cam.c" 2
...
# 61 "./src/main/io/rcdevice_cam.c"
                                     && (isPowerSimulationSupported || isWiFiSimulationSupported || isChangeModeSupported)) {
        return 
# 62 "./src/main/io/rcdevice_cam.c" 3 4
              1
# 62 "./src/main/io/rcdevice_cam.c"
                  ;
    }

    return 
# 65 "./src/main/io/rcdevice_cam.c" 3 4
          0
# 65 "./src/main/io/rcdevice_cam.c"
               ;
}


# 68 "./src/main/io/rcdevice_cam.c" 3 4
_Bool 
# 68 "./src/main/io/rcdevice_cam.c"
    rcdeviceIsEnabled(void)
{
...
# 70 "./src/main/io/rcdevice_cam.c"
        is5KeySimulationSupported = isFeatureSupported(RCDEVICE_PROTOCOL_FEATURE_SIMULATE_5_KEY_OSD_CABLE);

    if (camDevice->serialPort != 
# 72 "./src/main/io/rcdevice_cam.c" 3 4
                                ((void *)0) 
# 72 "./src/main/io/rcdevice_cam.c"
                                     && (rcdeviceIsCameraControlEnabled() || is5KeySimulationSupported)) {
        return 
# 73 "./src/main/io/rcdevice_cam.c" 3 4
              1
# 73 "./src/main/io/rcdevice_cam.c"
                  ;
    }

    return 
# 76 "./src/main/io/rcdevice_cam.c" 3 4
          0
# 76 "./src/main/io/rcdevice_cam.c"
               ;
}

static 
# 79 "./src/main/io/rcdevice_cam.c" 3 4
      _Bool 
# 79 "./src/main/io/rcdevice_cam.c"
...
# 81 "./src/main/io/rcdevice_cam.c"
        ...
        return 
# 82 "./src/main/io/rcdevice_cam.c" 3 4
              1
# 82 "./src/main/io/rcdevice_cam.c"
                  ;
    }

    return 
# 85 "./src/main/io/rcdevice_cam.c" 3 4
          0
# 85 "./src/main/io/rcdevice_cam.c"
               ;
}
...
{
    static 
# 90 "./src/main/io/rcdevice_cam.c" 3 4
          _Bool 
# 90 "./src/main/io/rcdevice_cam.c"
               hasSynchronizedTime = 
# 90 "./src/main/io/rcdevice_cam.c" 3 4
                                     0
# 90 "./src/main/io/rcdevice_cam.c"
...
# 109 "./src/main/io/rcdevice_cam.c" 3 4
           _Bool 
# 109 "./src/main/io/rcdevice_cam.c"
                ok = runcamDeviceWriteSetting(camDevice, RCDEVICE_PROTOCOL_SETTINGID_CAMERA_TIME,
                buf, sizeof(buf), &updateSettingResponse);
            if (ok && updateSettingResponse.resultCode == 0) {
                hasSynchronizedTime = 
# 112 "./src/main/io/rcdevice_cam.c" 3 4
                                     1
# 112 "./src/main/io/rcdevice_cam.c"
                                         ;
            }
        }
    }
...
# 152 "./src/main/io/rcdevice_cam.c" 3 4
                                                       1
# 152 "./src/main/io/rcdevice_cam.c"
                                                           ;
            }
        } else {
            switchStates[switchIndex].isActivated = 
# 155 "./src/main/io/rcdevice_cam.c" 3 4
                                                   0
# 155 "./src/main/io/rcdevice_cam.c"
                                                        ;
        }
    }
...
static 
# 161 "./src/main/io/rcdevice_cam.c" 3 4
      _Bool 
# 161 "./src/main/io/rcdevice_cam.c"
...
static 
# 188 "./src/main/io/rcdevice_cam.c" 3 4
      _Bool 
# 188 "./src/main/io/rcdevice_cam.c"
           rcdeviceSend5KeyOSDCableSimualtionEvent(rcdeviceCamSimulationKeyEvent_e key)
{
    
# 190 "./src/main/io/rcdevice_cam.c" 3 4
   _Bool 
# 190 "./src/main/io/rcdevice_cam.c"
        reqResult = 
# 190 "./src/main/io/rcdevice_cam.c" 3 4
                    0
# 190 "./src/main/io/rcdevice_cam.c"
...
# 195 "./src/main/io/rcdevice_cam.c"
    ...
    case RCDEVICE_CAM_KEY_CONNECTION_CLOSE:
        ...
        if (reqResult) {
            rcdeviceInMenu = 
# 202 "./src/main/io/rcdevice_cam.c" 3 4
                            0
# 202 "./src/main/io/rcdevice_cam.c"
                                 ;
    ...
    default:
        reqResult = 
# 217 "./src/main/io/rcdevice_cam.c" 3 4
                   0
# 217 "./src/main/io/rcdevice_cam.c"
                        ;
        break;
    }
...
static void rcdevice5KeySimulationProcess(timeUs_t currentTimeUs)
{
    ...
    if (needRelease) {
        if ((rcData[YAW] > 1250 && rcData[YAW] < 1750) && (rcData[PITCH] > 1250 && rcData[PITCH] < 1750) && (rcData[ROLL] > 1250 && rcData[ROLL] < 1750)) {
            key = RCDEVICE_CAM_KEY_RELEASE;
            if (rcdeviceSend5KeyOSDCableSimualtionEvent(key)) {
                needRelease = 
# 244 "./src/main/io/rcdevice_cam.c" 3 4
                             0
# 244 "./src/main/io/rcdevice_cam.c"
                                  ;
            } else {
                rcdeviceInMenu = 
# 246 "./src/main/io/rcdevice_cam.c" 3 4
                                0
# 246 "./src/main/io/rcdevice_cam.c"
                                     ;
            }
            return;
        } else {
        ...
        if ((rcData[THROTTLE] > 1250 && rcData[THROTTLE] < 1750) && (rcData[ROLL] > 1250 && rcData[ROLL] < 1750) && (rcData[PITCH] > 1250 && rcData[PITCH] < 1750) && (rcData[YAW] < 1250)) {
            if (rcdeviceInMenu) {
            ...
            if (rcdeviceInMenu) {
                ...
                } else if ((rcData[THROTTLE] > 1250 && rcData[THROTTLE] < 1750) && (rcData[ROLL] > 1250 && rcData[ROLL] < 1750) && (rcData[PITCH] > 1250 && rcData[PITCH] < 1750) && (rcData[YAW] > 1750)) {
                    key = RCDEVICE_CAM_KEY_ENTER;
                }
            } else {
                if ((rcData[THROTTLE] > 1250 && rcData[THROTTLE] < 1750) && (rcData[ROLL] > 1250 && rcData[ROLL] < 1750) && (rcData[PITCH] > 1250 && rcData[PITCH] < 1750) && (rcData[YAW] > 1750) && !(armingFlags & (ARMED))) {
    ...
    if (key != RCDEVICE_CAM_KEY_NONE) {
        if (rcdeviceSend5KeyOSDCableSimualtionEvent(key)) {
            needRelease = 
# 280 "./src/main/io/rcdevice_cam.c" 3 4
                         1
# 280 "./src/main/io/rcdevice_cam.c"
                             ;
        } else {
            rcdeviceInMenu = 
# 282 "./src/main/io/rcdevice_cam.c" 3 4
                            0
# 282 "./src/main/io/rcdevice_cam.c"
                                 ;
        }
    }
}
    ...
    rcdeviceInit(void)
{
    ...
    if (!runcamDeviceInit(camDevice)) {
        return 
# 302 "./src/main/io/rcdevice_cam.c" 3 4
              0
# 302 "./src/main/io/rcdevice_cam.c"
                   ;
    }
    ...
    for (boxId_e i = BOXCAMERA1; i <= BOXCAMERA3; i++) {
        uint8_t switchIndex = i - BOXCAMERA1;
        switchStates[switchIndex].isActivated = 
# 307 "./src/main/io/rcdevice_cam.c" 3 4
                                               1
# 307 "./src/main/io/rcdevice_cam.c"
                                                   ;
    }

    return 
# 310 "./src/main/io/rcdevice_cam.c" 3 4
          1
# 310 "./src/main/io/rcdevice_cam.c"
              ;
}
