...
# 67 "./src/main/io/rcdevice.c" 3 4
                                                                                                 _Bool 
# 67 "./src/main/io/rcdevice.c"
                                                                                                      *isDone)
{
    if (isDone == 
# 69 "./src/main/io/rcdevice.c" 3 4
                 ((void *)0)
# 69 "./src/main/io/rcdevice.c"
                     ) {
        return 
# 70 "./src/main/io/rcdevice.c" 3 4
              0
# 70 "./src/main/io/rcdevice.c"
                   ;
    }
    ...
    if (expectedResponseDataLength == 0xFF) {
        ...
        if (dataLen >= 3) {
            ...
            if (dataLen >= (settingDataLength + 4)) {
                *isDone = 
# 80 "./src/main/io/rcdevice.c" 3 4
                         1
# 80 "./src/main/io/rcdevice.c"
                             ;
                return 
# 81 "./src/main/io/rcdevice.c" 3 4
                      1
# 81 "./src/main/io/rcdevice.c"
                          ;
            }
        }
...
# 89 "./src/main/io/rcdevice.c"
                     ;
        return 
# 90 "./src/main/io/rcdevice.c" 3 4
              1
# 90 "./src/main/io/rcdevice.c"
                  ;
    }

    return 
# 93 "./src/main/io/rcdevice.c" 3 4
          1
# 93 "./src/main/io/rcdevice.c"
              ;
}
...
# 105 "./src/main/io/rcdevice.c" 3 4
   _Bool 
# 105 "./src/main/io/rcdevice.c"
        isWaitingHeader = 
# 105 "./src/main/io/rcdevice.c" 3 4
                          1
# 105 "./src/main/io/rcdevice.c"
    ...
    while (millis() < timeout) {
        if (serialRxBytesWaiting(device->serialPort) > 0) {
            ...
            if (isWaitingHeader) {
                if (c == 0xCC) {
                    isWaitingHeader = 
# 118 "./src/main/io/rcdevice.c" 3 4
                                     0
# 118 "./src/main/io/rcdevice.c"
                                          ;
                }
            } else {
                
# 121 "./src/main/io/rcdevice.c" 3 4
               _Bool 
# 121 "./src/main/io/rcdevice.c"
                    isDone = 
# 121 "./src/main/io/rcdevice.c" 3 4
                             0
# 121 "./src/main/io/rcdevice.c"
...
static 
# 184 "./src/main/io/rcdevice.c" 3 4
      _Bool 
# 184 "./src/main/io/rcdevice.c"
...
# 212 "./src/main/io/rcdevice.c"
    ...
    return 
# 216 "./src/main/io/rcdevice.c" 3 4
          0
# 216 "./src/main/io/rcdevice.c"
               ;
}
...
static 
# 259 "./src/main/io/rcdevice.c" 3 4
      _Bool 
# 259 "./src/main/io/rcdevice.c"
    ...
    while (max_retries--) {
        ...
        while (millis() < timeout) {
            if (serialRxBytesWaiting(device->serialPort) >= 5) {
                ...
                outputBuffer[4] = crc;
                return 
# 301 "./src/main/io/rcdevice.c" 3 4
                      1
# 301 "./src/main/io/rcdevice.c"
                          ;
            }
        }
    }
...
# 306 "./src/main/io/rcdevice.c" 3 4
                                                                                                   ((void *)0)
# 306 "./src/main/io/rcdevice.c"
                                                                                                       , 0, outputBuffer, 
# 306 "./src/main/io/rcdevice.c" 3 4
                                                                                                                          ((void *)0)
# 306 "./src/main/io/rcdevice.c"
...
static 
# 309 "./src/main/io/rcdevice.c" 3 4
      _Bool 
# 309 "./src/main/io/rcdevice.c"
           runcamDeviceSend5KeyOSDCableConnectionEvent(runcamDevice_t *device, uint8_t operation, uint8_t *outActionID, uint8_t *outErrorCode)
{
    ...
    if (!runcamDeviceSendRequestAndWaitingResp(device, 0x04, &operation, sizeof(uint8_t), respBuf, &outputDataLen)) {
        return 
# 314 "./src/main/io/rcdevice.c" 3 4
              0
# 314 "./src/main/io/rcdevice.c"
                   ;
    }
...
# 320 "./src/main/io/rcdevice.c" 3 4
   _Bool 
# 320 "./src/main/io/rcdevice.c"
    ...
    return 
# 329 "./src/main/io/rcdevice.c" 3 4
          1
# 329 "./src/main/io/rcdevice.c"
              ;
}
...
# 336 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 336 "./src/main/io/rcdevice.c"
    runcamDeviceInit(runcamDevice_t *device)
{
    serialPortFunction_e portID = FUNCTION_RCDEVICE;
    serialPortConfig_t *portConfig = findSerialPortConfig(portID);
    if (portConfig != 
# 340 "./src/main/io/rcdevice.c" 3 4
                     ((void *)0)
# 340 "./src/main/io/rcdevice.c"
                         ) {
...
# 341 "./src/main/io/rcdevice.c"
        ...
        if (device->serialPort != 
# 343 "./src/main/io/rcdevice.c" 3 4
                                 ((void *)0)
# 343 "./src/main/io/rcdevice.c"
                                     ) {
            ...
            if (runcamDeviceGetDeviceInfo(device, respBuf)) {
                ...
                return 
# 353 "./src/main/io/rcdevice.c" 3 4
                      1
# 353 "./src/main/io/rcdevice.c"
                          ;
            }
...
# 360 "./src/main/io/rcdevice.c"
                            ;
    return 
# 361 "./src/main/io/rcdevice.c" 3 4
          0
# 361 "./src/main/io/rcdevice.c"
               ;
}


# 364 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 364 "./src/main/io/rcdevice.c"
    runcamDeviceSimulateCameraButton(runcamDevice_t *device, uint8_t operation)
{
    if (device->info.protocolVersion == RCDEVICE_PROTOCOL_RCSPLIT_VERSION) {
        ...
        return 
# 371 "./src/main/io/rcdevice.c" 3 4
              0
# 371 "./src/main/io/rcdevice.c"
                   ;
    }

    return 
# 374 "./src/main/io/rcdevice.c" 3 4
          1
# 374 "./src/main/io/rcdevice.c"
              ;
}
...
# 379 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 379 "./src/main/io/rcdevice.c"
    runcamDeviceOpen5KeyOSDCableConnection(runcamDevice_t *device)
{
    uint8_t actionID = 0xFF;
    uint8_t code = 0xFF;
    
# 383 "./src/main/io/rcdevice.c" 3 4
   _Bool 
# 383 "./src/main/io/rcdevice.c"
...
# 389 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 389 "./src/main/io/rcdevice.c"
    runcamDeviceClose5KeyOSDCableConnection(runcamDevice_t *device)
{
    uint8_t actionID = 0xFF;
    uint8_t code = 0xFF;
    
# 393 "./src/main/io/rcdevice.c" 3 4
   _Bool 
# 393 "./src/main/io/rcdevice.c"
...
# 399 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 399 "./src/main/io/rcdevice.c"
    runcamDeviceSimulate5KeyOSDCableButtonPress(runcamDevice_t *device, uint8_t operation)
{
    if (operation == RCDEVICE_PROTOCOL_5KEY_SIMULATION_NONE) {
        return 
# 402 "./src/main/io/rcdevice.c" 3 4
              0
# 402 "./src/main/io/rcdevice.c"
                   ;
    }

    if (runcamDeviceSendRequestAndWaitingResp(device, 0x02, &operation, sizeof(uint8_t), 
# 405 "./src/main/io/rcdevice.c" 3 4
                                                                                                                                   ((void *)0)
# 405 "./src/main/io/rcdevice.c"
                                                                                                                                       , 
# 405 "./src/main/io/rcdevice.c" 3 4
                                                                                                                                         ((void *)0)
# 405 "./src/main/io/rcdevice.c"
...
# 406 "./src/main/io/rcdevice.c"
    ...
    return 
# 409 "./src/main/io/rcdevice.c" 3 4
          0
# 409 "./src/main/io/rcdevice.c"
               ;
}



# 413 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 413 "./src/main/io/rcdevice.c"
    runcamDeviceSimulate5KeyOSDCableButtonRelease(runcamDevice_t *device)
{
    return runcamDeviceSendRequestAndWaitingResp(device, 0x03, 
# 415 "./src/main/io/rcdevice.c" 3 4
                                                                                                           ((void *)0)
# 415 "./src/main/io/rcdevice.c"
                                                                                                               , 0, 
# 415 "./src/main/io/rcdevice.c" 3 4
                                                                                                                    ((void *)0)
# 415 "./src/main/io/rcdevice.c"
...
static 
# 418 "./src/main/io/rcdevice.c" 3 4
      _Bool 
# 418 "./src/main/io/rcdevice.c"
           runcamDeviceDecodeSettingDetail(sbuf_t *buf, runcamDeviceSettingDetail_t *outSettingDetail)
{
    char * saveptr;

    if (outSettingDetail == 
# 422 "./src/main/io/rcdevice.c" 3 4
                           ((void *)0) 
# 422 "./src/main/io/rcdevice.c"
                                || sbufBytesRemaining(buf) == 0) {
        return 
# 423 "./src/main/io/rcdevice.c" 3 4
              0
# 423 "./src/main/io/rcdevice.c"
                   ;
    }
    ...
    case RCDEVICE_PROTOCOL_SETTINGTYPE_TEXT_SELECTION: {
        ...
        while (result != 
# 462 "./src/main/io/rcdevice.c" 3 4
                        ((void *)0)
# 462 "./src/main/io/rcdevice.c"
                            ) {
            if (i >= 30) {
                break;
            }
            ...
            iterator++;
            result = strtok_r(
# 470 "./src/main/io/rcdevice.c" 3 4
                             ((void *)0)
# 470 "./src/main/io/rcdevice.c"
                                 , delims, &saveptr);
            i++;
        }
    }
    ...
    return 
# 495 "./src/main/io/rcdevice.c" 3 4
          1
# 495 "./src/main/io/rcdevice.c"
              ;
}
...
{
    if (responseData == 
# 500 "./src/main/io/rcdevice.c" 3 4
                       ((void *)0) 
# 500 "./src/main/io/rcdevice.c"
                            || responseDatalen == 
# 500 "./src/main/io/rcdevice.c" 3 4
                                                  ((void *)0)
# 500 "./src/main/io/rcdevice.c"
        ...
        return 
# 501 "./src/main/io/rcdevice.c" 3 4
              0
# 501 "./src/main/io/rcdevice.c"
                   ;
    }
...
# 512 "./src/main/io/rcdevice.c" 3 4
   _Bool 
# 512 "./src/main/io/rcdevice.c"
        result = runcamDeviceSendRequestAndWaitingResp(device, command, paramsBuf, sizeof(paramsBuf), outputBuf, &outputBufLen);
    if (!result) {
        return 
# 514 "./src/main/io/rcdevice.c" 3 4
              0
# 514 "./src/main/io/rcdevice.c"
                   ;
    }
    ...
    if (remainingChunk >= 12) {
        return 
# 520 "./src/main/io/rcdevice.c" 3 4
              0
# 520 "./src/main/io/rcdevice.c"
                   ;
    }
    ...
    while (remainingChunk > 0) {
        ...
        if (!result) {
            return 
# 539 "./src/main/io/rcdevice.c" 3 4
                  0
# 539 "./src/main/io/rcdevice.c"
                       ;
        }
...
# 558 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 558 "./src/main/io/rcdevice.c"
    runcamDeviceGetSettingDetail(runcamDevice_t *device, uint8_t settingID, runcamDeviceSettingDetail_t *outSettingDetail)
{
    if (outSettingDetail == 
# 560 "./src/main/io/rcdevice.c" 3 4
                           ((void *)0)
# 560 "./src/main/io/rcdevice.c"
                               )
        return 
# 561 "./src/main/io/rcdevice.c" 3 4
              0
# 561 "./src/main/io/rcdevice.c"
                   ;
...
# 566 "./src/main/io/rcdevice.c"
    ...
    if (!runcamDeviceDecodeSettingDetail(&dataBuf, outSettingDetail)) {
        return 
# 575 "./src/main/io/rcdevice.c" 3 4
              0
# 575 "./src/main/io/rcdevice.c"
                   ;
    }

    return 
# 578 "./src/main/io/rcdevice.c" 3 4
          1
# 578 "./src/main/io/rcdevice.c"
              ;
}



# 582 "./src/main/io/rcdevice.c" 3 4
_Bool 
# 582 "./src/main/io/rcdevice.c"
    runcamDeviceWriteSetting(runcamDevice_t *device, uint8_t settingID, const void *paramData, uint8_t paramDataLen, runcamDeviceWriteSettingResponse_t *response)
{
    if (response == 
# 584 "./src/main/io/rcdevice.c" 3 4
                   ((void *)0) 
# 584 "./src/main/io/rcdevice.c"
                        || paramDataLen > (62 - 1)) {
        return 
# 585 "./src/main/io/rcdevice.c" 3 4
              0
# 585 "./src/main/io/rcdevice.c"
                   ;
    }
...
# 598 "./src/main/io/rcdevice.c" 3 4
   _Bool 
# 598 "./src/main/io/rcdevice.c"
        result = runcamDeviceSendRequestAndWaitingResp(device, 0x13, paramsBuf, paramsBufLen, outputBuf, &outputBufLen);
    if (!result) {
        return 
# 600 "./src/main/io/rcdevice.c" 3 4
              0
# 600 "./src/main/io/rcdevice.c"
                   ;
    }
    ...
    return 
# 606 "./src/main/io/rcdevice.c" 3 4
          1
# 606 "./src/main/io/rcdevice.c"
              ;
}
