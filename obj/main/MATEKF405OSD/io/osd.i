...
#define STM32F4 1
#define MATEKF405OSD 1
#define MATEKF405 1
#define __FORKNAME__ "inav"
#define __TARGET__ "MATEKF405OSD"
#define __REVISION__ "32298a7"
# 1 "./src/main/io/osd.c"
...
# 188 "/usr/arm-none-eabi/include/stdlib.h" 3
...
# 221 "/usr/arm-none-eabi/include/stdlib.h" 3
...
# 308 "/usr/arm-none-eabi/include/stdlib.h" 3
void qsort_r (void *__base, size_t __nmemb, size_t __size, void *__thunk, int (*_compar)(void *, const void *, const void *))
             __asm__ ("" "__bsd_qsort_r");
# 318 "/usr/arm-none-eabi/include/stdlib.h" 3
extern long double _strtold_r (struct _reent *, const char *restrict, char **restrict);

extern long double strtold (const char *restrict, char **restrict);
# 335 "/usr/arm-none-eabi/include/stdlib.h" 3
...
# 1 "/usr/arm-none-eabi/include/ctype.h" 1 3

#define _CTYPE_H_ 
# 11 "/usr/arm-none-eabi/include/ctype.h" 3
...
# 82 "/usr/arm-none-eabi/include/ctype.h" 3
...
# 165 "/usr/arm-none-eabi/include/ctype.h" 3
...
# 1 "./src/main/target/MATEKF405/target.h" 1
# 18 "./src/main/target/MATEKF405/target.h"
...
# 157 "./src/main/target/MATEKF405/target.h"
#define USE_BARO 
...
# 26 "./src/main/drivers/display.h" 3 4
   _Bool 
# 26 "./src/main/drivers/display.h"
        force_sw_blink;
} displayConfig_t;

extern displayConfig_t displayConfig_System; extern displayConfig_t displayConfig_Copy; static inline const displayConfig_t* displayConfig(void) { return &displayConfig_System; } static inline displayConfig_t* displayConfigMutable(void) { return &displayConfig_System; } struct _dummy;
...
# 81 "./src/main/drivers/display.h"
        (*readChar)(displayPort_t *displayPort, uint8_t x, uint8_t y, uint8_t *c, textAttributes_t *attr);
    
# 82 "./src/main/drivers/display.h" 3 4
   _Bool 
# 82 "./src/main/drivers/display.h"
...
# 92 "./src/main/drivers/display.h" 3 4
   _Bool 
# 92 "./src/main/drivers/display.h"
        invert;
...
# 109 "./src/main/drivers/display.h" 3 4
_Bool 
# 109 "./src/main/drivers/display.h"
    displayReadCharWithAttr(displayPort_t *instance, uint8_t x, uint8_t y, uint8_t *c, textAttributes_t *attr);

# 110 "./src/main/drivers/display.h" 3 4
_Bool 
# 110 "./src/main/drivers/display.h"
...
#define PRINT_LABEL (1 << 1)
#define DYNAMIC (1 << 2)
#define OPTSTRING (1 << 3)
#define READONLY (1 << 4)
...
typedef enum {
    CMS_DATA_TYPE_ANGULAR_RATE = (1 << (4)),
} CMSDataType_e;
...
#define MENU_CHAIN_BACK (-1)
# 127 "./src/main/cms/cms_types.h"
...
# 8 "./src/main/cms/cms.h" 2

extern 
# 9 "./src/main/cms/cms.h" 3 4
      _Bool 
# 9 "./src/main/cms/cms.h"
           cmsInMenu;



# 12 "./src/main/cms/cms.h" 3 4
_Bool 
# 12 "./src/main/cms/cms.h"
...
# 1 "/usr/lib/gcc/arm-none-eabi/7.3.1/include/stdarg.h" 1 3 4
# 31 "/usr/lib/gcc/arm-none-eabi/7.3.1/include/stdarg.h" 3 4
#define _STDARG_H 
...
# 40 "/usr/lib/gcc/arm-none-eabi/7.3.1/include/stdarg.h" 3 4
...
# 99 "/usr/lib/gcc/arm-none-eabi/7.3.1/include/stdarg.h" 3 4
...
# 46 "./src/main/io/osd.c" 2
# 1 "./src/main/common/string_light.h" 1
# 18 "./src/main/common/string_light.h"
...
# 22 "./src/main/drivers/vtx_common.h"
#define VTX_SETTINGS_NO_BAND 0
...
#define VTX_SETTINGS_MIN_FREQUENCY_MHZ 0
#define VTX_SETTINGS_MAX_FREQUENCY_MHZ 5999
# 48 "./src/main/drivers/vtx_common.h"
...
# 110 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
# 110 "./src/main/drivers/vtx_common.h"
...
# 117 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
# 117 "./src/main/drivers/vtx_common.h"
        (*getBandAndChannel)(const vtxDevice_t *vtxDevice, uint8_t *pBand, uint8_t *pChannel);
    
# 118 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
# 118 "./src/main/drivers/vtx_common.h"
        (*getPowerIndex)(const vtxDevice_t *vtxDevice, uint8_t *pIndex);
    
# 119 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
# 119 "./src/main/drivers/vtx_common.h"
        (*getPitMode)(const vtxDevice_t *vtxDevice, uint8_t *pOnOff);
    
# 120 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
# 120 "./src/main/drivers/vtx_common.h"
...
# 135 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 135 "./src/main/drivers/vtx_common.h"
    vtxCommonDeviceIsReady(vtxDevice_t *vtxDevice);
...
# 140 "./src/main/drivers/vtx_common.h"
    vtxCommonGetBandAndChannel(vtxDevice_t *vtxDevice, uint8_t *pBand, uint8_t *pChannel);

# 141 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 141 "./src/main/drivers/vtx_common.h"
    vtxCommonGetPowerIndex(vtxDevice_t *vtxDevice, uint8_t *pIndex);

# 142 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 142 "./src/main/drivers/vtx_common.h"
    vtxCommonGetPitMode(vtxDevice_t *vtxDevice, uint8_t *pOnOff);

# 143 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 143 "./src/main/drivers/vtx_common.h"
    vtxCommonGetFrequency(const vtxDevice_t *vtxDevice, uint16_t *pFreq);

# 144 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 144 "./src/main/drivers/vtx_common.h"
    vtxCommonGetDeviceCapability(vtxDevice_t *vtxDevice, vtxDeviceCapability_t *pDeviceCapability);
# 59 "./src/main/io/osd.c" 2
...
typedef struct osdConfig_s {
    ...
    uint16_t item_pos[(3 + 1)][OSD_ITEM_COUNT];
...
# 175 "./src/main/io/osd.h" 3 4
   _Bool 
# 175 "./src/main/io/osd.h"
...
# 188 "./src/main/io/osd.h" 3 4
_Bool 
# 188 "./src/main/io/osd.h"
...
# 10 "./src/main/io/vtx_string.h" 3 4
_Bool 
# 10 "./src/main/io/vtx_string.h"
...
# 34 "./src/main/fc/controlrate_profile.h"
...
# 25 "./src/main/fc/fc_tasks.h" 3 4
_Bool 
# 25 "./src/main/fc/fc_tasks.h"
    taskUpdateRxCheck(timeUs_t currentTimeUs, timeDelta_t currentDeltaTime);
...
# 1 "/usr/lib/gcc/arm-none-eabi/7.3.1/include/stddef.h" 1 3 4
# 22 "./src/main/common/bitarray.h" 2
...
# 33 "./src/main/common/bitarray.h" 3 4
_Bool 
# 33 "./src/main/common/bitarray.h"
    bitArrayGet(const bitarrayElement_t *array, unsigned bit);
...
typedef struct boxBitmask_s { bitarrayElement_t bits[(CHECKBOX_ITEM_COUNT + 31) / 32]; } boxBitmask_t;
...
# 109 "./src/main/fc/rc_modes.h" 3 4
_Bool 
# 109 "./src/main/fc/rc_modes.h"
    IS_RC_MODE_ACTIVE(boxId_e boxId);
void rcModeUpdate(boxBitmask_t *newState);


# 112 "./src/main/fc/rc_modes.h" 3 4
_Bool 
# 112 "./src/main/fc/rc_modes.h"
...
# 116 "./src/main/fc/rc_modes.h" 3 4
_Bool 
# 116 "./src/main/fc/rc_modes.h"
    isUsingNavigationModes(void);
...
# 24 "./src/main/fc/rc_adjustments.h" 2
...
extern adjustmentRange_t adjustmentRanges_SystemArray[12]; extern adjustmentRange_t adjustmentRanges_CopyArray[12]; static inline const adjustmentRange_t* adjustmentRanges(int _index) { return &adjustmentRanges_SystemArray[_index]; } static inline adjustmentRange_t* adjustmentRangesMutable(int _index) { return &adjustmentRanges_SystemArray[_index]; } static inline adjustmentRange_t (* adjustmentRanges_array(void))[12] { return &adjustmentRanges_SystemArray; } struct _dummy;

void resetAdjustmentStates(void);
void updateAdjustmentStates(
# 138 "./src/main/fc/rc_adjustments.h" 3 4
                           _Bool 
# 138 "./src/main/fc/rc_adjustments.h"
                                canUseRxData);
struct controlRateConfig_s;
void processRcAdjustments(struct controlRateConfig_s *controlRateConfig, 
# 140 "./src/main/fc/rc_adjustments.h" 3 4
                                                                        _Bool 
# 140 "./src/main/fc/rc_adjustments.h"
                                                                             canUseRxData);

# 141 "./src/main/fc/rc_adjustments.h" 3 4
_Bool 
# 141 "./src/main/fc/rc_adjustments.h"
    isAdjustmentFunctionSelected(uint8_t adjustmentFunction);
...
# 1 "./src/main/fc/settings.h" 1
       


# 1 "/usr/lib/gcc/arm-none-eabi/7.3.1/include/stddef.h" 1 3 4
# 5 "./src/main/fc/settings.h" 2




# 1 "./obj/main/MATEKF405OSD/settings_generated.h" 1
...
static inline setting_type_e SETTING_TYPE(const setting_t *s) { return s->type & (0x0F); }
static inline setting_section_e SETTING_SECTION(const setting_t *s) { return s->type & (0x30); }
static inline setting_mode_e SETTING_MODE(const setting_t *s) { return s->type & (0xC0); }

void settingGetName(const setting_t *val, char *buf);

# 75 "./src/main/fc/settings.h" 3 4
_Bool 
# 75 "./src/main/fc/settings.h"
    settingNameContains(const setting_t *val, char *buf, const char *cmdline);

# 76 "./src/main/fc/settings.h" 3 4
_Bool 
# 76 "./src/main/fc/settings.h"
    settingNameIsExactMatch(const setting_t *val, char *buf, const char *cmdline, uint8_t var_name_length);
...
# 88 "./src/main/fc/settings.h" 3 4
_Bool 
# 88 "./src/main/fc/settings.h"
    settingsValidate(unsigned *invalidIndex);
...
# 128 "./src/main/fc/settings.h" 3 4
_Bool 
# 128 "./src/main/fc/settings.h"
    settingsGetParameterGroupIndexes(pgn_t pg, uint16_t *start, uint16_t *end);
...
# 1 "./src/main/flight/rth_estimator.h" 1


int32_t calculateRemainingFlightTimeBeforeRTH(
# 3 "./src/main/flight/rth_estimator.h" 3 4
                                             _Bool 
# 3 "./src/main/flight/rth_estimator.h"
                                                  takeWindIntoAccount);
int32_t calculateRemainingDistanceBeforeRTH(
# 4 "./src/main/flight/rth_estimator.h" 3 4
                                           _Bool 
# 4 "./src/main/flight/rth_estimator.h"
                                                takeWindIntoAccount);
# 79 "./src/main/io/osd.c" 2
# 1 "./src/main/flight/wind_estimator.h" 1
# 18 "./src/main/flight/wind_estimator.h"
       
# 28 "./src/main/flight/wind_estimator.h"

# 28 "./src/main/flight/wind_estimator.h" 3 4
_Bool 
# 28 "./src/main/flight/wind_estimator.h"
    isEstimatedWindSpeedValid(void);
...
# 28 "./src/main/navigation/navigation.h" 2
...
# 87 "./src/main/io/osd.c" 2
# 1 "./src/main/sensors/diagnostics.h" 1
...
# 28 "./src/main/sensors/diagnostics.h" 3 4
_Bool 
# 28 "./src/main/sensors/diagnostics.h"
    isHardwareHealthy(void);
# 88 "./src/main/io/osd.c" 2
...
# 20 "./src/main/drivers/pitotmeter.h" 2
...
#define ARMED_SCREEN_DISPLAY_TIME 1500
...
#define OSD_MESSAGE_STR(x) ({ STATIC_ASSERT(_CONST_STR_SIZE(x) <= OSD_MESSAGE_LENGTH, message_string_ ## __COUNTER__ ## _too_long); x; })
...
static 
# 155 "./src/main/io/osd.c" 3 4
      _Bool 
# 155 "./src/main/io/osd.c"
           refreshWaitForResumeCmdRelease;

static 
# 157 "./src/main/io/osd.c" 3 4
      _Bool 
# 157 "./src/main/io/osd.c"
           fullRedraw = 
# 157 "./src/main/io/osd.c" 3 4
                        0
# 157 "./src/main/io/osd.c"
...
# 191 "./src/main/io/osd.c"
 static 
# 191 "./src/main/io/osd.c" 3 4
       _Bool 
# 191 "./src/main/io/osd.c"
            osdFormatCentiNumber(char *buff, int32_t centivalue, uint32_t scale, int maxDecimals, int maxScaledDecimals, int length)
 {
    char *ptr = buff;
    char *dec;
    int decimals = maxDecimals;
    
# 196 "./src/main/io/osd.c" 3 4
   _Bool 
# 196 "./src/main/io/osd.c"
        negative = 
# 196 "./src/main/io/osd.c" 3 4
                   0
# 196 "./src/main/io/osd.c"
...
# 197 "./src/main/io/osd.c" 3 4
   _Bool 
# 197 "./src/main/io/osd.c"
        scaled = 
# 197 "./src/main/io/osd.c" 3 4
                 0
# 197 "./src/main/io/osd.c"
    ...
    if (centivalue < 0) {
        negative = 
# 202 "./src/main/io/osd.c" 3 4
                  1
# 202 "./src/main/io/osd.c"
                      ;
    ...
    if (remaining < 0 && scale > 0) {
        ...
        scaled = 
# 216 "./src/main/io/osd.c" 3 4
                1
# 216 "./src/main/io/osd.c"
                    ;
    ...
    decimals = ( __extension__ ({ __typeof__(remaining) _left2 = (remaining); __typeof__(( __extension__ ({ __typeof__(decimals) _left0 = (decimals); __typeof__(3) _right1 = (3); _left0 < _right1 ? _left0 : _right1; }))) _right3 = (( __extension__ ({ __typeof__(decimals) _left0 = (decimals); __typeof__(3) _right1 = (3); _left0 < _right1 ? _left0 : _right1; }))); _left2 < _right3 ? _left2 : _right3; }));
    remaining -= decimals;
...
static void osdFormatDistanceSymbol(char *buff, int32_t dist)
{
    ...
    case OSD_UNIT_IMPERIAL:
        if (osdFormatCentiNumber(buff + 1, (dist * (328 / 100.0)), 5280, 0, 3, 3)) {
            buff[0] = 184;
        } else {
            buff[0] = 183;
        }
    ...
    case OSD_UNIT_METRIC:
        if (osdFormatCentiNumber(buff + 1, dist, 1000, 0, 3, 3)) {
            buff[0] = 182;
        } else {
            buff[0] = 181;
        }
 ...
 static void osdFormatDistanceStr(char *buff, int32_t dist)
 {
     ...
     switch ((osd_unit_e)osdConfig()->units) {
     case OSD_UNIT_IMPERIAL:
        centifeet = (dist * (328 / 100.0));
        if (abs(centifeet) < 5280 * 100 / 2) {

            tfp_sprintf(buff, "%d%c", centifeet / 100, 0x0F);
        } else {

            tfp_sprintf(buff, "%d.%02d%c", centifeet / (100*5280),
            (abs(centifeet) % (100 * 5280)) / 5280, 187);
        }
        break;
     case OSD_UNIT_UK:
         __attribute__ ((fallthrough));
     case OSD_UNIT_METRIC:
        if (abs(dist) < 1000 * 100) {

            tfp_sprintf(buff, "%d%c", dist / 100, 185);
        } else {

            tfp_sprintf(buff, "%d.%02d%c", dist / (100*1000),
                (abs(dist) % (100 * 1000)) / 1000, 186);
         }
         break;
     }
 }
...
static void osdFormatVelocityStr(char* buff, int32_t vel)
{
    ...
    case OSD_UNIT_UK:
        __attribute__ ((fallthrough));
    case OSD_UNIT_IMPERIAL:
        tfp_sprintf(buff, "%3d%c", osdConvertVelocityToUnit(vel), 0xB0);
        break;
    case OSD_UNIT_METRIC:
        tfp_sprintf(buff, "%3d%c", osdConvertVelocityToUnit(vel), 0xA1);
        break;
    }
}
# 370 "./src/main/io/osd.c"
static void osdFormatWindSpeedStr(char *buff, int32_t ws, 
# 370 "./src/main/io/osd.c" 3 4
                                                         _Bool 
# 370 "./src/main/io/osd.c"
                                                              isValid)
{
...
static void osdFormatAltitudeSymbol(char *buff, int32_t alt)
{
    switch ((osd_unit_e)osdConfig()->units) {
        case OSD_UNIT_IMPERIAL:
            if (osdFormatCentiNumber(buff + 1, (alt * (328 / 100.0)), 1000, 0, 2, 3)) {
...
static void osdFormatAltitudeStr(char *buff, int32_t alt)
{
    ...
    switch ((osd_unit_e)osdConfig()->units) {
        case OSD_UNIT_IMPERIAL:
            value = (alt * (328 / 10000.0));
            tfp_sprintf(buff, "%d%c", value, 0x0F);
            break;
        case OSD_UNIT_UK:
            __attribute__ ((fallthrough));
        case OSD_UNIT_METRIC:
            value = (alt / 100);
            tfp_sprintf(buff, "%d%c", value, 185);
            break;
    }
}
...
{
    osdFormatTime(buff, micros() / 1000000, 0x9B, 0x70);
}

static inline void osdFormatFlyTime(char *buff, textAttributes_t *attr)
{
    uint32_t seconds = getFlightTime();
    osdFormatTime(buff, seconds, 0x9C, 0x71);
    if (attr && osdConfig()->time_alarm > 0) {
       if (seconds / 60 >= osdConfig()->time_alarm && (armingFlags & (ARMED))) {
            ((*attr) |= (1 << 0));
        }
    }
}
...
static uint16_t osdConvertRSSI(void)
{
    ...
    return constrain(getRSSI() * 100 / 1023, 0, 99);
}
...
static void osdFormatCoordinate(char *buff, char sym, int32_t val)
{
    ...
    buff[0] = sym;
    int32_t integerPart = val / 10000000L;


    int integerDigits = tfp_sprintf(buff + 1, (integerPart == 0 && val < 0) ? "-%d" : "%d", integerPart);

    int32_t decimalPart = abs(val % 10000000L);
    typedef char assert_failed_adjust_max_decimal_digits [(10000000L == 1e7) ? 1 : -1 ] __attribute__((unused));
    int decimalDigits = tfp_sprintf(buff + 1 + integerDigits, "%07d", decimalPart);

    buff[1 + integerDigits - 1] += 192 - '0';
    buff[1 + integerDigits] += 208 - '0';
...
static const char * osdArmingDisabledReasonMessage(void)
{
            ...
            if (failsafePhase() == FAILSAFE_RX_LOSS_MONITORING) {
                if (failsafeIsReceivingRxData()) {
                    if (isUsingSticksForArming()) {
                        ...
                        return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("POWER CYCLE TO ARM")/sizeof("POWER CYCLE TO ARM"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "POWER CYCLE TO ARM"; });
                    }



                    return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("TURN ARM SWITCH OFF")/sizeof("TURN ARM SWITCH OFF"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "TURN ARM SWITCH OFF"; });
                }

                return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("!RC RX LINK LOST!")/sizeof("!RC RX LINK LOST!"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "!RC RX LINK LOST!"; });
            }
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("DISABLED BY FAILSAFE")/sizeof("DISABLED BY FAILSAFE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "DISABLED BY FAILSAFE"; });
        case ARMING_DISABLED_NOT_LEVEL:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("AIRCRAFT IS NOT LEVEL")/sizeof("AIRCRAFT IS NOT LEVEL"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "AIRCRAFT IS NOT LEVEL"; });
        case ARMING_DISABLED_SENSORS_CALIBRATING:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("SENSORS CALIBRATING")/sizeof("SENSORS CALIBRATING"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "SENSORS CALIBRATING"; });
        case ARMING_DISABLED_SYSTEM_OVERLOADED:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("SYSTEM OVERLOADED")/sizeof("SYSTEM OVERLOADED"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "SYSTEM OVERLOADED"; });
        case ARMING_DISABLED_NAVIGATION_UNSAFE:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("NAVIGATION IS UNSAFE")/sizeof("NAVIGATION IS UNSAFE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "NAVIGATION IS UNSAFE"; });
        case ARMING_DISABLED_COMPASS_NOT_CALIBRATED:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("COMPASS NOT CALIBRATED")/sizeof("COMPASS NOT CALIBRATED"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "COMPASS NOT CALIBRATED"; });
        case ARMING_DISABLED_ACCELEROMETER_NOT_CALIBRATED:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("ACCELEROMETER NOT CALIBRATED")/sizeof("ACCELEROMETER NOT CALIBRATED"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "ACCELEROMETER NOT CALIBRATED"; });
        case ARMING_DISABLED_ARM_SWITCH:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("DISABLE ARM SWITCH FIRST")/sizeof("DISABLE ARM SWITCH FIRST"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "DISABLE ARM SWITCH FIRST"; });
        case ARMING_DISABLED_HARDWARE_FAILURE:
            {
                if (!(getHwGyroStatus() == HW_SENSOR_NONE || getHwGyroStatus() == HW_SENSOR_OK)) {
                    return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("GYRO FAILURE")/sizeof("GYRO FAILURE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "GYRO FAILURE"; });
                }
                if (!(getHwAccelerometerStatus() == HW_SENSOR_NONE || getHwAccelerometerStatus() == HW_SENSOR_OK)) {
                    return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("ACCELEROMETER FAILURE")/sizeof("ACCELEROMETER FAILURE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "ACCELEROMETER FAILURE"; });
                }
                if (!(getHwCompassStatus() == HW_SENSOR_NONE || getHwCompassStatus() == HW_SENSOR_OK)) {
                    return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("COMPASS FAILURE")/sizeof("COMPASS FAILURE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "COMPASS FAILURE"; });
                }
                if (!(getHwBarometerStatus() == HW_SENSOR_NONE || getHwBarometerStatus() == HW_SENSOR_OK)) {
                    return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("BAROMETER FAILURE")/sizeof("BAROMETER FAILURE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "BAROMETER FAILURE"; });
                }
                if (!(getHwGPSStatus() == HW_SENSOR_NONE || getHwGPSStatus() == HW_SENSOR_OK)) {
                    return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("GPS FAILURE")/sizeof("GPS FAILURE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "GPS FAILURE"; });
                }
                if (!(getHwRangefinderStatus() == HW_SENSOR_NONE || getHwRangefinderStatus() == HW_SENSOR_OK)) {
                    return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("RANGE FINDER FAILURE")/sizeof("RANGE FINDER FAILURE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "RANGE FINDER FAILURE"; });
                }
                if (!(getHwPitotmeterStatus() == HW_SENSOR_NONE || getHwPitotmeterStatus() == HW_SENSOR_OK)) {
                    return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("PITOT METER FAILURE")/sizeof("PITOT METER FAILURE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "PITOT METER FAILURE"; });
                }
            }
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("HARDWARE FAILURE")/sizeof("HARDWARE FAILURE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "HARDWARE FAILURE"; });
        case ARMING_DISABLED_BOXFAILSAFE:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("FAILSAFE MODE ENABLED")/sizeof("FAILSAFE MODE ENABLED"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "FAILSAFE MODE ENABLED"; });
        case ARMING_DISABLED_BOXKILLSWITCH:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("KILLSWITCH MODE ENABLED")/sizeof("KILLSWITCH MODE ENABLED"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "KILLSWITCH MODE ENABLED"; });
        case ARMING_DISABLED_RC_LINK:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("NO RC LINK")/sizeof("NO RC LINK"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "NO RC LINK"; });
        case ARMING_DISABLED_THROTTLE:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("THROTTLE IS NOT LOW")/sizeof("THROTTLE IS NOT LOW"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "THROTTLE IS NOT LOW"; });
        case ARMING_DISABLED_ROLLPITCH_NOT_CENTERED:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("ROLLPITCH NOT CENTERED")/sizeof("ROLLPITCH NOT CENTERED"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "ROLLPITCH NOT CENTERED"; });
        case ARMING_DISABLED_SERVO_AUTOTRIM:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("AUTOTRIM IS ACTIVE")/sizeof("AUTOTRIM IS ACTIVE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "AUTOTRIM IS ACTIVE"; });
        case ARMING_DISABLED_OOM:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("NOT ENOUGH MEMORY")/sizeof("NOT ENOUGH MEMORY"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "NOT ENOUGH MEMORY"; });
        case ARMING_DISABLED_INVALID_SETTING:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("INVALID SETTING")/sizeof("INVALID SETTING"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "INVALID SETTING"; });
        case ARMING_DISABLED_CLI:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("CLI IS ACTIVE")/sizeof("CLI IS ACTIVE"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "CLI IS ACTIVE"; });
    ...
    return 
# 606 "./src/main/io/osd.c" 3 4
          ((void *)0)
# 606 "./src/main/io/osd.c"
              ;
}
...
static const char * osdFailsafePhaseMessage(void)
{
    ...
    switch (failsafePhase()) {
        ...
        case FAILSAFE_RETURN_TO_HOME:
            ...
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("(RTH)")/sizeof("(RTH)"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "(RTH)"; });

        case FAILSAFE_LANDING:

            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("(EMERGENCY LANDING)")/sizeof("(EMERGENCY LANDING)"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "(EMERGENCY LANDING)"; });
    ...
    return 
# 648 "./src/main/io/osd.c" 3 4
          ((void *)0)
# 648 "./src/main/io/osd.c"
              ;
}
...
static const char * osdFailsafeInfoMessage(void)
{
    if (failsafeIsReceivingRxData()) {
        ...
        return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("!MOVE STICKS TO EXIT FS!")/sizeof("!MOVE STICKS TO EXIT FS!"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "!MOVE STICKS TO EXIT FS!"; });
    }
    return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("!RC RX LINK LOST!")/sizeof("!RC RX LINK LOST!"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "!RC RX LINK LOST!"; });
}
...
static const char * navigationStateMessage(void)
{
    ...
    switch (NAV_Status.state) {
        ...
        case MW_NAV_STATE_RTH_START:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("STARTING RTH")/sizeof("STARTING RTH"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "STARTING RTH"; });
        case MW_NAV_STATE_RTH_ENROUTE:

            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("EN ROUTE TO HOME")/sizeof("EN ROUTE TO HOME"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "EN ROUTE TO HOME"; });
        ...
        case MW_NAV_STATE_WP_ENROUTE:
            ...
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("EN ROUTE TO WAYPOINT")/sizeof("EN ROUTE TO WAYPOINT"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "EN ROUTE TO WAYPOINT"; });
        case MW_NAV_STATE_PROCESS_NEXT:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("PREPARING FOR NEXT WAYPOINT")/sizeof("PREPARING FOR NEXT WAYPOINT"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "PREPARING FOR NEXT WAYPOINT"; });
        ...
        case MW_NAV_STATE_LAND_IN_PROGRESS:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("LANDING")/sizeof("LANDING"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "LANDING"; });
        case MW_NAV_STATE_HOVER_ABOVE_HOME:
            if ((stateFlags & (FIXED_WING))) {
                return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("LOITERING AROUND HOME")/sizeof("LOITERING AROUND HOME"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "LOITERING AROUND HOME"; });
            }
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("HOVERING")/sizeof("HOVERING"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "HOVERING"; });
        case MW_NAV_STATE_LANDED:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("LANDED")/sizeof("LANDED"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "LANDED"; });
        case MW_NAV_STATE_LAND_SETTLE:
            return ({ typedef char assert_failed_message_string___COUNTER___too_long [(((sizeof("PREPARING TO LAND")/sizeof("PREPARING TO LAND"[0]))-1) <= 28) ? 1 : -1 ] __attribute__((unused)); "PREPARING TO LAND"; });
        case MW_NAV_STATE_LAND_START_DESCENT:

            break;
    }
    return 
# 705 "./src/main/io/osd.c" 3 4
          ((void *)0)
# 705 "./src/main/io/osd.c"
              ;
}
...
static void osdFormatMessage(char *buff, size_t size, const char *message)
{
    ...
    if (message) {
        ...
        int rem = ( __extension__ ({ __typeof__(0) _left4 = (0); __typeof__(28 - (int)messageLength) _right5 = (28 - (int)messageLength); _left4 > _right5 ? _left4 : _right5; }));


        strncpy(buff + rem / 2, message, ( __extension__ ({ __typeof__(28 - rem / 2) _left6 = (28 - rem / 2); __typeof__(messageLength) _right7 = (messageLength); _left6 < _right7 ? _left6 : _right7; })));
    }
...
static void osdFormatThrottlePosition(char *buff, 
# 762 "./src/main/io/osd.c" 3 4
                                                 _Bool 
# 762 "./src/main/io/osd.c"
                                                      autoThr, textAttributes_t *elemAttr)
{
    buff[0] = 0x04;
    buff[1] = 0x05;
    ...
    tfp_sprintf(buff + 2, "%3d", (constrain(thr, 1000, 2000) - 1000) * 100 / (2000 - 1000));
}
...
static uint8_t osdUpdateSidebar(osd_sidebar_scroll_e scroll, osd_sidebar_t *sidebar, timeMs_t currentTimeMs)
{
    ...
    if (offset) {
        decoration -= steps % (21 - 16 + 1);
        if (decoration > 21) {
            decoration -= (21 - 16 + 1);
        } else if (decoration < 16) {
            decoration += (21 - 16 + 1);
        }
    }
...
static 
# 852 "./src/main/io/osd.c" 3 4
      _Bool 
# 852 "./src/main/io/osd.c"
           osdIsHeadingValid(void)
{
...
{
    if (((*drawn) & 0x0800)) {
        displayWriteChar(osdDisplayPort, ((*drawn) & 0x001F), (((*drawn) >> 5) & 0x001F), 0x20);
        *drawn = 0;
    }
}
                       ...
                       uint16_t *drawn, uint32_t *usedScale)
{
    ...
    if (referenceSym) {
        displayWriteChar(osdDisplayPort, maxX, minY, 0x72);
        displayWriteChar(osdDisplayPort, maxX, minY + 1, referenceSym);
    }
    displayWriteChar(osdDisplayPort, minX, maxY, 175);
    displayWriteChar(osdDisplayPort, midX, midY, centerSym);
# 940 "./src/main/io/osd.c"
    ...
    const int scaleReductionMultiplier = ( __extension__ ({ __typeof__(midX - hMargin) _left8 = (midX - hMargin); __typeof__(midY - vMargin) _right9 = (midY - vMargin); _left8 < _right9 ? _left8 : _right9; })) / 2;

    switch (osdConfig()->units) {
        case OSD_UNIT_IMPERIAL:
            initialScale = 16;
            scaleToUnit = 100 / 1609.3440f;
            scaleUnitDivisor = 0;
            symUnscaled = 187;
            symScaled = 187;
            maxDecimals = 2;
    ...
    if ((stateFlags & (GPS_FIX))) {
        ...
        for (ii = 0; ii < 50; ii++) {
            ...
            if (poiX == midX && poiY == midY) {
                ...
                if (centerSym != 0x20 && ((millis() / 1000) % 2) == 0) {
                    break;
                }
            } else {
...
# 1018 "./src/main/io/osd.c" 3 4
                                                                           ((void *)0)
# 1018 "./src/main/io/osd.c"
                                                                               ) && c != 0x20) {
            ...
            if (poiSymbol == 0x60) {
                ...
                int mapHeading = osdGetHeadingAngle(((osdGetHeading()) / 10) - referenceHeading);
                poiSymbol += mapHeading * 2 / 45;
            }
            displayWriteChar(osdDisplayPort, poiX, poiY, poiSymbol);


            *drawn = ((poiX) | ((poiY) << 5)) | 0x0800;
            break;
        }
    }
...
# 1052 "./src/main/io/osd.c" 3 4
   _Bool 
# 1052 "./src/main/io/osd.c"
...
{
    osdDrawMap(referenceHeading, referenceSym, 191, GPS_distanceToHome, GPS_directionToHome, 0x60, drawn, usedScale);
}
...
{
    int16_t reference = ((osdGetHeading()) / 10);
    int16_t poiDirection = osdGetHeadingAngle(GPS_directionToHome + 180);
    osdDrawMap(reference, 0, 0x60, GPS_distanceToHome, poiDirection, 191, drawn, usedScale);
}
...
static void osdDrawRadarWP(uint32_t GPS_distanceToMe,uint32_t poiDirectionPlanes, uint16_t *drawn, uint32_t *usedScale)
{
    ...
    osdDrawMap(reference, 0, 0x60, GPS_distanceToMe, poiDirection, 0x68, drawn, usedScale);
}
...
# 1089 "./src/main/io/osd.c" 3 4
                                                                                                                            _Bool 
# 1089 "./src/main/io/osd.c"
                                                                                                                                 showDecimal) {
    strcpy(buff, label);
...
static void osdDisplayBatteryVoltage(uint8_t elemPosX, uint8_t elemPosY, uint16_t voltage, uint8_t digits, uint8_t decimals)
{
    ...
    elemAttr = 0;
    osdFormatCentiNumber(buff, voltage, 0, decimals, 0, ( __extension__ ({ __typeof__(digits) _left10 = (digits); __typeof__(4) _right11 = (4); _left10 < _right11 ? _left10 : _right11; })));
    strcat(buff, "V");
...
static void osdDisplayAdjustableDecimalValue(uint8_t elemPosX, uint8_t elemPosY, const char *str, const uint8_t valueOffset, const float value, const uint8_t valueLength, const uint8_t maxDecimals, adjustmentFunction_e adjFunc) {
    ...
    elemAttr = 0;
    osdFormatCentiNumber(buff, value * 100, 0, maxDecimals, 0, ( __extension__ ({ __typeof__(valueLength) _left12 = (valueLength); __typeof__(8) _right13 = (8); _left12 < _right13 ? _left12 : _right13; })));
...
static 
# 1159 "./src/main/io/osd.c" 3 4
      _Bool 
# 1159 "./src/main/io/osd.c"
           osdDrawSingleElement(uint8_t item)
{
    uint16_t pos = osdConfig()->item_pos[currentLayout][item];
    if (!((pos) & 0x0800)) {
        return 
# 1163 "./src/main/io/osd.c" 3 4
              0
# 1163 "./src/main/io/osd.c"
                   ;
    }

    uint8_t elemPosX = ((pos) & 0x001F);
    uint8_t elemPosY = (((pos) >> 5) & 0x001F);
    textAttributes_t elemAttr = 0;
    char buff[32];
    ...
    case OSD_MAIN_BATT_VOLTAGE:
        ...
        return 
# 1185 "./src/main/io/osd.c" 3 4
              1
# 1185 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_SAG_COMPENSATED_MAIN_BATT_VOLTAGE:
        ...
        return 
# 1189 "./src/main/io/osd.c" 3 4
              1
# 1189 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_BATTERY_REMAINING_CAPACITY:
        buff[0] = (currentBatteryProfile->capacity.unit == BAT_CAPACITY_UNIT_MAH ? 0x07 : 0xAB);
    ...
    case OSD_GPS_LAT:
        osdFormatCoordinate(buff, 0xA6, gpsSol.llh.lat);
        break;

    case OSD_GPS_LON:
        osdFormatCoordinate(buff, 0xA7, gpsSol.llh.lon);
        break;

    case OSD_HOME_DIR:
        {
            if ((stateFlags & (GPS_FIX)) && (stateFlags & (GPS_FIX_HOME)) && isImuHeadingValid()) {
                ...
                buff[0] = 0x60 + arrowOffset;
            } else {




                buff[0] = (armingFlags & (ARMED)) ? '-' : 0x60;
                ((elemAttr) |= (1 << 0));
            }
            buff[1] = 0;
            break;
    ...
    case OSD_HOME_HEADING_ERROR:
        {
            ...
            if (isImuHeadingValid() && navigationPositionEstimateIsHealthy()) {
                int16_t h = lrintf((((float)wrap_18000((((int32_t)GPS_directionToHome) * 100) - (((int32_t)osdGetHeading()) * 10))) / 100));
    ...
    case OSD_CRUISE_HEADING_ERROR:
        {
            if ((armingFlags & (ARMED)) && !(flightModeFlags & (NAV_CRUISE_MODE))) {
                ...
                return 
# 1338 "./src/main/io/osd.c" 3 4
                      1
# 1338 "./src/main/io/osd.c"
                          ;
            }

            buff[0] = 0xA9;

            if ((!(armingFlags & (ARMED))) || ((flightModeFlags & (NAV_CRUISE_MODE)) && isAdjustingPosition())) {
                buff[1] = buff[2] = buff[3] = '-';
            } else if ((flightModeFlags & (NAV_CRUISE_MODE))) {
                int16_t herr = lrintf((((float)navigationGetHeadingError()) / 100));
                if (( __extension__ ({ __typeof__(herr) _abs14 = (herr); _abs14 < 0 ? -_abs14 : _abs14; })) > 99)
                    strcpy(buff + 1, ">99");
                else
    ...
    case OSD_CRUISE_HEADING_ADJUSTMENT:
        {
            int16_t heading_adjust = lrintf((((float)getCruiseHeadingAdjustment()) / 100));

            if ((armingFlags & (ARMED)) && ((!(flightModeFlags & (NAV_CRUISE_MODE))) || !(isAdjustingPosition() || isAdjustingHeading() || (heading_adjust != 0)))) {
                displayWrite(osdDisplayPort, elemPosX, elemPosY, "      ");
                return 
# 1364 "./src/main/io/osd.c" 3 4
                      1
# 1364 "./src/main/io/osd.c"
                          ;
            }
    ...
    case OSD_GPS_HDOP:
        {
            buff[0] = 0xBD;
            buff[1] = 0xBE;
            int32_t centiHDOP = 100 * gpsSol.hdop / (100);
    ...
    case OSD_MAP_NORTH:
        {
            ...
            return 
# 1394 "./src/main/io/osd.c" 3 4
                  1
# 1394 "./src/main/io/osd.c"
                      ;
        }
    case OSD_MAP_TAKEOFF:
        {
            static uint16_t drawn = 0;
            static uint32_t scale = 0;
            osdDrawHomeMap(((navigationGetHomeHeading()) / 100), 'T', &drawn, &scale);
            return 
# 1401 "./src/main/io/osd.c" 3 4
                  1
# 1401 "./src/main/io/osd.c"
                      ;
        }
    case OSD_RADAR:
        {
            ...
            return 
# 1419 "./src/main/io/osd.c" 3 4
                  1
# 1419 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_ALTITUDE:
        {
            ...
            if ((alt_alarm > 0 && (alt / 100) > alt_alarm) ||
                (neg_alt_alarm > 0 && alt < 0 && -(alt / 100) > neg_alt_alarm)) {
    ...
    case OSD_REMAINING_FLIGHT_TIME_BEFORE_RTH:
        {
            ...
            if ((!(armingFlags & (ARMED))) || (timeSeconds == -1)) {
                buff[0] = 0x9C;
                strcpy(buff + 1, "--:--");
                updatedTimestamp = 0;
                ...
                buff[0] = 0x9C;
                buff[1] = buff[2] = buff[4] = buff[5] = 22;
                buff[3] = ':';
                buff[6] = '\0';
                ((elemAttr) |= (1 << 0));
            } else {
                osdFormatTime(buff, timeSeconds, 0x9C, 0x71);
                if (timeSeconds == 0)
                    ((elemAttr) |= (1 << 0));
            }
        }
    ...
    case OSD_REMAINING_DISTANCE_BEFORE_RTH:;
        ...
        buff[0] = 0x22;
        if ((!(armingFlags & (ARMED))) || (distanceMeters == -1)) {
            buff[1] = 181;
            strcpy(buff + 2, "---");
        } else if (distanceMeters == -2) {

            buff[1] = 181;
            buff[2] = buff[3] = buff[4] = 22;
            buff[5] = '\0';
            ((elemAttr) |= (1 << 0));
        } else {
    ...
    case OSD_FLYMODE:
        {
            ...
            if ((flightModeFlags & (FAILSAFE_MODE))) {
                p = "!FS!";
            } else if ((flightModeFlags & (MANUAL_MODE))) {
                p = "MANU";
            } else if ((flightModeFlags & (NAV_RTH_MODE))) {
                p = "RTH ";
            } else if ((flightModeFlags & (NAV_POSHOLD_MODE))) {
                if ((flightModeFlags & (NAV_ALTHOLD_MODE))) {

                    p = "HOLD";
                } else {
                    p = " PH ";
                }
            } else if ((flightModeFlags & (NAV_CRUISE_MODE)) && (flightModeFlags & (NAV_ALTHOLD_MODE))) {
                p = "3CRS";
            } else if ((flightModeFlags & (NAV_CRUISE_MODE))) {
                p = "CRS ";
            } else if ((flightModeFlags & (NAV_ALTHOLD_MODE)) && navigationRequiresAngleMode()) {



                p = " AH ";
            } else if ((flightModeFlags & (NAV_WP_MODE))) {
                p = " WP ";
            ...
            return 
# 1552 "./src/main/io/osd.c" 3 4
                  1
# 1552 "./src/main/io/osd.c"
                      ;
        }
...
# 1569 "./src/main/io/osd.c" 3 4
                                       0
# 1569 "./src/main/io/osd.c"
                                            , 
# 1569 "./src/main/io/osd.c" 3 4
                                              ((void *)0)
# 1569 "./src/main/io/osd.c"
...
# 1604 "./src/main/io/osd.c" 3 4
                                                 ((void *)0)
# 1604 "./src/main/io/osd.c"
                                                     );
    ...
    case OSD_ATTITUDE_ROLL:
        buff[0] = 0xCD;
        if (( __extension__ ({ __typeof__(attitude.values.roll) _abs15 = (attitude.values.roll); _abs15 < 0 ? -_abs15 : _abs15; })) >= 1)
            buff[0] += (attitude.values.roll < 0 ? -1 : 1);
        osdFormatCentiNumber(buff + 1, ((( __extension__ ({ __typeof__(attitude.values.roll) _abs16 = (attitude.values.roll); _abs16 < 0 ? -_abs16 : _abs16; }))) * 10), 0, 1, 0, 3);
        break;

    case OSD_ATTITUDE_PITCH:
        if (( __extension__ ({ __typeof__(attitude.values.pitch) _abs17 = (attitude.values.pitch); _abs17 < 0 ? -_abs17 : _abs17; })) < 1)
            buff[0] = 'P';
        else if (attitude.values.pitch > 0)
            buff[0] = 0xDF;
        else if (attitude.values.pitch < 0)
            buff[0] = 0xCF;
        osdFormatCentiNumber(buff + 1, ((( __extension__ ({ __typeof__(attitude.values.pitch) _abs18 = (attitude.values.pitch); _abs18 < 0 ? -_abs18 : _abs18; }))) * 10), 0, 1, 0, 3);
        break;
    ...
    case OSD_ARTIFICIAL_HORIZON:
        {
            ...
            static int8_t writtenY[9];

            
# 1652 "./src/main/io/osd.c" 3 4
           _Bool 
# 1652 "./src/main/io/osd.c"
                crosshairsVisible;
            int crosshairsX, crosshairsY, crosshairsXEnd;

            int rollAngle = constrain(attitude.values.roll, -400, 400);
            int pitchAngle = constrain(attitude.values.pitch, -200, 200);
            ...
            pitchAngle = ((pitchAngle * 25) / 200) - 41;
            crosshairsVisible = ((osdConfig()->item_pos[currentLayout][OSD_CROSSHAIRS]) & 0x0800);
...
# 1699 "./src/main/io/osd.c" 3 4
               _Bool 
# 1699 "./src/main/io/osd.c"
                    overlaps = (crosshairsVisible &&
                            crosshairsY == wy &&
                            x >= crosshairsX && x <= crosshairsXEnd) ||
                            (pwy != wy && displayReadCharWithAttr(osdDisplayPort, chX, chY, &c, 
# 1702 "./src/main/io/osd.c" 3 4
                                                                                               ((void *)0)
# 1702 "./src/main/io/osd.c"
                                                                                                   ) && c != 0x20);
                ...
                if (y >= 0 && y <= 80 && !overlaps) {
                    if (pwy != -1 && pwy != wy) {
                        ...
                        displayWriteChar(osdDisplayPort, chX, elemPosY + pwy, 0x20);
                    }
                    uint8_t ch = 0x80 + (y % 9);
            ...
            return 
# 1725 "./src/main/io/osd.c" 3 4
                  1
# 1725 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_HORIZON_SIDEBARS:
        {
            ...
            if (osdConfig()->sidebar_scroll_arrows) {
                displayWriteChar(osdDisplayPort, elemPosX - hudwidth, elemPosY - hudheight - 1,
                    left.arrow == OSD_SIDEBAR_ARROW_UP ? 5 : 0x20);

                displayWriteChar(osdDisplayPort, elemPosX + hudwidth, elemPosY - hudheight - 1,
                    right.arrow == OSD_SIDEBAR_ARROW_UP ? 5 : 0x20);

                displayWriteChar(osdDisplayPort, elemPosX - hudwidth, elemPosY + hudheight + 1,
                    left.arrow == OSD_SIDEBAR_ARROW_DOWN ? 36 : 0x20);

                displayWriteChar(osdDisplayPort, elemPosX + hudwidth, elemPosY + hudheight + 1,
                    right.arrow == OSD_SIDEBAR_ARROW_DOWN ? 36 : 0x20);
            }
            ...
            return 
# 1772 "./src/main/io/osd.c" 3 4
                  1
# 1772 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_VARIO:
        {
            int16_t v = getEstimatedActualVelocity(Z) / 50;
            ...
            return 
# 1811 "./src/main/io/osd.c" 3 4
                  1
# 1811 "./src/main/io/osd.c"
                      ;
        }
...
# 1853 "./src/main/io/osd.c"
    ...
    case OSD_POS_XY_PIDS:
        ...
        return 
# 1857 "./src/main/io/osd.c" 3 4
              1
# 1857 "./src/main/io/osd.c"
                  ;
...
# 1861 "./src/main/io/osd.c"
    ...
    case OSD_VEL_XY_PIDS:
        ...
        return 
# 1866 "./src/main/io/osd.c" 3 4
              1
# 1866 "./src/main/io/osd.c"
                  ;
...
# 1875 "./src/main/io/osd.c"
    ...
    case OSD_BOARD_ALIGN_ROLL:
        ...
        return 
# 1879 "./src/main/io/osd.c" 3 4
              1
# 1879 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_BOARD_ALIGN_PITCH:
        ...
        return 
# 1883 "./src/main/io/osd.c" 3 4
              1
# 1883 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_RC_EXPO:
        ...
        return 
# 1887 "./src/main/io/osd.c" 3 4
              1
# 1887 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_RC_YAW_EXPO:
        ...
        return 
# 1891 "./src/main/io/osd.c" 3 4
              1
# 1891 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_THROTTLE_EXPO:
        ...
        return 
# 1895 "./src/main/io/osd.c" 3 4
              1
# 1895 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_PITCH_RATE:
        ...
        displayWriteWithAttr(osdDisplayPort, elemPosX + 4, elemPosY, buff, elemAttr);
        return 
# 1905 "./src/main/io/osd.c" 3 4
              1
# 1905 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_ROLL_RATE:
        ...
        displayWriteWithAttr(osdDisplayPort, elemPosX + 4, elemPosY, buff, elemAttr);
        return 
# 1915 "./src/main/io/osd.c" 3 4
              1
# 1915 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_YAW_RATE:
        ...
        return 
# 1919 "./src/main/io/osd.c" 3 4
              1
# 1919 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_RC_EXPO:
        ...
        return 
# 1923 "./src/main/io/osd.c" 3 4
              1
# 1923 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_RC_YAW_EXPO:
        ...
        return 
# 1927 "./src/main/io/osd.c" 3 4
              1
# 1927 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_PITCH_RATE:
        ...
        displayWriteWithAttr(osdDisplayPort, elemPosX + 4, elemPosY, buff, elemAttr);
        return 
# 1937 "./src/main/io/osd.c" 3 4
              1
# 1937 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_ROLL_RATE:
        ...
        displayWriteWithAttr(osdDisplayPort, elemPosX + 4, elemPosY, buff, elemAttr);
        return 
# 1947 "./src/main/io/osd.c" 3 4
              1
# 1947 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_YAW_RATE:
        ...
        return 
# 1951 "./src/main/io/osd.c" 3 4
              1
# 1951 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_NAV_FW_CRUISE_THR:
        ...
        return 
# 1955 "./src/main/io/osd.c" 3 4
              1
# 1955 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_NAV_FW_PITCH2THR:
        ...
        return 
# 1959 "./src/main/io/osd.c" 3 4
              1
# 1959 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_FW_MIN_THROTTLE_DOWN_PITCH_ANGLE:
        ...
        return 
# 1963 "./src/main/io/osd.c" 3 4
              1
# 1963 "./src/main/io/osd.c"
                  ;
...
# 1975 "./src/main/io/osd.c" 3 4
                                                                            1
# 1975 "./src/main/io/osd.c"
                                                                                );
            break;
        }
...
# 1982 "./src/main/io/osd.c" 3 4
                                                                             0
# 1982 "./src/main/io/osd.c"
                                                                                  );
            break;
        }
...
# 1989 "./src/main/io/osd.c" 3 4
                                                                             0
# 1989 "./src/main/io/osd.c"
                                                                                  );
            break;
        }
...
# 1996 "./src/main/io/osd.c" 3 4
                                                                             0
# 1996 "./src/main/io/osd.c"
                                                                                  );
            break;
        }
    ...
    case OSD_MESSAGES:
        {
            const char *message = 
# 2044 "./src/main/io/osd.c" 3 4
                                 ((void *)0)
# 2044 "./src/main/io/osd.c"
                                     ;
            char messageBuf[( __extension__ ({ __typeof__(36) _left19 = (36); __typeof__(28 +1) _right20 = (28 +1); _left19 > _right20 ? _left19 : _right20; }))];
            if ((armingFlags & (ARMED))) {
                ...
                if ((flightModeFlags & (FAILSAFE_MODE))) {
                    ...
                    if (messageCount > 0) {
                        message = messages[((millis() / 1000) % messageCount)];
                    ...
                    if ((flightModeFlags & (NAV_RTH_MODE)) || (flightModeFlags & (NAV_WP_MODE)) || navigationIsExecutingAnEmergencyLanding()) {
                        const char *navStateMessage = navigationStateMessage();
                        if (navStateMessage) {
                            messages[messageCount++] = navStateMessage;
                        }
                    } else {
                        if ((flightModeFlags & (NAV_ALTHOLD_MODE)) && !navigationRequiresAngleMode()) {
            ...
            } else if ((armingFlags & (ARMING_DISABLED_ALL_FLAGS))) {
                unsigned invalidIndex;

                if ((armingFlags & (ARMING_DISABLED_INVALID_SETTING)) && !settingsValidate(&invalidIndex)) {
                    if (((millis() / 1000) % 2) == 0) {
    ...
    case OSD_MAIN_BATT_CELL_VOLTAGE:
        {
            ...
            return 
# 2141 "./src/main/io/osd.c" 3 4
                  1
# 2141 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_MAIN_BATT_SAG_COMPENSATED_CELL_VOLTAGE:
        {
            ...
            return 
# 2147 "./src/main/io/osd.c" 3 4
                  1
# 2147 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_THROTTLE_POS_AUTO_THR:
        {
            osdFormatThrottlePosition(buff, 
# 2152 "./src/main/io/osd.c" 3 4
                                           1
# 2152 "./src/main/io/osd.c"
                                               , &elemAttr);
            break;
        }
    ...
    case OSD_HEADING_GRAPH:
        {
            ...
            if (osdIsHeadingValid()) {
                ...
                buff[0] = buff[2] = buff[4] = buff[6] = buff[8] = 0x1D;
                buff[1] = buff[3] = buff[5] = buff[7] = 0x1C;
            }
            buff[9] = '\0';
            break;
        }
    ...
    case OSD_EFFICIENCY_MAH_PER_KM:
        {
            ...
            if ((stateFlags & (GPS_FIX)) && gpsSol.groundSpeed > 0) {
                if (efficiencyTimeDelta >= (5 * 1000)) {
...
# 2279 "./src/main/io/osd.c" 3 4
           _Bool 
# 2279 "./src/main/io/osd.c"
                valid = isEstimatedWindSpeedValid();
            float horizontalWindSpeed;
            if (valid) {
                uint16_t angle;
                horizontalWindSpeed = getEstimatedHorizontalWindSpeed(&angle);
                int16_t windDirection = osdGetHeadingAngle((int)angle - ((attitude.values.yaw) / 10));
                buff[1] = 0x72 + (windDirection * 2 / 90);
            } else {
...
# 2303 "./src/main/io/osd.c" 3 4
           _Bool 
# 2303 "./src/main/io/osd.c"
                valid = isEstimatedWindSpeedValid();
    ...
    default:
        return 
# 2324 "./src/main/io/osd.c" 3 4
              0
# 2324 "./src/main/io/osd.c"
                   ;
    }

    displayWriteWithAttr(osdDisplayPort, elemPosX, elemPosY, buff, elemAttr);
    return 
# 2328 "./src/main/io/osd.c" 3 4
          1
# 2328 "./src/main/io/osd.c"
              ;
}
...
{
    osdConfig->item_pos[0][OSD_ALTITUDE] = ((1) | ((0) << 5)) | 0x0800;
    osdConfig->item_pos[0][OSD_MAIN_BATT_VOLTAGE] = ((12) | ((0) << 5)) | 0x0800;
    osdConfig->item_pos[0][OSD_SAG_COMPENSATED_MAIN_BATT_VOLTAGE] = ((12) | ((1) << 5));

    osdConfig->item_pos[0][OSD_RSSI_VALUE] = ((23) | ((0) << 5)) | 0x0800;

    osdConfig->item_pos[0][OSD_HOME_DIST] = ((1) | ((1) << 5));
    osdConfig->item_pos[0][OSD_TRIP_DIST] = ((1) | ((2) << 5));
    osdConfig->item_pos[0][OSD_MAIN_BATT_CELL_VOLTAGE] = ((12) | ((1) << 5));
    osdConfig->item_pos[0][OSD_MAIN_BATT_SAG_COMPENSATED_CELL_VOLTAGE] = ((12) | ((1) << 5));
    osdConfig->item_pos[0][OSD_GPS_SPEED] = ((23) | ((1) << 5));

    osdConfig->item_pos[0][OSD_THROTTLE_POS] = ((1) | ((2) << 5)) | 0x0800;
    osdConfig->item_pos[0][OSD_THROTTLE_POS_AUTO_THR] = ((6) | ((2) << 5));
    osdConfig->item_pos[0][OSD_HEADING] = ((12) | ((2) << 5));
    osdConfig->item_pos[0][OSD_CRUISE_HEADING_ERROR] = ((12) | ((2) << 5));
    osdConfig->item_pos[0][OSD_CRUISE_HEADING_ADJUSTMENT] = ((12) | ((2) << 5));
    osdConfig->item_pos[0][OSD_HEADING_GRAPH] = ((18) | ((2) << 5));
    osdConfig->item_pos[0][OSD_CURRENT_DRAW] = ((1) | ((3) << 5)) | 0x0800;
    osdConfig->item_pos[0][OSD_MAH_DRAWN] = ((1) | ((4) << 5)) | 0x0800;
    osdConfig->item_pos[0][OSD_WH_DRAWN] = ((1) | ((5) << 5));
    osdConfig->item_pos[0][OSD_BATTERY_REMAINING_CAPACITY] = ((1) | ((6) << 5));
    osdConfig->item_pos[0][OSD_BATTERY_REMAINING_PERCENT] = ((1) | ((7) << 5));
    osdConfig->item_pos[0][OSD_POWER_SUPPLY_IMPEDANCE] = ((1) | ((8) << 5));

    osdConfig->item_pos[0][OSD_EFFICIENCY_MAH_PER_KM] = ((1) | ((5) << 5));
    osdConfig->item_pos[0][OSD_EFFICIENCY_WH_PER_KM] = ((1) | ((5) << 5));

    osdConfig->item_pos[0][OSD_ATTITUDE_ROLL] = ((1) | ((7) << 5));
    osdConfig->item_pos[0][OSD_ATTITUDE_PITCH] = ((1) | ((8) << 5));


    osdConfig->item_pos[0][OSD_VARIO] = ((23) | ((5) << 5));

    osdConfig->item_pos[0][OSD_VARIO_NUM] = ((24) | ((7) << 5));
    osdConfig->item_pos[0][OSD_HOME_DIR] = ((14) | ((11) << 5));
    osdConfig->item_pos[0][OSD_ARTIFICIAL_HORIZON] = ((8) | ((6) << 5)) | 0x0800;
    osdConfig->item_pos[0][OSD_HORIZON_SIDEBARS] = ((8) | ((6) << 5)) | 0x0800;

    osdConfig->item_pos[0][OSD_CRAFT_NAME] = ((20) | ((2) << 5));
    osdConfig->item_pos[0][OSD_VTX_CHANNEL] = ((8) | ((6) << 5));

    osdConfig->item_pos[0][OSD_ONTIME] = ((23) | ((8) << 5));
    osdConfig->item_pos[0][OSD_FLYTIME] = ((23) | ((9) << 5));
    osdConfig->item_pos[0][OSD_ONTIME_FLYTIME] = ((23) | ((11) << 5)) | 0x0800;
    osdConfig->item_pos[0][OSD_RTC_TIME] = ((23) | ((12) << 5));
    osdConfig->item_pos[0][OSD_REMAINING_FLIGHT_TIME_BEFORE_RTH] = ((23) | ((7) << 5));
    osdConfig->item_pos[0][OSD_REMAINING_DISTANCE_BEFORE_RTH] = ((23) | ((6) << 5));

    osdConfig->item_pos[0][OSD_GPS_SATS] = ((0) | ((11) << 5)) | 0x0800;
    osdConfig->item_pos[0][OSD_GPS_HDOP] = ((0) | ((10) << 5));

    osdConfig->item_pos[0][OSD_GPS_LAT] = ((0) | ((12) << 5));
    osdConfig->item_pos[0][OSD_FLYMODE] = ((12) | ((12) << 5)) | 0x0800;
    osdConfig->item_pos[0][OSD_GPS_LON] = ((18) | ((12) << 5));

    osdConfig->item_pos[0][OSD_ROLL_PIDS] = ((2) | ((10) << 5));
    osdConfig->item_pos[0][OSD_PITCH_PIDS] = ((2) | ((11) << 5));
    osdConfig->item_pos[0][OSD_YAW_PIDS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_LEVEL_PIDS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_POS_XY_PIDS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_POS_Z_PIDS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_VEL_XY_PIDS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_VEL_Z_PIDS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_HEADING_P] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_BOARD_ALIGN_ROLL] = ((2) | ((10) << 5));
    osdConfig->item_pos[0][OSD_BOARD_ALIGN_PITCH] = ((2) | ((11) << 5));
    osdConfig->item_pos[0][OSD_RC_EXPO] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_RC_YAW_EXPO] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_THROTTLE_EXPO] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_PITCH_RATE] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_ROLL_RATE] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_YAW_RATE] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_MANUAL_RC_EXPO] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_MANUAL_RC_YAW_EXPO] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_MANUAL_PITCH_RATE] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_MANUAL_ROLL_RATE] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_MANUAL_YAW_RATE] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_NAV_FW_CRUISE_THR] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_NAV_FW_PITCH2THR] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_FW_MIN_THROTTLE_DOWN_PITCH_ANGLE] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_FW_ALT_PID_OUTPUTS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_FW_POS_PID_OUTPUTS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_MC_VEL_X_PID_OUTPUTS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_MC_VEL_Y_PID_OUTPUTS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_MC_VEL_Z_PID_OUTPUTS] = ((2) | ((12) << 5));
    osdConfig->item_pos[0][OSD_MC_POS_XYZ_P_OUTPUTS] = ((2) | ((12) << 5));

    osdConfig->item_pos[0][OSD_POWER] = ((15) | ((1) << 5));

    osdConfig->item_pos[0][OSD_AIR_SPEED] = ((3) | ((5) << 5));
    osdConfig->item_pos[0][OSD_WIND_SPEED_HORIZONTAL] = ((3) | ((6) << 5));
    osdConfig->item_pos[0][OSD_WIND_SPEED_VERTICAL] = ((3) | ((7) << 5));


    osdConfig->item_pos[0][OSD_MESSAGES] = ((1) | ((13) << 5)) | 0x0800;

    for (unsigned ii = 1; ii < (3 + 1); ii++) {
        for (unsigned jj = 0; jj < (sizeof(osdConfig->item_pos[0]) / sizeof((osdConfig->item_pos[0])[0])); jj++) {
             osdConfig->item_pos[ii][jj] = osdConfig->item_pos[0][jj] & ~0x0800;
        }
    }
...
# 2518 "./src/main/io/osd.c" 3 4
                                              1
# 2518 "./src/main/io/osd.c"
                                                  ;
...
static void osdSetNextRefreshIn(uint32_t timeMs) {
    ...
    refreshWaitForResumeCmdRelease = 
# 2524 "./src/main/io/osd.c" 3 4
                                    1
# 2524 "./src/main/io/osd.c"
                                        ;
}
...
void osdInit(displayPort_t *osdDisplayPortToUse)
{
    ...
    ((void)sizeof(char[1 - 2*!!(0x3FF != ((31) | ((31) << 5)))]));
    ...
    tfp_sprintf(string_buffer, "INAV VERSION: %s", "2" "." "0" "." "1");
    displayWrite(osdDisplayPort, 5, y++, string_buffer);

    displayWrite(osdDisplayPort, 7, y++, "MENU: THR MID");
    displayWrite(osdDisplayPort, 11, y++, "+ YAW LEFT");
    displayWrite(osdDisplayPort, 11, y++, "+ PITCH UP");
...
#define STATS_VALUE_X_POS 24
    if (statsConfig()->stats_enabled) {
        displayWrite(osdDisplayPort, 4, ++y, "ODOMETER:");
        if (osdConfig()->units == OSD_UNIT_IMPERIAL) {
            tfp_sprintf(string_buffer, "%5d", statsConfig()->stats_total_dist / 1609);
            string_buffer[5] = 187;
        } else {
            tfp_sprintf(string_buffer, "%5d", statsConfig()->stats_total_dist / 1000);
            string_buffer[5] = 186;
        }
        string_buffer[6] = '\0';
        displayWrite(osdDisplayPort, 24 -5, y, string_buffer);

        displayWrite(osdDisplayPort, 4, ++y, "TOTAL TIME:");
        ...
        if (feature(FEATURE_VBAT) && feature(FEATURE_CURRENT_METER)) {
            displayWrite(osdDisplayPort, 4, ++y, "TOTAL ENERGY:");
            osdFormatCentiNumber(string_buffer, statsConfig()->stats_total_energy / 10, 0, 2, 0, 4);
            strcat(string_buffer, "\xAB");
            displayWrite(osdDisplayPort, 24 -4, y, string_buffer);

            displayWrite(osdDisplayPort, 4, ++y, "AVG EFFICIENCY:");
            if (statsConfig()->stats_total_dist) {
                uint32_t avg_efficiency = statsConfig()->stats_total_energy / (statsConfig()->stats_total_dist / 1000);
            ...
            string_buffer[4] = 173;
            string_buffer[5] = '\0';
            displayWrite(osdDisplayPort, 24 -3, y, string_buffer);
        }
...
static void osdUpdateStats(void)
{
    ...
    stats.max_altitude = ( __extension__ ({ __typeof__(stats.max_altitude) _left21 = (stats.max_altitude); __typeof__(osdGetAltitude()) _right22 = (osdGetAltitude()); _left21 > _right22 ? _left21 : _right22; }));
}
...
{
    dateTime_t dt;
    char buf[( __extension__ ({ __typeof__(32) _left23 = (32); __typeof__(30) _right24 = (30); _left23 > _right24 ? _left23 : _right24; }))];
    char *date;
    char *time;

    uint8_t y = ( __extension__ ({ __typeof__((osdDisplayPort->rows / 2) - 1) _left25 = ((osdDisplayPort->rows / 2) - 1); __typeof__(osdDisplayPort->rows - 6 - 1) _right26 = (osdDisplayPort->rows - 6 - 1); _left25 < _right26 ? _left25 : _right26; }));
    ...
    if (feature(FEATURE_GPS)) {
        if ((stateFlags & (GPS_FIX_HOME))) {
            osdFormatCoordinate(buf, 0xA6, GPS_home.lat);
            displayWrite(osdDisplayPort, (osdDisplayPort->cols - strlen(buf)) / 2, y, buf);
            osdFormatCoordinate(buf, 0xA7, GPS_home.lon);
...
static void osdRefresh(timeUs_t currentTimeUs)
{
    ...
    if (armState != (armingFlags & (ARMED))) {
        if ((armingFlags & (ARMED))) {
            osdResetStats();
            osdShowArmed();
            osdSetNextRefreshIn(1500);
        } else {
            osdShowStats();
            osdSetNextRefreshIn(60000);
        }
    ...
    if (resumeRefreshAt) {
        ...
        if (!(checkStickPosition(THR_HI) || checkStickPosition(PIT_HI)))
            refreshWaitForResumeCmdRelease = 
# 2805 "./src/main/io/osd.c" 3 4
                                            0
# 2805 "./src/main/io/osd.c"
                                                 ;
    ...
    if (!displayIsGrabbed(osdDisplayPort)) {
        if (fullRedraw) {
            displayClearScreen(osdDisplayPort);
            fullRedraw = 
# 2820 "./src/main/io/osd.c" 3 4
                        0
# 2820 "./src/main/io/osd.c"
                             ;
        }
        osdDrawNextElement();
        displayHeartbeat(osdDisplayPort);
...
#define STATS_FREQ_DENOM 50
    ...
    if (displayIsGrabbed(osdDisplayPort)) {
        (armingFlags |= (ARMING_DISABLED_OSD_MENU));
    } else {
        (armingFlags &= ~(ARMING_DISABLED_OSD_MENU));
    }
...
{
    fullRedraw = 
# 2900 "./src/main/io/osd.c" 3 4
                1
# 2900 "./src/main/io/osd.c"
                    ;
}

void osdOverrideLayout(int layout)
{
    layoutOverride = constrain(layout, -1, (sizeof(osdConfig()->item_pos) / sizeof((osdConfig()->item_pos)[0])) - 1);
}


# 2908 "./src/main/io/osd.c" 3 4
_Bool 
# 2908 "./src/main/io/osd.c"
    osdItemIsFixed(osd_items_e item)
{
