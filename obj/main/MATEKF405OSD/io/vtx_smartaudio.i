...
# 1 "./src/main/io/vtx_smartaudio.c"
# 23 "./src/main/io/vtx_smartaudio.c"
...
# 25 "./src/main/io/vtx_smartaudio.c" 2
...
# 27 "./src/main/io/vtx_smartaudio.c" 2
...
# 58 "./src/main/platform.h" 2
# 29 "./src/main/io/vtx_smartaudio.c" 2
...
# 36 "./src/main/io/vtx_smartaudio.c" 2
...
# 39 "./src/main/io/vtx_smartaudio.c" 2
...
# 40 "./src/main/io/vtx_smartaudio.c" 2
...
# 43 "./src/main/io/vtx_smartaudio.c" 2
...
# 47 "./src/main/io/vtx_smartaudio.c" 2
...
# 64 "./src/main/io/vtx_smartaudio.c"
static serialPort_t *smartAudioSerialPort = 
# 64 "./src/main/io/vtx_smartaudio.c" 3 4
                                           ((void *)0)
# 64 "./src/main/io/vtx_smartaudio.c"
                                               ;
...
# 149 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 149 "./src/main/io/vtx_smartaudio.c"
    saDeferred = 
# 149 "./src/main/io/vtx_smartaudio.c" 3 4
                 1
# 149 "./src/main/io/vtx_smartaudio.c"
...
# 201 "./src/main/io/vtx_smartaudio.c"
int saDacToPowerIndex(int dac)
{
...
static void saProcessResponse(uint8_t *buf, int len)
{
    ...
    case SA_CMD_GET_SETTINGS:
        ...
        {if (debugMode == (DEBUG_SMARTAUDIO)) {debug[(0)] = (saDevice.version * 100 + saDevice.mode);}};
        {if (debugMode == (DEBUG_SMARTAUDIO)) {debug[(1)] = (saDevice.channel);}};
        {if (debugMode == (DEBUG_SMARTAUDIO)) {debug[(2)] = (saDevice.freq);}};
        {if (debugMode == (DEBUG_SMARTAUDIO)) {debug[(3)] = (saDevice.power);}};
        break;
...
# 479 "./src/main/io/vtx_smartaudio.c"
...
static 
# 508 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 508 "./src/main/io/vtx_smartaudio.c"
           saQueueEmpty(void)
{
...
static 
# 513 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 513 "./src/main/io/vtx_smartaudio.c"
           saQueueFull(void)
{
...
static 
# 548 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 548 "./src/main/io/vtx_smartaudio.c"
...
# 603 "./src/main/io/vtx_smartaudio.c"
static 
# 603 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 603 "./src/main/io/vtx_smartaudio.c"
...
# 659 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 659 "./src/main/io/vtx_smartaudio.c"
    vtxSmartAudioInit(void)
{
# 671 "./src/main/io/vtx_smartaudio.c"
...
# 680 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                              ((void *)0)
...
# 680 "./src/main/io/vtx_smartaudio.c"
    ...
    if (!smartAudioSerialPort) {
        return 
# 684 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 684 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
...
static void vtxSAProcess(vtxDevice_t *vtxDevice, timeUs_t currentTimeUs)
{
    ...
    if (smartAudioSerialPort == 
# 704 "./src/main/io/vtx_smartaudio.c" 3 4
                               ((void *)0)
# 704 "./src/main/io/vtx_smartaudio.c"
                                   ) {
        return;
    }
...
static 
# 778 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 778 "./src/main/io/vtx_smartaudio.c"
           vtxSAIsReady(const vtxDevice_t *vtxDevice)
{
    return vtxDevice!=
# 780 "./src/main/io/vtx_smartaudio.c" 3 4
                     ((void *)0) 
# 780 "./src/main/io/vtx_smartaudio.c"
                          && !(saDevice.version == 0);
}
...
static 
# 837 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 837 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetBandAndChannel(const vtxDevice_t *vtxDevice, uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxSAIsReady(vtxDevice)) {
        return 
# 840 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 840 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    *pChannel = ((saDevice.channel) % (uint8_t)8) + 1;
    return 
# 847 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 847 "./src/main/io/vtx_smartaudio.c"
              ;
}

static 
# 850 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 850 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetPowerIndex(const vtxDevice_t *vtxDevice, uint8_t *pIndex)
{
    if (!vtxSAIsReady(vtxDevice)) {
        return 
# 853 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 853 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
...
static 
# 860 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 860 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetPitMode(const vtxDevice_t *vtxDevice, uint8_t *pOnOff)
{
    if (!(vtxSAIsReady(vtxDevice) && (saDevice.version == 2))) {
        return 
# 863 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 863 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
...
static 
# 870 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 870 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetFreq(const vtxDevice_t *vtxDevice, uint16_t *pFreq)
{
    if (!vtxSAIsReady(vtxDevice)) {
        return 
# 873 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 873 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    *pFreq = (saDevice.mode & 1) ? saDevice.freq :
        ...
        ((saDevice.channel) % (uint8_t)8) + 1);
    return 
# 880 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 880 "./src/main/io/vtx_smartaudio.c"
              ;
}
