...
# 20 "./src/main/drivers/light_ws2811strip.h" 2
...
# 47 "./src/main/drivers/light_ws2811strip.h" 3 4
_Bool 
# 47 "./src/main/drivers/light_ws2811strip.h"
    isWS2811LedStripReady(void);


extern uint32_t ledStripDMABuffer[((24 * 32) + 42)];
...
# 78 "./src/main/io/ledstrip.c"
                                      ;
static 
# 79 "./src/main/io/ledstrip.c" 3 4
      _Bool 
# 79 "./src/main/io/ledstrip.c"
           ledStripEnabled = 
# 79 "./src/main/io/ledstrip.c" 3 4
                             1
# 79 "./src/main/io/ledstrip.c"
...
{
    memset(instance->ledConfigs, 0, 32 * sizeof(ledConfig_t));

    memset(instance->colors, 0, (sizeof(hsv) / sizeof((hsv)[0])) * sizeof(hsvColor_t));
...
static void determineLedStripDimensions(void)
{
    ...
    for (int ledIndex = 0; ledIndex < ledCounts.count; ledIndex++) {
        ...
        maxX = ( __extension__ ({ __typeof__(ledGetX(ledConfig)) _left0 = (ledGetX(ledConfig)); __typeof__(maxX) _right1 = (maxX); _left0 > _right1 ? _left0 : _right1; }));
        maxY = ( __extension__ ({ __typeof__(ledGetY(ledConfig)) _left2 = (ledGetY(ledConfig)); __typeof__(maxY) _right3 = (maxY); _left2 > _right3 ? _left2 : _right3; }));
    }
    ledGridWidth = maxX + 1;
...
{
    highestYValueForNorth = ( __extension__ ({ __typeof__((ledGridHeight / 2) - 1) _left4 = ((ledGridHeight / 2) - 1); __typeof__(0) _right5 = (0); _left4 < _right5 ? _left4 : _right5; }));
    lowestYValueForSouth = (ledGridHeight + 1) / 2;
    highestXValueForWest = ( __extension__ ({ __typeof__((ledGridWidth / 2) - 1) _left6 = ((ledGridWidth / 2) - 1); __typeof__(0) _right7 = (0); _left6 < _right7 ? _left6 : _right7; }));
...
# 228 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 228 "./src/main/io/ledstrip.c"
    parseLedStripConfig(int ledIndex, const char *config)
{
    if (ledIndex >= 32)
        return 
# 231 "./src/main/io/ledstrip.c" 3 4
              0
# 231 "./src/main/io/ledstrip.c"
                   ;
    ...
    for (enum parseState_e parseState = 0; parseState < PARSE_STATE_COUNT; parseState++) {
        char chunk[11];
        {
            ...
            if (*config != chunkSeparator) {
                return 
# 261 "./src/main/io/ledstrip.c" 3 4
                      0
# 261 "./src/main/io/ledstrip.c"
                           ;
            }
            config++;
        }
    ...
    *ledConfig = (((((((x) & 0x0F) << 4) | (((y) & 0x0F) << 0))) << 0) | ((color) << 18) | ((direction_flags) << 22) | ((baseFunction) << 8) | ((overlay_flags) << 12) | ((0) << 28));
    ...
    return 
# 312 "./src/main/io/ledstrip.c" 3 4
          1
# 312 "./src/main/io/ledstrip.c"
              ;
}
...
static const hsvColor_t* getDirectionalModeColor(const int ledIndex, const modeColorIndexes_t *modeColors)
{
    ...
    return 
# 414 "./src/main/io/ledstrip.c" 3 4
          ((void *)0)
# 414 "./src/main/io/ledstrip.c"
              ;
}
...
# 504 "./src/main/io/ledstrip.c" 3 4
                                _Bool 
# 504 "./src/main/io/ledstrip.c"
                                     updateNow, timeUs_t *timer)
{
    ...
    if (updateNow) {
        ...
        if (warningFlashCounter == 0) {
            ...
            if (!(armingFlags & (ARMED)) && (armingFlags & (ARMING_DISABLED_ALL_FLAGS)))
...
# 531 "./src/main/io/ledstrip.c" 3 4
       _Bool 
# 531 "./src/main/io/ledstrip.c"
        ...
        if (warningFlags & (1 << warningId)) {
            switch (warningId) {
                ...
                case WARNING_HW_ERROR:
                    warningColor = colorOn ? &(hsv[COLOR_BLUE]) : &(hsv[COLOR_BLACK]);
                    break;
                default:;
            }
        }
...
# 555 "./src/main/io/ledstrip.c" 3 4
                                _Bool 
# 555 "./src/main/io/ledstrip.c"
                                     updateNow, timeUs_t *timer)
{
    static 
# 557 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 557 "./src/main/io/ledstrip.c"
               flash = 
# 557 "./src/main/io/ledstrip.c" 3 4
                       0
# 557 "./src/main/io/ledstrip.c"
    ...
    if (updateNow) {
       ...
       switch (state) {
           case BATTERY_OK:
               flash = 
# 567 "./src/main/io/ledstrip.c" 3 4
                      0
# 567 "./src/main/io/ledstrip.c"
                           ;
               timeOffset = 1;
               break;
...
{
    static 
# 591 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 591 "./src/main/io/ledstrip.c"
               flash = 
# 591 "./src/main/io/ledstrip.c" 3 4
                       0
# 591 "./src/main/io/ledstrip.c"
    ...
    if (updateNow) {
       ...
       if (state > 50) {
           flash = 
# 600 "./src/main/io/ledstrip.c" 3 4
                  0
# 600 "./src/main/io/ledstrip.c"
                       ;
           timeOffset = 1;
       } else if (state > 20) {
           timeOffset = 2;
...
# 620 "./src/main/io/ledstrip.c" 3 4
                            _Bool 
# 620 "./src/main/io/ledstrip.c"
                                 updateNow, timeUs_t *timer)
{
...
# 644 "./src/main/io/ledstrip.c" 3 4
       _Bool 
# 644 "./src/main/io/ledstrip.c"
...
# 659 "./src/main/io/ledstrip.c" 3 4
                                  _Bool 
# 659 "./src/main/io/ledstrip.c"
                                       updateNow, timeUs_t *timer)
{
    static 
# 661 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 661 "./src/main/io/ledstrip.c"
               flash = 0;

    if (updateNow) {
        if (rxIsReceivingSignal()) {

            int scale = ( __extension__ ({ __typeof__(( __extension__ ({ __typeof__(rcCommand[ROLL]) _abs8 = (rcCommand[ROLL]); _abs8 < 0 ? -_abs8 : _abs8; }))) _left10 = (( __extension__ ({ __typeof__(rcCommand[ROLL]) _abs8 = (rcCommand[ROLL]); _abs8 < 0 ? -_abs8 : _abs8; }))); __typeof__(( __extension__ ({ __typeof__(rcCommand[PITCH]) _abs9 = (rcCommand[PITCH]); _abs9 < 0 ? -_abs9 : _abs9; }))) _right11 = (( __extension__ ({ __typeof__(rcCommand[PITCH]) _abs9 = (rcCommand[PITCH]); _abs9 < 0 ? -_abs9 : _abs9; }))); _left10 > _right11 ? _left10 : _right11; }));
            scale += (50 - 25);
            *timer += ((int32_t)((1000 * 1000) / (5))) * 50 / ( __extension__ ({ __typeof__(50) _left12 = (50); __typeof__(scale) _right13 = (scale); _left12 > _right13 ? _left12 : _right13; }));
...
# 722 "./src/main/io/ledstrip.c" 3 4
                                   _Bool 
# 722 "./src/main/io/ledstrip.c"
                                        updateNow, timeUs_t *timer)
{
...
# 738 "./src/main/io/ledstrip.c" 3 4
           _Bool 
# 738 "./src/main/io/ledstrip.c"
                applyColor;
...
static int brightnessForLarsonIndex(larsonParameters_t *larsonParameters, uint8_t larsonIndex)
{
    ...
    if (( __extension__ ({ __typeof__(offset) _abs14 = (offset); _abs14 < 0 ? -_abs14 : _abs14; })) > 1)
...
# 793 "./src/main/io/ledstrip.c" 3 4
                                   _Bool 
# 793 "./src/main/io/ledstrip.c"
                                        updateNow, timeUs_t *timer)
{
...
# 818 "./src/main/io/ledstrip.c" 3 4
                              _Bool 
# 818 "./src/main/io/ledstrip.c"
                                   updateNow, timeUs_t *timer)
{
...
# 831 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 831 "./src/main/io/ledstrip.c"
        ledOn = (blinkMask & 1);
    if (!ledOn) {
...
# 900 "./src/main/io/ledstrip.c" 3 4
                               _Bool 
# 900 "./src/main/io/ledstrip.c"
                                    updateNow, timeUs_t *timer);
...
void ledStripUpdate(timeUs_t currentTimeUs)
{
    ...
    if (IS_RC_MODE_ACTIVE(BOXLEDLOW)) {
        if (ledStripEnabled) {
            ledStripDisable();
            ledStripEnabled = 
# 927 "./src/main/io/ledstrip.c" 3 4
                             0
# 927 "./src/main/io/ledstrip.c"
                                  ;
        }
        return;
    }
    ledStripEnabled = 
# 931 "./src/main/io/ledstrip.c" 3 4
                     1
# 931 "./src/main/io/ledstrip.c"
                         ;
...
# 958 "./src/main/io/ledstrip.c" 3 4
       _Bool 
# 958 "./src/main/io/ledstrip.c"
...
# 964 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 964 "./src/main/io/ledstrip.c"
    parseColor(int index, const char *colorConfig)
{
...
# 970 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 970 "./src/main/io/ledstrip.c"
        result = 
# 970 "./src/main/io/ledstrip.c" 3 4
                 1
# 970 "./src/main/io/ledstrip.c"
    ...
    for (int componentIndex = 0; result && componentIndex < (HSV_VALUE + 1); componentIndex++) {
        ...
        if (val > hsv_limit[componentIndex]) {
            result = 
# 979 "./src/main/io/ledstrip.c" 3 4
                    0
# 979 "./src/main/io/ledstrip.c"
                         ;
            break;
        }
        ...
        if (remainingCharacters) {
            ...
            if (componentIndex < (HSV_VALUE + 1) - 1) {
                result = 
# 998 "./src/main/io/ledstrip.c" 3 4
                        0
# 998 "./src/main/io/ledstrip.c"
                             ;
            }
        }
    }
...
# 1013 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 1013 "./src/main/io/ledstrip.c"
    setModeColor(ledModeIndex_e modeIndex, int modeColorIndex, int colorIndex)
{

    if (colorIndex < 0 || colorIndex >= 16)
        return 
# 1017 "./src/main/io/ledstrip.c" 3 4
              0
# 1017 "./src/main/io/ledstrip.c"
                   ;
    if (modeIndex < 6) {
        if (modeColorIndex < 0 || modeColorIndex >= 6)
            return 
# 1020 "./src/main/io/ledstrip.c" 3 4
                  0
# 1020 "./src/main/io/ledstrip.c"
                       ;
        ...
        if (modeColorIndex < 0 || modeColorIndex >= 11)
            return 
# 1024 "./src/main/io/ledstrip.c" 3 4
                  0
# 1024 "./src/main/io/ledstrip.c"
                       ;
        ledStripConfigMutable()->specialColors.color[modeColorIndex] = colorIndex;
    } else {
        return 
# 1027 "./src/main/io/ledstrip.c" 3 4
              0
# 1027 "./src/main/io/ledstrip.c"
                   ;
    }
    return 
# 1029 "./src/main/io/ledstrip.c" 3 4
          1
# 1029 "./src/main/io/ledstrip.c"
              ;
}
...
{
    ledStripInitialised = 
# 1034 "./src/main/io/ledstrip.c" 3 4
                         0
# 1034 "./src/main/io/ledstrip.c"
                              ;
}
...
void ledStripEnable(void)
{
    reevaluateLedConfig();
    ledStripInitialised = 
# 1040 "./src/main/io/ledstrip.c" 3 4
                         1
# 1040 "./src/main/io/ledstrip.c"
                             ;
