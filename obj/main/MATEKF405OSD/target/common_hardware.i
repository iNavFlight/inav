# 1 "./src/main/target/common_hardware.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/target/common_hardware.c"
# 18 "./src/main/target/common_hardware.c"
...
# 58 "./src/main/platform.h" 2
# 19 "./src/main/target/common_hardware.c" 2
...
# 20 "./src/main/target/common_hardware.c" 2
...
# 21 "./src/main/target/common_hardware.c" 2
# 31 "./src/main/target/common_hardware.c"
#define MPU_ADDRESS 0x68
# 43 "./src/main/target/common_hardware.c"
        extern const busDeviceDescriptor_t busdev_mpu6000_registry; static busDevice_t busdev_mpu6000_memory; const busDeviceDescriptor_t busdev_mpu6000_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_mpu6000_memory, .busType = BUSTYPE_SPI, .devHwType = DEVHW_MPU6000, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.spi = { .spiBus = SPIDEV_1, .csnPin = ((((2) + 1) << 4) | (2)) }, .irqPin = ((((2) + 1) << 4) | (3)) }; struct _dummy;
# 52 "./src/main/target/common_hardware.c"
        extern const busDeviceDescriptor_t busdev_mpu6500_registry; static busDevice_t busdev_mpu6500_memory; const busDeviceDescriptor_t busdev_mpu6500_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_mpu6500_memory, .busType = BUSTYPE_SPI, .devHwType = DEVHW_MPU6500, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.spi = { .spiBus = SPIDEV_1, .csnPin = ((((2) + 1) << 4) | (2)) }, .irqPin = ((((2) + 1) << 4) | (3)) }; struct _dummy;
# 80 "./src/main/target/common_hardware.c"
#define BMP085_I2C_BUS BARO_I2C_BUS

    extern const busDeviceDescriptor_t busdev_bmp085_registry; static busDevice_t busdev_bmp085_memory; const busDeviceDescriptor_t busdev_bmp085_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_bmp085_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_BMP085, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x77 }, .irqPin = 0 }; struct _dummy;
...
#define BMP280_I2C_BUS BARO_I2C_BUS
    ...
    extern const busDeviceDescriptor_t busdev_bmp280_registry; static busDevice_t busdev_bmp280_memory; const busDeviceDescriptor_t busdev_bmp280_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_bmp280_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_BMP280, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x76 }, .irqPin = 0 }; struct _dummy;
# 114 "./src/main/target/common_hardware.c"
#define MS5611_I2C_BUS BARO_I2C_BUS

    extern const busDeviceDescriptor_t busdev_ms5611_registry; static busDevice_t busdev_ms5611_memory; const busDeviceDescriptor_t busdev_ms5611_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_ms5611_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_MS5611, .flags = DEVFLAGS_USE_RAW_REGISTERS, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x77 }, .irqPin = 0 }; struct _dummy;
...
#define HMC5883_I2C_BUS MAG_I2C_BUS
    ...
    extern const busDeviceDescriptor_t busdev_hmc5883_registry; static busDevice_t busdev_hmc5883_memory; const busDeviceDescriptor_t busdev_hmc5883_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_hmc5883_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_HMC5883, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x1E }, .irqPin = 0 }; struct _dummy;
...
#define QMC5883_I2C_BUS MAG_I2C_BUS
    ...
    extern const busDeviceDescriptor_t busdev_qmc5883_registry; static busDevice_t busdev_qmc5883_memory; const busDeviceDescriptor_t busdev_qmc5883_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_qmc5883_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_QMC5883, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x0D }, .irqPin = 0 }; struct _dummy;
...
#define AK8963_I2C_BUS MAG_I2C_BUS
    ...
    extern const busDeviceDescriptor_t busdev_ak8963_registry; static busDevice_t busdev_ak8963_memory; const busDeviceDescriptor_t busdev_ak8963_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_ak8963_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_AK8963, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x0C }, .irqPin = 0 }; struct _dummy;
# 152 "./src/main/target/common_hardware.c"
#define AK8975_I2C_BUS MAG_I2C_BUS

    extern const busDeviceDescriptor_t busdev_ak8975_registry; static busDevice_t busdev_ak8975_memory; const busDeviceDescriptor_t busdev_ak8975_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_ak8975_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_AK8975, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x0C }, .irqPin = 0 }; struct _dummy;
...
#define MAG3110_I2C_BUS MAG_I2C_BUS
    ...
    extern const busDeviceDescriptor_t busdev_mag3110_registry; static busDevice_t busdev_mag3110_memory; const busDeviceDescriptor_t busdev_mag3110_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_mag3110_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_MAG3110, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x0E }, .irqPin = 0 }; struct _dummy;
...
#define LIS3MDL_I2C_BUS MAG_I2C_BUS
    ...
    extern const busDeviceDescriptor_t busdev_lis3mdl_registry; static busDevice_t busdev_lis3mdl_memory; const busDeviceDescriptor_t busdev_lis3mdl_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_lis3mdl_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_LIS3MDL, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x1E }, .irqPin = 0 }; struct _dummy;
...
#define IST8310_I2C_BUS MAG_I2C_BUS
    ...
    extern const busDeviceDescriptor_t busdev_ist8310_registry; static busDevice_t busdev_ist8310_memory; const busDeviceDescriptor_t busdev_ist8310_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_ist8310_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_IST8310, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x0C }, .irqPin = 0 }; struct _dummy;
...
#define IST8308_I2C_BUS MAG_I2C_BUS
    ...
    extern const busDeviceDescriptor_t busdev_ist8308_registry; static busDevice_t busdev_ist8308_memory; const busDeviceDescriptor_t busdev_ist8308_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_ist8308_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_IST8308, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x0C }, .irqPin = 0 }; struct _dummy;
# 200 "./src/main/target/common_hardware.c"
#define HCSR04_I2C_BUS RANGEFINDER_I2C_BUS

    extern const busDeviceDescriptor_t busdev_hcsr04_registry; static busDevice_t busdev_hcsr04_memory; const busDeviceDescriptor_t busdev_hcsr04_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_hcsr04_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_HCSR04_I2C, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x14 }, .irqPin = 0 }; struct _dummy;
# 217 "./src/main/target/common_hardware.c"
#define MS4525_I2C_BUS PITOT_I2C_BUS

    extern const busDeviceDescriptor_t busdev_ms5425_registry; static busDevice_t busdev_ms5425_memory; const busDeviceDescriptor_t busdev_ms5425_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_ms5425_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_MS4525, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x28 }, .irqPin = 0 }; struct _dummy;
    ...
    extern const busDeviceDescriptor_t busdev_max7456_registry; static busDevice_t busdev_max7456_memory; const busDeviceDescriptor_t busdev_max7456_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_max7456_memory, .busType = BUSTYPE_SPI, .devHwType = DEVHW_MAX7456, .flags = DEVFLAGS_USE_RAW_REGISTERS, .tag = 0, .busdev.spi = { .spiBus = SPIDEV_2, .csnPin = ((((1) + 1) << 4) | (10)) }, .irqPin = 0 }; struct _dummy;



    extern const busDeviceDescriptor_t busdev_m25p16_registry; static busDevice_t busdev_m25p16_memory; const busDeviceDescriptor_t busdev_m25p16_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_m25p16_memory, .busType = BUSTYPE_SPI, .devHwType = DEVHW_M25P16, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.spi = { .spiBus = SPIDEV_3, .csnPin = ((((2) + 1) << 4) | (0)) }, .irqPin = 0 }; struct _dummy;
...
#define UG2864_I2C_BUS BUS_I2C1
    ...
    extern const busDeviceDescriptor_t busdev_ug2864_registry; static busDevice_t busdev_ug2864_memory; const busDeviceDescriptor_t busdev_ug2864_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_ug2864_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_UG2864, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CDEV_1, .address = 0x3C }, .irqPin = 0 }; struct _dummy;
        ...
        extern const busDeviceDescriptor_t busdev_pca9685_registry; static busDevice_t busdev_pca9685_memory; const busDeviceDescriptor_t busdev_pca9685_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_pca9685_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_PCA9685, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CINVALID, .address = 0x40 }, .irqPin = 0 }; struct _dummy;
