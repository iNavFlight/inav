# 1 "./src/main/target/system_stm32f4xx.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/target/system_stm32f4xx.c"
# 317 "./src/main/target/system_stm32f4xx.c"
...
# 318 "./src/main/target/system_stm32f4xx.c" 2
# 1 "./src/main/target/system_stm32f4xx.h" 1
# 319 "./src/main/target/system_stm32f4xx.c" 2

uint32_t hse_value = 8000000;
# 367 "./src/main/target/system_stm32f4xx.c"
#define VECT_TAB_OFFSET 0x00
# 378 "./src/main/target/system_stm32f4xx.c"
#define PLL_M 8
# 400 "./src/main/target/system_stm32f4xx.c"
#define PLL_N 336

#define PLL_P 2

#define PLL_Q 7
# 442 "./src/main/target/system_stm32f4xx.c"
uint32_t SystemCoreClock = 1000000 * 336 / 2;

volatile const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
# 454 "./src/main/target/system_stm32f4xx.c"
void SetSysClock(void);
# 475 "./src/main/target/system_stm32f4xx.c"
...
# 512 "./src/main/target/system_stm32f4xx.c"
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = ((uint32_t)0x08000000) | 0x00;

}
# 552 "./src/main/target/system_stm32f4xx.c"
void SystemCoreClockUpdate(void)
{
  ...
  switch (tmp)
  {
    ...
    case 0x08:
      ...
      break;
# 612 "./src/main/target/system_stm32f4xx.c"
    default:
      SystemCoreClock = ((uint32_t)16000000);
      break;
  }
...
# 631 "./src/main/target/system_stm32f4xx.c"
void SetSysClock(void)
{
...
# 696 "./src/main/target/system_stm32f4xx.c"
...
# 722 "./src/main/target/system_stm32f4xx.c"
...
# 731 "./src/main/target/system_stm32f4xx.c"
