...
# 58 "./src/main/platform.h" 2
# 23 "./src/main/cms/cms_menu_osd.c" 2
...
# 27 "./src/main/cms/cms_menu_osd.c" 2
...
# 29 "./src/main/cms/cms_menu_osd.c" 2
...
# 33 "./src/main/cms/cms_menu_osd.c" 2
...
# 35 "./src/main/cms/cms_menu_osd.c" 2
...
# 37 "./src/main/cms/cms_menu_osd.c" 2
...
static const OSD_Entry cmsx_menuAlarmsEntries[] = {
    ((OSD_Entry){ "--- ALARMS ---", OME_Label, {.func = 
# 52 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 52 "./src/main/cms/cms_menu_osd.c"
   }, 
# 52 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 52 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ...
    { "RSSI", OME_Setting, 
# 54 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 54 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 315, 0 }, 0 },
    { "FLY TIME", OME_Setting, 
# 55 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 55 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 316, 0 }, 0 },
    { "MAX ALT", OME_Setting, 
# 56 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 56 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 317, 0 }, 0 },
    { "MAX DIST", OME_Setting, 
# 57 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 57 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 318, 0 }, 0 },
    { "MAX NEG ALT", OME_Setting, 
# 58 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 58 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 319, 0 }, 0 },

    ((OSD_Entry){ "BACK", OME_Back, {.func = 
# 60 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 60 "./src/main/cms/cms_menu_osd.c"
   }, 
# 60 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 60 "./src/main/cms/cms_menu_osd.c"
...
static long cmsx_osdElementOnChange(displayPort_t *displayPort, const void *ptr)
{
    ...
    *pos = ((osdCurrentElementColumn) | ((osdCurrentElementRow) << 5));
...
static const OSD_Entry menuOsdElemActionsEntries[] = {
    ...
    ((OSD_Entry){ "ENABLED", OME_Bool, {.func = cmsx_osdElementOnChange}, &osdCurrentElementVisible, 0 }),
    ((OSD_Entry){ "ROW", OME_UINT8, {.func = cmsx_osdElementOnChange}, (&(const OSD_UINT8_t){ &osdCurrentElementRow, 0, ((0x3FF) & 0x001F), 1 }), 0 }),
    ((OSD_Entry){ "COLUMN", OME_UINT8, {.func = cmsx_osdElementOnChange}, (&(const OSD_UINT8_t){ &osdCurrentElementColumn, 0, (((0x3FF) >> 5) & 0x001F), 1 }), 0 }),
    ((OSD_Entry){ "PREVIEW", OME_Funcall, {.func = osdElementPreview}, 
...
# 111 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ...
    ((OSD_Entry){ "BACK", OME_Back, {.func = 
# 113 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 113 "./src/main/cms/cms_menu_osd.c"
   }, 
# 113 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 113 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ((OSD_Entry){ 
# 114 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 114 "./src/main/cms/cms_menu_osd.c"
   , OME_END, {.func = 
# 114 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 114 "./src/main/cms/cms_menu_osd.c"
...
static CMS_Menu cmsx_menuOsdElementActions = {
    ...
    .onExit = 
# 123 "./src/main/cms/cms_menu_osd.c" 3 4
             ((void *)0)
# 123 "./src/main/cms/cms_menu_osd.c"
                 ,
    .onGlobalExit = 
# 124 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 124 "./src/main/cms/cms_menu_osd.c"
                       ,
...
static long osdElemActionsOnEnter(const OSD_Entry *from)
{
    ...
    osdCurrentElementColumn = ((pos) & 0x001F);
    osdCurrentElementRow = (((pos) >> 5) & 0x001F);
    osdCurrentElementVisible = ((pos) & 0x0800) ? 1 : 0;
...
{
    ((OSD_Entry){ "--- OSD ITEMS ---", OME_Label, {.func = 
...
# 147 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ...
    ((OSD_Entry){ "RSSI", OME_Submenu, {.itemId = OSD_RSSI_VALUE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "MAIN BATTERY", OME_Submenu, {.itemId = OSD_MAIN_BATT_VOLTAGE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "MAIN BATT SC", OME_Submenu, {.itemId = OSD_SAG_COMPENSATED_MAIN_BATT_VOLTAGE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "CELL VOLTAGE", OME_Submenu, {.itemId = OSD_MAIN_BATT_CELL_VOLTAGE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "CELL VOLT. SC", OME_Submenu, {.itemId = OSD_MAIN_BATT_SAG_COMPENSATED_CELL_VOLTAGE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "BAT IMPEDANCE", OME_Submenu, {.itemId = OSD_POWER_SUPPLY_IMPEDANCE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "CROSSHAIRS", OME_Submenu, {.itemId = OSD_CROSSHAIRS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "HORIZON", OME_Submenu, {.itemId = OSD_ARTIFICIAL_HORIZON}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "HORIZON SIDEBARS", OME_Submenu, {.itemId = OSD_HORIZON_SIDEBARS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "ON TIME", OME_Submenu, {.itemId = OSD_ONTIME}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "FLY TIME", OME_Submenu, {.itemId = OSD_FLYTIME}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "ON/FLY TIME", OME_Submenu, {.itemId = OSD_ONTIME_FLYTIME}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "REM. TIME", OME_Submenu, {.itemId = OSD_REMAINING_FLIGHT_TIME_BEFORE_RTH}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "REM. DIST", OME_Submenu, {.itemId = OSD_REMAINING_DISTANCE_BEFORE_RTH}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "TIME (HOUR)", OME_Submenu, {.itemId = OSD_RTC_TIME}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "FLY MODE", OME_Submenu, {.itemId = OSD_FLYMODE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "NAME", OME_Submenu, {.itemId = OSD_CRAFT_NAME}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "THR. (MANU)", OME_Submenu, {.itemId = OSD_THROTTLE_POS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "THR. (MANU/AUTO)", OME_Submenu, {.itemId = OSD_THROTTLE_POS_AUTO_THR}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "SYS MESSAGES", OME_Submenu, {.itemId = OSD_MESSAGES}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "VTX CHAN", OME_Submenu, {.itemId = OSD_VTX_CHANNEL}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "CURRENT (A)", OME_Submenu, {.itemId = OSD_CURRENT_DRAW}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "POWER", OME_Submenu, {.itemId = OSD_POWER}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "USED MAH", OME_Submenu, {.itemId = OSD_MAH_DRAWN}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "USED WH", OME_Submenu, {.itemId = OSD_WH_DRAWN}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "EFF/KM (AH)", OME_Submenu, {.itemId = OSD_EFFICIENCY_MAH_PER_KM}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "EFF/KM (WH)", OME_Submenu, {.itemId = OSD_EFFICIENCY_WH_PER_KM}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "BATT CAP REM", OME_Submenu, {.itemId = OSD_BATTERY_REMAINING_CAPACITY}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "BATT % REM", OME_Submenu, {.itemId = OSD_BATTERY_REMAINING_PERCENT}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "HOME DIR", OME_Submenu, {.itemId = OSD_HOME_DIR}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "HOME HEAD. ERR", OME_Submenu, {.itemId = OSD_HOME_HEADING_ERROR}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "HOME DIST", OME_Submenu, {.itemId = OSD_HOME_DIST}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "TRIP DIST", OME_Submenu, {.itemId = OSD_TRIP_DIST}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "GPS SPEED", OME_Submenu, {.itemId = OSD_GPS_SPEED}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "GPS SATS", OME_Submenu, {.itemId = OSD_GPS_SATS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "GPS LAT", OME_Submenu, {.itemId = OSD_GPS_LAT}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "GPS LON", OME_Submenu, {.itemId = OSD_GPS_LON}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "GPS HDOP", OME_Submenu, {.itemId = OSD_GPS_HDOP}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "HEADING", OME_Submenu, {.itemId = OSD_HEADING}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "HEADING GR.", OME_Submenu, {.itemId = OSD_HEADING_GRAPH}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "CRS HEAD. ERR", OME_Submenu, {.itemId = OSD_CRUISE_HEADING_ERROR}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "CRS HEAD. ADJ", OME_Submenu, {.itemId = OSD_CRUISE_HEADING_ADJUSTMENT}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "VARIO", OME_Submenu, {.itemId = OSD_VARIO}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "VARIO NUM", OME_Submenu, {.itemId = OSD_VARIO_NUM}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "ALTITUDE", OME_Submenu, {.itemId = OSD_ALTITUDE}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "AIR SPEED", OME_Submenu, {.itemId = OSD_AIR_SPEED}, &cmsx_menuOsdElementActions, 0 }),


    ((OSD_Entry){ "MAP NORTH", OME_Submenu, {.itemId = OSD_MAP_NORTH}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "MAP TAKE OFF", OME_Submenu, {.itemId = OSD_MAP_TAKEOFF}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "RADAR", OME_Submenu, {.itemId = OSD_RADAR}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "EXPO", OME_Submenu, {.itemId = OSD_RC_EXPO}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "YAW EXPO", OME_Submenu, {.itemId = OSD_RC_YAW_EXPO}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "THR EXPO", OME_Submenu, {.itemId = OSD_THROTTLE_EXPO}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "ROLL RATE", OME_Submenu, {.itemId = OSD_ROLL_RATE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "PITCH RATE", OME_Submenu, {.itemId = OSD_PITCH_RATE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "YAW RATE", OME_Submenu, {.itemId = OSD_YAW_RATE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "M EXPO", OME_Submenu, {.itemId = OSD_MANUAL_RC_EXPO}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "M YAW EXPO", OME_Submenu, {.itemId = OSD_MANUAL_RC_YAW_EXPO}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "M ROLL RATE", OME_Submenu, {.itemId = OSD_MANUAL_ROLL_RATE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "M PITCH RATE", OME_Submenu, {.itemId = OSD_MANUAL_PITCH_RATE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "M YAW RATE", OME_Submenu, {.itemId = OSD_MANUAL_YAW_RATE}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "CRUISE THR", OME_Submenu, {.itemId = OSD_NAV_FW_CRUISE_THR}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "PITCH TO THR", OME_Submenu, {.itemId = OSD_NAV_FW_PITCH2THR}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "ROLL PIDS", OME_Submenu, {.itemId = OSD_ROLL_PIDS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "PITCH PIDS", OME_Submenu, {.itemId = OSD_PITCH_PIDS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "YAW PIDS", OME_Submenu, {.itemId = OSD_YAW_PIDS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "LEVEL PIDS", OME_Submenu, {.itemId = OSD_LEVEL_PIDS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "POSXY PIDS", OME_Submenu, {.itemId = OSD_POS_XY_PIDS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "POSZ PIDS", OME_Submenu, {.itemId = OSD_POS_Z_PIDS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "VELXY PIDS", OME_Submenu, {.itemId = OSD_VEL_XY_PIDS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "VELZ PIDS", OME_Submenu, {.itemId = OSD_VEL_Z_PIDS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "HEAD P", OME_Submenu, {.itemId = OSD_HEADING_P}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "ALIGN ROLL", OME_Submenu, {.itemId = OSD_BOARD_ALIGN_ROLL}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "ALIGN PITCH", OME_Submenu, {.itemId = OSD_BOARD_ALIGN_PITCH}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "0THR PITCH", OME_Submenu, {.itemId = OSD_FW_MIN_THROTTLE_DOWN_PITCH_ANGLE}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "FW ALT PID OUT", OME_Submenu, {.itemId = OSD_FW_ALT_PID_OUTPUTS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "FW POS PID OUT", OME_Submenu, {.itemId = OSD_FW_POS_PID_OUTPUTS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "MC VELX PID OUT", OME_Submenu, {.itemId = OSD_MC_VEL_X_PID_OUTPUTS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "MC VELY PID OUT", OME_Submenu, {.itemId = OSD_MC_VEL_Y_PID_OUTPUTS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "MC VELZ PID OUT", OME_Submenu, {.itemId = OSD_MC_VEL_Z_PID_OUTPUTS}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "MC POS PID OUT", OME_Submenu, {.itemId = OSD_MC_POS_XYZ_P_OUTPUTS}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "ATTI PITCH", OME_Submenu, {.itemId = OSD_ATTITUDE_PITCH}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "ATTI ROLL", OME_Submenu, {.itemId = OSD_ATTITUDE_ROLL}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "WIND HOR", OME_Submenu, {.itemId = OSD_WIND_SPEED_HORIZONTAL}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "WIND VERT", OME_Submenu, {.itemId = OSD_WIND_SPEED_VERTICAL}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "BACK", OME_Back, {.func = 
# 247 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 247 "./src/main/cms/cms_menu_osd.c"
   }, 
# 247 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 247 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ((OSD_Entry){ 
# 248 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 248 "./src/main/cms/cms_menu_osd.c"
   , OME_END, {.func = 
# 248 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 248 "./src/main/cms/cms_menu_osd.c"
...
_Static_assert((sizeof(menuOsdElemsEntries) / sizeof((menuOsdElemsEntries)[0])) - 3 + 1 == OSD_ITEM_COUNT, "missing OSD elements in CMS");
...
const CMS_Menu menuOsdElements = {
    ...
    .onGlobalExit = 
# 265 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 265 "./src/main/cms/cms_menu_osd.c"
                       ,
...
{
    ((OSD_Entry){ "---SCREEN LAYOUT---", OME_Label, {.func = 
# 274 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 274 "./src/main/cms/cms_menu_osd.c"
   }, 
# 274 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 274 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ...
    ((OSD_Entry){ "DEFAULT", OME_Submenu, {.func = 
# 276 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 276 "./src/main/cms/cms_menu_osd.c"
   }, &menuOsdElements, 0 }),

    ((OSD_Entry){ "ALTERNATE 1", OME_Submenu, {.func = 
# 278 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 278 "./src/main/cms/cms_menu_osd.c"
   }, &menuOsdElements, 0 }),

    ((OSD_Entry){ "ALTERNATE 2", OME_Submenu, {.func = 
# 280 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 280 "./src/main/cms/cms_menu_osd.c"
   }, &menuOsdElements, 0 }),

    ((OSD_Entry){ "ALTERNATE 3", OME_Submenu, {.func = 
# 282 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 282 "./src/main/cms/cms_menu_osd.c"
   }, &menuOsdElements, 0 }),
...
const CMS_Menu cmsx_menuOsdLayout = {
    ...
    .onEnter = 
# 296 "./src/main/cms/cms_menu_osd.c" 3 4
              ((void *)0)
# 296 "./src/main/cms/cms_menu_osd.c"
                  ,
    .onExit = 
# 297 "./src/main/cms/cms_menu_osd.c" 3 4
             ((void *)0)
# 297 "./src/main/cms/cms_menu_osd.c"
                 ,
    .onGlobalExit = 
# 298 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 298 "./src/main/cms/cms_menu_osd.c"
                       ,
...
static const OSD_Entry menuOsdSettingsEntries[] = {
    ((OSD_Entry){ "--- OSD SETTINGS ---", OME_Label, {.func = 
# 321 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 321 "./src/main/cms/cms_menu_osd.c"
   }, 
# 321 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 321 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ...
    { "VOLT. DECIMALS", OME_Setting, 
# 323 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 323 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 325, 0 }, 0 },
    { "COORD. DIGITS", OME_Setting, 
# 324 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 324 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 326, 0 }, 0 },
    { "CROSSHAIRS STYLE", OME_Setting, 
# 325 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 325 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 321, 0 }, 0 },
    { "LEFT SCROLL", OME_Setting, 
# 326 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 326 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 322, 0 }, 0 },
    { "RIGHT SCROLL", OME_Setting, 
# 327 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 327 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 323, 0 }, 0 },
    { "SCROLL ARROWS", OME_Setting, 
# 328 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 328 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 324, 0 }, 0 },


    ((OSD_Entry){ "BACK", OME_Back, {.func = 
# 331 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 331 "./src/main/cms/cms_menu_osd.c"
   }, 
# 331 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 331 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ((OSD_Entry){ 
# 332 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 332 "./src/main/cms/cms_menu_osd.c"
   , OME_END, {.func = 
# 332 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 332 "./src/main/cms/cms_menu_osd.c"
...
static const CMS_Menu cmsx_menuOsdSettings = {
    ...
    .onEnter = 
# 340 "./src/main/cms/cms_menu_osd.c" 3 4
              ((void *)0)
# 340 "./src/main/cms/cms_menu_osd.c"
                  ,
    .onExit = 
# 341 "./src/main/cms/cms_menu_osd.c" 3 4
             ((void *)0)
# 341 "./src/main/cms/cms_menu_osd.c"
                 ,
    .onGlobalExit = 
# 342 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 342 "./src/main/cms/cms_menu_osd.c"
                       ,
    .entries = menuOsdSettingsEntries,
};

static const OSD_Entry menuOsdEntries[] = {
    ((OSD_Entry){ "--- OSD ---", OME_Label, {.func = 
# 347 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 347 "./src/main/cms/cms_menu_osd.c"
   }, 
# 347 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 347 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ...
    ((OSD_Entry){ "LAYOUTS", OME_Submenu, {.func = 
# 349 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 349 "./src/main/cms/cms_menu_osd.c"
   }, &cmsx_menuOsdLayout, 0 }),
    ((OSD_Entry){ "SETTINGS", OME_Submenu, {.func = 
# 350 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 350 "./src/main/cms/cms_menu_osd.c"
   }, &cmsx_menuOsdSettings, 0 }),
    ((OSD_Entry){ "ALARMS", OME_Submenu, {.func = 
# 351 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 351 "./src/main/cms/cms_menu_osd.c"
   }, &cmsx_menuAlarms, 0 }),

    ((OSD_Entry){ "BACK", OME_Back, {.func = 
# 353 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 353 "./src/main/cms/cms_menu_osd.c"
   }, 
# 353 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 353 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ((OSD_Entry){ 
# 354 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 354 "./src/main/cms/cms_menu_osd.c"
   , OME_END, {.func = 
# 354 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 354 "./src/main/cms/cms_menu_osd.c"
...
const CMS_Menu cmsx_menuOsd = {
    ...
    .onEnter = 
# 363 "./src/main/cms/cms_menu_osd.c" 3 4
              ((void *)0)
# 363 "./src/main/cms/cms_menu_osd.c"
                  ,
    .onExit = 
# 364 "./src/main/cms/cms_menu_osd.c" 3 4
             ((void *)0)
# 364 "./src/main/cms/cms_menu_osd.c"
                 ,
    .onGlobalExit = 
# 365 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 365 "./src/main/cms/cms_menu_osd.c"
                       ,
