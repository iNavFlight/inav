# 1 "./src/main/drivers/adc_stm32f4xx.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/adc_stm32f4xx.c"
# 18 "./src/main/drivers/adc_stm32f4xx.c"
...
# 19 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 20 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 21 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 58 "./src/main/platform.h" 2
# 23 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 24 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 26 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 27 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 28 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 30 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 31 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 33 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 66 "./src/main/drivers/adc_impl.h" 3 4
   _Bool 
# 66 "./src/main/drivers/adc_impl.h"
        enabled;
...
# 75 "./src/main/drivers/adc_impl.h" 3 4
   _Bool 
# 75 "./src/main/drivers/adc_impl.h"
        enabled;
    uint8_t sampleTime;
} adc_config_t;

extern const adcTagMap_t adcTagMap[16];
extern adc_config_t adcConfig[ADC_CHN_COUNT];
extern volatile uint16_t adcValues[ADCDEV_COUNT][ADC_CHN_COUNT * 20];

void adcHardwareInit(drv_adc_config_t *init);
ADCDevice adcDeviceByInstance(ADC_TypeDef *instance);
uint8_t adcChannelByTag(ioTag_t ioTag);
# 34 "./src/main/drivers/adc_stm32f4xx.c" 2
...
static adcDevice_t adcHardware[ADCDEV_COUNT] = {
    { .ADCx = ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), .rccADC = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00000100))>65535L) + (8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L)) >>8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L)) >>8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255))/2+1))))), .rccDMA = (((RCC_AHB1) << 5) | (16*((((uint32_t)0x00400000))>65535L) + (8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L)) >>8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L)) >>8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255))/2+1))))), .DMAy_Streamx = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), .channel = ((uint32_t)0x00000000), .enabled = 
# 40 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                                                                                                                                             0
# 40 "./src/main/drivers/adc_stm32f4xx.c"
                                                                                                                                                  , .usedChannelCount = 0 },
...
# 56 "./src/main/drivers/adc_stm32f4xx.c"
    { ((((2) + 1) << 4) | (0)), ((uint8_t)0x0A) },
    { ((((2) + 1) << 4) | (1)), ((uint8_t)0x0B) },
    { ((((2) + 1) << 4) | (2)), ((uint8_t)0x0C) },
    { ((((2) + 1) << 4) | (3)), ((uint8_t)0x0D) },
    { ((((2) + 1) << 4) | (4)), ((uint8_t)0x0E) },
    { ((((2) + 1) << 4) | (5)), ((uint8_t)0x0F) },
    { ((((1) + 1) << 4) | (0)), ((uint8_t)0x08) },
    { ((((1) + 1) << 4) | (1)), ((uint8_t)0x09) },
    { ((((0) + 1) << 4) | (0)), ((uint8_t)0x00) },
    { ((((0) + 1) << 4) | (1)), ((uint8_t)0x01) },
    { ((((0) + 1) << 4) | (2)), ((uint8_t)0x02) },
    { ((((0) + 1) << 4) | (3)), ((uint8_t)0x03) },
    { ((((0) + 1) << 4) | (4)), ((uint8_t)0x04) },
    { ((((0) + 1) << 4) | (5)), ((uint8_t)0x05) },
    { ((((0) + 1) << 4) | (6)), ((uint8_t)0x06) },
    { ((((0) + 1) << 4) | (7)), ((uint8_t)0x07) },
};

ADCDevice adcDeviceByInstance(ADC_TypeDef *instance)
{
    if (instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)))
        return ADCDEV_1;
...
static void adcInstanceInit(ADCDevice adcDevice)
{
    ...
    DMA_InitStructure.DMA_BufferSize = adc->usedChannelCount * 20;
    DMA_InitStructure.DMA_PeripheralInc = ((uint32_t)0x00000000);
    DMA_InitStructure.DMA_MemoryInc = ((adc->usedChannelCount > 1) || (20 > 1)) ? ((uint32_t)0x00000400) : ((uint32_t)0x00000000);
    ...
    ADC_CommonInitStructure.ADC_Prescaler = ((uint32_t)0x00030000);
...
void adcHardwareInit(drv_adc_config_t *init)
{
    ...
    for (int i = ADC_CHN_1; i < ADC_CHN_COUNT; i++) {
        ...
        IOConfigGPIO(IOGetByTag(adcConfig[i].tag), ((GPIO_Mode_AN) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)));

        adcConfig[i].adcChannel = adcChannelByTag(adcConfig[i].tag);
        adcConfig[i].dmaIndex = adc->usedChannelCount++;
        adcConfig[i].sampleTime = ((uint8_t)0x07);
        adcConfig[i].enabled = 
# 166 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                              1
# 166 "./src/main/drivers/adc_stm32f4xx.c"
                                  ;

        adc->enabled = 
# 168 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                      1
# 168 "./src/main/drivers/adc_stm32f4xx.c"
                          ;
