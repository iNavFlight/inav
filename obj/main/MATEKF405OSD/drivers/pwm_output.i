...
# 58 "./src/main/platform.h" 2
# 23 "./src/main/drivers/pwm_output.c" 2
...
# 30 "./src/main/drivers/pwm_mapping.h"
...
# 1 "./src/main/drivers/io_pca9685.h" 3 4
_Bool 
# 1 "./src/main/drivers/io_pca9685.h"
    pca9685Initialize(void);
...
# 30 "./src/main/drivers/pwm_output.c" 2
...
# 32 "./src/main/drivers/pwm_output.c" 2
...
# 34 "./src/main/drivers/pwm_output.c" 2
...
# 36 "./src/main/drivers/pwm_output.c" 2
...
# 37 "./src/main/drivers/pwm_output.c" 2
...
static pwmOutputPort_t pwmOutputPorts[6];
...
static 
# 63 "./src/main/drivers/pwm_output.c" 3 4
      _Bool 
# 63 "./src/main/drivers/pwm_output.c"
           pwmMotorsEnabled = 
# 63 "./src/main/drivers/pwm_output.c" 3 4
                              1
# 63 "./src/main/drivers/pwm_output.c"
...
static pwmOutputPort_t *pwmOutConfigMotor(const timerHardware_t *timerHardware, uint8_t mhz, uint16_t period, uint16_t value, 
# 83 "./src/main/drivers/pwm_output.c" 3 4
                                                                                                                             _Bool 
# 83 "./src/main/drivers/pwm_output.c"
                                                                                                                                  enableOutput)
{
    if (allocatedOutputPortCount >= 6) {
        debugTracePrintf(
# 86 "./src/main/drivers/pwm_output.c" 3 4
       0
# 86 "./src/main/drivers/pwm_output.c"
       , "Attempt to allocate PWM output beyond MAX_PWM_OUTPUT_PORTS");
        return 
# 87 "./src/main/drivers/pwm_output.c" 3 4
              ((void *)0)
# 87 "./src/main/drivers/pwm_output.c"
                  ;
    }
    ...
    if (enableOutput) {
        IOConfigGPIOAF(io, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), timerHardware->alternateFunction);
    }
    else {

        IOConfigGPIO(io, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
        IOLo(io);
    }
...
{
    *motors[index]->ccr = lrintf((float)(value * 12/8.0f));
}

static void pwmWriteOneShot42(uint8_t index, uint16_t value)
{
    *motors[index]->ccr = lrintf((float)(value * 21/24.0f));
}

static void pwmWriteMultiShot(uint8_t index, uint16_t value)
{
    *motors[index]->ccr = lrintf(((float)(value-1000) * (84 * 20 / 1000.0f)) + (84 * 5));
}
...
{
    pwmMotorsEnabled = 
# 152 "./src/main/drivers/pwm_output.c" 3 4
                      0
# 152 "./src/main/drivers/pwm_output.c"
                           ;
}
...
{
    pwmMotorsEnabled = 
# 157 "./src/main/drivers/pwm_output.c" 3 4
                      1
# 157 "./src/main/drivers/pwm_output.c"
                          ;
}


# 160 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 160 "./src/main/drivers/pwm_output.c"
...
# 165 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 165 "./src/main/drivers/pwm_output.c"
    pwmMotorConfig(const timerHardware_t *timerHardware, uint8_t motorIndex, uint16_t motorPwmRate, uint16_t idlePulse, motorPwmProtocolTypes_e proto, 
# 165 "./src/main/drivers/pwm_output.c" 3 4
                                                                                                                                                       _Bool 
# 165 "./src/main/drivers/pwm_output.c"
                                                                                                                                                            enableOutput)
{
    ...
    if (port) {
        ...
        return 
# 210 "./src/main/drivers/pwm_output.c" 3 4
              1
# 210 "./src/main/drivers/pwm_output.c"
                  ;
    }

    return 
# 213 "./src/main/drivers/pwm_output.c" 3 4
          0
# 213 "./src/main/drivers/pwm_output.c"
               ;
}


# 216 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 216 "./src/main/drivers/pwm_output.c"
    pwmServoConfig(const timerHardware_t *timerHardware, uint8_t servoIndex, uint16_t servoPwmRate, uint16_t servoCenterPulse, 
# 216 "./src/main/drivers/pwm_output.c" 3 4
                                                                                                                               _Bool 
# 216 "./src/main/drivers/pwm_output.c"
                                                                                                                                    enableOutput)
{
    pwmOutputPort_t * port = pwmOutConfigMotor(timerHardware, 1, 1000000 / servoPwmRate, servoCenterPulse, enableOutput);

    if (port) {
        servos[servoIndex] = port;
        return 
# 222 "./src/main/drivers/pwm_output.c" 3 4
              1
# 222 "./src/main/drivers/pwm_output.c"
                  ;
    }

    return 
# 225 "./src/main/drivers/pwm_output.c" 3 4
          0
# 225 "./src/main/drivers/pwm_output.c"
               ;
}
...
void pwmWriteServo(uint8_t index, uint16_t value)
{
    ...
    if (feature(FEATURE_PWM_SERVO_DRIVER) && (stateFlags & (PWM_DRIVER_AVAILABLE))) {
        pwmDriverSetPulse(index, value);
    } else if (!feature(FEATURE_PWM_SERVO_DRIVER) && servos[index] && index < 8) {
