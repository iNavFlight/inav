...
# 34 "./src/main/drivers/rx_pwm.c" 2
...
# 37 "./src/main/drivers/rx_pwm.c" 2
...
# 40 "./src/main/drivers/rx_pwm.c" 2
...
# 102 "./src/main/drivers/rx_pwm.c" 3 4
   _Bool 
# 102 "./src/main/drivers/rx_pwm.c"
            tracking;
    
# 103 "./src/main/drivers/rx_pwm.c" 3 4
   _Bool 
# 103 "./src/main/drivers/rx_pwm.c"
            overflowed;
} ppmDevice_t;
...
# 117 "./src/main/drivers/rx_pwm.c" 3 4
_Bool 
# 117 "./src/main/drivers/rx_pwm.c"
    isPPMDataBeingReceived(void)
{
...
static void ppmInit(void)
{
    ...
    ppmDev.tracking = 
# 169 "./src/main/drivers/rx_pwm.c" 3 4
                         0
# 169 "./src/main/drivers/rx_pwm.c"
                              ;
    ppmDev.overflowed = 
# 170 "./src/main/drivers/rx_pwm.c" 3 4
                         0
# 170 "./src/main/drivers/rx_pwm.c"
                              ;
}
...
static void ppmOverflowCallback(timerOvrHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    if (capture == 0x10000 - 1) {
        ppmDev.overflowed = 
# 180 "./src/main/drivers/rx_pwm.c" 3 4
                           1
# 180 "./src/main/drivers/rx_pwm.c"
                               ;
    }
}
...
static void ppmEdgeCallback(timerCCHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    ppmDev.overflowed = 
# 216 "./src/main/drivers/rx_pwm.c" 3 4
                       0
# 216 "./src/main/drivers/rx_pwm.c"
                            ;
    ...
    if (ppmDev.deltaTime > 2700) {
        ...
        if (ppmDev.pulseIndex == ppmDev.numChannels && ppmDev.tracking) {
            ...
            for (i = ppmDev.numChannels; i < 16; i++) {
                captures[i] = 0;
            }
            ppmFrameCount++;
        }
        ...
        ppmDev.tracking = 
# 270 "./src/main/drivers/rx_pwm.c" 3 4
                           1
# 270 "./src/main/drivers/rx_pwm.c"
                               ;
        ...
        if (ppmDev.deltaTime > 750
            ...
            ppmDev.tracking = 
# 285 "./src/main/drivers/rx_pwm.c" 3 4
                             0
# 285 "./src/main/drivers/rx_pwm.c"
                                  ;
            for (i = 0; i < 16; i++) {
                ppmDev.captures[i] = 0;
            }
...
# 295 "./src/main/drivers/rx_pwm.c" 3 4
_Bool 
# 295 "./src/main/drivers/rx_pwm.c"
    isPWMDataBeingReceived(void)
{
    int channel;
    for (channel = 0; channel < 16; channel++) {
        if (captures[channel] != 0) {
            return 
# 300 "./src/main/drivers/rx_pwm.c" 3 4
                  1
# 300 "./src/main/drivers/rx_pwm.c"
                      ;
        }
    }
    return 
# 303 "./src/main/drivers/rx_pwm.c" 3 4
          0
# 303 "./src/main/drivers/rx_pwm.c"
               ;
}
...
# 309 "./src/main/drivers/rx_pwm.c" 3 4
                                  __builtin_offsetof (
# 309 "./src/main/drivers/rx_pwm.c"
                                  pwmInputPort_t
# 309 "./src/main/drivers/rx_pwm.c" 3 4
                                  , 
# 309 "./src/main/drivers/rx_pwm.c"
...
# 319 "./src/main/drivers/rx_pwm.c" 3 4
                                  __builtin_offsetof (
# 319 "./src/main/drivers/rx_pwm.c"
                                  pwmInputPort_t
# 319 "./src/main/drivers/rx_pwm.c" 3 4
                                  , 
# 319 "./src/main/drivers/rx_pwm.c"
...
# 325 "./src/main/drivers/rx_pwm.c" 3 4
                                         0
# 325 "./src/main/drivers/rx_pwm.c"
                                              , 10);
    } else {
        ...
        timerChConfigIC(timerHardwarePtr, 
# 340 "./src/main/drivers/rx_pwm.c" 3 4
                                         1
# 340 "./src/main/drivers/rx_pwm.c"
                                             , 10);
        pwmInputPort->missedEvents = 0;
    }
}
...
void pwmInConfig(const timerHardware_t *timerHardwarePtr, uint8_t channel)
{
    ...
    IOInit(io, OWNER_PWMINPUT, RESOURCE_INPUT, (channel + 1));
    ...
    timerChConfigIC(timerHardwarePtr, 
# 363 "./src/main/drivers/rx_pwm.c" 3 4
                                     1
# 363 "./src/main/drivers/rx_pwm.c"
                                         , 10);
}
...
void ppmInConfig(const timerHardware_t *timerHardwarePtr, uint8_t motorPwmProtocol)
{
    ...
    timerChConfigCallbacks(timerHardwarePtr, &self->edgeCb, &self->overflowCb);
    timerChConfigIC(timerHardwarePtr, 
# 416 "./src/main/drivers/rx_pwm.c" 3 4
                                     1
# 416 "./src/main/drivers/rx_pwm.c"
                                         , 10);
}
