...
extiCallbackHandlerConfig_t extiHandlerConfigs[1];
...
{
    for ( uint8_t __basepri_save __attribute__((__cleanup__(__basepriRestoreMem))) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        sysTickUptime++;
        sysTickValStamp = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL;
        sysTickPending = 0;
...
void failureMode(failureMode_e mode)
{
    ...
    while (codeRepeatsRemaining--) {
        ledSet(1, 
# 217 "./src/main/drivers/system.c" 3 4
       1
# 217 "./src/main/drivers/system.c"
       );
        ledSet(0, 
# 218 "./src/main/drivers/system.c" 3 4
       0
# 218 "./src/main/drivers/system.c"
       );
        ...
        while (shortFlashesRemaining || codeFlashesRemaining) {
            ...
            ledToggle(0);
            systemBeep(
# 226 "./src/main/drivers/system.c" 3 4
           1
# 226 "./src/main/drivers/system.c"
           );
            delay(flashDuration);
            ...
            ledToggle(0);
            systemBeep(
# 231 "./src/main/drivers/system.c" 3 4
           0
# 231 "./src/main/drivers/system.c"
           );
            delay(flashDuration);
