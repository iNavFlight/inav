# 1 "./src/main/drivers/compass/compass_ist8310.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/compass/compass_ist8310.c"
# 18 "./src/main/drivers/compass/compass_ist8310.c"
...
# 19 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 20 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 22 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 58 "./src/main/platform.h" 2
# 24 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 28 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 30 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 31 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 33 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 34 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 35 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 44 "./src/main/drivers/exti.h"
                             enable);
# 36 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 37 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 55 "./src/main/drivers/light_led.h"
                         state);
# 38 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 40 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 41 "./src/main/drivers/compass/compass_ist8310.c" 2
...
# 43 "./src/main/drivers/compass/compass_ist8310.c" 2

#define IST8310_ADDRESS 0x0C
# 88 "./src/main/drivers/compass/compass_ist8310.c"
...
static 
# 114 "./src/main/drivers/compass/compass_ist8310.c" 3 4
      _Bool 
# 114 "./src/main/drivers/compass/compass_ist8310.c"
           ist8310Init(magDev_t * mag)
{
    busWrite(mag->busDev, 0x0A, 0x07);
    delay(5);

    busWrite(mag->busDev, 0x41, 0x24);
    delay(5);

    busWrite(mag->busDev, 0x42, 0xC0);
    delay(5);

    return 
# 125 "./src/main/drivers/compass/compass_ist8310.c" 3 4
          1
# 125 "./src/main/drivers/compass/compass_ist8310.c"
              ;
}

static 
# 128 "./src/main/drivers/compass/compass_ist8310.c" 3 4
      _Bool 
# 128 "./src/main/drivers/compass/compass_ist8310.c"
           ist8310Read(magDev_t * mag)
{
    uint8_t buf[6];
    uint8_t LSB2FSV = 3;
...
# 138 "./src/main/drivers/compass/compass_ist8310.c" 3 4
   _Bool 
# 138 "./src/main/drivers/compass/compass_ist8310.c"
        ack = busReadBuf(mag->busDev, 0x03, buf, 6);
    if (!ack) {
        return 
# 140 "./src/main/drivers/compass/compass_ist8310.c" 3 4
              0
# 140 "./src/main/drivers/compass/compass_ist8310.c"
                   ;
    }
    ...
    return 
# 148 "./src/main/drivers/compass/compass_ist8310.c" 3 4
          1
# 148 "./src/main/drivers/compass/compass_ist8310.c"
              ;
}

#define DETECTION_MAX_RETRY_COUNT 5
static 
# 152 "./src/main/drivers/compass/compass_ist8310.c" 3 4
      _Bool 
# 152 "./src/main/drivers/compass/compass_ist8310.c"
...
# 158 "./src/main/drivers/compass/compass_ist8310.c" 3 4
       _Bool 
# 158 "./src/main/drivers/compass/compass_ist8310.c"
            ack = busRead(mag->busDev, 0x00, &sig);

        if (ack && sig == 0x10) {
            return 
# 161 "./src/main/drivers/compass/compass_ist8310.c" 3 4
                  1
# 161 "./src/main/drivers/compass/compass_ist8310.c"
                      ;
        }
    }

    return 
# 165 "./src/main/drivers/compass/compass_ist8310.c" 3 4
          0
# 165 "./src/main/drivers/compass/compass_ist8310.c"
               ;
}


# 168 "./src/main/drivers/compass/compass_ist8310.c" 3 4
_Bool 
# 168 "./src/main/drivers/compass/compass_ist8310.c"
    ist8310Detect(magDev_t * mag)
{
    mag->busDev = busDeviceInit(BUSTYPE_ANY, DEVHW_IST8310, mag->magSensorToUse, OWNER_COMPASS);
    if (mag->busDev == 
# 171 "./src/main/drivers/compass/compass_ist8310.c" 3 4
                      ((void *)0)
# 171 "./src/main/drivers/compass/compass_ist8310.c"
                          ) {
        return 
# 172 "./src/main/drivers/compass/compass_ist8310.c" 3 4
              0
# 172 "./src/main/drivers/compass/compass_ist8310.c"
                   ;
    }
    ...
    if (!deviceDetect(mag)) {
        ...
        return 
# 177 "./src/main/drivers/compass/compass_ist8310.c" 3 4
              0
# 177 "./src/main/drivers/compass/compass_ist8310.c"
                   ;
    }
    ...
    return 
# 183 "./src/main/drivers/compass/compass_ist8310.c" 3 4
          1
# 183 "./src/main/drivers/compass/compass_ist8310.c"
              ;
}
