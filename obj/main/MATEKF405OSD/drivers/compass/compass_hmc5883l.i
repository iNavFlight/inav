...
# 103 "./src/main/drivers/compass/compass_hmc5883l.c"
...
static 
# 117 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
      _Bool 
# 117 "./src/main/drivers/compass/compass_hmc5883l.c"
           hmc5883lRead(magDev_t * mag)
{
    uint8_t buf[6];
    
# 120 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
   _Bool 
# 120 "./src/main/drivers/compass/compass_hmc5883l.c"
        ack;

    if (mag->busDev->busType == BUSTYPE_SPI) {
        ack = busReadBuf(mag->busDev, (0x03 | 0x40), buf, 6);
    }
    else {
    ...
    if (!ack) {
        ...
        mag->magADCRaw[Z] = 0;
        return 
# 133 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
              0
# 133 "./src/main/drivers/compass/compass_hmc5883l.c"
                   ;
    }
    ...
    return 
# 140 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 140 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}

#define INITIALISATION_MAX_READ_FAILURES 5
static 
# 144 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
      _Bool 
# 144 "./src/main/drivers/compass/compass_hmc5883l.c"
           hmc5883lInit(magDev_t * mag)
{
    busWrite(mag->busDev, 0x00, 0x78);
    delay(5);

    busWrite(mag->busDev, 0x01, 0x20);
    delay(5);

    busWrite(mag->busDev, 0x02, 0x00);
    delay(100);

    return 
# 155 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 155 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}

#define DETECTION_MAX_RETRY_COUNT 200
static 
# 159 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
      _Bool 
# 159 "./src/main/drivers/compass/compass_hmc5883l.c"
           deviceDetect(magDev_t * mag)
{
    for (int retryCount = 0; retryCount < 200; retryCount++) {
        delay(10);

        uint8_t sig = 0;
        
# 165 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
       _Bool 
# 165 "./src/main/drivers/compass/compass_hmc5883l.c"
            ack = busRead(mag->busDev, 0x0A, &sig);

        if (ack && sig == 'H') {
            return 
# 168 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
                  1
# 168 "./src/main/drivers/compass/compass_hmc5883l.c"
                      ;
        }
    }

    return 
# 172 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          0
# 172 "./src/main/drivers/compass/compass_hmc5883l.c"
               ;
}


# 175 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
_Bool 
# 175 "./src/main/drivers/compass/compass_hmc5883l.c"
    hmc5883lDetect(magDev_t * mag)
{
    mag->busDev = busDeviceInit(BUSTYPE_ANY, DEVHW_HMC5883, mag->magSensorToUse, OWNER_COMPASS);
    if (mag->busDev == 
# 178 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
                      ((void *)0)
# 178 "./src/main/drivers/compass/compass_hmc5883l.c"
                          ) {
        return 
# 179 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
              0
# 179 "./src/main/drivers/compass/compass_hmc5883l.c"
                   ;
    }
    ...
    if (!deviceDetect(mag)) {
        ...
        return 
# 184 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
              0
# 184 "./src/main/drivers/compass/compass_hmc5883l.c"
                   ;
    }
    ...
    return 
# 190 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 190 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}
