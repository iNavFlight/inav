# 1 "./src/main/drivers/serial_uart_stm32f4xx.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/serial_uart_stm32f4xx.c"
# 18 "./src/main/drivers/serial_uart_stm32f4xx.c"
...
# 19 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 20 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 58 "./src/main/platform.h" 2
# 22 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 24 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 25 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 26 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 27 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 28 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 30 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 74 "./src/main/drivers/serial_uart.h" 3 4
   _Bool 
# 74 "./src/main/drivers/serial_uart.h"
        txDMAEmpty;
...
# 94 "./src/main/drivers/serial_uart.h" 3 4
_Bool 
# 94 "./src/main/drivers/serial_uart.h"
    isUartTransmitBufferEmpty(const serialPort_t *s);
# 31 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 32 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
{
    .DMAChannel = ((uint32_t)0x08000000),
    ...
    .dev = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)),
    .rx = ((((0) + 1) << 4) | (10)),
    .tx = ((((0) + 1) << 4) | (9)),
    .af = ((uint8_t)0x07),
...
static uartDevice_t uart2 =
{
    ...
    .dev = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)),
    .rx = ((((0) + 1) << 4) | (3)),
    .tx = ((((0) + 1) << 4) | (2)),
    .af = ((uint8_t)0x07),
    ...
    .rcc_apb1 = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00020000))>65535L) + (8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L)) >>8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L)) >>8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255))/2+1))))),
    .txIrq = DMA1_ST6_HANDLER,
    .rxIrq = USART2_IRQn,
    .txPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0),
    .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)
};
...
static uartDevice_t uart3 =
{
    ...
    .dev = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)),
    .rx = ((((2) + 1) << 4) | (11)),
    .tx = ((((2) + 1) << 4) | (10)),
    .af = ((uint8_t)0x07),
    ...
    .rcc_apb1 = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00040000))>65535L) + (8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L)) >>8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L)) >>8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255))/2+1))))),
...
static uartDevice_t uart4 =
{
    ...
    .dev = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00)),
    .rx = ((((0) + 1) << 4) | (1)),
    .tx = ((((0) + 1) << 4) | (0)),
    .af = ((uint8_t)0x08),
    ...
    .rcc_apb1 = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00080000))>65535L) + (8*(((((uint32_t)0x00080000))*1L >>16*((((uint32_t)0x00080000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00080000))*1L >>16*((((uint32_t)0x00080000))>65535L)) >>8*(((((uint32_t)0x00080000))*1L >>16*((((uint32_t)0x00080000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00080000))*1L >>16*((((uint32_t)0x00080000))>65535L)) >>8*(((((uint32_t)0x00080000))*1L >>16*((((uint32_t)0x00080000))>65535L))>255))/2+1))))),
...
static uartDevice_t uart5 =
{
    ...
    .dev = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000)),
    .rx = ((((3) + 1) << 4) | (2)),
    .tx = ((((2) + 1) << 4) | (12)),
    .af = ((uint8_t)0x08),
...
# 278 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
   ((void *)0)
# 278 "./src/main/drivers/serial_uart_stm32f4xx.c"
       ,
...
# 283 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
   ((void *)0)
# 283 "./src/main/drivers/serial_uart_stm32f4xx.c"
       ,
...
# 288 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
   ((void *)0)
# 288 "./src/main/drivers/serial_uart_stm32f4xx.c"
       ,
...
{
    if (!s->rxDMAStream && (USART_GetITStatus(s->USARTx, ((uint16_t)0x0525)) == SET)) {
    ...
    if (!s->txDMAStream && (USART_GetITStatus(s->USARTx, ((uint16_t)0x0727)) == SET)) {
    ...
    if (USART_GetITStatus(s->USARTx, ((uint16_t)0x0008)) == SET)
    {
        USART_ClearITPendingBit (s->USARTx, ((uint16_t)0x0360));
    }
}
# 353 "./src/main/drivers/serial_uart_stm32f4xx.c"
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_t mode, portOptions_t options)
{
    ...
    if (!uart) return 
# 359 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
                     ((void *)0)
# 359 "./src/main/drivers/serial_uart_stm32f4xx.c"
                         ;
    ...
    if (options & SERIAL_BIDIR) {
        IOInit(tx, OWNER_SERIAL, RESOURCE_UART_TXRX, (device + 1));
        if (options & SERIAL_BIDIR_PP)
            IOConfigGPIOAF(tx, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), uart->af);
        else
            IOConfigGPIOAF(tx, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)), uart->af);
    }
    else {
        if (mode & MODE_TX) {
            IOInit(tx, OWNER_SERIAL, RESOURCE_UART_TX, (device + 1));
            IOConfigGPIOAF(tx, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), uart->af);
        }

        if (mode & MODE_RX) {
            IOInit(rx, OWNER_SERIAL, RESOURCE_UART_RX, (device + 1));
            IOConfigGPIOAF(rx, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), uart->af);
        }
    }
    ...
    if (!(s->rxDMAChannel)) {
        ...
        NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = (((uart->rxPriority)>>(4-(7-(((uint32_t)0x500)>>8))))>>4);
        NVIC_InitStructure.NVIC_IRQChannelSubPriority = (((uart->rxPriority)&(0x0f>>(7-(((uint32_t)0x500)>>8))))>>4);
