...
# 23 "./src/main/drivers/flash_m25p16.h" 2
...
# 35 "./src/main/drivers/flash_m25p16.h" 3 4
_Bool 
# 35 "./src/main/drivers/flash_m25p16.h"
    m25p16_isReady(void);

# 36 "./src/main/drivers/flash_m25p16.h" 3 4
_Bool 
# 36 "./src/main/drivers/flash_m25p16.h"
...
# 69 "./src/main/drivers/flash_m25p16.c" 3 4
                             ((void *)0)
# 69 "./src/main/drivers/flash_m25p16.c"
                                 ;
static 
# 70 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 70 "./src/main/drivers/flash_m25p16.c"
           isLargeFlash = 
# 70 "./src/main/drivers/flash_m25p16.c" 3 4
                          0
# 70 "./src/main/drivers/flash_m25p16.c"
...
static 
# 77 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 77 "./src/main/drivers/flash_m25p16.c"
           couldBeBusy = 
# 77 "./src/main/drivers/flash_m25p16.c" 3 4
                         0
# 77 "./src/main/drivers/flash_m25p16.c"
...
{
    busTransfer(busDev, 
# 84 "./src/main/drivers/flash_m25p16.c" 3 4
                       ((void *)0)
# 84 "./src/main/drivers/flash_m25p16.c"
                           , &command, 1);
}
...
static void m25p16_writeEnable(void)
{
    ...
    couldBeBusy = 
# 96 "./src/main/drivers/flash_m25p16.c" 3 4
                 1
# 96 "./src/main/drivers/flash_m25p16.c"
                     ;
}
...
# 109 "./src/main/drivers/flash_m25p16.c" 3 4
_Bool 
# 109 "./src/main/drivers/flash_m25p16.c"
    m25p16_isReady(void)
{
...
# 117 "./src/main/drivers/flash_m25p16.c" 3 4
_Bool 
# 117 "./src/main/drivers/flash_m25p16.c"
    m25p16_waitForReady(uint32_t timeoutMillis)
{
...
# 122 "./src/main/drivers/flash_m25p16.c"
    ...
    return 
# 126 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 126 "./src/main/drivers/flash_m25p16.c"
              ;
}
...
static 
# 134 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 134 "./src/main/drivers/flash_m25p16.c"
           m25p16_readIdentification(void)
{
 ...
 case 0x016018:
        ...
        default:
            ...
            return 
# 195 "./src/main/drivers/flash_m25p16.c" 3 4
                  0
# 195 "./src/main/drivers/flash_m25p16.c"
                       ;
    }
...
# 202 "./src/main/drivers/flash_m25p16.c"
                          ;
        m25p16_performOneByteCommand(0xB7);
    }

    couldBeBusy = 
# 206 "./src/main/drivers/flash_m25p16.c" 3 4
                 1
# 206 "./src/main/drivers/flash_m25p16.c"
                     ;

    return 
# 208 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 208 "./src/main/drivers/flash_m25p16.c"
              ;
}
    ...
    m25p16_init(int flashNumToUse)
{
    if (busDev) {
        return 
# 220 "./src/main/drivers/flash_m25p16.c" 3 4
              1
# 220 "./src/main/drivers/flash_m25p16.c"
                  ;
    }

    busDev = busDeviceInit(BUSTYPE_SPI, DEVHW_M25P16, flashNumToUse, OWNER_FLASH);
    if (busDev == 
# 224 "./src/main/drivers/flash_m25p16.c" 3 4
                 ((void *)0)
# 224 "./src/main/drivers/flash_m25p16.c"
                     ) {
        return 
# 225 "./src/main/drivers/flash_m25p16.c" 3 4
              0
# 225 "./src/main/drivers/flash_m25p16.c"
                   ;
    }
...
void m25p16_setCommandAddress(uint8_t *buf, uint32_t address, 
# 235 "./src/main/drivers/flash_m25p16.c" 3 4
                                                             _Bool 
# 235 "./src/main/drivers/flash_m25p16.c"
                                                                  useLongAddress)
{
    if (useLongAddress) {
        *buf++ = (address >> 24) & 0xff;
...
void m25p16_eraseSector(uint32_t address)
{
    ...
    busTransfer(busDev, 
# 259 "./src/main/drivers/flash_m25p16.c" 3 4
                       ((void *)0)
# 259 "./src/main/drivers/flash_m25p16.c"
                           , out, isLargeFlash ? 5 : 4);
}
...
uint32_t m25p16_pageProgram(uint32_t address, const uint8_t *data, int length)
{
    uint8_t command[5] = { 0x02 };

    busTransferDescriptor_t txn[2] = {
        { 
# 291 "./src/main/drivers/flash_m25p16.c" 3 4
         ((void *)0)
# 291 "./src/main/drivers/flash_m25p16.c"
             , command, isLargeFlash ? 5 : 4 },
        { 
# 292 "./src/main/drivers/flash_m25p16.c" 3 4
         ((void *)0)
# 292 "./src/main/drivers/flash_m25p16.c"
             , data, length }
    };
...
# 314 "./src/main/drivers/flash_m25p16.c"
int m25p16_readBytes(uint32_t address, uint8_t *buffer, int length)
{
    uint8_t command[5] = { 0x03 };

    busTransferDescriptor_t txn[2] = {
        { 
# 319 "./src/main/drivers/flash_m25p16.c" 3 4
         ((void *)0)
# 319 "./src/main/drivers/flash_m25p16.c"
             , command, isLargeFlash ? 5 : 4 },
        { buffer, 
# 320 "./src/main/drivers/flash_m25p16.c" 3 4
                 ((void *)0)
# 320 "./src/main/drivers/flash_m25p16.c"
                     , length }
    };
