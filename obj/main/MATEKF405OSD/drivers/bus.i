...
static 
# 73 "./src/main/drivers/bus.c" 3 4
      _Bool 
# 73 "./src/main/drivers/bus.c"
           busDevInit_I2C(busDevice_t * dev, const busDeviceDescriptor_t * descriptor)
{
    ...
    return 
# 79 "./src/main/drivers/bus.c" 3 4
          1
# 79 "./src/main/drivers/bus.c"
              ;
}
...
static 
# 84 "./src/main/drivers/bus.c" 3 4
      _Bool 
# 84 "./src/main/drivers/bus.c"
           busDevInit_SPI(busDevice_t * dev, const busDeviceDescriptor_t * descriptor, resourceOwner_e owner)
{
    dev->busType = descriptor->busType;
    dev->irqPin = IOGetByTag(descriptor->irqPin);
    ...
    if (dev->busdev.spi.csnPin) {
        ...
        IOConfigGPIO(dev->busdev.spi.csnPin, ((GPIO_Mode_OUT) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
        IOHi(dev->busdev.spi.csnPin);
        return 
# 94 "./src/main/drivers/bus.c" 3 4
              1
# 94 "./src/main/drivers/bus.c"
                  ;
    }

    return 
# 97 "./src/main/drivers/bus.c" 3 4
          0
# 97 "./src/main/drivers/bus.c"
               ;
}
...
void busDeviceDeInit(busDevice_t * dev)
{
    ...
    dev->descriptorPtr = 
# 104 "./src/main/drivers/bus.c" 3 4
                        ((void *)0)
# 104 "./src/main/drivers/bus.c"
                            ;
        ...
        if (hw == descriptor->devHwType && (bus == descriptor->busType || bus == BUSTYPE_ANY) && (tag == descriptor->tag)) {
            ...
            if (dev) {
                switch (descriptor->busType) {
                    case BUSTYPE_NONE:
                        return 
# 125 "./src/main/drivers/bus.c" 3 4
                              ((void *)0)
# 125 "./src/main/drivers/bus.c"
                                  ;
                    ...
                    case BUSTYPE_I2C:
                        ...
                        if (!busDevInit_I2C(dev, descriptor)) {
                            busDeviceDeInit(dev);
                            return 
# 131 "./src/main/drivers/bus.c" 3 4
                                  ((void *)0)
# 131 "./src/main/drivers/bus.c"
                                      ;
                        }
                        break;
                    ...
                    case BUSTYPE_SPI:
                        ...
                        if (!busDevInit_SPI(dev, descriptor, owner)) {
                            busDeviceDeInit(dev);
                            return 
# 143 "./src/main/drivers/bus.c" 3 4
                                  ((void *)0)
# 143 "./src/main/drivers/bus.c"
                                      ;
                        }
                        break;
                ...
                return 
# 155 "./src/main/drivers/bus.c" 3 4
                      ((void *)0)
# 155 "./src/main/drivers/bus.c"
                          ;
            }
        }
    }
    ...
    return 
# 160 "./src/main/drivers/bus.c" 3 4
          ((void *)0)
# 160 "./src/main/drivers/bus.c"
              ;
}
...
busDevice_t * busDeviceOpen(busType_e bus, devHardwareType_e hw, uint8_t tag)
{
    ...
    return 
# 175 "./src/main/drivers/bus.c" 3 4
          ((void *)0)
# 175 "./src/main/drivers/bus.c"
              ;
}
...
# 212 "./src/main/drivers/bus.c" 3 4
_Bool 
# 212 "./src/main/drivers/bus.c"
    busTransfer(const busDevice_t * dev, uint8_t * rxBuf, const uint8_t * txBuf, int length)
{
    ...
    return 
# 232 "./src/main/drivers/bus.c" 3 4
          0
# 232 "./src/main/drivers/bus.c"
               ;
}


# 235 "./src/main/drivers/bus.c" 3 4
_Bool 
# 235 "./src/main/drivers/bus.c"
    busTransferMultiple(const busDevice_t * dev, busTransferDescriptor_t * dsc, int count)
{
    ...
    return 
# 248 "./src/main/drivers/bus.c" 3 4
          0
# 248 "./src/main/drivers/bus.c"
               ;
}


# 251 "./src/main/drivers/bus.c" 3 4
_Bool 
# 251 "./src/main/drivers/bus.c"
    busWriteBuf(const busDevice_t * dev, uint8_t reg, const uint8_t * data, uint8_t length)
{
    switch (dev->busType) {
        case BUSTYPE_SPI:
        ...
        default:
            return 
# 274 "./src/main/drivers/bus.c" 3 4
                  0
# 274 "./src/main/drivers/bus.c"
                       ;
    }
}


# 278 "./src/main/drivers/bus.c" 3 4
_Bool 
# 278 "./src/main/drivers/bus.c"
    busWrite(const busDevice_t * dev, uint8_t reg, uint8_t data)
{
    switch (dev->busType) {
        case BUSTYPE_SPI:
        ...
        default:
            return 
# 301 "./src/main/drivers/bus.c" 3 4
                  0
# 301 "./src/main/drivers/bus.c"
                       ;
    }
}


# 305 "./src/main/drivers/bus.c" 3 4
_Bool 
# 305 "./src/main/drivers/bus.c"
    busReadBuf(const busDevice_t * dev, uint8_t reg, uint8_t * data, uint8_t length)
{
    switch (dev->busType) {
        case BUSTYPE_SPI:
        ...
        default:
            return 
# 328 "./src/main/drivers/bus.c" 3 4
                  0
# 328 "./src/main/drivers/bus.c"
                       ;
    }
}


# 332 "./src/main/drivers/bus.c" 3 4
_Bool 
# 332 "./src/main/drivers/bus.c"
    busRead(const busDevice_t * dev, uint8_t reg, uint8_t * data)
{
    switch (dev->busType) {
        case BUSTYPE_SPI:
        ...
        default:
            return 
# 355 "./src/main/drivers/bus.c" 3 4
                  0
# 355 "./src/main/drivers/bus.c"
                       ;
    }
}
