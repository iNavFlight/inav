...
# 34 "./src/main/drivers/sound_beeper.c" 3 4
                      ((void *)0)
# 34 "./src/main/drivers/sound_beeper.c"
                                    ;
static 
...
void systemBeep(
# 40 "./src/main/drivers/sound_beeper.c" 3 4
               _Bool 
# 40 "./src/main/drivers/sound_beeper.c"
                    onoff)
{
...
void beeperInit(const beeperDevConfig_t *config)
{
    ...
    if (beeperIO) {
        ...
        IOConfigGPIO(beeperIO, config->isOD ? ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)) : ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));

    }

    systemBeep(
# 77 "./src/main/drivers/sound_beeper.c" 3 4
              0
# 77 "./src/main/drivers/sound_beeper.c"
                   );
