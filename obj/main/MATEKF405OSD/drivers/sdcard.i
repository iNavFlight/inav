...
# 29 "./src/main/drivers/sdcard.c" 2
# 1 "./src/main/drivers/dma.h" 1
# 20 "./src/main/drivers/dma.h"
...
# 22 "./src/main/drivers/bus_spi.h" 2
...
# 32 "./src/main/drivers/sdcard.c" 2
...
# 35 "./src/main/drivers/sdcard.c" 2
...
#define SDCARD_GET_CSD_FIELD(csd,version,fieldname) readBitfield(csd.data, SDCARD_CSD_V ## version ## _ ## fieldname ## _OFFSET, SDCARD_CSD_V ## version ## _ ## fieldname ## _LEN)
...
# 36 "./src/main/drivers/sdcard.c" 2
...
# 37 "./src/main/drivers/sdcard.c" 2
...
# 39 "./src/main/drivers/sdcard.c" 2
...
# 99 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 99 "./src/main/drivers/sdcard.c"
        highCapacity;
...
static sdcard_t sdcard;
    ...
    static 
# 117 "./src/main/drivers/sdcard.c" 3 4
          _Bool 
# 117 "./src/main/drivers/sdcard.c"
               useDMAForTx;
# 126 "./src/main/drivers/sdcard.c"
...
static IO_t sdCardCsPin = ((IO_t)0);
...
# 155 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 155 "./src/main/drivers/sdcard.c"
    sdcard_isInserted(void)
{
    
# 157 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 157 "./src/main/drivers/sdcard.c"
        result = 
# 157 "./src/main/drivers/sdcard.c" 3 4
                 1
# 157 "./src/main/drivers/sdcard.c"
                     ;
# 169 "./src/main/drivers/sdcard.c"
    return result;
}
...
# 176 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 176 "./src/main/drivers/sdcard.c"
    sdcard_isFunctional(void)
{
...
static void sdcard_deselect(void)
{
    ...
    while (spiIsBusBusy(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)))) {
    }
...
static void sdcard_reset(void)
{
    ...
    if (sdcard.state >= SDCARD_STATE_READY) {
        spiSetSpeed(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), SPI_CLOCK_INITIALIZATON);
    }
...
static 
# 228 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 228 "./src/main/drivers/sdcard.c"
           sdcard_waitForIdle(int maxBytesToWait)
{
    while (maxBytesToWait > 0) {
        uint8_t b = spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 0xFF);
        if (b == 0xFF) {
            return 
# 233 "./src/main/drivers/sdcard.c" 3 4
                  1
# 233 "./src/main/drivers/sdcard.c"
                      ;
        }
        maxBytesToWait--;
    }
    ...
    return 
# 238 "./src/main/drivers/sdcard.c" 3 4
          0
# 238 "./src/main/drivers/sdcard.c"
               ;
}
...
static uint8_t sdcard_waitForNonIdleByte(int maxDelay)
{
    for (int i = 0; i < maxDelay + 1; i++) {
        uint8_t response = spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 0xFF);
...
static uint8_t sdcard_sendCommand(uint8_t commandCode, uint32_t commandArgument)
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 
# 284 "./src/main/drivers/sdcard.c" 3 4
                                    ((void *)0)
# 284 "./src/main/drivers/sdcard.c"
...
static 
# 304 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 304 "./src/main/drivers/sdcard.c"
           sdcard_validateInterfaceCondition(void)
{
    ...
    if (status == (4 | 1)) {
        ...
        spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ifCondReply, 
...
static 
# 336 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 336 "./src/main/drivers/sdcard.c"
           sdcard_readOCRRegister(uint32_t *result)
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), response, 
# 344 "./src/main/drivers/sdcard.c" 3 4
                                              ((void *)0)
# 344 "./src/main/drivers/sdcard.c"
                                                  , sizeof(response));
    ...
    if (status == 0) {
        ...
        *result = (response[0] << 24) | (response[1] << 16) | (response[2] << 8) | response[3];
        ...
        return 
# 351 "./src/main/drivers/sdcard.c" 3 4
              1
# 351 "./src/main/drivers/sdcard.c"
                  ;
    } else {
        sdcard_deselect();

        return 
# 355 "./src/main/drivers/sdcard.c" 3 4
              0
# 355 "./src/main/drivers/sdcard.c"
                   ;
    }
}
...
static sdcardReceiveBlockStatus_e sdcard_receiveDataBlock(uint8_t *buffer, int count)
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), buffer, 
# 382 "./src/main/drivers/sdcard.c" 3 4
                                            ((void *)0)
# 382 "./src/main/drivers/sdcard.c"
                                                , count);


    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 0xFF);
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 0xFF);
...
static 
# 391 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 391 "./src/main/drivers/sdcard.c"
           sdcard_sendDataBlockFinish(void)
{

    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 0x00);
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 0x00);

    uint8_t dataResponseToken = spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 0xFF);
# 411 "./src/main/drivers/sdcard.c"
...
# 417 "./src/main/drivers/sdcard.c" 3 4
                                                      _Bool 
# 417 "./src/main/drivers/sdcard.c"
                                                           multiBlockWrite)
{

    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 0xFF);

    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), multiBlockWrite ? 0xFC : 0xFE);
    ...
    if (useDMAForTx) {
        ...
        DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t) &((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))->DR;
        DMA_InitStructure.DMA_Priority = ((uint32_t)0x00000000);
        ...
        DMA_DeInit(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)));
        DMA_Init(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)), &DMA_InitStructure);

        DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)), ENABLE);

        SPI_I2S_DMACmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002), ENABLE);
        ...
        spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 
# 464 "./src/main/drivers/sdcard.c" 3 4
                                        ((void *)0)
# 464 "./src/main/drivers/sdcard.c"
                                            , buffer, 256);
    }
}

static 
# 468 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 468 "./src/main/drivers/sdcard.c"
           sdcard_receiveCID(void)
{
    ...
    if (sdcard_receiveDataBlock(cid, sizeof(cid)) != SDCARD_RECEIVE_SUCCESS) {
        return 
# 473 "./src/main/drivers/sdcard.c" 3 4
              0
# 473 "./src/main/drivers/sdcard.c"
                   ;
    }
    ...
    return 
# 489 "./src/main/drivers/sdcard.c" 3 4
          1
# 489 "./src/main/drivers/sdcard.c"
              ;
}

static 
# 492 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 492 "./src/main/drivers/sdcard.c"
...
# 502 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 502 "./src/main/drivers/sdcard.c"
        success =
    ...
    if (success) {
        switch (readBitfield(sdcard.csd.data, 0, 2)) {
            ...
            default:
                success = 
# 525 "./src/main/drivers/sdcard.c" 3 4
                         0
# 525 "./src/main/drivers/sdcard.c"
                              ;
        }
    }
...
static 
# 539 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 539 "./src/main/drivers/sdcard.c"
...
void sdcard_init(
# 554 "./src/main/drivers/sdcard.c" 3 4
                _Bool 
# 554 "./src/main/drivers/sdcard.c"
                     useDMA)
{

    useDMAForTx = useDMA;

    dmaEnableClock(dmaFindHandlerIdentifier(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8))));
    DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)), DISABLE);
    ...
    sdCardCsPin = IOGetByTag(((((2) + 1) << 4) | (1)));
    IOInit(sdCardCsPin, OWNER_SDCARD, RESOURCE_SPI_CS, 0);
    IOConfigGPIO(sdCardCsPin, ((GPIO_Mode_OUT) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 
# 582 "./src/main/drivers/sdcard.c" 3 4
                                    ((void *)0)
# 582 "./src/main/drivers/sdcard.c"
                                        , 
# 582 "./src/main/drivers/sdcard.c" 3 4
                                          ((void *)0)
# 582 "./src/main/drivers/sdcard.c"
...
static 
# 599 "./src/main/drivers/sdcard.c" 3 4
      _Bool 
# 599 "./src/main/drivers/sdcard.c"
...
static sdcardOperationStatus_e sdcard_endWriteBlocks(void)
{
    ...
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 0xFD);
...
# 654 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 654 "./src/main/drivers/sdcard.c"
    sdcard_poll(void)
{
    uint8_t initStatus;
    
# 657 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 657 "./src/main/drivers/sdcard.c"
        sendComplete;
        ...
        case SDCARD_STATE_CARD_INIT_IN_PROGRESS:
            if (sdcard_checkInitDone()) {
                if (sdcard.version == 2) {
                    ...
                    sdcard.highCapacity = 
# 699 "./src/main/drivers/sdcard.c" 3 4
                                         0
# 699 "./src/main/drivers/sdcard.c"
                                              ;
                }
        ...
        case SDCARD_STATE_INITIALIZATION_RECEIVE_CID:
            if (sdcard_receiveCID()) {
                ...
                spiSetSpeed(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), SPI_CLOCK_STANDARD);
        ...
        case SDCARD_STATE_SENDING_WRITE:
            ...
            sendComplete = 
# 744 "./src/main/drivers/sdcard.c" 3 4
                          0
# 744 "./src/main/drivers/sdcard.c"
                               ;
# 770 "./src/main/drivers/sdcard.c"
            if (useDMAForTx && DMA_GetFlagStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)), ((uint32_t)0x28000000)) == SET) {
                DMA_ClearFlag(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)), ((uint32_t)0x28000000));
                ...
                while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0001)) == SET) {
                    ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))->DR;
                }
                ...
                SPI_I2S_DMACmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002), DISABLE);

                sendComplete = 
# 790 "./src/main/drivers/sdcard.c" 3 4
                              1
# 790 "./src/main/drivers/sdcard.c"
                                  ;
            }
            ...
            if (!useDMAForTx) {
                ...
                spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), 
# 796 "./src/main/drivers/sdcard.c" 3 4
                                                ((void *)0)
# 796 "./src/main/drivers/sdcard.c"
                                                    , sdcard.pendingOperation.buffer + 256 * sdcard.pendingOperation.chunkIndex, 256);
...
# 822 "./src/main/drivers/sdcard.c" 3 4
                                                                                                                          ((void *)0)
# 822 "./src/main/drivers/sdcard.c"
...
# 911 "./src/main/drivers/sdcard.c" 3 4
                           ((void *)0)
# 911 "./src/main/drivers/sdcard.c"
                               ,
                            sdcard.pendingOperation.callbackData
                        );
                    }
...
# 1031 "./src/main/drivers/sdcard.c"
sdcardOperationStatus_e sdcard_beginWriteBlocks(uint32_t blockIndex, uint32_t blockCount)
{
    if (sdcard.state != SDCARD_STATE_READY) {
...
# 1079 "./src/main/drivers/sdcard.c"

# 1079 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 1079 "./src/main/drivers/sdcard.c"
    sdcard_readBlock(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData)
{
    if (sdcard.state != SDCARD_STATE_READY) {
        if (sdcard.state == SDCARD_STATE_WRITING_MULTIPLE_BLOCKS) {
            if (sdcard_endWriteBlocks() != SDCARD_OPERATION_SUCCESS) {
                return 
# 1084 "./src/main/drivers/sdcard.c" 3 4
                      0
# 1084 "./src/main/drivers/sdcard.c"
                           ;
            }
        } else {
            return 
# 1087 "./src/main/drivers/sdcard.c" 3 4
                  0
# 1087 "./src/main/drivers/sdcard.c"
                       ;
        }
    }
    ...
    if (status == 0) {
        ...
        return 
# 1112 "./src/main/drivers/sdcard.c" 3 4
              1
# 1112 "./src/main/drivers/sdcard.c"
                  ;
    } else {
        sdcard_deselect();

        return 
# 1116 "./src/main/drivers/sdcard.c" 3 4
              0
# 1116 "./src/main/drivers/sdcard.c"
                   ;
    }
}
...
# 1123 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 1123 "./src/main/drivers/sdcard.c"
    sdcard_isInitialized(void)
{
