# 1 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
# 25 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
...
# 26 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 27 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 58 "./src/main/platform.h" 2
# 29 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 30 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 32 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 33 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 35 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 36 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 37 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 44 "./src/main/drivers/exti.h"
                             enable);
# 38 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 39 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 41 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 42 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 43 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
# 44 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 2
...
static void mpu6000AccAndGyroInit(gyroDev_t *gyro)
{
    ...
    busWrite(busDev, 0x6B, 0x80);
    delay(150);

    busWrite(busDev, 0x68, 3 | 2 | 1);
    delay(150);


    busWrite(busDev, 0x6B, 0x03);
    delayMicroseconds(15);


    busWrite(busDev, 0x6A, 0x10);
    delayMicroseconds(15);

    busWrite(busDev, 0x6C, 0x00);
    delayMicroseconds(15);



    busWrite(busDev, 0x19, config->gyroConfigValues[1]);
    delayMicroseconds(15);


    busWrite(busDev, 0x1B, INV_FSR_2000DPS << 3);
    delayMicroseconds(15);


    busWrite(busDev, 0x1C, INV_FSR_16G << 3);
    delayMicroseconds(15);

    busWrite(busDev, 0x37, 0 << 7 | 0 << 6 | 0 << 5 | 1 << 4 | 0 << 3 | 0 << 2 | 0 << 1 | 0 << 0);
    delayMicroseconds(15);


    busWrite(busDev, 0x38, (1 << 0));
    delayMicroseconds(15);



    busWrite(busDev, 0x1A, config->gyroConfigValues[0]);
    delayMicroseconds(1);
...
# 139 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
_Bool 
# 139 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
    mpu6000AccDetect(accDev_t *acc)
{
    acc->busDev = busDeviceOpen(BUSTYPE_ANY, DEVHW_MPU6000, acc->imuSensorToUse);
    if (acc->busDev == 
# 142 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
                      ((void *)0)
# 142 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
                          ) {
        return 
# 143 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
              0
# 143 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
                   ;
    }
    ...
    if (ctx->chipMagicNumber != 0x6860) {
        return 
# 148 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
              0
# 148 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
                   ;
    }
    ...
    return 
# 154 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
          1
# 154 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
              ;
}

static 
# 157 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
      _Bool 
# 157 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
           mpu6000DeviceDetect(busDevice_t * busDev)
{
    uint8_t in;
    ...
    do {
        ...
        busRead(busDev, 0x75, &in);
        if (in == (0x68)) {
            break;
        }
        if (!attemptsRemaining) {
            return 
# 174 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
                  0
# 174 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
                       ;
        }
    } while (attemptsRemaining--);

    busRead(busDev, 0x0C, &in);
    ...
    switch (in) {
        ...
        case 0x5A:
            return 
# 194 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
                  1
# 194 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
                      ;
    }

    return 
# 197 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
          0
# 197 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
               ;
}


# 200 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
_Bool 
# 200 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
    mpu6000GyroDetect(gyroDev_t *gyro)
{
    gyro->busDev = busDeviceInit(BUSTYPE_ANY, DEVHW_MPU6000, gyro->imuSensorToUse, OWNER_MPU);
    if (gyro->busDev == 
# 203 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
                       ((void *)0)
# 203 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
                           ) {
        return 
# 204 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
              0
# 204 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
                   ;
    }
    ...
    if (!mpu6000DeviceDetect(gyro->busDev)) {
        ...
        return 
# 209 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
              0
# 209 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
                   ;
    }
    ...
    return 
# 222 "./src/main/drivers/accgyro/accgyro_mpu6000.c" 3 4
          1
# 222 "./src/main/drivers/accgyro/accgyro_mpu6000.c"
              ;
}
