...
# 58 "./src/main/platform.h" 2
# 23 "./src/main/drivers/pwm_mapping.c" 2

# 1 "./src/main/common/memory.h" 1
# 25 "./src/main/common/memory.h"
...
# 35 "/usr/arm-none-eabi/include/stdlib.h" 3
typedef struct
{
  int quot;
  int rem;
...
# 22 "./src/main/drivers/resource.h"
typedef enum {
    OWNER_FREE = 0,
    OWNER_PWMIO,
    OWNER_PWMINPUT,
...
# 25 "./src/main/drivers/pwm_mapping.c" 2
...
# 49 "./src/main/drivers/pwm_mapping.c" 3 4
_Bool 
# 49 "./src/main/drivers/pwm_mapping.c"
    CheckGPIOPin(ioTag_t tag, GPIO_TypeDef *gpio, uint16_t pin)
{
    return IO_GPIO(IOGetByTag(tag)) == gpio && IO_Pin(IOGetByTag(tag)) == pin;
}


# 54 "./src/main/drivers/pwm_mapping.c" 3 4
_Bool 
# 54 "./src/main/drivers/pwm_mapping.c"
    CheckGPIOPinSource(ioTag_t tag, GPIO_TypeDef *gpio, uint16_t pin)
{
    return IO_GPIO(IOGetByTag(tag)) == gpio && IO_GPIO_PinSource(IOGetByTag(tag)) == pin;
}
...
# 88 "./src/main/drivers/pwm_mapping.c"
        const timerHardware_t *ss1TimerHardware = timerGetByTag(((((0) + 1) << 4) | (1)), TIM_USE_ANY);
        if (init->useSoftSerial && ss1TimerHardware != 
# 89 "./src/main/drivers/pwm_mapping.c" 3 4
                                                      ((void *)0) 
# 89 "./src/main/drivers/pwm_mapping.c"
                                                           && ss1TimerHardware->tim == timerHardwarePtr->tim) {
        ...
        if (init->useSoftSerial && ss2TimerHardware != 
# 97 "./src/main/drivers/pwm_mapping.c" 3 4
                                                      ((void *)0) 
# 97 "./src/main/drivers/pwm_mapping.c"
                                                           && ss2TimerHardware->tim == timerHardwarePtr->tim) {
            addBootlogEvent6(BOOT_EVENT_TIMER_CH_SKIPPED, BOOT_EVENT_FLAGS_WARNING, timerIndex, pwmIOConfiguration.motorCount, pwmIOConfiguration.servoCount, 3);
            continue;
        }
# 153 "./src/main/drivers/pwm_mapping.c"
        if (init->useSerialRx) {
            type = MAP_TO_NONE;
        }
        ...
        if (type == MAP_TO_PPM_INPUT) {
            ...
            if (pwmIOConfiguration.motorCount >= 12) {
            ...
            if (pwmIOConfiguration.servoCount >= 8) {
                addBootlogEvent6(BOOT_EVENT_TIMER_CH_SKIPPED, BOOT_EVENT_FLAGS_WARNING, timerIndex, pwmIOConfiguration.motorCount, pwmIOConfiguration.servoCount, 3);
                continue;
            }
