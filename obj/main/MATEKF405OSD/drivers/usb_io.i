...
# 55 "./src/main/drivers/usb_io.c" 3 4
_Bool 
# 55 "./src/main/drivers/usb_io.c"
    usbCableIsInserted(void)
{
    
# 57 "./src/main/drivers/usb_io.c" 3 4
   _Bool 
# 57 "./src/main/drivers/usb_io.c"
        result = 
# 57 "./src/main/drivers/usb_io.c" 3 4
                 0
# 57 "./src/main/drivers/usb_io.c"
...
void usbGenerateDisconnectPulse(void)
{
    ...
    IO_t usbPin = IOGetByTag(((((0) + 1) << 4) | (12)));
