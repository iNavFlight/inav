# 1 "./src/main/drivers/timer_impl_stdperiph.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 9 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 10 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 58 "./src/main/platform.h" 2
# 12 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 14 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 16 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 18 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 19 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 20 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 21 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 22 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 23 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
void impl_timerPWMStart(TIM_TypeDef * tim, unsigned channel, 
# 52 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
                                                            _Bool 
# 52 "./src/main/drivers/timer_impl_stdperiph.c"
                                                                 isNChannel)
{
    (void)(channel);
    (void)(isNChannel);
...
void impl_timerChConfigIC(const timerHardware_t *timHw, 
# 92 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
                                                       _Bool 
# 92 "./src/main/drivers/timer_impl_stdperiph.c"
                                                            polarityRising, unsigned inputFilterTicks)
{
...
void impl_timerPWMConfigChannel(TIM_TypeDef * tim, uint8_t channel, 
# 170 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
                                                                   _Bool 
# 170 "./src/main/drivers/timer_impl_stdperiph.c"
                                                                        isNChannel, 
# 170 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
                                                                                    _Bool 
# 170 "./src/main/drivers/timer_impl_stdperiph.c"
                                                                                         inverted, uint16_t value)
{
    ...
    if (isNChannel) {
        ...
        TIM_OCInitStructure.TIM_OCNPolarity = inverted ? ((uint16_t)0x0002) : ((uint16_t)0x0000);
        ...
        TIM_OCInitStructure.TIM_OCPolarity = inverted ? ((uint16_t)0x0002) : ((uint16_t)0x0000);
...
volatile timCCR_t * impl_timerCCR(TIM_TypeDef *tim, uint8_t channel)
{
    ...
    return 
# 241 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
          ((void *)0)
# 241 "./src/main/drivers/timer_impl_stdperiph.c"
              ;
}
