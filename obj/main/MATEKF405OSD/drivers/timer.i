...
#define TIM_N(n) (1 << (n))
# 48 "./src/main/drivers/timer.c"
timerConfig_t * timerConfig[14];
...
void timerConfigure(const timerHardware_t *timerHardwarePtr, uint16_t period, uint8_t mhz)
{
    ...
    if (timerDefinitions[timer].irq != 0) {
        impl_timerNVICConfigure(timerDefinitions[timer].irq, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0));
    }

    if (timerDefinitions[timer].secondIrq != 0) {
        impl_timerNVICConfigure(timerDefinitions[timer].secondIrq, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0));
    }
}
...
void timerChOvrHandlerInit(timerOvrHandlerRec_t *self, timerOvrHandlerCallback *fn)
{
    self->fn = fn;
    self->next = 
# 106 "./src/main/drivers/timer.c" 3 4
                ((void *)0)
# 106 "./src/main/drivers/timer.c"
                    ;
}
...
static void timerChConfig_UpdateOverflow(timerConfig_t *cfg, TIM_TypeDef *tim) {
    ...
    for ( uint8_t __basepri_save __attribute__((__cleanup__(__basepriRestoreMem))) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        ...
        *chain = 
# 119 "./src/main/drivers/timer.c" 3 4
                ((void *)0)
# 119 "./src/main/drivers/timer.c"
                    ;
    }


    if (cfg->overflowCallbackActive) {
        impl_timerEnableIT(tim, ((uint16_t)0x0001));
    }
    else {
        impl_timerDisableIT(tim, ((uint16_t)0x0001));
    }
}
...
timerConfig_t * timerGetConfigContext(int timerIndex)
{
    ...
    if (timerConfig[timerIndex] == 
# 134 "./src/main/drivers/timer.c" 3 4
                                  ((void *)0)
# 134 "./src/main/drivers/timer.c"
                                      ) {
...
void timerChConfigCallbacks(const timerHardware_t *timHw, timerCCHandlerRec_t *edgeCallback, timerOvrHandlerRec_t *overflowCallback)
{
    ...
    if (edgeCallback == 
# 151 "./src/main/drivers/timer.c" 3 4
                       ((void *)0)
# 151 "./src/main/drivers/timer.c"
                           )
        impl_timerDisableIT(timHw->tim, (((uint16_t)0x0002) << ((timHw->channel) / 4)));
    ...
    if (cfg) {
        ...
        if (edgeCallback)
            impl_timerEnableIT(timHw->tim, (((uint16_t)0x0002) << ((timHw->channel) / 4)));
...
void timerChConfigIC(const timerHardware_t *timHw, 
# 174 "./src/main/drivers/timer.c" 3 4
                                                  _Bool 
# 174 "./src/main/drivers/timer.c"
                                                       polarityRising, unsigned inputFilterTicks)
{
...
void timerInit(void)
{
    ...
    for (int i = 0; i < timerHardwareCount; i++) {
        ...
        IOConfigGPIO(IOGetByTag(timerHardwarePtr->tag), ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_DOWN) << 5)));
    }
}
...
const timerHardware_t *timerGetByTag(ioTag_t tag, timerUsageFlag_e flag)
{
    if (!tag) {
        return 
# 205 "./src/main/drivers/timer.c" 3 4
              ((void *)0)
# 205 "./src/main/drivers/timer.c"
                  ;
    }
    ...
    return 
# 215 "./src/main/drivers/timer.c" 3 4
          ((void *)0)
# 215 "./src/main/drivers/timer.c"
              ;
}

void timerPWMConfigChannel(TIM_TypeDef * tim, uint8_t channel, 
# 218 "./src/main/drivers/timer.c" 3 4
                                                              _Bool 
# 218 "./src/main/drivers/timer.c"
                                                                   isNChannel, 
# 218 "./src/main/drivers/timer.c" 3 4
                                                                               _Bool 
# 218 "./src/main/drivers/timer.c"
...
void timerPWMStart(TIM_TypeDef * tim, uint8_t channel, 
# 228 "./src/main/drivers/timer.c" 3 4
                                                      _Bool 
# 228 "./src/main/drivers/timer.c"
                                                           isNChannel)
{
