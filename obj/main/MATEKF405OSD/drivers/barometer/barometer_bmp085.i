...
# 25 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 27 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 29 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 22 "./src/main/drivers/barometer/barometer_bmp085.h" 3 4
_Bool 
# 22 "./src/main/drivers/barometer/barometer_bmp085.h"
    bmp085Detect(baroDev_t *baro);
# 35 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
{
    uint8_t data[22];
    busReadBuf(baro->busDev, 0xaa, data, 22);
...
static 
# 178 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 178 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085_start_ut(baroDev_t *baro)
{
    
# 180 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 180 "./src/main/drivers/barometer/barometer_bmp085.c"
        ack = busWrite(baro->busDev, 0xF4, 0x2E);
    return ack;
}

static 
# 184 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 184 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085_get_ut(baroDev_t *baro)
{
    uint8_t data[2];
    
# 187 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 187 "./src/main/drivers/barometer/barometer_bmp085.c"
        ack = busReadBuf(baro->busDev, 0xF6, data, 2);
    if (ack) {
...
static 
# 195 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 195 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085_start_up(baroDev_t *baro)
{
    uint8_t ctrl_reg_data = 0x34 + (bmp085.oversampling_setting << 6);
    
# 198 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 198 "./src/main/drivers/barometer/barometer_bmp085.c"
        ack = busWrite(baro->busDev, 0xF4, ctrl_reg_data);
    return ack;
}
...
static 
# 206 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 206 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085_get_up(baroDev_t *baro)
{
    uint8_t data[3];
    
# 209 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 209 "./src/main/drivers/barometer/barometer_bmp085.c"
        ack = busReadBuf(baro->busDev, 0xF6, data, 3);
...
static 
# 218 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                  _Bool 
# 218 "./src/main/drivers/barometer/barometer_bmp085.c"
                       bmp085_calculate(baroDev_t *baro, int32_t *pressure, int32_t *temperature)
{
    (void)(baro);
    int32_t temp, press;
...
static 
# 234 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 234 "./src/main/drivers/barometer/barometer_bmp085.c"
           deviceDetect(busDevice_t * busDev)
{
...
# 241 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
       _Bool 
# 241 "./src/main/drivers/barometer/barometer_bmp085.c"
            ack = busRead(busDev, 0xD0, &chipId);
        if (ack && ((chipId & 0xFF) >> 0) == 0x55) {
            return 
# 243 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                  1
# 243 "./src/main/drivers/barometer/barometer_bmp085.c"
                      ;
        }
    };

    return 
# 247 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
          0
# 247 "./src/main/drivers/barometer/barometer_bmp085.c"
               ;
}


# 250 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
_Bool 
# 250 "./src/main/drivers/barometer/barometer_bmp085.c"
    bmp085Detect(baroDev_t *baro)
{
    baro->busDev = busDeviceInit(BUSTYPE_ANY, DEVHW_BMP085, 0, OWNER_BARO);
    if (baro->busDev == 
# 253 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                       ((void *)0)
# 253 "./src/main/drivers/barometer/barometer_bmp085.c"
                           ) {
        return 
# 254 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
              0
# 254 "./src/main/drivers/barometer/barometer_bmp085.c"
                   ;
    }
    ...
    if (!deviceDetect(baro->busDev)) {
        ...
        return 
# 259 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
              0
# 259 "./src/main/drivers/barometer/barometer_bmp085.c"
                   ;
    }

    bmp085.oversampling_setting = 3;
    bmp085_get_cal_param(baro);
    ...
    return 
# 275 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
          1
# 275 "./src/main/drivers/barometer/barometer_bmp085.c"
              ;
}
