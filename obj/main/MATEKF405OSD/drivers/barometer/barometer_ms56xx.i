# 1 "./src/main/drivers/barometer/barometer_ms56xx.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/barometer/barometer_ms56xx.c"
# 18 "./src/main/drivers/barometer/barometer_ms56xx.c"
...
# 19 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
...
# 20 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
...
# 58 "./src/main/platform.h" 2
# 22 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
...
# 24 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
...
# 25 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
...
# 27 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
...
# 28 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
...
# 29 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
...
# 30 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
# 1 "./src/main/drivers/barometer/barometer_ms56xx.h" 1
# 18 "./src/main/drivers/barometer/barometer_ms56xx.h"
...
# 58 "./src/main/sensors/barometer.h"
    baroIsHealthy(void);
# 20 "./src/main/drivers/barometer/barometer_ms56xx.h" 2


# 21 "./src/main/drivers/barometer/barometer_ms56xx.h" 3 4
_Bool 
# 21 "./src/main/drivers/barometer/barometer_ms56xx.h"
    ms5607Detect(baroDev_t *baro);

# 22 "./src/main/drivers/barometer/barometer_ms56xx.h" 3 4
_Bool 
# 22 "./src/main/drivers/barometer/barometer_ms56xx.h"
    ms5611Detect(baroDev_t *baro);
# 31 "./src/main/drivers/barometer/barometer_ms56xx.c" 2
...
static uint32_t ms56xx_ut;
static uint32_t ms56xx_up;
static uint16_t ms56xx_c[8];
static uint8_t ms56xx_osr = 0x08;

static int8_t ms56xx_crc(uint16_t *prom)
{
    int32_t i, j;
    uint32_t res = 0;
...
# 62 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
   _Bool 
# 62 "./src/main/drivers/barometer/barometer_ms56xx.c"
        blankEeprom = 
# 62 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
                      1
# 62 "./src/main/drivers/barometer/barometer_ms56xx.c"
    ...
    for (i = 0; i < 16; i++) {
        if (prom[i >> 1]) {
            blankEeprom = 
# 66 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
                         0
# 66 "./src/main/drivers/barometer/barometer_ms56xx.c"
                              ;
        }
        if (i & 1)
            res ^= ((prom[i >> 1]) & 0x00FF);
...
{
    uint8_t rxbuf[3];
    busReadBuf(baro->busDev, 0x00, rxbuf, 3);
    return (rxbuf[0] << 16) | (rxbuf[1] << 8) | rxbuf[2];
}

static 
# 92 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
      _Bool 
# 92 "./src/main/drivers/barometer/barometer_ms56xx.c"
           ms56xx_start_ut(baroDev_t *baro)
{
    return busWrite(baro->busDev, 0x40 + 0x10 + ms56xx_osr, 1);
}

static 
# 97 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
      _Bool 
# 97 "./src/main/drivers/barometer/barometer_ms56xx.c"
           ms56xx_get_ut(baroDev_t *baro)
{
    ms56xx_ut = ms56xx_read_adc(baro);
    return 
# 100 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
          1
# 100 "./src/main/drivers/barometer/barometer_ms56xx.c"
              ;
}

static 
# 103 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
      _Bool 
# 103 "./src/main/drivers/barometer/barometer_ms56xx.c"
           ms56xx_start_up(baroDev_t *baro)
{
    return busWrite(baro->busDev, 0x40 + 0x00 + ms56xx_osr, 1);
}

static 
# 108 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
      _Bool 
# 108 "./src/main/drivers/barometer/barometer_ms56xx.c"
           ms56xx_get_up(baroDev_t *baro)
{
    ms56xx_up = ms56xx_read_adc(baro);
    return 
# 111 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
          1
# 111 "./src/main/drivers/barometer/barometer_ms56xx.c"
              ;
}


static 
# 115 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
                  _Bool 
# 115 "./src/main/drivers/barometer/barometer_ms56xx.c"
                       ms5611_calculate(baroDev_t *baro, int32_t *pressure, int32_t *temperature)
{
    (void)(baro);
    uint32_t press;
    int64_t temp;
    ...
    return 
# 146 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
          1
# 146 "./src/main/drivers/barometer/barometer_ms56xx.c"
              ;
}
# 186 "./src/main/drivers/barometer/barometer_ms56xx.c"
#define DETECTION_MAX_RETRY_COUNT 5
static 
# 187 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
      _Bool 
# 187 "./src/main/drivers/barometer/barometer_ms56xx.c"
           deviceDetect(busDevice_t * dev)
{
...
# 194 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
       _Bool 
# 194 "./src/main/drivers/barometer/barometer_ms56xx.c"
            ack = busRead(dev, 0xA0, &sig);
        if (ack && sig != 0xFF) {
            return 
# 196 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
                  1
# 196 "./src/main/drivers/barometer/barometer_ms56xx.c"
                      ;
        }
    };

    return 
# 200 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
          0
# 200 "./src/main/drivers/barometer/barometer_ms56xx.c"
               ;
}

static 
# 203 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
      _Bool 
# 203 "./src/main/drivers/barometer/barometer_ms56xx.c"
           deviceInit(baroDev_t *baro)
{
    busSetSpeed(baro->busDev, BUS_SPEED_STANDARD);

    busWrite(baro->busDev, 0x1E, 1);
    delay(5);


    for (int i = 0; i < 8; i++) {
        uint8_t rxbuf[2] = { 0, 0 };
        busReadBuf(baro->busDev, 0xA0 + i * 2, rxbuf, 2);
    ...
    if (ms56xx_crc(ms56xx_c) != 0) {
        return 
# 219 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
              0
# 219 "./src/main/drivers/barometer/barometer_ms56xx.c"
                   ;
    }
    ...
    return 
# 229 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
          1
# 229 "./src/main/drivers/barometer/barometer_ms56xx.c"
              ;
}
# 257 "./src/main/drivers/barometer/barometer_ms56xx.c"

# 257 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
_Bool 
# 257 "./src/main/drivers/barometer/barometer_ms56xx.c"
    ms5611Detect(baroDev_t *baro)
{
    ...
    if (baro->busDev == 
# 260 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
                       ((void *)0)
# 260 "./src/main/drivers/barometer/barometer_ms56xx.c"
                           ) {
        return 
# 261 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
              0
# 261 "./src/main/drivers/barometer/barometer_ms56xx.c"
                   ;
    }
    ...
    if (!deviceDetect(baro->busDev)) {
        ...
        return 
# 266 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
              0
# 266 "./src/main/drivers/barometer/barometer_ms56xx.c"
                   ;
    }
    ...
    if (!deviceInit(baro)) {
        busDeviceDeInit(baro->busDev);
        return 
# 271 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
              0
# 271 "./src/main/drivers/barometer/barometer_ms56xx.c"
                   ;
    }
    ...
    return 
# 276 "./src/main/drivers/barometer/barometer_ms56xx.c" 3 4
          1
# 276 "./src/main/drivers/barometer/barometer_ms56xx.c"
              ;
}
