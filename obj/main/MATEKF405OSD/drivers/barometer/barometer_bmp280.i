...
# 23 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 28 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 29 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 30 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 69 "./src/main/drivers/barometer/barometer_bmp280.h" 3 4
_Bool 
# 69 "./src/main/drivers/barometer/barometer_bmp280.h"
...
static 
# 57 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 57 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280_start_ut(baroDev_t * baro)
{
    (void)(baro);
    return 
# 60 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 60 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}

static 
# 63 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 63 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280_get_ut(baroDev_t * baro)
{
    (void)(baro);
    return 
# 66 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 66 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}

static 
# 69 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 69 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280_start_up(baroDev_t * baro)
{


    busWrite(baro->busDev, (0xF4), (((0x04)) << 2 | ((0x01)) << 5 | (0x01)));
    return 
# 74 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 74 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}

static 
# 77 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 77 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280_get_up(baroDev_t * baro)
{
    uint8_t data[(6)];
...
# 86 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
   _Bool 
# 86 "./src/main/drivers/barometer/barometer_bmp280.c"
        ack = busReadBuf(baro->busDev, (0xF7), data, (6));
...
static 
# 141 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                  _Bool 
# 141 "./src/main/drivers/barometer/barometer_bmp280.c"
                       bmp280_calculate(baroDev_t * baro, int32_t * pressure, int32_t * temperature)
{
    (void)(baro);
    ...
    return 
# 156 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 156 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
...
# 160 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 160 "./src/main/drivers/barometer/barometer_bmp280.c"
...
# 167 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
       _Bool 
# 167 "./src/main/drivers/barometer/barometer_bmp280.c"
            ack = busRead(busDev, (0xD0), &chipId);

        if (ack && chipId == (0x58)) {
            return 
# 170 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                  1
# 170 "./src/main/drivers/barometer/barometer_bmp280.c"
                      ;
        }
    };

    return 
# 174 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          0
# 174 "./src/main/drivers/barometer/barometer_bmp280.c"
               ;
}


# 177 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
_Bool 
# 177 "./src/main/drivers/barometer/barometer_bmp280.c"
    bmp280Detect(baroDev_t *baro)
{
    baro->busDev = busDeviceInit(BUSTYPE_ANY, DEVHW_BMP280, 0, OWNER_BARO);
    if (baro->busDev == 
# 180 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                       ((void *)0)
# 180 "./src/main/drivers/barometer/barometer_bmp280.c"
                           ) {
        return 
# 181 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
              0
# 181 "./src/main/drivers/barometer/barometer_bmp280.c"
                   ;
    }
    ...
    if (!deviceDetect(baro->busDev)) {
        ...
        return 
# 188 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
              0
# 188 "./src/main/drivers/barometer/barometer_bmp280.c"
                   ;
    }


    busReadBuf(baro->busDev, (0x88), (uint8_t *)&bmp280_cal, 24);


    busWrite(baro->busDev, (0xF5), ((0x03) << 2));
    ...
    return 
# 210 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 210 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
