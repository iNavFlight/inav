# 1 "./src/main/drivers/bus_busdev_spi.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/bus_busdev_spi.c"
# 18 "./src/main/drivers/bus_busdev_spi.c"
...
# 19 "./src/main/drivers/bus_busdev_spi.c" 2
...
# 20 "./src/main/drivers/bus_busdev_spi.c" 2
...
# 21 "./src/main/drivers/bus_busdev_spi.c" 2
...
# 58 "./src/main/platform.h" 2
# 23 "./src/main/drivers/bus_busdev_spi.c" 2
...
# 24 "./src/main/drivers/bus_busdev_spi.c" 2
...
# 28 "./src/main/drivers/bus_busdev_spi.c" 2
...
# 29 "./src/main/drivers/bus_busdev_spi.c" 2
...
# 31 "./src/main/drivers/bus_busdev_spi.c" 2
...
# 46 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 46 "./src/main/drivers/bus_busdev_spi.c"
    spiBusTransferMultiple(const busDevice_t * dev, busTransferDescriptor_t * dsc, int count)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
    ...
    return 
# 60 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 60 "./src/main/drivers/bus_busdev_spi.c"
              ;
}


# 63 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 63 "./src/main/drivers/bus_busdev_spi.c"
    spiBusWriteRegister(const busDevice_t * dev, uint8_t reg, uint8_t data)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
    ...
    return 
# 74 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 74 "./src/main/drivers/bus_busdev_spi.c"
              ;
}


# 77 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 77 "./src/main/drivers/bus_busdev_spi.c"
    spiBusWriteBuffer(const busDevice_t * dev, uint8_t reg, const uint8_t * data, uint8_t length)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
...
# 83 "./src/main/drivers/bus_busdev_spi.c" 3 4
                         ((void *)0)
# 83 "./src/main/drivers/bus_busdev_spi.c"
                             , data, length);
    IOHi(dev->busdev.spi.csnPin);

    return 
# 86 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 86 "./src/main/drivers/bus_busdev_spi.c"
              ;
}


# 89 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 89 "./src/main/drivers/bus_busdev_spi.c"
    spiBusReadBuffer(const busDevice_t * dev, uint8_t reg, uint8_t * data, uint8_t length)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
    ...
    IOLo(dev->busdev.spi.csnPin);
    spiTransferByte(instance, reg);
    spiTransfer(instance, data, 
# 95 "./src/main/drivers/bus_busdev_spi.c" 3 4
                               ((void *)0)
# 95 "./src/main/drivers/bus_busdev_spi.c"
                                   , length);
    IOHi(dev->busdev.spi.csnPin);

    return 
# 98 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 98 "./src/main/drivers/bus_busdev_spi.c"
              ;
}


# 101 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 101 "./src/main/drivers/bus_busdev_spi.c"
    spiBusReadRegister(const busDevice_t * dev, uint8_t reg, uint8_t * data)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
    ...
    spiTransferByte(instance, reg);
    spiTransfer(instance, data, 
# 107 "./src/main/drivers/bus_busdev_spi.c" 3 4
                               ((void *)0)
# 107 "./src/main/drivers/bus_busdev_spi.c"
                                   , 1);
    IOHi(dev->busdev.spi.csnPin);

    return 
# 110 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 110 "./src/main/drivers/bus_busdev_spi.c"
              ;
}
