...
# 27 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 30 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 49 "./src/main/drivers/light_ws2811strip_stdperiph.c"
static IO_t ws2811IO = ((IO_t)0);

# 50 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
_Bool 
# 50 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    ws2811Initialised = 
# 50 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                        0
# 50 "./src/main/drivers/light_ws2811strip_stdperiph.c"
...
static DMA_Stream_TypeDef *dmaRef = 
# 52 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                                   ((void *)0)
# 52 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                                       ;
...
# 58 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                           ((void *)0)
# 58 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                               ;
...
void ws2811LedStripHardwareInit(void)
{
    ...
    const timerHardware_t *timerHardware = timerGetByTag(((((0) + 1) << 4) | (15)), TIM_USE_ANY);

    if (timerHardware == 
# 75 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                        ((void *)0)
# 75 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                            ) {
        return;
    }
    ...
    ws2811IO = IOGetByTag(((((0) + 1) << 4) | (15)));
    IOInit(ws2811IO, OWNER_LED_STRIP, RESOURCE_OUTPUT, 0);
    IOConfigGPIOAF(ws2811IO, ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5)), timerHardware->alternateFunction);


    TIM_Cmd(timer, DISABLE);


    uint16_t period = 1000000 * 24 / 800000;

    BIT_COMPARE_1 = period / 3 * 2;
    BIT_COMPARE_0 = period / 3;


    timerConfigBase(timer, period, 24);
    ...
    dmaRef = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088));
    dmaInit(DMA1_ST5_HANDLER, OWNER_LED_STRIP, 0);
    dmaSetHandler(DMA1_ST5_HANDLER, WS2811_DMA_IRQHandler, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), 0);
    ...
    DMA_InitStructure.DMA_MemoryDataSize = ((uint32_t)0x00004000);
    DMA_InitStructure.DMA_Priority = ((uint32_t)0x00030000);
# 137 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    DMA_InitStructure.DMA_Mode = ((uint32_t)0x00000000);

    DMA_Init(dmaRef, &DMA_InitStructure);
    TIM_DMACmd(timer, timerDmaSource(timerHardware->channel), ENABLE);
    DMA_ITConfig(dmaRef, ((uint32_t)0x00000010), ENABLE);
    ws2811Initialised = 
# 142 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                       1
# 142 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                           ;
}
