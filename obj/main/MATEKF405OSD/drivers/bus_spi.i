...
static spiDevice_t spiHardwareMap[] = {
    { .dev = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), .nss = 0, .sck = ((((0) + 1) << 4) | (5)), .miso = ((((0) + 1) << 4) | (6)), .mosi = ((((0) + 1) << 4) | (7)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00001000))>65535L) + (8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L)) >>8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L)) >>8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x05), 
# 110 "./src/main/drivers/bus_spi.c" 3 4
                                                                                                                                                                                     0
# 110 "./src/main/drivers/bus_spi.c"
                                                                                                                                                                                          , .divisorMap = spiDivisorMapFast },
    { .dev = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), .nss = 0, .sck = ((((1) + 1) << 4) | (13)), .miso = ((((1) + 1) << 4) | (14)), .mosi = ((((1) + 1) << 4) | (15)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00004000))>65535L) + (8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x05), 
# 111 "./src/main/drivers/bus_spi.c" 3 4
                                                                                                                                                                                     0
# 111 "./src/main/drivers/bus_spi.c"
                                                                                                                                                                                          , .divisorMap = spiDivisorMapSlow },

    { .dev = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), .nss = 0, .sck = ((((1) + 1) << 4) | (3)), .miso = ((((1) + 1) << 4) | (4)), .mosi = ((((1) + 1) << 4) | (5)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00008000))>65535L) + (8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L)) >>8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L)) >>8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x06), 
# 113 "./src/main/drivers/bus_spi.c" 3 4
                                                                                                                                                                                     0
# 113 "./src/main/drivers/bus_spi.c"
                                                                                                                                                                                          , .divisorMap = spiDivisorMapSlow }
...
SPIDevice spiDeviceByInstance(SPI_TypeDef *instance)
{
    if (instance == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)))
        return SPIDEV_1;

    if (instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)))
        return SPIDEV_2;

    if (instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)))
        return SPIDEV_3;
...
void spiInitDevice(SPIDevice device)
{
    ...
    if (spi->dev == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))) {
        spi->leadingEdge = 
# 137 "./src/main/drivers/bus_spi.c" 3 4
                          1
# 137 "./src/main/drivers/bus_spi.c"
                              ;
    }
# 147 "./src/main/drivers/bus_spi.c"
    ...
    if (spi->leadingEdge) {
        IOConfigGPIOAF(IOGetByTag(spi->sck), ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_DOWN) << 5)), spi->af);
        IOConfigGPIOAF(IOGetByTag(spi->miso), ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5)), spi->af);
        IOConfigGPIOAF(IOGetByTag(spi->mosi), ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), spi->af);
    } else {
        IOConfigGPIOAF(IOGetByTag(spi->sck), ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), spi->af);
        IOConfigGPIOAF(IOGetByTag(spi->miso), ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), spi->af);
        IOConfigGPIOAF(IOGetByTag(spi->mosi), ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), spi->af);
    }

    if (spi->nss) {
        IOConfigGPIOAF(IOGetByTag(spi->nss), ((GPIO_Mode_OUT) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), spi->af);
    }
...
# 204 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 204 "./src/main/drivers/bus_spi.c"
    spiInit(SPIDevice device)
{
    switch (device) {
    case SPIINVALID:
...
# 208 "./src/main/drivers/bus_spi.c"
    ...
    case SPIDEV_1:
        ...
        return 
# 212 "./src/main/drivers/bus_spi.c" 3 4
              1
# 212 "./src/main/drivers/bus_spi.c"
                  ;
    ...
    case SPIDEV_2:
        ...
        spiInitDevice(device);
        return 
# 219 "./src/main/drivers/bus_spi.c" 3 4
              1
# 219 "./src/main/drivers/bus_spi.c"
                  ;
    ...
    case SPIDEV_3:
        ...
        spiInitDevice(device);
        return 
# 226 "./src/main/drivers/bus_spi.c" 3 4
              1
# 226 "./src/main/drivers/bus_spi.c"
    ...
    return 
# 238 "./src/main/drivers/bus_spi.c" 3 4
          0
# 238 "./src/main/drivers/bus_spi.c"
               ;
}
...
# 280 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 280 "./src/main/drivers/bus_spi.c"
    spiIsBusBusy(SPI_TypeDef *instance)
{
...
# 290 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 290 "./src/main/drivers/bus_spi.c"
    spiTransfer(SPI_TypeDef *instance, uint8_t *out, const uint8_t *in, int len)
{
    uint16_t spiTimeout = 1000;
    ...
    return 
# 320 "./src/main/drivers/bus_spi.c" 3 4
          1
# 320 "./src/main/drivers/bus_spi.c"
              ;
}
