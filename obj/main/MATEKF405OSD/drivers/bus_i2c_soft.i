...
# 27 "./src/main/drivers/bus_i2c_soft.c" 2
...
# 28 "./src/main/drivers/bus_i2c_soft.c" 2
...
static 
# 82 "./src/main/drivers/bus_i2c_soft.c" 3 4
      _Bool 
# 82 "./src/main/drivers/bus_i2c_soft.c"
           I2C_Start(void)
{
    IOHi(sda);
    IOHi(scl);
    ...
    if (!IORead(sda)) {
        return 
# 88 "./src/main/drivers/bus_i2c_soft.c" 3 4
              0
# 88 "./src/main/drivers/bus_i2c_soft.c"
                   ;
    }
    IOLo(sda);
    I2C_delay();
    if (IORead(sda)) {
        return 
# 93 "./src/main/drivers/bus_i2c_soft.c" 3 4
              0
# 93 "./src/main/drivers/bus_i2c_soft.c"
                   ;
    }
    IOLo(scl);
    I2C_delay();
    return 
# 97 "./src/main/drivers/bus_i2c_soft.c" 3 4
          1
# 97 "./src/main/drivers/bus_i2c_soft.c"
              ;
}
...
static 
# 136 "./src/main/drivers/bus_i2c_soft.c" 3 4
      _Bool 
# 136 "./src/main/drivers/bus_i2c_soft.c"
           I2C_WaitAck(void)
{
    IOLo(scl);
    I2C_delay();
    ...
    if (IORead(sda)) {
        IOLo(scl);
        return 
# 146 "./src/main/drivers/bus_i2c_soft.c" 3 4
              0
# 146 "./src/main/drivers/bus_i2c_soft.c"
                   ;
    }
    IOLo(scl);
    return 
# 149 "./src/main/drivers/bus_i2c_soft.c" 3 4
          1
# 149 "./src/main/drivers/bus_i2c_soft.c"
              ;
}
...
void i2cInit(I2CDevice device)
{
    ...
    scl = IOGetByTag(((((2) + 1) << 4) | (10)));
    sda = IOGetByTag(((((2) + 1) << 4) | (11)));

    IOConfigGPIOAF(scl, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)), 0);
    IOConfigGPIOAF(sda, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_NOPULL) << 5)), 0);
}


# 203 "./src/main/drivers/bus_i2c_soft.c" 3 4
_Bool 
# 203 "./src/main/drivers/bus_i2c_soft.c"
    i2cWriteBuffer(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t len, const uint8_t * data)
{
    (void)(device);
    ...
    if (!I2C_Start()) {
        i2cErrorCount++;
        return 
# 210 "./src/main/drivers/bus_i2c_soft.c" 3 4
              0
# 210 "./src/main/drivers/bus_i2c_soft.c"
                   ;
    }
    I2C_SendByte(addr << 1 | ((uint8_t)0x00));
    if (!I2C_WaitAck()) {
        I2C_Stop();
        return 
# 215 "./src/main/drivers/bus_i2c_soft.c" 3 4
              0
# 215 "./src/main/drivers/bus_i2c_soft.c"
                   ;
    }
    I2C_SendByte(reg);
    I2C_WaitAck();
    for (i = 0; i < len; i++) {
        ...
        if (!I2C_WaitAck()) {
            ...
            i2cErrorCount++;
            return 
# 224 "./src/main/drivers/bus_i2c_soft.c" 3 4
                  0
# 224 "./src/main/drivers/bus_i2c_soft.c"
                       ;
        }
    }
    I2C_Stop();
    return 
# 228 "./src/main/drivers/bus_i2c_soft.c" 3 4
          1
# 228 "./src/main/drivers/bus_i2c_soft.c"
              ;
}


# 231 "./src/main/drivers/bus_i2c_soft.c" 3 4
_Bool 
# 231 "./src/main/drivers/bus_i2c_soft.c"
    i2cWrite(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t data)
{
    (void)(device);

    if (!I2C_Start()) {
        return 
# 236 "./src/main/drivers/bus_i2c_soft.c" 3 4
              0
# 236 "./src/main/drivers/bus_i2c_soft.c"
                   ;
    }
    I2C_SendByte(addr << 1 | ((uint8_t)0x00));
    if (!I2C_WaitAck()) {
        ...
        i2cErrorCount++;
        return 
# 242 "./src/main/drivers/bus_i2c_soft.c" 3 4
              0
# 242 "./src/main/drivers/bus_i2c_soft.c"
                   ;
    }
    I2C_SendByte(reg);
    I2C_WaitAck();
    ...
    I2C_Stop();
    return 
# 249 "./src/main/drivers/bus_i2c_soft.c" 3 4
          1
# 249 "./src/main/drivers/bus_i2c_soft.c"
              ;
}


# 252 "./src/main/drivers/bus_i2c_soft.c" 3 4
_Bool 
# 252 "./src/main/drivers/bus_i2c_soft.c"
    i2cRead(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t len, uint8_t *buf)
{
    (void)(device);

    if (!I2C_Start()) {
        return 
# 257 "./src/main/drivers/bus_i2c_soft.c" 3 4
              0
# 257 "./src/main/drivers/bus_i2c_soft.c"
                   ;
    }
    I2C_SendByte(addr << 1 | ((uint8_t)0x00));
    if (!I2C_WaitAck()) {
        ...
        i2cErrorCount++;
        return 
# 263 "./src/main/drivers/bus_i2c_soft.c" 3 4
              0
# 263 "./src/main/drivers/bus_i2c_soft.c"
                   ;
    }
    I2C_SendByte(reg);
    I2C_WaitAck();
    I2C_Start();
    I2C_SendByte(addr << 1 | ((uint8_t)0x01));
    I2C_WaitAck();
    while (len) {
        *buf = I2C_ReceiveByte();
        if (len == 1) {
    ...
    I2C_Stop();
    return 
# 282 "./src/main/drivers/bus_i2c_soft.c" 3 4
          1
# 282 "./src/main/drivers/bus_i2c_soft.c"
              ;
}
