...
# 1 "./src/main/drivers/uart_inverter.h" 1
# 18 "./src/main/drivers/uart_inverter.h"
...
void uartInverterSet(USART_TypeDef *USARTx, uartInverterLine_e line, 
# 28 "./src/main/drivers/uart_inverter.h" 3 4
                                                                    _Bool 
# 28 "./src/main/drivers/uart_inverter.h"
                                                                         enable);
...
static void usartConfigurePinInversion(uartPort_t *uartPort) {
    ...
    (void)(uartPort);
# 68 "./src/main/drivers/serial_uart.c"
}
...
{
    uartPort_t *s = 
# 109 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 109 "./src/main/drivers/serial_uart.c"
                       ;

    if (
# 111 "./src/main/drivers/serial_uart.c" 3 4
       0
# 111 "./src/main/drivers/serial_uart.c"
            ) {

    } else if (USARTx == ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))) {
...
# 190 "./src/main/drivers/serial_uart.c"
...
# 212 "./src/main/drivers/serial_uart.c"
        } else {
    ...
    if (mode & MODE_TX) {
        ...
        if (s->txDMAStream) {
            ...
            DMA_InitStructure.DMA_MemoryBurst = ((uint32_t)0x00000000) ;
            DMA_InitStructure.DMA_PeripheralBurst = ((uint32_t)0x00000000);
# 244 "./src/main/drivers/serial_uart.c"
            ...
            DMA_ITConfig(s->txDMAStream, ((uint32_t)0x00000010) | ((uint32_t)0x00000080) | ((uint32_t)0x00000004) | ((uint32_t)0x00000002), ENABLE);
            DMA_SetCurrDataCounter(s->txDMAStream, 0);
# 263 "./src/main/drivers/serial_uart.c"
...
void uartStartTxDMA(uartPort_t *s)
{
    ...
    DMA_MemoryTargetConfig(s->txDMAStream, (uint32_t)&s->port.txBuffer[s->port.txBufferTail], ((uint32_t)0x00000000));
    ...
    s->txDMAEmpty = 
# 302 "./src/main/drivers/serial_uart.c" 3 4
                   0
# 302 "./src/main/drivers/serial_uart.c"
                        ;
    DMA_Cmd(s->txDMAStream, ENABLE);
# 316 "./src/main/drivers/serial_uart.c"
}
...
# 377 "./src/main/drivers/serial_uart.c"
...
# 385 "./src/main/drivers/serial_uart.c" 3 4
_Bool 
# 385 "./src/main/drivers/serial_uart.c"
...
const struct serialPortVTable uartVTable[] = {
    {
        ...
        .setMode = uartSetMode,
        .isConnected = 
# 455 "./src/main/drivers/serial_uart.c" 3 4
                      ((void *)0)
# 455 "./src/main/drivers/serial_uart.c"
                          ,
        .writeBuf = 
# 456 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 456 "./src/main/drivers/serial_uart.c"
                       ,
        .beginWrite = 
# 457 "./src/main/drivers/serial_uart.c" 3 4
                     ((void *)0)
# 457 "./src/main/drivers/serial_uart.c"
                         ,
        .endWrite = 
# 458 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 458 "./src/main/drivers/serial_uart.c"
                       ,
    }
};
