...
# 58 "./src/main/platform.h" 2
# 22 "./src/main/fc/controlrate_profile.c" 2
...
# 24 "./src/main/fc/controlrate_profile.c" 2
...
# 21 "./src/main/config/config_reset.h" 2
...
# 26 "./src/main/fc/controlrate_profile.c" 2
...
# 30 "./src/main/fc/controlrate_profile.c" 2
...
extern void pgResetFn_controlRateProfiles(controlRateConfig_t *); controlRateConfig_t controlRateProfiles_SystemArray[3]; controlRateConfig_t controlRateProfiles_CopyArray[3]; extern const pgRegistry_t controlRateProfiles_Registry; const pgRegistry_t controlRateProfiles_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 12 | (2 << 12), .size = (sizeof(controlRateConfig_t) * 3) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&controlRateProfiles_SystemArray, .copy = (uint8_t*)&controlRateProfiles_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_controlRateProfiles}, };

void pgResetFn_controlRateProfiles(controlRateConfig_t *instance)
{
    for (int i = 0; i < 3; i++) {
        static const controlRateConfig_t _reset_template_65 = { .throttle = { .rcMid8 = 50, .rcExpo8 = 0, .dynPID = 0, .pa_breakpoint = 1500, .fixedWingTauMs = 0 }, .stabilized = { .rcExpo8 = 70, .rcYawExpo8 = 20, .rates[FD_ROLL] = 20, .rates[FD_PITCH] = 20, .rates[FD_YAW] = 20, }, .manual = { .rcExpo8 = 70, .rcYawExpo8 = 20, .rates[FD_ROLL] = 100, .rates[FD_PITCH] = 100, .rates[FD_YAW] = 100 } }; memcpy((&instance[i]), &_reset_template_65, sizeof(*(&instance[i])));
# 65 "./src/main/fc/controlrate_profile.c"
         ;
    }
}
