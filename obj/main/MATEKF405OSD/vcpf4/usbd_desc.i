...
# 24 "./src/main/vcpf4/usbd_desc.c" 2
...
# 25 "./src/main/vcpf4/usbd_desc.c" 2
...
# 26 "./src/main/vcpf4/usbd_desc.c" 2
# 1 "./src/main/vcpf4/usbd_conf.h" 1
# 27 "./src/main/vcpf4/usbd_desc.c" 2
# 1 "./lib/main/STM32_USB_OTG_Driver/inc/usb_regs.h" 1
# 28 "./src/main/vcpf4/usbd_desc.c" 2
...
# 58 "./src/main/platform.h" 2
# 29 "./src/main/vcpf4/usbd_desc.c" 2
...
# 30 "./src/main/vcpf4/usbd_desc.c" 2
# 53 "./src/main/vcpf4/usbd_desc.c"
...
# 102 "./src/main/vcpf4/usbd_desc.c"
 ...
 uint8_t USBD_DeviceDesc[18] =
  {
    ...
    0x00,
    64,
    ((uint8_t)((0x0483) & 0x00FF)), ((uint8_t)(((0x0483) & 0xFF00) >>8)),
    ((uint8_t)((0x5740) & 0x00FF)), ((uint8_t)(((0x5740) & 0xFF00) >>8)),
    0x00, 0x02,
    0x01,
    0x02,
    0x03,
 ...
 uint8_t USBD_LangIDDesc[4] =
{
     4,
     3,
     ((uint8_t)((0x409) & 0x00FF)),
     ((uint8_t)(((0x409) & 0xFF00) >>8)),
};
# 195 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_DeviceDescriptor( uint8_t speed , uint16_t *length)
{
    (void)speed;
...
# 209 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_LangIDStrDescriptor( uint8_t speed , uint16_t *length)
{
    (void)speed;
...
# 224 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_ProductStrDescriptor( uint8_t speed , uint16_t *length)
{


  if (speed == 0)
    USBD_GetString ((uint8_t*)"MatekF4", USBD_StrDesc, length);
  else
    USBD_GetString ((uint8_t*)"MatekF4", USBD_StrDesc, length);

  return USBD_StrDesc;
}
# 243 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_ManufacturerStrDescriptor( uint8_t speed , uint16_t *length)
{
    (void)speed;
  USBD_GetString ((uint8_t*)"INAV", USBD_StrDesc, length);
  return USBD_StrDesc;
}
# 257 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_SerialStrDescriptor( uint8_t speed , uint16_t *length)
{
  if (speed == 0)
    USBD_GetString ((uint8_t*)"0x8000000", USBD_StrDesc, length);
  else
    USBD_GetString ((uint8_t*)"0x8000000", USBD_StrDesc, length);

  return USBD_StrDesc;
}
# 274 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_ConfigStrDescriptor( uint8_t speed , uint16_t *length)
{
  if (speed == 0)
    USBD_GetString ((uint8_t*)"VCP Config", USBD_StrDesc, length);
  else
    USBD_GetString ((uint8_t*)"VCP Config", USBD_StrDesc, length);

  return USBD_StrDesc;
}
# 292 "./src/main/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_InterfaceStrDescriptor( uint8_t speed , uint16_t *length)
{
  if (speed == 0)
    USBD_GetString ((uint8_t*)"VCP Interface", USBD_StrDesc, length);
  else
    USBD_GetString ((uint8_t*)"VCP Interface", USBD_StrDesc, length);
