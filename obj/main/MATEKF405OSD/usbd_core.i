# 1 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
# 29 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
...
# 50 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_def.h"
#define NULL 0
...
# 30 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c" 2
# 1 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_req.h" 1
# 31 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_req.h"
#define __USB_REQUEST_H_ 



# 1 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_core.h" 1
# 36 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_req.h" 2
# 83 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_req.h"
...
# 31 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c" 2
...
uint16_t USBD_GetRxCount (USB_OTG_CORE_HANDLE *pdev ,
                           uint8_t epnum);
# 32 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c" 2
...
# 33 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c" 2
...
# 34 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c" 2
# 75 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
...
# 97 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
volatile USB_OTG_DCTL_TypeDef SET_TEST_MODE;
...
# 137 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
void USBD_Init(USB_OTG_CORE_HANDLE *pdev,
               USB_OTG_CORE_ID_TypeDef coreID,
               USBD_DEVICE *pDevice,
               USBD_Class_cb_TypeDef *class_cb,
...
# 217 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
static uint8_t USBD_DataOutStage(USB_OTG_CORE_HANDLE *pdev , uint8_t epnum)
{
  USB_OTG_EP *ep;
    ...
    if ( pdev->dev.device_state == 3)
    {
      if(ep->rem_data_len > ep->maxpacket)
      {
        ...
        USBD_CtlContinueRx (pdev,
                            ep->xfer_buff,
                            (((ep->rem_data_len) < (ep->maxpacket)) ? (ep->rem_data_len) : (ep->maxpacket)));
      }
      else
      {
        if((pdev->dev.class_cb->EP0_RxReady != 0)&&
           (pdev->dev.device_status == 3))
        {
  ...
  else if((pdev->dev.class_cb->DataOut != 0)&&
          (pdev->dev.device_status == 3))
  {
...
# 270 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
static uint8_t USBD_DataInStage(USB_OTG_CORE_HANDLE *pdev , uint8_t epnum)
{
  USB_OTG_EP *ep;
    ...
    if ( pdev->dev.device_state == 2)
    {
      ...
      else
      {
             ...
             (ep->total_data_len < ep->ctl_data_len ))
        {
          ...
          USBD_CtlContinueSendData(pdev , 0, 0);
          ep->ctl_data_len = 0;
        ...
        {
          if((pdev->dev.class_cb->EP0_TxSent != 0)&&
             (pdev->dev.device_status == 3))
          {
  ...
  else if((pdev->dev.class_cb->DataIn != 0)&&
          (pdev->dev.device_status == 3))
  {
...
# 352 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
static uint8_t USBD_RunTestMode (USB_OTG_CORE_HANDLE *pdev)
{
  (*(volatile uint32_t *)(&pdev->regs.DREGS->DCTL) = (SET_TEST_MODE.d32));
  return USBD_OK;
}
# 365 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
static uint8_t USBD_Reset(USB_OTG_CORE_HANDLE *pdev)
{
...
# 393 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
static uint8_t USBD_Resume(USB_OTG_CORE_HANDLE *pdev)
{
...
# 410 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
static uint8_t USBD_Suspend(USB_OTG_CORE_HANDLE *pdev)
{
  pdev->dev.device_old_status = pdev->dev.device_status;
  pdev->dev.device_status = 4;

  pdev->dev.usr_cb->DeviceSuspended();
  return USBD_OK;
}
# 427 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
static uint8_t USBD_SOF(USB_OTG_CORE_HANDLE *pdev)
{
...
# 443 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
USBD_Status USBD_SetCfg(USB_OTG_CORE_HANDLE *pdev, uint8_t cfgidx)
{
...
# 459 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_core.c"
USBD_Status USBD_ClrCfg(USB_OTG_CORE_HANDLE *pdev, uint8_t cfgidx)
{
