...
# 186 "./src/main/drivers/accgyro/accgyro_mpu.h" 3 4
_Bool 
# 186 "./src/main/drivers/accgyro/accgyro_mpu.h"
    mpuGyroRead(struct gyroDev_s *gyro);

# 187 "./src/main/drivers/accgyro/accgyro_mpu.h" 3 4
_Bool 
# 187 "./src/main/drivers/accgyro/accgyro_mpu.h"
    mpuGyroReadScratchpad(struct gyroDev_s *gyro);

# 188 "./src/main/drivers/accgyro/accgyro_mpu.h" 3 4
_Bool 
# 188 "./src/main/drivers/accgyro/accgyro_mpu.h"
    mpuAccReadScratchpad(struct accDev_s *acc);

# 189 "./src/main/drivers/accgyro/accgyro_mpu.h" 3 4
_Bool 
# 189 "./src/main/drivers/accgyro/accgyro_mpu.h"
    mpuTemperatureReadScratchpad(struct gyroDev_s *gyro, int16_t * data);
...
# 20 "./src/main/drivers/accgyro/accgyro_mpu3050.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro/accgyro_mpu3050.h"
    mpu3050Detect(gyroDev_t *gyro);
# 39 "./src/main/sensors/gyro.c" 2
# 1 "./src/main/drivers/accgyro/accgyro_mpu6000.h" 1
# 18 "./src/main/drivers/accgyro/accgyro_mpu6000.h"
       




# 22 "./src/main/drivers/accgyro/accgyro_mpu6000.h" 3 4
_Bool 
# 22 "./src/main/drivers/accgyro/accgyro_mpu6000.h"
    mpu6000AccDetect(accDev_t *acc);

# 23 "./src/main/drivers/accgyro/accgyro_mpu6000.h" 3 4
_Bool 
# 23 "./src/main/drivers/accgyro/accgyro_mpu6000.h"
    mpu6000GyroDetect(gyroDev_t *gyro);
...
# 22 "./src/main/drivers/accgyro/accgyro_mpu6050.h" 3 4
_Bool 
# 22 "./src/main/drivers/accgyro/accgyro_mpu6050.h"
    mpu6050AccDetect(accDev_t *acc);

# 23 "./src/main/drivers/accgyro/accgyro_mpu6050.h" 3 4
_Bool 
# 23 "./src/main/drivers/accgyro/accgyro_mpu6050.h"
...
# 20 "./src/main/drivers/accgyro/accgyro_mpu6500.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro/accgyro_mpu6500.h"
    mpu6500AccDetect(accDev_t *acc);

# 21 "./src/main/drivers/accgyro/accgyro_mpu6500.h" 3 4
_Bool 
# 21 "./src/main/drivers/accgyro/accgyro_mpu6500.h"
    mpu6500GyroDetect(gyroDev_t *gyro);
# 42 "./src/main/sensors/gyro.c" 2
# 1 "./src/main/drivers/accgyro/accgyro_mpu9250.h" 1
# 18 "./src/main/drivers/accgyro/accgyro_mpu9250.h"
       


# 20 "./src/main/drivers/accgyro/accgyro_mpu9250.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro/accgyro_mpu9250.h"
    mpu9250AccDetect(accDev_t *acc);

# 21 "./src/main/drivers/accgyro/accgyro_mpu9250.h" 3 4
_Bool 
# 21 "./src/main/drivers/accgyro/accgyro_mpu9250.h"
    mpu9250GyroDetect(gyroDev_t *gyro);
...
# 20 "./src/main/drivers/accgyro/accgyro_lsm303dlhc.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro/accgyro_lsm303dlhc.h"
...
# 20 "./src/main/drivers/accgyro/accgyro_adxl345.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro/accgyro_adxl345.h"
    adxl345Detect(accDev_t *acc);
...
# 1 "./src/main/drivers/accgyro/accgyro_bmi160.h" 1
# 25 "./src/main/drivers/accgyro/accgyro_bmi160.h"
       




# 29 "./src/main/drivers/accgyro/accgyro_bmi160.h" 3 4
_Bool 
# 29 "./src/main/drivers/accgyro/accgyro_bmi160.h"
    bmi160AccDetect(accDev_t *acc);

# 30 "./src/main/drivers/accgyro/accgyro_bmi160.h" 3 4
_Bool 
# 30 "./src/main/drivers/accgyro/accgyro_bmi160.h"
    bmi160GyroDetect(gyroDev_t *gyro);
...
# 22 "./src/main/drivers/accgyro/accgyro_fake.h"
    fakeAccDetect(accDev_t *acc);
void fakeAccSet(int16_t x, int16_t y, int16_t z);


# 25 "./src/main/drivers/accgyro/accgyro_fake.h" 3 4
_Bool 
# 25 "./src/main/drivers/accgyro/accgyro_fake.h"
    fakeGyroDetect(gyroDev_t *gyro);
...
__attribute__ ((section(".fastram_bss"), aligned(4))) gyro_t gyro;

static gyroDev_t gyroDev0;
static __attribute__ ((section(".fastram_bss"), aligned(4))) int16_t gyroTemperature0;
...
static __attribute__ ((section(".fastram_bss"), aligned(4))) gyroCalibration_t gyroCalibration;
static __attribute__ ((section(".fastram_bss"), aligned(4))) int32_t gyroADC[3];

static __attribute__ ((section(".fastram_bss"), aligned(4))) filterApplyFnPtr softLpfFilterApplyFn;
static __attribute__ ((section(".fastram_bss"), aligned(4))) void *softLpfFilter[3];


static __attribute__ ((section(".fastram_bss"), aligned(4))) filterApplyFnPtr notchFilter1ApplyFn;
static __attribute__ ((section(".fastram_bss"), aligned(4))) void *notchFilter1[3];


static __attribute__ ((section(".fastram_bss"), aligned(4))) filterApplyFnPtr notchFilter2ApplyFn;
static __attribute__ ((section(".fastram_bss"), aligned(4))) void *notchFilter2[3];




static __attribute__ ((section(".fastram_bss"), aligned(4))) filterApplyFnPtr gyroFilterStage2ApplyFn;
static __attribute__ ((section(".fastram_bss"), aligned(4))) void *stage2Filter[3];


extern const gyroConfig_t pgResetTemplate_gyroConfig; gyroConfig_t gyroConfig_System; gyroConfig_t gyroConfig_Copy; extern const pgRegistry_t gyroConfig_Registry; const pgRegistry_t gyroConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 10 | (3 << 12), .size = sizeof(gyroConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&gyroConfig_System, .copy = (uint8_t*)&gyroConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_gyroConfig}, };

const gyroConfig_t pgResetTemplate_gyroConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .gyro_lpf = 3, .gyro_soft_lpf_hz = 60, .gyro_align = ALIGN_DEFAULT, .gyroMovementCalibrationThreshold = 32, .looptime = 1000, .gyroSync = 0, .gyro_to_use = 0, .gyro_soft_notch_hz_1 = 0, .gyro_soft_notch_cutoff_1 = 1, .gyro_soft_notch_hz_2 = 0, .gyro_soft_notch_cutoff_2 = 1, .gyro_stage2_lowpass_hz = 0 }
# 118 "./src/main/sensors/gyro.c"
 ;

static gyroSensor_e gyroDetect(gyroDev_t *dev, gyroSensor_e gyroHardware)
{
...
# 247 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 247 "./src/main/sensors/gyro.c"
    gyroInit(void)
{
    ...
    if (gyroDetect(&gyroDev0, GYRO_AUTODETECT) == GYRO_NONE) {
        return 
# 259 "./src/main/sensors/gyro.c" 3 4
              0
# 259 "./src/main/sensors/gyro.c"
                   ;
    }
    ...
    gyroInitFilters();
    return 
# 276 "./src/main/sensors/gyro.c" 3 4
          1
# 276 "./src/main/sensors/gyro.c"
              ;
}

void gyroInitFilters(void)
{
    static __attribute__ ((section(".fastram_bss"), aligned(4))) biquadFilter_t gyroFilterLPF[3];
    softLpfFilterApplyFn = nullFilterApply;

    static __attribute__ ((section(".fastram_bss"), aligned(4))) biquadFilter_t gyroFilterNotch_1[3];
    notchFilter1ApplyFn = nullFilterApply;


    static __attribute__ ((section(".fastram_bss"), aligned(4))) biquadFilter_t gyroFilterNotch_2[3];
    notchFilter2ApplyFn = nullFilterApply;



    static __attribute__ ((section(".fastram_bss"), aligned(4))) biquadFilter_t gyroFilterStage2[3];
...
static 
# 339 "./src/main/sensors/gyro.c" 3 4
                  _Bool 
# 339 "./src/main/sensors/gyro.c"
                       isCalibrationComplete(gyroCalibration_t *gyroCalibration)
{
    return gyroCalibration->calibratingG == 0;
}


# 344 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 344 "./src/main/sensors/gyro.c"
    gyroIsCalibrationComplete(void)
{
    return gyroCalibration.calibratingG == 0;
}
...
static 
# 349 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 349 "./src/main/sensors/gyro.c"
           isOnFinalGyroCalibrationCycle(gyroCalibration_t *gyroCalibration)
{
    return gyroCalibration->calibratingG == 1;
}

static 
# 354 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 354 "./src/main/sensors/gyro.c"
           isOnFirstGyroCalibrationCycle(gyroCalibration_t *gyroCalibration)
{
    return gyroCalibration->calibratingG == 1000;
}

static void performGyroCalibration(gyroDev_t *dev, gyroCalibration_t *gyroCalibration, uint8_t gyroMovementCalibrationThreshold)
{
    for (int axis = 0; axis < 3; axis++) {
        ...
        if (isOnFinalGyroCalibrationCycle(gyroCalibration)) {
            ...
            dev->gyroZero[axis] = (gyroCalibration->g[axis] + (1000 / 2)) / 1000;
        }
    }

    if (isOnFinalGyroCalibrationCycle(gyroCalibration)) {
        debugTracePrintf(
# 388 "./src/main/sensors/gyro.c" 3 4
       1
# 388 "./src/main/sensors/gyro.c"
       , "Gyro calibration complete (%d, %d, %d)", dev->gyroZero[0], dev->gyroZero[1], dev->gyroZero[2]);
...
static __attribute__ ((section(".fastram_bss"), aligned(4))) float accumulatedRates[3];
static __attribute__ ((section(".fastram_bss"), aligned(4))) timeUs_t accumulatedRateTimeUs;
...
void gyroGetMeasuredRotationRate(fpVector3_t *measuredRotationRate)
{
    ...
    for (int axis = 0; axis < 3; axis++) {
        measuredRotationRate->v[axis] = ((accumulatedRates[axis] / accumulatedRateTime) * (3.14159265358979323846f / 180.0f));
...
void gyroUpdate(timeDelta_t gyroUpdateDeltaUs)
{
    ...
    for (int axis = 0; axis < 3; axis++) {
        ...
        if (axis < 2) {
            {if (debugMode == (DEBUG_STAGE2)) {debug[(axis)] = (lrintf(gyroADCf));}};
        }
        ...
        if (axis < 2) {
            {if (debugMode == (DEBUG_STAGE2)) {debug[(axis + 2)] = (lrintf(gyroADCf));}};
        }

        gyroADCf = softLpfFilterApplyFn(softLpfFilter[axis], gyroADCf);

        {if (debugMode == (DEBUG_NOTCH)) {debug[(axis)] = (lrintf(gyroADCf));}};
...
# 488 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 488 "./src/main/sensors/gyro.c"
    gyroReadTemperature(void)
{
    ...
    return 
# 495 "./src/main/sensors/gyro.c" 3 4
          0
# 495 "./src/main/sensors/gyro.c"
               ;
}
...
# 508 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 508 "./src/main/sensors/gyro.c"
    gyroSyncCheckUpdate(void)
{
    if (!gyroDev0.intStatusFn)
        return 
# 511 "./src/main/sensors/gyro.c" 3 4
              0
# 511 "./src/main/sensors/gyro.c"
                   ;
