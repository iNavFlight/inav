...
# 26 "./src/main/sensors/rangefinder.c" 2
...
# 27 "./src/main/sensors/rangefinder.c" 2
...
# 29 "./src/main/sensors/rangefinder.c" 2
...
# 30 "./src/main/sensors/rangefinder.c" 2
...
# 33 "./src/main/sensors/rangefinder.c" 2
...
# 35 "./src/main/sensors/rangefinder.c" 2
...
# 37 "./src/main/sensors/rangefinder.c" 2
...
# 38 "./src/main/sensors/rangefinder.c" 2
...
# 39 "./src/main/sensors/rangefinder.c" 2
...
# 40 "./src/main/sensors/rangefinder.c" 2
...
# 24 "./src/main/drivers/rangefinder/rangefinder_hcsr04.h" 3 4
_Bool 
# 24 "./src/main/drivers/rangefinder/rangefinder_hcsr04.h"
    hcsr04Detect(rangefinderDev_t *dev, const rangefinderHardwarePins_t * rangefinderHardwarePins);
# 41 "./src/main/sensors/rangefinder.c" 2
# 1 "./src/main/drivers/rangefinder/rangefinder_srf10.h" 1
# 18 "./src/main/drivers/rangefinder/rangefinder_srf10.h"
       

#define RANGEFINDER_SRF10_TASK_PERIOD_MS 70


# 22 "./src/main/drivers/rangefinder/rangefinder_srf10.h" 3 4
_Bool 
# 22 "./src/main/drivers/rangefinder/rangefinder_srf10.h"
    srf10Detect(rangefinderDev_t *dev);
# 42 "./src/main/sensors/rangefinder.c" 2
# 1 "./src/main/drivers/rangefinder/rangefinder_hcsr04_i2c.h" 1
# 18 "./src/main/drivers/rangefinder/rangefinder_hcsr04_i2c.h"
       

#define RANGEFINDER_HCSR04_i2C_TASK_PERIOD_MS 100


# 22 "./src/main/drivers/rangefinder/rangefinder_hcsr04_i2c.h" 3 4
_Bool 
# 22 "./src/main/drivers/rangefinder/rangefinder_hcsr04_i2c.h"
    hcsr04i2c0Detect(rangefinderDev_t *dev);
# 43 "./src/main/sensors/rangefinder.c" 2
# 1 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.h" 1
# 25 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.h"
       

#define RANGEFINDER_VL53L0X_TASK_PERIOD_MS 33


# 29 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.h" 3 4
_Bool 
# 29 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.h"
    vl53l0xDetect(rangefinderDev_t *dev);
# 44 "./src/main/sensors/rangefinder.c" 2
# 1 "./src/main/drivers/rangefinder/rangefinder_virtual.h" 1
# 25 "./src/main/drivers/rangefinder/rangefinder_virtual.h"
...
# 32 "./src/main/drivers/rangefinder/rangefinder_virtual.h" 3 4
   _Bool 
# 32 "./src/main/drivers/rangefinder/rangefinder_virtual.h"
        (*detect)(void);
    void (*init)(void);
    void (*update)(void);
    int32_t (*read)(void);
...
# 38 "./src/main/drivers/rangefinder/rangefinder_virtual.h" 3 4
_Bool 
# 38 "./src/main/drivers/rangefinder/rangefinder_virtual.h"
    virtualRangefinderDetect(rangefinderDev_t * dev, const virtualRangefinderVTable_t * vtable);
# 45 "./src/main/sensors/rangefinder.c" 2
...
# 47 "./src/main/sensors/rangefinder.c" 2
...
# 48 "./src/main/sensors/rangefinder.c" 2
...
# 50 "./src/main/sensors/rangefinder.c" 2
...
# 51 "./src/main/sensors/rangefinder.c" 2
...
# 52 "./src/main/sensors/rangefinder.c" 2

# 1 "./src/main/io/rangefinder.h" 1
# 25 "./src/main/io/rangefinder.h"
...
# 54 "./src/main/sensors/rangefinder.c" 2
...
# 56 "./src/main/sensors/rangefinder.c" 2

# 1 "./src/main/uav_interconnect/uav_interconnect.h" 1
# 29 "./src/main/uav_interconnect/uav_interconnect.h"
...
# 13 "/usr/arm-none-eabi/include/ctype.h" 3
int isalnum (int __c);
int isalpha (int __c);
int iscntrl (int __c);
int isdigit (int __c);
...
# 30 "./src/main/uav_interconnect/uav_interconnect.h" 2
...
# 45 "./src/main/uav_interconnect/uav_interconnect.h"
typedef enum {
    UIB_DATA_NONE = 0,
    UIB_DATA_VALID = (1 << 0),
} uibDataFlags_t;
...
# 58 "./src/main/sensors/rangefinder.c" 2
...
extern const rangefinderConfig_t pgResetTemplate_rangefinderConfig; rangefinderConfig_t rangefinderConfig_System; rangefinderConfig_t rangefinderConfig_Copy; extern const pgRegistry_t rangefinderConfig_Registry; const pgRegistry_t rangefinderConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 1006 | (1 << 12), .size = sizeof(rangefinderConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&rangefinderConfig_System, .copy = (uint8_t*)&rangefinderConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_rangefinderConfig}, };

const rangefinderConfig_t pgResetTemplate_rangefinderConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .rangefinder_hardware = RANGEFINDER_NONE, .use_median_filtering = 0, }
...
const rangefinderHardwarePins_t * rangefinderGetHardwarePins(void)
{
    ...
    rangefinderHardwarePins.triggerTag = 0;
    rangefinderHardwarePins.echoTag = 0;
...
static 
# 92 "./src/main/sensors/rangefinder.c" 3 4
      _Bool 
# 92 "./src/main/sensors/rangefinder.c"
           rangefinderDetect(rangefinderDev_t * dev, uint8_t rangefinderHardwareToUse)
{
...
# 108 "./src/main/sensors/rangefinder.c"
            break;
        ...
        case RANGEFINDER_SRF10:
            ...
            if (hcsr04i2c0Detect(dev)) {
                ...
                rescheduleTask(TASK_RANGEFINDER, ((100) * 1000));
            }
        ...
        case RANGEFINDER_MSP:
            ...
            if (virtualRangefinderDetect(dev, &rangefinderMSPVtable)) {
                ...
                rescheduleTask(TASK_RANGEFINDER, ((30) * 1000));
            }
    ...
    if (rangefinderHardware == RANGEFINDER_NONE) {
        ...
        return 
# 164 "./src/main/sensors/rangefinder.c" 3 4
              0
# 164 "./src/main/sensors/rangefinder.c"
                   ;
    }
    ...
    return 
# 169 "./src/main/sensors/rangefinder.c" 3 4
          1
# 169 "./src/main/sensors/rangefinder.c"
              ;
}


# 172 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 172 "./src/main/sensors/rangefinder.c"
    rangefinderInit(void)
{
    if (!rangefinderDetect(&rangefinder.dev, rangefinderConfig()->rangefinder_hardware)) {
        return 
# 175 "./src/main/sensors/rangefinder.c" 3 4
              0
# 175 "./src/main/sensors/rangefinder.c"
                   ;
    }

    rangefinder.dev.init(&rangefinder.dev);
    rangefinder.rawAltitude = (-1);
    rangefinder.calculatedAltitude = (-1);
    rangefinder.maxTiltCos = cos_approx((((rangefinder.dev.detectionConeExtendedDeciDegrees / 2.0f) / 10.0f) * (3.14159265358979323846f / 180.0f)));
    rangefinder.lastValidResponseTimeMs = millis();

    return 
# 184 "./src/main/sensors/rangefinder.c" 3 4
          1
# 184 "./src/main/sensors/rangefinder.c"
              ;
}
...
#define DISTANCE_SAMPLES_MEDIAN 5
    static int32_t filterSamples[5];
    static int filterSampleIndex = 0;
    static 
# 192 "./src/main/sensors/rangefinder.c" 3 4
          _Bool 
# 192 "./src/main/sensors/rangefinder.c"
               medianFilterReady = 
# 192 "./src/main/sensors/rangefinder.c" 3 4
                                   0
# 192 "./src/main/sensors/rangefinder.c"
    ...
    if (newReading > (-1)) {
        ...
        ++filterSampleIndex;
        if (filterSampleIndex == 5) {
            filterSampleIndex = 0;
            medianFilterReady = 
# 199 "./src/main/sensors/rangefinder.c" 3 4
                               1
# 199 "./src/main/sensors/rangefinder.c"
                                   ;
        }
    }
...
timeDelta_t rangefinderUpdate(void)
{
    ...
    return rangefinder.dev.delayMs * 1000;
}
...
# 220 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 220 "./src/main/sensors/rangefinder.c"
    rangefinderProcess(float cosTiltAngle)
{
    if (rangefinder.dev.read) {
        ...
        if (distance == (-3)) {
            return 
# 227 "./src/main/sensors/rangefinder.c" 3 4
                  0
# 227 "./src/main/sensors/rangefinder.c"
                       ;
        }
    ...
    return 
# 264 "./src/main/sensors/rangefinder.c" 3 4
          1
# 264 "./src/main/sensors/rangefinder.c"
              ;
}
...
# 280 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 280 "./src/main/sensors/rangefinder.c"
    rangefinderIsHealthy(void)
{
    return (millis() - rangefinder.lastValidResponseTimeMs) < 500;
}
