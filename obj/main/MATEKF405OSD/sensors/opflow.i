...
# 26 "./src/main/sensors/opflow.c" 2
...
# 27 "./src/main/sensors/opflow.c" 2
...
# 28 "./src/main/sensors/opflow.c" 2
...
# 29 "./src/main/sensors/opflow.c" 2
...
# 58 "./src/main/platform.h" 2
# 31 "./src/main/sensors/opflow.c" 2
...
# 33 "./src/main/sensors/opflow.c" 2
...
# 35 "./src/main/sensors/opflow.c" 2
...
# 36 "./src/main/sensors/opflow.c" 2
...
# 37 "./src/main/sensors/opflow.c" 2
...
# 38 "./src/main/sensors/opflow.c" 2
...
# 40 "./src/main/sensors/opflow.c" 2
...
# 42 "./src/main/sensors/opflow.c" 2
...
# 44 "./src/main/sensors/opflow.c" 2
...
# 45 "./src/main/sensors/opflow.c" 2
...
# 46 "./src/main/sensors/opflow.c" 2
...
# 48 "./src/main/sensors/opflow.c" 2
# 1 "./src/main/drivers/opflow/opflow_fake.h" 1
# 25 "./src/main/drivers/opflow/opflow_fake.h"
       


# 27 "./src/main/drivers/opflow/opflow_fake.h" 3 4
_Bool 
# 27 "./src/main/drivers/opflow/opflow_fake.h"
    fakeOpflowDetect(opflowDev_t * dev);
void fakeOpflowSet(timeDelta_t deltaTime, int32_t flowRateX, int32_t flowRateY, int16_t quality);
# 49 "./src/main/sensors/opflow.c" 2
# 1 "./src/main/drivers/opflow/opflow_virtual.h" 1
# 25 "./src/main/drivers/opflow/opflow_virtual.h"
...
# 30 "./src/main/drivers/opflow/opflow_virtual.h" 3 4
   _Bool 
# 30 "./src/main/drivers/opflow/opflow_virtual.h"
        (*detect)(void);
    
# 31 "./src/main/drivers/opflow/opflow_virtual.h" 3 4
   _Bool 
# 31 "./src/main/drivers/opflow/opflow_virtual.h"
        (*init)(void);
    
# 32 "./src/main/drivers/opflow/opflow_virtual.h" 3 4
   _Bool 
# 32 "./src/main/drivers/opflow/opflow_virtual.h"
        (*update)(opflowData_t * data);
} virtualOpflowVTable_t;


# 35 "./src/main/drivers/opflow/opflow_virtual.h" 3 4
_Bool 
# 35 "./src/main/drivers/opflow/opflow_virtual.h"
    virtualOpflowDetect(opflowDev_t * dev, const virtualOpflowVTable_t * vtable);
# 50 "./src/main/sensors/opflow.c" 2
...
# 52 "./src/main/sensors/opflow.c" 2
...
# 53 "./src/main/sensors/opflow.c" 2
...
# 55 "./src/main/sensors/opflow.c" 2
...
# 56 "./src/main/sensors/opflow.c" 2
...
# 57 "./src/main/sensors/opflow.c" 2
...
# 58 "./src/main/sensors/opflow.c" 2
...
# 60 "./src/main/sensors/opflow.c" 2

# 1 "./src/main/io/opflow.h" 1
# 25 "./src/main/io/opflow.h"
...
# 62 "./src/main/sensors/opflow.c" 2
...
# 64 "./src/main/sensors/opflow.c" 2
...
extern const opticalFlowConfig_t pgResetTemplate_opticalFlowConfig; opticalFlowConfig_t opticalFlowConfig_System; opticalFlowConfig_t opticalFlowConfig_Copy; extern const pgRegistry_t opticalFlowConfig_Registry; const pgRegistry_t opticalFlowConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 1012 | (1 << 12), .size = sizeof(opticalFlowConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&opticalFlowConfig_System, .copy = (uint8_t*)&opticalFlowConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_opticalFlowConfig}, };

const opticalFlowConfig_t pgResetTemplate_opticalFlowConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .opflow_hardware = OPFLOW_NONE, .opflow_align = CW0_DEG_FLIP, .opflow_scale = 1.0f, }
...
static 
# 80 "./src/main/sensors/opflow.c" 3 4
      _Bool 
# 80 "./src/main/sensors/opflow.c"
           opflowDetect(opflowDev_t * dev, uint8_t opflowHardwareToUse)
{
    ...
    if (opflowHardware == OPFLOW_NONE) {
        ...
        return 
# 119 "./src/main/sensors/opflow.c" 3 4
              0
# 119 "./src/main/sensors/opflow.c"
                   ;
    }
    ...
    return 
# 124 "./src/main/sensors/opflow.c" 3 4
          1
# 124 "./src/main/sensors/opflow.c"
              ;
}
...
# 134 "./src/main/sensors/opflow.c" 3 4
_Bool 
# 134 "./src/main/sensors/opflow.c"
    opflowInit(void)
{
    if (!opflowDetect(&opflow.dev, opticalFlowConfig()->opflow_hardware)) {
        return 
# 137 "./src/main/sensors/opflow.c" 3 4
              0
# 137 "./src/main/sensors/opflow.c"
                   ;
    }
    ...
    if (!opflow.dev.initFn(&opflow.dev)) {
        sensorsClear(SENSOR_OPFLOW);
        return 
# 142 "./src/main/sensors/opflow.c" 3 4
              0
# 142 "./src/main/sensors/opflow.c"
                   ;
    }
    ...
    return 
# 147 "./src/main/sensors/opflow.c" 3 4
          1
# 147 "./src/main/sensors/opflow.c"
              ;
}
...
void opflowUpdate(timeUs_t currentTimeUs)
{
    ...
    if (opflow.dev.updateFn(&opflow.dev)) {
        ...
        opflow.isHwHealty = 
# 161 "./src/main/sensors/opflow.c" 3 4
                           1
# 161 "./src/main/sensors/opflow.c"
                               ;
        ...
        switch (opflow.flowQuality) {
            case OPFLOW_QUALITY_INVALID:
                if (opflow.dev.rawData.quality >= 35) {
                    opflow.flowQuality = OPFLOW_QUALITY_VALID;
                }
                break;

            case OPFLOW_QUALITY_VALID:
                if (opflow.dev.rawData.quality <= 10) {
        ...
        if ((opflow.flowQuality == OPFLOW_QUALITY_VALID) && (opflow.gyroBodyRateTimeUs > 0)) {
            ...
            opflow.flowRate[X] = ((opflow.dev.rawData.flowRateRaw[X] * integralToRateScaler) * (3.14159265358979323846f / 180.0f));
            opflow.flowRate[Y] = ((opflow.dev.rawData.flowRateRaw[Y] * integralToRateScaler) * (3.14159265358979323846f / 180.0f));

            opflow.bodyRate[X] = ((opflow.gyroBodyRateAcc[X] / opflow.gyroBodyRateTimeUs) * (3.14159265358979323846f / 180.0f));
            opflow.bodyRate[Y] = ((opflow.gyroBodyRateAcc[Y] / opflow.gyroBodyRateTimeUs) * (3.14159265358979323846f / 180.0f));

            {if (debugMode == (DEBUG_FLOW_RAW)) {debug[(0)] = (((opflow.dev.rawData.flowRateRaw[X]) / (3.14159265358979323846f / 180.0f)));}};
            {if (debugMode == (DEBUG_FLOW_RAW)) {debug[(1)] = (((opflow.dev.rawData.flowRateRaw[Y]) / (3.14159265358979323846f / 180.0f)));}};
            {if (debugMode == (DEBUG_FLOW_RAW)) {debug[(2)] = (((opflow.bodyRate[X]) / (3.14159265358979323846f / 180.0f)));}};
            {if (debugMode == (DEBUG_FLOW_RAW)) {debug[(3)] = (((opflow.bodyRate[Y]) / (3.14159265358979323846f / 180.0f)));}};
        }
        else {
        ...
        if (opflow.isHwHealty && ((currentTimeUs - opflow.lastValidUpdate) > 200000)) {
            opflow.isHwHealty = 
# 212 "./src/main/sensors/opflow.c" 3 4
                               0
# 212 "./src/main/sensors/opflow.c"
                                    ;
...
# 240 "./src/main/sensors/opflow.c" 3 4
_Bool 
# 240 "./src/main/sensors/opflow.c"
    opflowIsHealthy(void)
{
