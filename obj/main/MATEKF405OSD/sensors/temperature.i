# 1 "./src/main/sensors/temperature.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/sensors/temperature.c"
# 18 "./src/main/sensors/temperature.c"
...
# 19 "./src/main/sensors/temperature.c" 2
...
# 20 "./src/main/sensors/temperature.c" 2
...
# 58 "./src/main/platform.h" 2
# 22 "./src/main/sensors/temperature.c" 2
...
# 24 "./src/main/sensors/temperature.c" 2
...
# 26 "./src/main/sensors/temperature.c" 2
...
# 27 "./src/main/sensors/temperature.c" 2
...
# 29 "./src/main/sensors/temperature.c" 2
...
# 30 "./src/main/sensors/temperature.c" 2

static 
# 31 "./src/main/sensors/temperature.c" 3 4
      _Bool 
# 31 "./src/main/sensors/temperature.c"
               tempSensorValid[TEMP_COUNT];
static int16_t tempSensorValue[TEMP_COUNT];


# 34 "./src/main/sensors/temperature.c" 3 4
_Bool 
# 34 "./src/main/sensors/temperature.c"
    isTemperatureSensorValid(tempSensor_e sensor)
{
...
# 48 "./src/main/sensors/temperature.c" 3 4
                                    1
# 48 "./src/main/sensors/temperature.c"
                                        ;
