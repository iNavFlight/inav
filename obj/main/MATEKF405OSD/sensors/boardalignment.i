...
# 31 "./src/main/sensors/boardalignment.c" 2
...
# 33 "./src/main/sensors/boardalignment.c" 2

static 
# 34 "./src/main/sensors/boardalignment.c" 3 4
      _Bool 
# 34 "./src/main/sensors/boardalignment.c"
...
static 
# 40 "./src/main/sensors/boardalignment.c" 3 4
      _Bool 
# 40 "./src/main/sensors/boardalignment.c"
...
void initBoardAlignment(void)
{
    if (isBoardAlignmentStandard(boardAlignment())) {
        standardBoardAlignment = 
# 48 "./src/main/sensors/boardalignment.c" 3 4
                                1
# 48 "./src/main/sensors/boardalignment.c"
                                    ;
    } else {
...
# 52 "./src/main/sensors/boardalignment.c"
        ...
        rotationAngles.angles.roll = (((boardAlignment()->rollDeciDegrees) / 10.0f) * (3.14159265358979323846f / 180.0f));
        rotationAngles.angles.pitch = (((boardAlignment()->pitchDeciDegrees) / 10.0f) * (3.14159265358979323846f / 180.0f));
        rotationAngles.angles.yaw = (((boardAlignment()->yawDeciDegrees) / 10.0f) * (3.14159265358979323846f / 180.0f));
...
void updateBoardAlignment(int16_t roll, int16_t pitch)
{
    const float sinAlignYaw = sin_approx((((boardAlignment()->yawDeciDegrees) / 10.0f) * (3.14159265358979323846f / 180.0f)));
    const float cosAlignYaw = cos_approx((((boardAlignment()->yawDeciDegrees) / 10.0f) * (3.14159265358979323846f / 180.0f)));
