# 1 "./src/main/sensors/pitotmeter.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/sensors/pitotmeter.c"
# 18 "./src/main/sensors/pitotmeter.c"
...
# 19 "./src/main/sensors/pitotmeter.c" 2
...
# 20 "./src/main/sensors/pitotmeter.c" 2
...
# 21 "./src/main/sensors/pitotmeter.c" 2
...
# 58 "./src/main/platform.h" 2
# 23 "./src/main/sensors/pitotmeter.c" 2
...
# 25 "./src/main/sensors/pitotmeter.c" 2
...
# 27 "./src/main/sensors/pitotmeter.c" 2
...
# 29 "./src/main/sensors/pitotmeter.c" 2
...
# 32 "./src/main/sensors/pitotmeter.c" 2
...
# 34 "./src/main/sensors/pitotmeter.c" 2
...
# 35 "./src/main/sensors/pitotmeter.c" 2
# 1 "./src/main/drivers/pitotmeter_ms4525.h" 1
# 18 "./src/main/drivers/pitotmeter_ms4525.h"
       


# 20 "./src/main/drivers/pitotmeter_ms4525.h" 3 4
_Bool 
# 20 "./src/main/drivers/pitotmeter_ms4525.h"
    ms4525Detect(pitotDev_t *pitot);
# 36 "./src/main/sensors/pitotmeter.c" 2
# 1 "./src/main/drivers/pitotmeter_adc.h" 1
# 18 "./src/main/drivers/pitotmeter_adc.h"
       


# 20 "./src/main/drivers/pitotmeter_adc.h" 3 4
_Bool 
# 20 "./src/main/drivers/pitotmeter_adc.h"
    adcPitotDetect(pitotDev_t *pitot);
# 37 "./src/main/sensors/pitotmeter.c" 2
...
# 38 "./src/main/sensors/pitotmeter.c" 2
...
# 40 "./src/main/sensors/pitotmeter.c" 2
...
# 41 "./src/main/sensors/pitotmeter.c" 2
...
# 59 "./src/main/sensors/pitotmeter.h"
    pitotIsHealthy(void);
# 43 "./src/main/sensors/pitotmeter.c" 2
...
# 44 "./src/main/sensors/pitotmeter.c" 2
...
static 
# 50 "./src/main/sensors/pitotmeter.c" 3 4
      _Bool 
# 50 "./src/main/sensors/pitotmeter.c"
           pitotCalibrationFinished = 
# 50 "./src/main/sensors/pitotmeter.c" 3 4
                                      0
# 50 "./src/main/sensors/pitotmeter.c"
                                           ;
...
extern const pitotmeterConfig_t pgResetTemplate_pitotmeterConfig; pitotmeterConfig_t pitotmeterConfig_System; pitotmeterConfig_t pitotmeterConfig_Copy; extern const pgRegistry_t pitotmeterConfig_Registry; const pgRegistry_t pitotmeterConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 1000 | (0 << 12), .size = sizeof(pitotmeterConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&pitotmeterConfig_System, .copy = (uint8_t*)&pitotmeterConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_pitotmeterConfig}, };
...
const pitotmeterConfig_t pgResetTemplate_pitotmeterConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .pitot_hardware = PITOT_AUTODETECT, .use_median_filtering = 1, .pitot_noise_lpf = 0.6f, .pitot_scale = 1.00f }
...
# 70 "./src/main/sensors/pitotmeter.c" 3 4
_Bool 
# 70 "./src/main/sensors/pitotmeter.c"
    pitotDetect(pitotDev_t *dev, uint8_t pitotHardwareToUse)
{
    ...
    switch (pitotHardwareToUse) {
        ...
        case PITOT_VIRTUAL:
# 113 "./src/main/sensors/pitotmeter.c"
            if (pitotHardwareToUse != PITOT_AUTODETECT) {
                break;
            }
            __attribute__ ((fallthrough));
    ...
    if (pitotHardware == PITOT_NONE) {
        ...
        return 
# 140 "./src/main/sensors/pitotmeter.c" 3 4
              0
# 140 "./src/main/sensors/pitotmeter.c"
                   ;
    }
    ...
    return 
# 145 "./src/main/sensors/pitotmeter.c" 3 4
          1
# 145 "./src/main/sensors/pitotmeter.c"
              ;
}


# 148 "./src/main/sensors/pitotmeter.c" 3 4
_Bool 
# 148 "./src/main/sensors/pitotmeter.c"
    pitotInit(void)
{
    if (!pitotDetect(&pitot.dev, pitotmeterConfig()->pitot_hardware)) {
        return 
# 151 "./src/main/sensors/pitotmeter.c" 3 4
              0
# 151 "./src/main/sensors/pitotmeter.c"
                   ;
    }
    return 
# 153 "./src/main/sensors/pitotmeter.c" 3 4
          1
# 153 "./src/main/sensors/pitotmeter.c"
              ;
}


# 156 "./src/main/sensors/pitotmeter.c" 3 4
_Bool 
# 156 "./src/main/sensors/pitotmeter.c"
    pitotIsCalibrationComplete(void)
{
...
void pitotStartCalibration(void)
{
    ...
    pitotCalibrationFinished = 
# 164 "./src/main/sensors/pitotmeter.c" 3 4
                              0
# 164 "./src/main/sensors/pitotmeter.c"
                                   ;
}
...
{
    static int32_t pitotFilterSamples[3];
    static int currentFilterSampleIndex = 0;
    static 
# 173 "./src/main/sensors/pitotmeter.c" 3 4
          _Bool 
# 173 "./src/main/sensors/pitotmeter.c"
               medianFilterReady = 
# 173 "./src/main/sensors/pitotmeter.c" 3 4
                                   0
# 173 "./src/main/sensors/pitotmeter.c"
    ...
    if (nextSampleIndex == 3) {
        nextSampleIndex = 0;
        medianFilterReady = 
# 179 "./src/main/sensors/pitotmeter.c" 3 4
                           1
# 179 "./src/main/sensors/pitotmeter.c"
                               ;
    }
...
#define AIR_DENSITY_SEA_LEVEL_15C 1.225f
#define AIR_GAS_CONST 287.1f
#define P0 101325.0f
...
static void performPitotCalibrationCycle(void)
{
    ...
    if (( __extension__ ({ __typeof__(pitotPressureZeroError) _abs0 = (pitotPressureZeroError); _abs0 < 0 ? -_abs0 : _abs0; })) < (101325.0f * 0.00001f)) {
        if ((millis() - pitotCalibrationTimeout) > 250) {
            pitotCalibrationFinished = 
# 231 "./src/main/sensors/pitotmeter.c" 3 4
                                      1
# 231 "./src/main/sensors/pitotmeter.c"
                                          ;
        }
    }
    else {
...
# 250 "./src/main/sensors/pitotmeter.c"
        const float indicatedAirspeed_tmp = pitotmeterConfig()->pitot_scale * sqrtf(2.0f * fabsf(pitotPressure - pitotPressureZero) / 1.225f);
...
# 261 "./src/main/sensors/pitotmeter.c" 3 4
_Bool 
# 261 "./src/main/sensors/pitotmeter.c"
    pitotIsHealthy(void)
{
    return 
# 263 "./src/main/sensors/pitotmeter.c" 3 4
          1
# 263 "./src/main/sensors/pitotmeter.c"
              ;
}
