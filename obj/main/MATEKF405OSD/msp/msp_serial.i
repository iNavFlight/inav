...
# 36 "./src/main/msp/msp_serial.c" 2
...
# 39 "./src/main/msp/msp_serial.c" 2
...
# 61 "./src/main/msp/msp_serial.c" 3 4
                                                                                       ((void *)0)
# 61 "./src/main/msp/msp_serial.c"
                                                                                           , 
# 61 "./src/main/msp/msp_serial.c" 3 4
                                                                                             ((void *)0)
# 61 "./src/main/msp/msp_serial.c"
...
static 
# 82 "./src/main/msp/msp_serial.c" 3 4
      _Bool 
# 82 "./src/main/msp/msp_serial.c"
    ...
    switch (mspPort->c_state) {
        ...
        case MSP_IDLE:
            if (c == '$') {
                ...
                return 
# 92 "./src/main/msp/msp_serial.c" 3 4
                      0
# 92 "./src/main/msp/msp_serial.c"
                           ;
            }
            break;
        ...
        case MSP_HEADER_V1:
            ...
            if (mspPort->offset == sizeof(mspHeaderV1_t)) {
                ...
                if (hdr->size > 192) {
                    ...
                    mspPort->cmdFlags = 0;
                    mspPort->offset = 0;
                    mspPort->c_state = mspPort->dataSize > 0 ? MSP_PAYLOAD_V1 : MSP_CHECKSUM_V1;
                }
            }
            break;
    ...
    return 
# 257 "./src/main/msp/msp_serial.c" 3 4
          1
# 257 "./src/main/msp/msp_serial.c"
              ;
}
...
#define V1_CHECKSUM_STARTPOS 3
    if (mspVersion == MSP_V1) {
        ...
        crcBuf[crcLen] = mspSerialChecksumBuf(0, hdrBuf + 3, hdrLen - 3);
...
# 400 "./src/main/msp/msp_serial.c" 3 4
                                          ((void *)0)
# 400 "./src/main/msp/msp_serial.c"
                                              ;
    ...
    switch(mspPort->pendingRequest) {
        ...
        case MSP_PENDING_CLI:
            if (!cliMode) {
                ...
                mspPort->port = 
# 441 "./src/main/msp/msp_serial.c" 3 4
                               ((void *)0)
# 441 "./src/main/msp/msp_serial.c"
                                   ;
            }
            break;
...
void mspSerialProcess(mspEvaluateNonMspData_e evaluateNonMspData, mspProcessCommandFnPtr mspProcessCommandFn)
{
    for (uint8_t portIndex = 0; portIndex < 3; portIndex++) {
        ...
        mspPostProcessFnPtr mspPostProcessFn = 
# 463 "./src/main/msp/msp_serial.c" 3 4
                                              ((void *)0)
# 463 "./src/main/msp/msp_serial.c"
                                                  ;
        ...
        if (serialRxBytesWaiting(mspPort->port)) {
            ...
            while (serialRxBytesWaiting(mspPort->port)) {
                ...
                const 
# 473 "./src/main/msp/msp_serial.c" 3 4
                     _Bool 
# 473 "./src/main/msp/msp_serial.c"
...
int mspSerialPushPort(uint16_t cmd, const uint8_t *data, int datalen, mspPort_t *mspPort, mspVersion_e version)
{
    uint8_t pushBuf[(4096 + 16)];

    mspPacket_t push = {
        .buf = { .ptr = pushBuf, .end = (&(pushBuf)[(sizeof(pushBuf) / sizeof((pushBuf)[0]))]), },
        .cmd = cmd,
        .result = 0,
    };
...
{
    uint32_t ret = 
# 541 "./src/main/msp/msp_serial.c" 3 4
                  (0xffffffffUL)
# 541 "./src/main/msp/msp_serial.c"
                            ;
...
mspPort_t * mspSerialPortFind(const serialPort_t *serialPort)
{
    ...
    return 
# 571 "./src/main/msp/msp_serial.c" 3 4
          ((void *)0)
# 571 "./src/main/msp/msp_serial.c"
              ;
}
