...
# 1 "./src/main/telemetry/ibus_shared.c"
# 18 "./src/main/telemetry/ibus_shared.c"
...
# 19 "./src/main/telemetry/ibus_shared.c" 2
...
# 20 "./src/main/telemetry/ibus_shared.c" 2
...
# 21 "./src/main/telemetry/ibus_shared.c" 2
...
# 58 "./src/main/platform.h" 2
# 22 "./src/main/telemetry/ibus_shared.c" 2
# 1 "./src/main/telemetry/ibus_shared.h" 1
# 18 "./src/main/telemetry/ibus_shared.h"
...
# 21 "./src/main/telemetry/ibus_shared.h" 2
...
uint8_t respondToIbusRequest(uint8_t ibusPacket[static ((4))]);
...
# 165 "./src/main/telemetry/ibus_shared.h" 3 4
_Bool 
# 165 "./src/main/telemetry/ibus_shared.h"
    ibusIsChecksumOkIa6b(const uint8_t *ibusPacket, const uint8_t length);
uint16_t ibusCalculateChecksum(const uint8_t *ibusPacket, size_t packetLength);
# 23 "./src/main/telemetry/ibus_shared.c" 2
...
# 33 "./src/main/telemetry/ibus_shared.c" 2
...
# 35 "./src/main/telemetry/ibus_shared.c" 2
...
# 58 "./src/main/sensors/barometer.h"
    baroIsHealthy(void);
# 39 "./src/main/telemetry/ibus_shared.c" 2
...
# 40 "./src/main/telemetry/ibus_shared.c" 2
...
# 41 "./src/main/telemetry/ibus_shared.c" 2
...
# 59 "./src/main/sensors/pitotmeter.h"
    pitotIsHealthy(void);
# 43 "./src/main/telemetry/ibus_shared.c" 2
...
void imuInit(void);
# 45 "./src/main/telemetry/ibus_shared.c" 2
...
# 46 "./src/main/telemetry/ibus_shared.c" 2
...
# 48 "./src/main/telemetry/ibus_shared.c" 2
...
# 24 "./src/main/telemetry/ibus.h" 3 4
_Bool 
# 24 "./src/main/telemetry/ibus.h"
    checkIbusTelemetryState(void);

void configureIbusTelemetryPort(void);
void freeIbusTelemetryPort(void);
# 50 "./src/main/telemetry/ibus_shared.c" 2
...
# 51 "./src/main/telemetry/ibus_shared.c" 2
...
# 52 "./src/main/telemetry/ibus_shared.c" 2
...
static IBUS_SENSOR SENSOR_ADDRESS_TYPE_LOOKUP[] = {
    {.type = IBUS_MEAS_TYPE_INTERNAL_VOLTAGE, .size = 2, .value = IBUS_MEAS_VALUE_NONE },
    {.type = IBUS_MEAS_TYPE_EXTERNAL_VOLTAGE, .size = 2, .value = IBUS_MEAS_VALUE_EXTERNAL_VOLTAGE },
    {.type = IBUS_MEAS_TYPE_TEMPERATURE, .size = 2, .value = IBUS_MEAS_VALUE_TEMPERATURE },
    {.type = IBUS_MEAS_TYPE_RPM, .size = 2, .value = IBUS_MEAS_VALUE_STATUS },
    {.type = IBUS_MEAS_TYPE_RPM, .size = 2, .value = IBUS_MEAS_VALUE_ACC_Z },
    {.type = IBUS_MEAS_TYPE_EXTERNAL_VOLTAGE, .size = 2, .value = IBUS_MEAS_VALUE_CURRENT },
    {.type = IBUS_MEAS_TYPE_EXTERNAL_VOLTAGE, .size = 2, .value = IBUS_MEAS_VALUE_ALT },
    {.type = IBUS_MEAS_TYPE_RPM, .size = 2, .value = IBUS_MEAS_VALUE_HEADING },
    {.type = IBUS_MEAS_TYPE_RPM, .size = 2, .value = IBUS_MEAS_VALUE_DIST },
    {.type = IBUS_MEAS_TYPE_RPM, .size = 2, .value = IBUS_MEAS_VALUE_COG },
    {.type = IBUS_MEAS_TYPE_RPM, .size = 2, .value = IBUS_MEAS_VALUE_GALT },
    {.type = IBUS_MEAS_TYPE_RPM, .size = 2, .value = IBUS_MEAS_VALUE_GPS_LAT2 },
    {.type = IBUS_MEAS_TYPE_RPM, .size = 2, .value = IBUS_MEAS_VALUE_GPS_LON2 },
    {.type = IBUS_MEAS_TYPE_EXTERNAL_VOLTAGE, .size = 2, .value = IBUS_MEAS_VALUE_GPS_LAT1 },
    {.type = IBUS_MEAS_TYPE_EXTERNAL_VOLTAGE, .size = 2, .value = IBUS_MEAS_VALUE_GPS_LON1 },
    {.type = IBUS_MEAS_TYPE_RPM, .size = 2, .value = IBUS_MEAS_VALUE_SPE }
};

static serialPort_t *ibusSerialPort = 
# 88 "./src/main/telemetry/ibus_shared.c" 3 4
                                     ((void *)0)
# 88 "./src/main/telemetry/ibus_shared.c"
                                         ;

static uint8_t transmitIbusPacket(uint8_t ibusPacket[static (2 + (2))], size_t packetLength) {
    uint16_t checksum = ibusCalculateChecksum(ibusPacket, packetLength);
    ibusPacket[packetLength - (2)] = (checksum & 0xFF);
    ibusPacket[packetLength - (2) + 1] = (checksum >> 8);
...
static 
# 122 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 122 "./src/main/telemetry/ibus_shared.c"
           isCommand(ibusCommand_e expected, uint8_t ibusPacket[static (2 + (2))]) {
    return (ibusPacket[1] & 0xF0) == expected;
}

static ibusAddress_t getAddress(uint8_t ibusPacket[static (2 + (2))]) {
...
static uint8_t dispatchMeasurementRequest(ibusAddress_t address) {
    ...
    if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_TEMPERATURE) {
        if (sensors(SENSOR_BARO)) return sendIbusMeasurement2(address, (uint16_t) ((baro.baroTemperature + 50) / 10 + (0x0190)));
        else {
          ...
          return sendIbusMeasurement2(address, (uint16_t) (5 + (0x0190)));
        }
    ...
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_EXTERNAL_VOLTAGE) {
    ...
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_CURRENT) {
        if (isAmperageConfigured()) return sendIbusMeasurement2(address, (uint16_t) getAmperage());
        else return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_FUEL) {
        if (isAmperageConfigured()) return sendIbusMeasurement2(address, (uint16_t) getMAhDrawn());
        else return sendIbusMeasurement2(address, 0);
    ...
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_ACC_Z) {
        return sendIbusMeasurement2(address, (uint16_t) (attitude.values.yaw * 10));
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_ACC_Y) {
        return sendIbusMeasurement2(address, (uint16_t) (-attitude.values.pitch * 10));
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_ACC_X) {
        return sendIbusMeasurement2(address, (uint16_t) (attitude.values.roll * 10));
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_VSPEED) {

        if (sensors(SENSOR_PITOT)) return sendIbusMeasurement2(address, (uint16_t) (pitot.airSpeed));
        else

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_ARMED) {
        if ((telemetryConfig()->ibusTelemetryType & 0x7F) < 8) {
            return sendIbusMeasurement2(address, (armingFlags & (ARMED)) ? 0 : 1);
        } else {
            return sendIbusMeasurement2(address, (armingFlags & (ARMED)) ? 1 : 0);
        }
    ...
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_PRES) {
        if (sensors(SENSOR_BARO)) return sendIbusMeasurement2(address, (int16_t) (baro.baroPressure / 10));
        else return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_ALT) {
        if (sensors(SENSOR_BARO)) return sendIbusMeasurement2(address, (uint16_t) baro.BaroAlt);
        else return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_ALT4) {
        if (sensors(SENSOR_BARO)) return sendIbusMeasurement4(address, (int32_t) baro.BaroAlt);
        else return sendIbusMeasurement4(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_STATUS) {
        uint16_t status = flightModeToIBusTelemetryMode1[getFlightModeForTelemetry()];

        if (sensors(SENSOR_GPS)) {
            status += gpsSol.numSat * 1000;
            status += fix * 100;
            if ((stateFlags & (GPS_FIX_HOME))) status += 500;
            status += constrain(gpsSol.hdop / 1000, 0, 9) * 10;
        }

        return sendIbusMeasurement2(address, status);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_HEADING) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (uint16_t) GPS_directionToHome); else

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_DIST) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (uint16_t) GPS_distanceToHome); else

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_SPE) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (uint16_t) gpsSol.groundSpeed * 36 / 100); else

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_SPEED) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (uint16_t) gpsSol.groundSpeed);

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_COG) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (uint16_t) (gpsSol.groundCourse / 10)); else

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_GPS_STATUS) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (((uint16_t)fix)<<8) + gpsSol.numSat); else

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_GPS_LAT) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement4(address, (int32_t)gpsSol.llh.lat); else

        return sendIbusMeasurement4(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_GPS_LON) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement4(address, (int32_t)gpsSol.llh.lon); else

        return sendIbusMeasurement4(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_GPS_LAT1) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (uint16_t) (gpsSol.llh.lat / 100000)); else

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_GPS_LON1) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (uint16_t) (gpsSol.llh.lon / 100000)); else

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_GPS_LAT2) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (uint16_t) ((gpsSol.llh.lat % 100000)/10));

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_GPS_LON2) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (uint16_t) ((gpsSol.llh.lon % 100000)/10)); else

        return sendIbusMeasurement2(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_GALT4) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement4(address, (int32_t) (gpsSol.llh.alt)); else

        return sendIbusMeasurement4(address, 0);
    } else if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_GALT) {

        if (sensors(SENSOR_GPS)) return sendIbusMeasurement2(address, (uint16_t) (gpsSol.llh.alt / 100)); else
