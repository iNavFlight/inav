...
# 21 "./src/main/telemetry/crsf.h" 2
...
# 18 "./src/main/telemetry/msp_shared.c" 2
...
# 50 "./src/main/telemetry/smartport.h" 3 4
_Bool 
# 50 "./src/main/telemetry/smartport.h"
...
# 55 "./src/main/telemetry/smartport.h" 3 4
                                                    _Bool 
# 55 "./src/main/telemetry/smartport.h"
...
# 60 "./src/main/telemetry/smartport.h" 3 4
_Bool 
# 60 "./src/main/telemetry/smartport.h"
...
# 33 "./src/main/telemetry/msp_shared.h" 3 4
_Bool 
# 33 "./src/main/telemetry/msp_shared.h"
    handleMspFrame(uint8_t *frameStart, int frameLength);

# 34 "./src/main/telemetry/msp_shared.h" 3 4
_Bool 
# 34 "./src/main/telemetry/msp_shared.h"
    sendMspReply(uint8_t payloadSize, mspResponseFnPtr responseFn);
# 19 "./src/main/telemetry/msp_shared.c" 2
...
# 61 "./src/main/telemetry/msp_shared.c" 3 4
                                          ((void *)0)
# 61 "./src/main/telemetry/msp_shared.c"
                                              ;
    ...
    if (mspPostProcessFn) {
        mspPostProcessFn(
# 66 "./src/main/telemetry/msp_shared.c" 3 4
                        ((void *)0)
# 66 "./src/main/telemetry/msp_shared.c"
                            );
    }
...
# 83 "./src/main/telemetry/msp_shared.c" 3 4
_Bool 
# 83 "./src/main/telemetry/msp_shared.c"
    handleMspFrame(uint8_t *frameStart, int frameLength)
{
    ...
    if (version != 1) {
        ...
        return 
# 105 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 105 "./src/main/telemetry/msp_shared.c"
                  ;
    }
    ...
    if (header & (1 << 4)) {
        ...
        return 
# 121 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 121 "./src/main/telemetry/msp_shared.c"
                   ;
    } else if (((lastSeq + 1) & 0x0F) != seqNumber) {

        mspStarted = 0;
        return 
# 125 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 125 "./src/main/telemetry/msp_shared.c"
                   ;
    }
    ...
    if (bufferBytesRemaining >= frameBytesRemaining) {
        ...
        return 
# 138 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 138 "./src/main/telemetry/msp_shared.c"
                   ;
    } else {
        ...
        if (checksum != *frameBuf->ptr) {
            ...
            return 
# 151 "./src/main/telemetry/msp_shared.c" 3 4
                  1
# 151 "./src/main/telemetry/msp_shared.c"
                      ;
        }
    }
    ...
    processMspPacket();
    return 
# 158 "./src/main/telemetry/msp_shared.c" 3 4
          1
# 158 "./src/main/telemetry/msp_shared.c"
              ;
}


# 161 "./src/main/telemetry/msp_shared.c" 3 4
_Bool 
# 161 "./src/main/telemetry/msp_shared.c"
    sendMspReply(uint8_t payloadSize, mspResponseFnPtr responseFn)
{
    static uint8_t checksum = 0;
    ...
    if (bufferBytesRemaining >= payloadBytesRemaining) {
        ...
        return 
# 199 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 199 "./src/main/telemetry/msp_shared.c"
                  ;
    ...
    responseFn(payloadOut);
    return 
# 222 "./src/main/telemetry/msp_shared.c" 3 4
          0
# 222 "./src/main/telemetry/msp_shared.c"
               ;
}
