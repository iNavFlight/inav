...
# 35 "./src/main/telemetry/ibus.c" 2
...
# 44 "./src/main/fc/fc_core.h"
                  bootLoader);
# 40 "./src/main/telemetry/ibus.c" 2
...
# 54 "./src/main/telemetry/ibus.c" 2
...
# 61 "./src/main/telemetry/ibus.c" 2
# 169 "./src/main/telemetry/ibus.c"
static serialPort_t *ibusSerialPort = 
# 169 "./src/main/telemetry/ibus.c" 3 4
                                     ((void *)0)
# 169 "./src/main/telemetry/ibus.c"
                                         ;
...
static 
# 172 "./src/main/telemetry/ibus.c" 3 4
      _Bool 
# 172 "./src/main/telemetry/ibus.c"
...
void initIbusTelemetry(void) {
    ...
    ibusTelemetryEnabled = 
# 262 "./src/main/telemetry/ibus.c" 3 4
                          0
# 262 "./src/main/telemetry/ibus.c"
                               ;
}
...
void handleIbusTelemetry(void) {
    ...
    while (serialRxBytesWaiting(ibusSerialPort) > 0) {
        ...
        if (ibusIsChecksumOkIa6b(ibusReceiveBuffer, ((4)))) {
...
# 282 "./src/main/telemetry/ibus.c" 3 4
_Bool 
# 282 "./src/main/telemetry/ibus.c"
    checkIbusTelemetryState(void) {
    
# 283 "./src/main/telemetry/ibus.c" 3 4
   _Bool 
# 283 "./src/main/telemetry/ibus.c"
        newTelemetryEnabledValue = telemetryDetermineEnabledState(ibusPortSharing);

    if (newTelemetryEnabledValue == ibusTelemetryEnabled) {
        return 
# 286 "./src/main/telemetry/ibus.c" 3 4
              0
# 286 "./src/main/telemetry/ibus.c"
                   ;
    }
    ...
    return 
# 296 "./src/main/telemetry/ibus.c" 3 4
          1
# 296 "./src/main/telemetry/ibus.c"
              ;
}
...
# 307 "./src/main/telemetry/ibus.c" 3 4
                                                                                              ((void *)0)
# 307 "./src/main/telemetry/ibus.c"
                                                                                                  , 
# 307 "./src/main/telemetry/ibus.c" 3 4
                                                                                                    ((void *)0)
# 307 "./src/main/telemetry/ibus.c"
                                                                                                        , (115200), MODE_RXTX, SERIAL_BIDIR | SERIAL_NOT_INVERTED);
    if (!ibusSerialPort) {
        return;
    }
    initSharedIbusTelemetry(ibusSerialPort);
    ibusTelemetryEnabled = 
# 312 "./src/main/telemetry/ibus.c" 3 4
                          1
# 312 "./src/main/telemetry/ibus.c"
                              ;
...
void freeIbusTelemetryPort(void) {
    ...
    ibusSerialPort = 
# 318 "./src/main/telemetry/ibus.c" 3 4
                    ((void *)0)
# 318 "./src/main/telemetry/ibus.c"
                        ;

    ibusTelemetryEnabled = 
# 320 "./src/main/telemetry/ibus.c" 3 4
                          0
# 320 "./src/main/telemetry/ibus.c"
                               ;
}
