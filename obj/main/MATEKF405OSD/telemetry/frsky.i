...
# 7 "./src/main/telemetry/frsky.c" 2
...
# 8 "./src/main/telemetry/frsky.c" 2
...
# 58 "./src/main/platform.h" 2
# 10 "./src/main/telemetry/frsky.c" 2
...
# 14 "./src/main/telemetry/frsky.c" 2
...
# 15 "./src/main/telemetry/frsky.c" 2
...
# 16 "./src/main/telemetry/frsky.c" 2
...
# 17 "./src/main/telemetry/frsky.c" 2
...
# 18 "./src/main/telemetry/frsky.c" 2
...
uint16_t frskyGetFlightMode(void)
{
    ...
    if ((flightModeFlags & (NAV_ALTHOLD_MODE)))
        tmpi += 200;
    if ((flightModeFlags & (NAV_POSHOLD_MODE)))
        tmpi += 400;


    if ((flightModeFlags & (NAV_RTH_MODE)))
        tmpi += 1000;
    if ((flightModeFlags & (NAV_CRUISE_MODE)))
        tmpi += 8000;
    ...
    if ((flightModeFlags & (FAILSAFE_MODE)))
        tmpi += 40000;
    else if ((flightModeFlags & (AUTO_TUNE)))
        tmpi += 20000;
...
uint16_t frskyGetGPSState(void)
{
    ...
    if ((stateFlags & (GPS_FIX_HOME)))
        tmpi += 2000;
    if ((armingFlags & (ARMED)) && IS_RC_MODE_ACTIVE(BOXHOMERESET) && !(flightModeFlags & (NAV_RTH_MODE)) && !(flightModeFlags & (NAV_WP_MODE)))
        tmpi += 4000;
