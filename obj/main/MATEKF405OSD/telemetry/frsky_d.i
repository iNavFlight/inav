# 1 "./src/main/telemetry/frsky_d.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/telemetry/frsky_d.c"
# 22 "./src/main/telemetry/frsky_d.c"
...
# 23 "./src/main/telemetry/frsky_d.c" 2
...
# 24 "./src/main/telemetry/frsky_d.c" 2
...
# 25 "./src/main/telemetry/frsky_d.c" 2
...
# 26 "./src/main/telemetry/frsky_d.c" 2
...
# 58 "./src/main/platform.h" 2
# 28 "./src/main/telemetry/frsky_d.c" 2
...
# 32 "./src/main/telemetry/frsky_d.c" 2
...
# 33 "./src/main/telemetry/frsky_d.c" 2
...
# 35 "./src/main/telemetry/frsky_d.c" 2
...
# 37 "./src/main/telemetry/frsky_d.c" 2
...
# 38 "./src/main/telemetry/frsky_d.c" 2
...
# 40 "./src/main/telemetry/frsky_d.c" 2
...
# 41 "./src/main/telemetry/frsky_d.c" 2
...
# 43 "./src/main/telemetry/frsky_d.c" 2
...
# 44 "./src/main/telemetry/frsky_d.c" 2
...
# 46 "./src/main/telemetry/frsky_d.c" 2
...
# 47 "./src/main/telemetry/frsky_d.c" 2
...
void imuInit(void);
# 48 "./src/main/telemetry/frsky_d.c" 2
...
# 50 "./src/main/telemetry/frsky_d.c" 2
...
# 51 "./src/main/telemetry/frsky_d.c" 2
...
# 53 "./src/main/telemetry/frsky_d.c" 2
...
# 55 "./src/main/telemetry/frsky_d.c" 2
...
# 58 "./src/main/sensors/barometer.h"
    baroIsHealthy(void);
# 56 "./src/main/telemetry/frsky_d.c" 2
...
# 57 "./src/main/telemetry/frsky_d.c" 2
...
# 58 "./src/main/telemetry/frsky_d.c" 2
...
# 61 "./src/main/telemetry/frsky_d.c" 2
# 1 "./src/main/telemetry/frsky_d.h" 1
# 18 "./src/main/telemetry/frsky_d.h"
...
# 62 "./src/main/telemetry/frsky_d.c" 2
# 1 "./src/main/telemetry/frsky.h" 1
# 23 "./src/main/telemetry/frsky.h"
       

uint16_t frskyGetFlightMode(void);
uint16_t frskyGetGPSState(void);
# 63 "./src/main/telemetry/frsky_d.c" 2

static serialPort_t *frskyPort = 
# 64 "./src/main/telemetry/frsky_d.c" 3 4
                                ((void *)0)
# 64 "./src/main/telemetry/frsky_d.c"
                                    ;
...
static 
# 70 "./src/main/telemetry/frsky_d.c" 3 4
      _Bool 
# 70 "./src/main/telemetry/frsky_d.c"
...
static void sendBaro(void)
{
    ...
    serialize16(alt / 100);
    sendDataHead(0x21);
    serialize16(( __extension__ ({ __typeof__(alt % 100) _abs0 = (alt % 100); _abs0 < 0 ? -_abs0 : _abs0; })));
}


static void sendGpsAltitude(void)
{
    uint16_t altitude = gpsSol.llh.alt / 100;
...
static void sendThrottleOrBatterySizeAsRpm(void)
{
    ...
    if ((armingFlags & (ARMED))) {
        ...
        serialize16((currentBatteryProfile->capacity.value / 5));
    }
...
static void GPStoDDDMM_MMMM(int32_t mwiigps, gpsCoordinateDDDMMmmmm_t *result)
{
    ...
    absgps = ( __extension__ ({ __typeof__(mwiigps) _abs1 = (mwiigps); _abs1 < 0 ? -_abs1 : _abs1; }));
...
static void sendGPSLatLong(void)
{
    ...
    if ((stateFlags & (GPS_FIX)) || gpsFixOccured == 1) {
        ...
        gpsFixOccured = 1;
        coord[0] = gpsSol.llh.lat;
        coord[1] = gpsSol.llh.lon;
        sendLatLong(coord);
    } else {
...
static void sendVoltage(void)
{
    ...
    uint16_t payload;
# 372 "./src/main/telemetry/frsky_d.c"
...
void freeFrSkyTelemetryPort(void)
{
    ...
    frskyPort = 
# 460 "./src/main/telemetry/frsky_d.c" 3 4
               ((void *)0)
# 460 "./src/main/telemetry/frsky_d.c"
                   ;
    frskyTelemetryEnabled = 
# 461 "./src/main/telemetry/frsky_d.c" 3 4
                           0
# 461 "./src/main/telemetry/frsky_d.c"
                                ;
}
...
# 470 "./src/main/telemetry/frsky_d.c" 3 4
                                                                                ((void *)0)
# 470 "./src/main/telemetry/frsky_d.c"
                                                                                    , 
# 470 "./src/main/telemetry/frsky_d.c" 3 4
                                                                                      ((void *)0)
# 470 "./src/main/telemetry/frsky_d.c"
    ...
    frskyTelemetryEnabled = 
# 475 "./src/main/telemetry/frsky_d.c" 3 4
                           1
# 475 "./src/main/telemetry/frsky_d.c"
                               ;
}


# 478 "./src/main/telemetry/frsky_d.c" 3 4
_Bool 
# 478 "./src/main/telemetry/frsky_d.c"
...
void checkFrSkyTelemetryState(void)
{
    if (portConfig && telemetryCheckRxPortShared(portConfig)) {
        if (!frskyTelemetryEnabled && telemetrySharedPort != 
# 486 "./src/main/telemetry/frsky_d.c" 3 4
                                                            ((void *)0)
# 486 "./src/main/telemetry/frsky_d.c"
                                                                ) {
            frskyPort = telemetrySharedPort;
            frskyTelemetryEnabled = 
# 488 "./src/main/telemetry/frsky_d.c" 3 4
                                   1
# 488 "./src/main/telemetry/frsky_d.c"
                                       ;
        }
    } else {
        
# 491 "./src/main/telemetry/frsky_d.c" 3 4
       _Bool 
# 491 "./src/main/telemetry/frsky_d.c"
