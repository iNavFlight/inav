# 1 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd_int.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd_int.c"
# 29 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd_int.c"
# 1 "./lib/main/STM32_USB_OTG_Driver/inc/usb_dcd_int.h" 1
# 30 "./lib/main/STM32_USB_OTG_Driver/inc/usb_dcd_int.h"
#define USB_DCD_INT_H__ 


# 1 "./lib/main/STM32_USB_OTG_Driver/inc/usb_dcd.h" 1
# 30 "./lib/main/STM32_USB_OTG_Driver/inc/usb_dcd.h"
#define __DCD_H__ 
...
# 49 "./lib/main/STM32_USB_OTG_Driver/inc/usb_dcd.h"
...
void DCD_SetEPStatus (USB_OTG_CORE_HANDLE *pdev ,
                      uint8_t epnum ,
                      uint32_t Status);
# 34 "./lib/main/STM32_USB_OTG_Driver/inc/usb_dcd_int.h" 2
# 51 "./lib/main/STM32_USB_OTG_Driver/inc/usb_dcd_int.h"
...
# 85 "./lib/main/STM32_USB_OTG_Driver/inc/usb_dcd_int.h"
...
# 110 "./lib/main/STM32_USB_OTG_Driver/inc/usb_dcd_int.h"
uint32_t USBD_OTG_ISR_Handler (USB_OTG_CORE_HANDLE *pdev);
uint32_t USBD_OTG_EP1OUT_ISR_Handler (USB_OTG_CORE_HANDLE *pdev);
uint32_t USBD_OTG_EP1IN_ISR_Handler (USB_OTG_CORE_HANDLE *pdev);
# 30 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd_int.c" 2
# 77 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd_int.c"
...
# 207 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd_int.c"
uint32_t USBD_OTG_ISR_Handler (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  if (USB_OTG_IsDeviceMode(pdev))
  {
    ...
    if (gintr_status.b.modemismatch)
    {
      ...
      (*(volatile uint32_t *)(&pdev->regs.GREGS->GINTSTS) = (gintsts.d32));
    }
...
# 291 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd_int.c"
  }
  return retval;
}
# 344 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd_int.c"
static uint32_t DCD_HandleResume_ISR(USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_GINTSTS_TypeDef gintsts;
  ...
  (*(volatile uint32_t *)((&pdev->regs.DREGS->DCTL)) = (((((*(volatile uint32_t *)(&pdev->regs.DREGS->DCTL))) & ~(devctl.d32)) | (0))));
...
static uint32_t DCD_HandleUSBSuspend_ISR(USB_OTG_CORE_HANDLE *pdev)
{
    ...
    (prev_status == 3))
  {
    ...
    power.d32 = 0;
    power.b.stoppclk = 1;
    (*(volatile uint32_t *)((pdev->regs.PCGCCTL)) = (((((*(volatile uint32_t *)(pdev->regs.PCGCCTL))) & ~(0)) | (power.d32))));
...
static uint32_t DCD_HandleInEP_ISR(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  while ( ep_intr )
  {
    if ((ep_intr & 0x1) == 0x01)
    {
      diepint.d32 = DCD_ReadDevInEP(pdev , epnum);
      if ( diepint.b.xfercompl )
      {
        fifoemptymsk = 0x1 << epnum;
        (*(volatile uint32_t *)((&pdev->regs.DREGS->DIEPEMPMSK)) = (((((*(volatile uint32_t *)(&pdev->regs.DREGS->DIEPEMPMSK))) & ~(fifoemptymsk)) | (0))));
        diepint.d32=0; diepint.b.xfercompl = 1; (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[epnum]->DIEPINT) = (diepint.d32));;

        USBD_DCD_INT_fops->DataInStage(pdev , epnum);

        if (pdev->cfg.dma_enable == 1)
        {
          if((epnum == 0) && (pdev->dev.device_state == 4))
          {
      ...
      {
        diepint.d32=0; diepint.b.timeout = 1; (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[epnum]->DIEPINT) = (diepint.d32));;
      }
      if (diepint.b.intktxfemp)
      {
        diepint.d32=0; diepint.b.intktxfemp = 1; (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[epnum]->DIEPINT) = (diepint.d32));;
      }
      if (diepint.b.inepnakeff)
      {
        diepint.d32=0; diepint.b.inepnakeff = 1; (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[epnum]->DIEPINT) = (diepint.d32));;
      }
      if ( diepint.b.epdisabled )
      {
        diepint.d32=0; diepint.b.epdisabled = 1; (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[epnum]->DIEPINT) = (diepint.d32));;
      }
  ...
  while ( ep_intr )
  {
    if (ep_intr&0x1)
    {
      ...
      if ( doepint.b.xfercompl )
      {
        ...
        doepint.d32=0; doepint.b.xfercompl = 1; (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[(epnum)]->DOEPINT) = (doepint.d32));;
        if (pdev->cfg.dma_enable == 1)
        {
          deptsiz.d32 = (*(volatile uint32_t *)(&(pdev->regs.OUTEP_REGS[epnum]->DOEPTSIZ)));
        ...
        if (pdev->cfg.dma_enable == 1)
        {
          if((epnum == 0) && (pdev->dev.device_state == 5))
          {
      ...
      if ( doepint.b.epdisabled )
      {
        ...
        doepint.d32=0; doepint.b.epdisabled = 1; (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[(epnum)]->DOEPINT) = (doepint.d32));;
      }
      ...
      if ( doepint.b.setup )
      {
        ...
        doepint.d32=0; doepint.b.setup = 1; (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[(epnum)]->DOEPINT) = (doepint.d32));;
      }
    }
    epnum++;
    ep_intr >>= 1;
...
static uint32_t DCD_HandleRxStatusQueueLevel_ISR(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  (*(volatile uint32_t *)((&pdev->regs.GREGS->GINTMSK)) = (((((*(volatile uint32_t *)(&pdev->regs.GREGS->GINTMSK))) & ~(int_mask.d32)) | (0))));


  status.d32 = (*(volatile uint32_t *)(&pdev->regs.GREGS->GRXSTSP));
  ...
  (*(volatile uint32_t *)((&pdev->regs.GREGS->GINTMSK)) = (((((*(volatile uint32_t *)(&pdev->regs.GREGS->GINTMSK))) & ~(0)) | (int_mask.d32))));
...
static uint32_t DCD_WriteEmptyTxFifo(USB_OTG_CORE_HANDLE *pdev, uint32_t epnum)
{
  ...
  len32b = (len + 3) / 4;
  txstatus.d32 = (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[epnum]->DTXFSTS));
...
static uint32_t DCD_HandleUsbReset_ISR(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  daintmsk.ep.in = 1;
  daintmsk.ep.out = 1;
  (*(volatile uint32_t *)(&pdev->regs.DREGS->DAINTMSK) = (daintmsk.d32));

  doepmsk.b.setup = 1;
  doepmsk.b.xfercompl = 1;
  doepmsk.b.epdisabled = 1;
  (*(volatile uint32_t *)(&pdev->regs.DREGS->DOEPMSK) = (doepmsk.d32));
  ...
  (*(volatile uint32_t *)(&pdev->regs.DREGS->DIEPMSK) = (diepmsk.d32));
...
static uint32_t DCD_HandleEnumDone_ISR(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  gusbcfg.d32 = (*(volatile uint32_t *)(&pdev->regs.GREGS->GUSBCFG));
  gusbcfg.b.usbtrdtim = 0;
  (*(volatile uint32_t *)(&pdev->regs.GREGS->GUSBCFG) = (gusbcfg.d32));
...
# 881 "./lib/main/STM32_USB_OTG_Driver/src/usb_dcd_int.c"
static uint32_t DCD_IsoINIncomplete_ISR(USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_GINTSTS_TypeDef gintsts;
...
{
  uint32_t v, msk, emp;
  msk = (*(volatile uint32_t *)(&pdev->regs.DREGS->DIEPMSK));
  emp = (*(volatile uint32_t *)(&pdev->regs.DREGS->DIEPEMPMSK));
  msk |= ((emp >> epnum) & 0x1) << 7;
  v = (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[epnum]->DIEPINT)) & msk;
  return v;
}
