...
# 19 "./src/main/scheduler/scheduler.c" 2
...
# 20 "./src/main/scheduler/scheduler.c" 2
...
static __attribute__ ((section(".fastram_bss"), aligned(4))) cfTask_t *currentTask = 
# 35 "./src/main/scheduler/scheduler.c" 3 4
                                      ((void *)0)
# 35 "./src/main/scheduler/scheduler.c"
                                          ;

static __attribute__ ((section(".fastram_bss"), aligned(4))) uint32_t totalWaitingTasks;
static __attribute__ ((section(".fastram_bss"), aligned(4))) uint32_t totalWaitingTasksSamples;

__attribute__ ((section(".fastram_bss"), aligned(4))) uint16_t averageSystemLoadPercent = 0;


static __attribute__ ((section(".fastram_bss"), aligned(4))) int taskQueuePos = 0;
static __attribute__ ((section(".fastram_bss"), aligned(4))) int taskQueueSize = 0;




static __attribute__ ((section(".fastram_bss"), aligned(4))) cfTask_t* taskQueueArray[TASK_COUNT + 1];
...
# 65 "./src/main/scheduler/scheduler.c"
static 
# 65 "./src/main/scheduler/scheduler.c" 3 4
                  _Bool 
# 65 "./src/main/scheduler/scheduler.c"
                       ...
                       queueRemove(cfTask_t *task)
{
    for (int ii = 0; ii < taskQueueSize; ++ii) {
        if (taskQueueArray[ii] == task) {
            ...
            --taskQueueSize;
            return 
# 97 "./src/main/scheduler/scheduler.c" 3 4
                  1
# 97 "./src/main/scheduler/scheduler.c"
                      ;
        }
    }
    return 
...
__attribute__ ((section(".fastram_bss"), aligned(4))) timeUs_t checkFuncMaxExecutionTime;
__attribute__ ((section(".fastram_bss"), aligned(4))) timeUs_t checkFuncTotalExecutionTime;
__attribute__ ((section(".fastram_bss"), aligned(4))) timeUs_t checkFuncMovingSumExecutionTime;
...
void rescheduleTask(cfTaskId_e taskId, timeDelta_t newPeriodUs)
{
    if (taskId == TASK_SELF) {
        ...
        task->desiredPeriod = ( __extension__ ({ __typeof__(100) _left0 = (100); __typeof__(newPeriodUs) _right1 = (newPeriodUs); _left0 > _right1 ? _left0 : _right1; }));
    } else if (taskId < TASK_COUNT) {
        cfTask_t *task = &cfTasks[taskId];
        task->desiredPeriod = ( __extension__ ({ __typeof__(100) _left2 = (100); __typeof__(newPeriodUs) _right3 = (newPeriodUs); _left2 > _right3 ? _left2 : _right3; }));
    }
}

void setTaskEnabled(cfTaskId_e taskId, 
# 169 "./src/main/scheduler/scheduler.c" 3 4
                                      _Bool 
# 169 "./src/main/scheduler/scheduler.c"
                                           enabled)
{
...
# 222 "./src/main/scheduler/scheduler.c"
        ...
        if ((int32_t)(currentTimeUs - nextExecuteAt) >= 0) {
            ...
            timeToNextRealtimeTask = ( __extension__ ({ __typeof__(timeToNextRealtimeTask) _left4 = (timeToNextRealtimeTask); __typeof__(newTimeInterval) _right5 = (newTimeInterval); _left4 < _right5 ? _left4 : _right5; }));
        }
    }
    const 
# 231 "./src/main/scheduler/scheduler.c" 3 4
         _Bool 
# 231 "./src/main/scheduler/scheduler.c"
              outsideRealtimeGuardInterval = (timeToNextRealtimeTask > 0);
...
# 239 "./src/main/scheduler/scheduler.c" 3 4
                                               ((void *)0)
# 239 "./src/main/scheduler/scheduler.c"
                                                   ; task = queueNext()) {
        ...
        if (task->checkFunc) {
            ...
            if (task->dynamicPriority > 0) {
                ...
                checkFuncMovingSumExecutionTime -= checkFuncMovingSumExecutionTime / 32;
                checkFuncMovingSumExecutionTime += checkFuncExecutionTime;
                checkFuncTotalExecutionTime += checkFuncExecutionTime;
                checkFuncMaxExecutionTime = ( __extension__ ({ __typeof__(checkFuncMaxExecutionTime) _left6 = (checkFuncMaxExecutionTime); __typeof__(checkFuncExecutionTime) _right7 = (checkFuncExecutionTime); _left6 > _right7 ? _left6 : _right7; }));
        ...
        if (task->dynamicPriority > selectedTaskDynamicPriority) {
            const 
# 275 "./src/main/scheduler/scheduler.c" 3 4
                 _Bool 
# 275 "./src/main/scheduler/scheduler.c"
    ...
    if (selectedTask) {
        ...
        selectedTask->maxExecutionTime = ( __extension__ ({ __typeof__(selectedTask->maxExecutionTime) _left8 = (selectedTask->maxExecutionTime); __typeof__(taskExecutionTime) _right9 = (taskExecutionTime); _left8 > _right9 ? _left8 : _right9; }));
