...
# 26 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 33 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 35 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 39 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 41 "./src/main/cms/cms_menu_ledstrip.c" 2
...
# 43 "./src/main/cms/cms_menu_ledstrip.c" 2



static 
# 46 "./src/main/cms/cms_menu_ledstrip.c" 3 4
      _Bool 
# 46 "./src/main/cms/cms_menu_ledstrip.c"
           cmsx_FeatureLedStrip_Enabled(
# 46 "./src/main/cms/cms_menu_ledstrip.c" 3 4
                                        _Bool 
# 46 "./src/main/cms/cms_menu_ledstrip.c"
                                             *enabled)
...
{
    ((OSD_Entry){ "-- LED STRIP --", OME_Label, {.func = 
# 60 "./src/main/cms/cms_menu_ledstrip.c" 3 4
   ((void *)0)
# 60 "./src/main/cms/cms_menu_ledstrip.c"
   }, 
# 60 "./src/main/cms/cms_menu_ledstrip.c" 3 4
   ((void *)0)
# 60 "./src/main/cms/cms_menu_ledstrip.c"
...
# 61 "./src/main/cms/cms_menu_ledstrip.c" 3 4
   ((void *)0)
# 61 "./src/main/cms/cms_menu_ledstrip.c"
   }, cmsx_FeatureLedStrip_Enabled, 0 }),

    ((OSD_Entry){ "BACK", OME_Back, {.func = 
# 63 "./src/main/cms/cms_menu_ledstrip.c" 3 4
   ((void *)0)
# 63 "./src/main/cms/cms_menu_ledstrip.c"
   }, 
# 63 "./src/main/cms/cms_menu_ledstrip.c" 3 4
   ((void *)0)
# 63 "./src/main/cms/cms_menu_ledstrip.c"
   , 0 }),
    ((OSD_Entry){ 
# 64 "./src/main/cms/cms_menu_ledstrip.c" 3 4
   ((void *)0)
# 64 "./src/main/cms/cms_menu_ledstrip.c"
   , OME_END, {.func = 
# 64 "./src/main/cms/cms_menu_ledstrip.c" 3 4
   ((void *)0)
# 64 "./src/main/cms/cms_menu_ledstrip.c"
...
const CMS_Menu cmsx_menuLedstrip = {
    ...
    .onEnter = 
# 72 "./src/main/cms/cms_menu_ledstrip.c" 3 4
              ((void *)0)
# 72 "./src/main/cms/cms_menu_ledstrip.c"
                  ,
    .onExit = 
