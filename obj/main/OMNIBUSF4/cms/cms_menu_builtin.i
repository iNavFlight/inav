...
# 32 "./src/main/cms/cms_menu_builtin.c" 2
...
# 40 "./src/main/cms/cms_menu_builtin.c" 2
...
# 55 "./src/main/cms/cms_menu_builtin.c" 2
...
# 56 "./src/main/cms/cms_menu_builtin.c" 2




static char infoGitRev[8 + 1];
static char infoTargetName[] = "OMNIBUSF4";

# 1 "./src/main/msp/msp_protocol.h" 1
# 54 "./src/main/msp/msp_protocol.h"
...
# 1 "./src/main/msp/msp_protocol_v2_common.h" 1
# 18 "./src/main/msp/msp_protocol_v2_common.h"
...
# 330 "./src/main/msp/msp_protocol.h" 2
# 1 "./src/main/msp/msp_protocol_v2_sensor.h" 1
# 18 "./src/main/msp/msp_protocol_v2_sensor.h"
#define MSP2_IS_SENSOR_MESSAGE(x) ((x) >= 0x1F00 && (x) <= 0x1FFF)

#define MSP2_SENSOR_RANGEFINDER 0x1F01
#define MSP2_SENSOR_OPTIC_FLOW 0x1F02
# 331 "./src/main/msp/msp_protocol.h" 2
# 1 "./src/main/msp/msp_protocol_v2_inav.h" 1
# 21 "./src/main/msp/msp_protocol_v2_inav.h"
...
# 331 "./src/main/msp/msp_protocol.h" 2
# 64 "./src/main/cms/cms_menu_builtin.c" 2
...
# 82 "./src/main/cms/cms_menu_builtin.c"
   , 0 }),
    ((OSD_Entry){ "FWID", OME_String, {.func = 
# 83 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 83 "./src/main/cms/cms_menu_builtin.c"
   }, "INAV", 0 }),
    ((OSD_Entry){ "FWVER", OME_String, {.func = 
# 84 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 84 "./src/main/cms/cms_menu_builtin.c"
   }, "2" "." "0" "." "1", 0 }),
    ((OSD_Entry){ "GITREV", OME_String, {.func = 
# 85 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 85 "./src/main/cms/cms_menu_builtin.c"
   }, infoGitRev, 0 }),
    ((OSD_Entry){ "TARGET", OME_String, {.func = 
# 86 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 86 "./src/main/cms/cms_menu_builtin.c"
   }, infoTargetName, 0 }),

    ((OSD_Entry){ "BACK", OME_Back, {.func = 
# 88 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 88 "./src/main/cms/cms_menu_builtin.c"
   }, 
# 88 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 88 "./src/main/cms/cms_menu_builtin.c"
   , 0 }),
    ((OSD_Entry){ 
# 89 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 89 "./src/main/cms/cms_menu_builtin.c"
   , OME_END, {.func = 
# 89 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 89 "./src/main/cms/cms_menu_builtin.c"
...
static const CMS_Menu menuInfo = {
    ...
    .onExit = 
# 98 "./src/main/cms/cms_menu_builtin.c" 3 4
             ((void *)0)
# 98 "./src/main/cms/cms_menu_builtin.c"
                 ,
    .onGlobalExit = 
...
{
    ((OSD_Entry){ "--- FEATURES ---", OME_Label, {.func = 
# 107 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 107 "./src/main/cms/cms_menu_builtin.c"
   }, 
# 107 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 107 "./src/main/cms/cms_menu_builtin.c"
   , 0 }),
    ((OSD_Entry){ "BLACKBOX", OME_Submenu, {.func = 
# 108 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 108 "./src/main/cms/cms_menu_builtin.c"
   }, &cmsx_menuBlackbox, 0 }),

    ((OSD_Entry){ "NAVIGATION", OME_Submenu, {.func = 
# 110 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 110 "./src/main/cms/cms_menu_builtin.c"
   }, &cmsx_menuNavigation, 0 }),
    ...
    ((OSD_Entry){ "VTX SA", OME_Submenu, {.func = 
# 117 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 117 "./src/main/cms/cms_menu_builtin.c"
   }, &cmsx_menuVtxSmartAudio, 0 }),


    ((OSD_Entry){ "VTX TR", OME_Submenu, {.func = 
# 120 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 120 "./src/main/cms/cms_menu_builtin.c"
   }, &cmsx_menuVtxTramp, 0 }),



    ((OSD_Entry){ "LED STRIP", OME_Submenu, {.func = 
# 124 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 124 "./src/main/cms/cms_menu_builtin.c"
   }, &cmsx_menuLedstrip, 0 }),
...
# 136 "./src/main/cms/cms_menu_builtin.c"
                  ,
    .onExit = 
# 137 "./src/main/cms/cms_menu_builtin.c" 3 4
             ((void *)0)
# 137 "./src/main/cms/cms_menu_builtin.c"
                 ,
    .onGlobalExit = 
# 138 "./src/main/cms/cms_menu_builtin.c" 3 4
                   ((void *)0)
# 138 "./src/main/cms/cms_menu_builtin.c"
                       ,
...
{
    ((OSD_Entry){ "-- MAIN --", OME_Label, {.func = 
# 146 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 146 "./src/main/cms/cms_menu_builtin.c"
   }, 
# 146 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 146 "./src/main/cms/cms_menu_builtin.c"
   , 0 }),
    ...
    ((OSD_Entry){ "PID TUNING", OME_Submenu, {.func = 
# 148 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 148 "./src/main/cms/cms_menu_builtin.c"
   }, &cmsx_menuImu, 0 }),
    ((OSD_Entry){ "FEATURES", OME_Submenu, {.func = 
# 149 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 149 "./src/main/cms/cms_menu_builtin.c"
   }, &menuFeatures, 0 }),

    ((OSD_Entry){ "OSD", OME_Submenu, {.func = 
# 151 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 151 "./src/main/cms/cms_menu_builtin.c"
   }, &cmsx_menuOsd, 0 }),

    ((OSD_Entry){ "BATTERY", OME_Submenu, {.func = 
# 153 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 153 "./src/main/cms/cms_menu_builtin.c"
   }, &cmsx_menuBattery, 0 }),
    ((OSD_Entry){ "FC&FW INFO", OME_Submenu, {.func = 
# 154 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 154 "./src/main/cms/cms_menu_builtin.c"
   }, &menuInfo, 0 }),
    ((OSD_Entry){ "MISC", OME_Submenu, {.func = 
# 155 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 155 "./src/main/cms/cms_menu_builtin.c"
   }, &cmsx_menuMisc, 0 }),

    {"SAVE&REBOOT", OME_OSD_Exit, {.func = cmsMenuExit}, (void*)(2), 0},
    {"EXIT", OME_OSD_Exit, {.func = cmsMenuExit}, (void*)(0), 0},




    ((OSD_Entry){ 
# 163 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 163 "./src/main/cms/cms_menu_builtin.c"
   , OME_END, {.func = 
# 163 "./src/main/cms/cms_menu_builtin.c" 3 4
   ((void *)0)
# 163 "./src/main/cms/cms_menu_builtin.c"
...
const CMS_Menu menuMain = {
    ...
    .onEnter = 
# 171 "./src/main/cms/cms_menu_builtin.c" 3 4
              ((void *)0)
# 171 "./src/main/cms/cms_menu_builtin.c"
                  ,
    .onExit = 
# 172 "./src/main/cms/cms_menu_builtin.c" 3 4
             ((void *)0)
# 172 "./src/main/cms/cms_menu_builtin.c"
                 ,
    .onGlobalExit = 
# 173 "./src/main/cms/cms_menu_builtin.c" 3 4
                   ((void *)0)
# 173 "./src/main/cms/cms_menu_builtin.c"
                       ,
