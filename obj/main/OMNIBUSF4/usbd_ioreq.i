# 1 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_ioreq.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_ioreq.c"
# 29 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_ioreq.c"
...
uint16_t USBD_GetRxCount (USB_OTG_CORE_HANDLE *pdev ,
                           uint8_t epnum);
# 30 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_ioreq.c" 2
# 95 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_ioreq.c"
USBD_Status USBD_CtlSendData (USB_OTG_CORE_HANDLE *pdev,
                               uint8_t *pbuf,
                               uint16_t len)
{
  ...
  pdev->dev.device_state = 2;

  DCD_EP_Tx (pdev, 0, pbuf, len);

  return ret;
}
# 118 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_ioreq.c"
USBD_Status USBD_CtlContinueSendData (USB_OTG_CORE_HANDLE *pdev,
                                       uint8_t *pbuf,
                                       uint16_t len)
{
...
# 138 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_ioreq.c"
USBD_Status USBD_CtlPrepareRx (USB_OTG_CORE_HANDLE *pdev,
                                  uint8_t *pbuf,
                                  uint16_t len)
{
...
# 165 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_ioreq.c"
USBD_Status USBD_CtlContinueRx (USB_OTG_CORE_HANDLE *pdev,
                                          uint8_t *pbuf,
                                          uint16_t len)
{
...
# 225 "./lib/main/STM32_USB_Device_Library/Core/src/usbd_ioreq.c"
