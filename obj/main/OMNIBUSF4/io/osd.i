...
static const char * navigationStateMessage(void)
{
    ...
    return 
# 704 "./src/main/io/osd.c" 3 4
          ((void *)0)
# 704 "./src/main/io/osd.c"
              ;
}
...
# 761 "./src/main/io/osd.c" 3 4
                                                 _Bool 
# 761 "./src/main/io/osd.c"
...
static 
# 851 "./src/main/io/osd.c" 3 4
      _Bool 
# 851 "./src/main/io/osd.c"
...
# 997 "./src/main/io/osd.c" 3 4
                                                                           ((void *)0)
# 997 "./src/main/io/osd.c"
                                                                               ) && c != 0x20) {
...
# 1031 "./src/main/io/osd.c" 3 4
   _Bool 
# 1031 "./src/main/io/osd.c"
...
# 1068 "./src/main/io/osd.c" 3 4
                                                                                                                            _Bool 
# 1068 "./src/main/io/osd.c"
                                                                                                                                 showDecimal) {
    strcpy(buff, label);
...
static 
# 1138 "./src/main/io/osd.c" 3 4
      _Bool 
# 1138 "./src/main/io/osd.c"
           osdDrawSingleElement(uint8_t item)
{
    uint16_t pos = osdConfig()->item_pos[currentLayout][item];
    if (!((pos) & 0x0800)) {
        return 
# 1142 "./src/main/io/osd.c" 3 4
              0
# 1142 "./src/main/io/osd.c"
                   ;
    }
    ...
    case OSD_MAIN_BATT_VOLTAGE:
        ...
        return 
# 1164 "./src/main/io/osd.c" 3 4
              1
# 1164 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_CRUISE_HEADING_ERROR:
        {
            if ((armingFlags & (ARMED)) && !(flightModeFlags & (NAV_CRUISE_MODE))) {
                ...
                return 
# 1317 "./src/main/io/osd.c" 3 4
                      1
# 1317 "./src/main/io/osd.c"
                          ;
            }
    ...
    case OSD_MAP_NORTH:
        {
            ...
            return 
# 1373 "./src/main/io/osd.c" 3 4
                  1
# 1373 "./src/main/io/osd.c"
                      ;
        }
    case OSD_MAP_TAKEOFF:
        {
            ...
            return 
# 1380 "./src/main/io/osd.c" 3 4
                  1
# 1380 "./src/main/io/osd.c"
                      ;
        }
    case OSD_RADAR:
        {
            ...
            return 
# 1395 "./src/main/io/osd.c" 3 4
                  1
# 1395 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_FLYMODE:
        {
            ...
            return 
# 1528 "./src/main/io/osd.c" 3 4
                  1
# 1528 "./src/main/io/osd.c"
                      ;
        }
...
# 1545 "./src/main/io/osd.c" 3 4
                                       0
# 1545 "./src/main/io/osd.c"
                                            , 
# 1545 "./src/main/io/osd.c" 3 4
                                              ((void *)0)
# 1545 "./src/main/io/osd.c"
...
# 1580 "./src/main/io/osd.c" 3 4
                                                 ((void *)0)
# 1580 "./src/main/io/osd.c"
                                                     );
...
# 1628 "./src/main/io/osd.c" 3 4
           _Bool 
# 1628 "./src/main/io/osd.c"
                crosshairsVisible;
...
# 1675 "./src/main/io/osd.c" 3 4
               _Bool 
# 1675 "./src/main/io/osd.c"
...
# 1678 "./src/main/io/osd.c"
            ...
            return 
# 1701 "./src/main/io/osd.c" 3 4
                  1
# 1701 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_HORIZON_SIDEBARS:
        {
            ...
            return 
# 1748 "./src/main/io/osd.c" 3 4
                  1
# 1748 "./src/main/io/osd.c"
                      ;
        }
...
# 1837 "./src/main/io/osd.c"
    ...
    case OSD_VEL_XY_PIDS:
        ...
        return 
# 1842 "./src/main/io/osd.c" 3 4
              1
# 1842 "./src/main/io/osd.c"
                  ;
...
# 1851 "./src/main/io/osd.c"
    ...
    case OSD_BOARD_ALIGN_ROLL:
        ...
        return 
# 1855 "./src/main/io/osd.c" 3 4
              1
# 1855 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_BOARD_ALIGN_PITCH:
        ...
        return 
# 1859 "./src/main/io/osd.c" 3 4
              1
# 1859 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_RC_EXPO:
        ...
        return 
# 1863 "./src/main/io/osd.c" 3 4
              1
# 1863 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_RC_YAW_EXPO:
        ...
        return 
# 1867 "./src/main/io/osd.c" 3 4
              1
# 1867 "./src/main/io/osd.c"
                  ;
...
# 1871 "./src/main/io/osd.c"
    ...
    case OSD_PITCH_RATE:
        ...
        displayWriteWithAttr(osdDisplayPort, elemPosX + 4, elemPosY, buff, elemAttr);
        return 
# 1881 "./src/main/io/osd.c" 3 4
              1
# 1881 "./src/main/io/osd.c"
                  ;
...
# 1895 "./src/main/io/osd.c"
    ...
    case OSD_MANUAL_RC_EXPO:
        ...
        return 
# 1899 "./src/main/io/osd.c" 3 4
              1
# 1899 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_RC_YAW_EXPO:
        ...
        return 
# 1903 "./src/main/io/osd.c" 3 4
              1
# 1903 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_PITCH_RATE:
        ...
        displayWriteWithAttr(osdDisplayPort, elemPosX + 4, elemPosY, buff, elemAttr);
        return 
# 1913 "./src/main/io/osd.c" 3 4
              1
# 1913 "./src/main/io/osd.c"
                  ;
...
# 1927 "./src/main/io/osd.c"
    ...
    case OSD_NAV_FW_CRUISE_THR:
        ...
        return 
# 1931 "./src/main/io/osd.c" 3 4
              1
# 1931 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_NAV_FW_PITCH2THR:
        ...
        return 
# 1935 "./src/main/io/osd.c" 3 4
              1
# 1935 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_FW_MIN_THROTTLE_DOWN_PITCH_ANGLE:
        ...
        return 
# 1939 "./src/main/io/osd.c" 3 4
              1
# 1939 "./src/main/io/osd.c"
                  ;
...
# 1944 "./src/main/io/osd.c" 3 4
                                                                            1
# 1944 "./src/main/io/osd.c"
                                                                                );
            break;
        }
...
# 1958 "./src/main/io/osd.c" 3 4
                                                                             0
# 1958 "./src/main/io/osd.c"
                                                                                  );
            break;
        }
...
# 1965 "./src/main/io/osd.c" 3 4
                                                                             0
# 1965 "./src/main/io/osd.c"
                                                                                  );
            break;
        }
...
# 1972 "./src/main/io/osd.c" 3 4
                                                                             0
# 1972 "./src/main/io/osd.c"
                                                                                  );
            break;
        }
    ...
    case OSD_MESSAGES:
        {
            const char *message = 
# 2020 "./src/main/io/osd.c" 3 4
                                 ((void *)0)
# 2020 "./src/main/io/osd.c"
                                     ;
    ...
    case OSD_MAIN_BATT_CELL_VOLTAGE:
        {
            ...
            return 
# 2117 "./src/main/io/osd.c" 3 4
                  1
# 2117 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_MAIN_BATT_SAG_COMPENSATED_CELL_VOLTAGE:
        {
            ...
            return 
# 2123 "./src/main/io/osd.c" 3 4
                  1
# 2123 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_THROTTLE_POS_AUTO_THR:
        {
            osdFormatThrottlePosition(buff, 
# 2128 "./src/main/io/osd.c" 3 4
                                           1
# 2128 "./src/main/io/osd.c"
                                               , &elemAttr);
            break;
        }
...
# 2255 "./src/main/io/osd.c" 3 4
           _Bool 
# 2255 "./src/main/io/osd.c"
...
# 2279 "./src/main/io/osd.c"
    ...
    default:
        return 
# 2300 "./src/main/io/osd.c" 3 4
              0
# 2300 "./src/main/io/osd.c"
                   ;
    }

    displayWriteWithAttr(osdDisplayPort, elemPosX, elemPosY, buff, elemAttr);
    return 
# 2304 "./src/main/io/osd.c" 3 4
          1
# 2304 "./src/main/io/osd.c"
              ;
}
...
# 2494 "./src/main/io/osd.c" 3 4
                                              1
# 2494 "./src/main/io/osd.c"
                                                  ;
...
static void osdSetNextRefreshIn(uint32_t timeMs) {
    ...
    refreshWaitForResumeCmdRelease = 
# 2500 "./src/main/io/osd.c" 3 4
                                    1
# 2500 "./src/main/io/osd.c"
                                        ;
}
...
static void osdRefresh(timeUs_t currentTimeUs)
{
    ...
    if (resumeRefreshAt) {
        ...
        if (!(checkStickPosition(THR_HI) || checkStickPosition(PIT_HI)))
            refreshWaitForResumeCmdRelease = 
# 2781 "./src/main/io/osd.c" 3 4
                                            0
# 2781 "./src/main/io/osd.c"
                                                 ;
    ...
    if (!displayIsGrabbed(osdDisplayPort)) {
        if (fullRedraw) {
            displayClearScreen(osdDisplayPort);
            fullRedraw = 
# 2796 "./src/main/io/osd.c" 3 4
                        0
# 2796 "./src/main/io/osd.c"
                             ;
        }
        osdDrawNextElement();
        displayHeartbeat(osdDisplayPort);
...
{
    fullRedraw = 
# 2876 "./src/main/io/osd.c" 3 4
                1
# 2876 "./src/main/io/osd.c"
                    ;
}
...
# 2884 "./src/main/io/osd.c" 3 4
_Bool 
# 2884 "./src/main/io/osd.c"
    osdItemIsFixed(osd_items_e item)
{
