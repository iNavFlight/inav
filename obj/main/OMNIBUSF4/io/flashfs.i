...
static 
# 58 "./src/main/io/flashfs.c" 3 4
      _Bool 
# 58 "./src/main/io/flashfs.c"
           flashfsBufferIsEmpty(void)
{
...
# 107 "./src/main/io/flashfs.c" 3 4
_Bool 
# 107 "./src/main/io/flashfs.c"
    flashfsIsReady(void)
{
...
static uint32_t flashfsWriteBuffers(uint8_t const **buffers, uint32_t *bufferSizes, int bufferCount, 
# 165 "./src/main/io/flashfs.c" 3 4
                                                                                                    _Bool 
# 165 "./src/main/io/flashfs.c"
                                                                                                         sync)
{
...
# 303 "./src/main/io/flashfs.c" 3 4
_Bool 
# 303 "./src/main/io/flashfs.c"
    flashfsFlushAsync(void)
{
    if (flashfsBufferIsEmpty()) {
        return 
# 306 "./src/main/io/flashfs.c" 3 4
              1
# 306 "./src/main/io/flashfs.c"
                  ;
    }
    ...
    flashfsGetDirtyDataBuffers(buffers, bufferSizes);
    bytesWritten = flashfsWriteBuffers(buffers, bufferSizes, 2, 
# 314 "./src/main/io/flashfs.c" 3 4
                                                               0
# 314 "./src/main/io/flashfs.c"
                                                                    );
...
# 336 "./src/main/io/flashfs.c" 3 4
                                                1
# 336 "./src/main/io/flashfs.c"
                                                    );
...
void flashfsWrite(const uint8_t *data, unsigned int len, 
# 378 "./src/main/io/flashfs.c" 3 4
                                                        _Bool 
# 378 "./src/main/io/flashfs.c"
                                                             sync)
{
    ...
    if (bufferSizes[0] + bufferSizes[1] + bufferSizes[2] >= 64) {
        ...
        bytesWritten = flashfsWriteBuffers(buffers, bufferSizes, 3, 
# 398 "./src/main/io/flashfs.c" 3 4
                                                                   0
# 398 "./src/main/io/flashfs.c"
                                                                        );
...
# 417 "./src/main/io/flashfs.c" 3 4
                                                            1
# 417 "./src/main/io/flashfs.c"
                                                                );
                flashfsClearBuffer();
            } else {
...
# 514 "./src/main/io/flashfs.c" 3 4
   _Bool 
# 514 "./src/main/io/flashfs.c"
        blockErased;
    ...
    while (left < right) {
        ...
        blockErased = 
# 525 "./src/main/io/flashfs.c" 3 4
                     1
# 525 "./src/main/io/flashfs.c"
                         ;
        for (i = 0; i < FREE_BLOCK_TEST_SIZE_INTS; i++) {
            if (testBuffer.ints[i] != 0xFFFFFFFF) {
                blockErased = 
# 528 "./src/main/io/flashfs.c" 3 4
                             0
# 528 "./src/main/io/flashfs.c"
                                  ;
                break;
            }
        }
...
# 551 "./src/main/io/flashfs.c" 3 4
_Bool 
# 551 "./src/main/io/flashfs.c"
    flashfsIsEOF(void)
{
