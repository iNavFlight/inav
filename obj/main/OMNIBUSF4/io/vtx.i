...
const vtxSettingsConfig_t pgResetTemplate_vtxSettingsConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .band = 4, .channel = 1, .power = 1, .freq = 5740, .pitModeFreq = 0, .lowPowerDisarm = VTX_LOW_POWER_DISARM_OFF, }
...
# 68 "./src/main/io/vtx.c" 3 4
   _Bool 
# 68 "./src/main/io/vtx.c"
        settingsUpdated = 
# 68 "./src/main/io/vtx.c" 3 4
                          0
# 68 "./src/main/io/vtx.c"
    ...
    if (vtxSettingsConfig()->band && freq != vtxSettingsConfig()->freq) {
        ...
        settingsUpdated = 
# 74 "./src/main/io/vtx.c" 3 4
                         1
# 74 "./src/main/io/vtx.c"
                             ;
    }
    ...
    if (vtxSettingsConfig()->pitModeFreq) {
        const uint16_t constrainedPitModeFreq = ( __extension__ ({ __typeof__(vtxSettingsConfig()->pitModeFreq) _left0 = (vtxSettingsConfig()->pitModeFreq); __typeof__(5000) _right1 = (5000); _left0 > _right1 ? _left0 : _right1; }));
        if (constrainedPitModeFreq != vtxSettingsConfig()->pitModeFreq) {
            vtxSettingsConfigMutable()->pitModeFreq = constrainedPitModeFreq;
            settingsUpdated = 
# 83 "./src/main/io/vtx.c" 3 4
                             1
# 83 "./src/main/io/vtx.c"
                                 ;
        }
    }
...
# 114 "./src/main/io/vtx.c"
    if (!(armingFlags & (ARMED)) && !failsafeIsActive() &&
        ((settings.lowPowerDisarm == VTX_LOW_POWER_DISARM_ALWAYS) ||
        (settings.lowPowerDisarm == VTX_LOW_POWER_DISARM_UNTIL_FIRST_ARM && !(armingFlags & (WAS_EVER_ARMED))))) {
...
static 
# 124 "./src/main/io/vtx.c" 3 4
      _Bool 
# 124 "./src/main/io/vtx.c"
           vtxProcessBandAndChannel(vtxDevice_t *vtxDevice)
{
...
# 133 "./src/main/io/vtx.c"
    ...
    return 
# 137 "./src/main/io/vtx.c" 3 4
          0
# 137 "./src/main/io/vtx.c"
               ;
}


static 
# 141 "./src/main/io/vtx.c" 3 4
      _Bool 
# 141 "./src/main/io/vtx.c"
           vtxProcessFrequency(vtxDevice_t *vtxDevice)
{
    if(!(armingFlags & (ARMED))) {
        uint16_t vtxFreq;
        if (vtxCommonGetFrequency(vtxDevice, &vtxFreq)) {
            ...
            if (vtxFreq != settings.freq) {
                ...
                return 
# 149 "./src/main/io/vtx.c" 3 4
                      1
# 149 "./src/main/io/vtx.c"
                          ;
            }
        }
    }
    return 
# 153 "./src/main/io/vtx.c" 3 4
          0
# 153 "./src/main/io/vtx.c"
               ;
}
...
# 157 "./src/main/io/vtx.c"
           vtxProcessPower(vtxDevice_t *vtxDevice)
{
    uint8_t vtxPower;
    if (vtxCommonGetPowerIndex(vtxDevice, &vtxPower)) {
        ...
        if (vtxPower != settings.power) {
            ...
            return 
# 164 "./src/main/io/vtx.c" 3 4
                  1
# 164 "./src/main/io/vtx.c"
                      ;
        }
    }
    return 
# 167 "./src/main/io/vtx.c" 3 4
          0
# 167 "./src/main/io/vtx.c"
               ;
}

static 
# 170 "./src/main/io/vtx.c" 3 4
      _Bool 
# 170 "./src/main/io/vtx.c"
           vtxProcessPitMode(vtxDevice_t *vtxDevice)
{
    uint8_t pitOnOff;

    
# 174 "./src/main/io/vtx.c" 3 4
   _Bool 
# 174 "./src/main/io/vtx.c"
               currPmSwitchState = 
# 174 "./src/main/io/vtx.c" 3 4
                                   0
# 174 "./src/main/io/vtx.c"
                                        ;
    static 
# 175 "./src/main/io/vtx.c" 3 4
          _Bool 
# 175 "./src/main/io/vtx.c"
               prevPmSwitchState = 
# 175 "./src/main/io/vtx.c" 3 4
                                   0
# 175 "./src/main/io/vtx.c"
    ...
    if (!(armingFlags & (ARMED)) && vtxCommonGetPitMode(vtxDevice, &pitOnOff)) {
        ...
        if (currPmSwitchState != prevPmSwitchState) {
            ...
            if (currPmSwitchState) {
                ...
                if (vtxSettingsConfig()->pitModeFreq) {
                    return 
# 190 "./src/main/io/vtx.c" 3 4
                          0
# 190 "./src/main/io/vtx.c"
                               ;
                }
...
# 199 "./src/main/io/vtx.c" 3 4
                                                      1
# 199 "./src/main/io/vtx.c"
                                                          );
                        return 
...
# 200 "./src/main/io/vtx.c"
                ...
                if (pitOnOff) {
                    vtxCommonSetPitMode(vtxDevice, 
# 205 "./src/main/io/vtx.c" 3 4
                                                  0
# 205 "./src/main/io/vtx.c"
                                                       );
                    return 
# 206 "./src/main/io/vtx.c" 3 4
                          1
# 206 "./src/main/io/vtx.c"
                              ;
                }
            }
        }
    ...
    return 
# 211 "./src/main/io/vtx.c" 3 4
          0
# 211 "./src/main/io/vtx.c"
               ;
}

static 
# 214 "./src/main/io/vtx.c" 3 4
      _Bool 
# 214 "./src/main/io/vtx.c"
           vtxProcessStateUpdate(vtxDevice_t *vtxDevice)
{
    ...
    return (
# 229 "./src/main/io/vtx.c" 3 4
           _Bool
# 229 "./src/main/io/vtx.c"
...
# 246 "./src/main/io/vtx.c" 3 4
       _Bool 
# 246 "./src/main/io/vtx.c"
            vtxUpdatePending = 
# 246 "./src/main/io/vtx.c" 3 4
                               0
# 246 "./src/main/io/vtx.c"
