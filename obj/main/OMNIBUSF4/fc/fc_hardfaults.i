...
void init(void);
# 27 "./src/main/fc/fc_hardfaults.c" 2
...
# 29 "./src/main/fc/fc_hardfaults.c" 2
# 93 "./src/main/fc/fc_hardfaults.c"
void HardFault_Handler(void)
{
    ...
    do {} while (0);
    ledSet(0, 
# 104 "./src/main/fc/fc_hardfaults.c" 3 4
   0
# 104 "./src/main/fc/fc_hardfaults.c"
   );
