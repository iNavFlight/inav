...
const featureConfig_t pgResetTemplate_featureConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .enabledFeatures = (FEATURE_TX_PROF_SEL | FEATURE_BLACKBOX | FEATURE_VBAT | FEATURE_OSD) | (FEATURE_TX_PROF_SEL) }
...
# 242 "./src/main/fc/config.c"
    ...
    if (featureConfigured(FEATURE_SOFTSERIAL) && featureConfigured(FEATURE_LED_STRIP)) {
        const timerHardware_t *ledTimerHardware = timerGetByTag(((((0) + 1) << 4) | (1)), TIM_USE_ANY);
        if (ledTimerHardware != 
...
# 265 "./src/main/fc/config.c"
            ...
            const timerHardware_t *ss1TimerHardware = timerGetByTag(((((2) + 1) << 4) | (8)), TIM_USE_ANY);
            if (ss1TimerHardware != 
