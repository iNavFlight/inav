...
const telemetryConfig_t pgResetTemplate_telemetryConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .gpsNoFixLatitude = 0, .gpsNoFixLongitude = 0, .telemetry_switch = 0, .telemetry_inverted = 0, .frsky_coordinate_format = FRSKY_FORMAT_DMS, .frsky_unit = FRSKY_UNIT_METRICS, .frsky_vfas_precision = 0, .frsky_pitch_roll = 0, .report_cell_voltage = 0, .hottAlarmSoundInterval = 5, .smartportUartUnidirectional = 0, .smartportFuelUnit = SMARTPORT_FUEL_UNIT_MAH, .ibusTelemetryType = 0, .ltmUpdateRate = LTM_RATE_NORMAL, }
# 69 "./src/main/telemetry/telemetry.c"
 ;
...
# 108 "./src/main/telemetry/telemetry.c" 3 4
_Bool 
# 108 "./src/main/telemetry/telemetry.c"
    telemetryDetermineEnabledState(portSharing_e portSharing)
{
...
# 122 "./src/main/telemetry/telemetry.c" 3 4
_Bool 
# 122 "./src/main/telemetry/telemetry.c"
    telemetryCheckRxPortShared(const serialPortConfig_t *portConfig)
{
    return portConfig->functionMask & FUNCTION_RX_SERIAL && portConfig->functionMask & (FUNCTION_TELEMETRY_FRSKY | FUNCTION_TELEMETRY_LTM | FUNCTION_TELEMETRY_IBUS);
}

serialPort_t *telemetrySharedPort = 
# 127 "./src/main/telemetry/telemetry.c" 3 4
                                   ((void *)0)
# 127 "./src/main/telemetry/telemetry.c"
                                       ;
