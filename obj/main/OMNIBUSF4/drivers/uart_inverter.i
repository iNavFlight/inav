# 1 "./src/main/drivers/uart_inverter.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/uart_inverter.c"
# 18 "./src/main/drivers/uart_inverter.c"
...
# 19 "./src/main/drivers/uart_inverter.c" 2
...
# 20 "./src/main/drivers/uart_inverter.c" 2
...
# 58 "./src/main/platform.h" 2
# 22 "./src/main/drivers/uart_inverter.c" 2
...
# 24 "./src/main/drivers/uart_inverter.c" 2
...
# 25 "./src/main/drivers/uart_inverter.c" 2
...
# 28 "./src/main/drivers/uart_inverter.h"
                                                                         enable);
# 26 "./src/main/drivers/uart_inverter.c" 2



static void inverterPinSet(IO_t pin, 
# 29 "./src/main/drivers/uart_inverter.c" 3 4
                                    _Bool 
# 29 "./src/main/drivers/uart_inverter.c"
                                         on)
{
    IOWrite(pin, on);
}
...
static void initInverter(ioTag_t ioTag)
{
    ...
    IOConfigGPIO(pin, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));

    inverterPinSet(pin, 
# 40 "./src/main/drivers/uart_inverter.c" 3 4
                       0
# 40 "./src/main/drivers/uart_inverter.c"
                            );
}
...
void uartInverterInit(void)
{
    ...
    initInverter(((((2) + 1) << 4) | (0)));
# 100 "./src/main/drivers/uart_inverter.c"
}

void uartInverterSet(USART_TypeDef *USARTx, uartInverterLine_e line, 
# 102 "./src/main/drivers/uart_inverter.c" 3 4
                                                                    _Bool 
# 102 "./src/main/drivers/uart_inverter.c"
                                                                         enable)
{
    IO_t rx_pin = ((IO_t)0);
    IO_t tx_pin = ((IO_t)0);
    ...
    if (USARTx == ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000))) {
        ...
        rx_pin = IOGetByTag(((((2) + 1) << 4) | (0)));




    }
# 180 "./src/main/drivers/uart_inverter.c"
    if (rx_pin != ((IO_t)0) && (line & UART_INVERTER_LINE_RX)) {
        inverterPinSet(rx_pin, enable);
    }
    if (tx_pin != ((IO_t)0) && (line & UART_INVERTER_LINE_TX)) {
