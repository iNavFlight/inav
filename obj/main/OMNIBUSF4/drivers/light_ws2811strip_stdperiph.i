...
void ws2811LedStripHardwareInit(void)
{
    ...
    const timerHardware_t *timerHardware = timerGetByTag(((((0) + 1) << 4) | (1)), TIM_USE_ANY);
...
# 75 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    ...
    dmaRef = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070));
    dmaInit(DMA1_ST4_HANDLER, OWNER_LED_STRIP, 0);
    dmaSetHandler(DMA1_ST4_HANDLER, WS2811_DMA_IRQHandler, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), 0);
    ...
    DMA_InitStructure.DMA_Channel = ((uint32_t)0x0C000000);
