# 1 "./src/main/drivers/compass/compass_ist8308.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/compass/compass_ist8308.c"
# 18 "./src/main/drivers/compass/compass_ist8308.c"
...
# 19 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 20 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 22 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 58 "./src/main/platform.h" 2
# 24 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 28 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 30 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 31 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 33 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 34 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 35 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 44 "./src/main/drivers/exti.h"
                             enable);
# 36 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 37 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 55 "./src/main/drivers/light_led.h"
                         state);
# 38 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 40 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 41 "./src/main/drivers/compass/compass_ist8308.c" 2
...
# 43 "./src/main/drivers/compass/compass_ist8308.c" 2
...
static 
# 98 "./src/main/drivers/compass/compass_ist8308.c" 3 4
      _Bool 
# 98 "./src/main/drivers/compass/compass_ist8308.c"
           ist8308Init(magDev_t * mag)
{
    
# 100 "./src/main/drivers/compass/compass_ist8308.c" 3 4
   _Bool 
# 100 "./src/main/drivers/compass/compass_ist8308.c"
        ack = busWrite(mag->busDev, 0x41, 0x04 | (0x04<<3));
    ack = ack && busWrite(mag->busDev, 0x30, 0x20);
    ack = ack && busWrite(mag->busDev, 0x31, 0x06);
    ack = ack && busWrite(mag->busDev, 0x34, 0x00);
    delay(5);

    return 
# 106 "./src/main/drivers/compass/compass_ist8308.c" 3 4
          1
# 106 "./src/main/drivers/compass/compass_ist8308.c"
              ;
}

static 
# 109 "./src/main/drivers/compass/compass_ist8308.c" 3 4
      _Bool 
# 109 "./src/main/drivers/compass/compass_ist8308.c"
           ist8308Read(magDev_t * mag)
{
    const float LSB2FSV = 1.5;

    uint8_t buf[6];

    
# 115 "./src/main/drivers/compass/compass_ist8308.c" 3 4
   _Bool 
# 115 "./src/main/drivers/compass/compass_ist8308.c"
        ack = busReadBuf(mag->busDev, 0x11, buf, 6);
    if (!ack) {
        ...
        return 
# 122 "./src/main/drivers/compass/compass_ist8308.c" 3 4
              0
# 122 "./src/main/drivers/compass/compass_ist8308.c"
                   ;
    }
    ...
    return 
# 129 "./src/main/drivers/compass/compass_ist8308.c" 3 4
          1
# 129 "./src/main/drivers/compass/compass_ist8308.c"
              ;
}

#define DETECTION_MAX_RETRY_COUNT 5
static 
# 133 "./src/main/drivers/compass/compass_ist8308.c" 3 4
      _Bool 
# 133 "./src/main/drivers/compass/compass_ist8308.c"
...
# 139 "./src/main/drivers/compass/compass_ist8308.c" 3 4
       _Bool 
# 139 "./src/main/drivers/compass/compass_ist8308.c"
            ack = busRead(mag->busDev, 0x00, &sig);

        if (ack && sig == 0x08) {
            return 
# 142 "./src/main/drivers/compass/compass_ist8308.c" 3 4
                  1
# 142 "./src/main/drivers/compass/compass_ist8308.c"
                      ;
        }
    }

    return 
# 146 "./src/main/drivers/compass/compass_ist8308.c" 3 4
          0
# 146 "./src/main/drivers/compass/compass_ist8308.c"
               ;
}


# 149 "./src/main/drivers/compass/compass_ist8308.c" 3 4
_Bool 
# 149 "./src/main/drivers/compass/compass_ist8308.c"
    ist8308Detect(magDev_t * mag)
{
    mag->busDev = busDeviceInit(BUSTYPE_ANY, DEVHW_IST8308, mag->magSensorToUse, OWNER_COMPASS);
    if (mag->busDev == 
# 152 "./src/main/drivers/compass/compass_ist8308.c" 3 4
                      ((void *)0)
# 152 "./src/main/drivers/compass/compass_ist8308.c"
                          ) {
        return 
# 153 "./src/main/drivers/compass/compass_ist8308.c" 3 4
              0
# 153 "./src/main/drivers/compass/compass_ist8308.c"
                   ;
    }
    ...
    if (!deviceDetect(mag)) {
        ...
        return 
# 158 "./src/main/drivers/compass/compass_ist8308.c" 3 4
              0
# 158 "./src/main/drivers/compass/compass_ist8308.c"
                   ;
    }
    ...
    return 
# 164 "./src/main/drivers/compass/compass_ist8308.c" 3 4
          1
# 164 "./src/main/drivers/compass/compass_ist8308.c"
              ;
}
