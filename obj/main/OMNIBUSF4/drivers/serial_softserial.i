...
# 1 "./src/main/drivers/serial_softserial.c"
# 24 "./src/main/drivers/serial_softserial.c"
...
# 26 "./src/main/drivers/serial_softserial.c" 2
...
# 58 "./src/main/platform.h" 2
# 28 "./src/main/drivers/serial_softserial.c" 2
...
# 41 "./src/main/drivers/serial_softserial.c" 2
...
# 44 "./src/main/drivers/serial_softserial.c" 2
...
# 46 "./src/main/drivers/serial_softserial.c" 2
...
static softSerial_t softSerialPorts[1];
...
{
    if (softSerial->port.options & SERIAL_INVERTED) {
        const uint8_t pinConfig = (softSerial->port.options & SERIAL_BIDIR_NOPULL) ? ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)) : ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_DOWN) << 5));
        IOConfigGPIOAF(softSerial->rxIO, pinConfig, softSerial->timerHardware->alternateFunction);
    } else {
        const uint8_t pinConfig = (softSerial->port.options & SERIAL_BIDIR_NOPULL) ? ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)) : ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5));
        IOConfigGPIOAF(softSerial->rxIO, pinConfig, softSerial->timerHardware->alternateFunction);
    }

    softSerial->rxActive = 
# 140 "./src/main/drivers/serial_softserial.c" 3 4
                          1
# 140 "./src/main/drivers/serial_softserial.c"
                              ;
    softSerial->isSearchingForStartBit = 
# 141 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 141 "./src/main/drivers/serial_softserial.c"
                                            ;
...
static void serialInputPortDeActivate(softSerial_t *softSerial)
{
    ...
    IOConfigGPIOAF(softSerial->rxIO, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)), softSerial->timerHardware->alternateFunction);
    softSerial->rxActive = 
# 160 "./src/main/drivers/serial_softserial.c" 3 4
                          0
# 160 "./src/main/drivers/serial_softserial.c"
                               ;
}
...
static 
# 179 "./src/main/drivers/serial_softserial.c" 3 4
      _Bool 
# 179 "./src/main/drivers/serial_softserial.c"
...
static void serialTimerConfigureTimebase(const timerHardware_t *timerHardwarePtr, uint32_t baud)
{
    ...
    uint16_t mhz = baseClock / 1000000;
...
# 240 "./src/main/drivers/serial_softserial.c"
...
# 251 "./src/main/drivers/serial_softserial.c"
        ...
        IOInit(txIO, OWNER_SOFTSERIAL, RESOURCE_UART_TXRX, (portIndex + 1));
    } else {
        if (mode & MODE_RX) {
...
# 262 "./src/main/drivers/serial_softserial.c"
            ...
            IOInit(rxIO, OWNER_SOFTSERIAL, RESOURCE_UART_RX, (portIndex + 1));
        }
...
# 280 "./src/main/drivers/serial_softserial.c"
            ...
            IOInit(txIO, OWNER_SOFTSERIAL, RESOURCE_UART_TX, (portIndex + 1));
        }
    }
...
# 374 "./src/main/drivers/serial_softserial.c"
    ...
    softSerial->isTransmittingData = 
# 394 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 394 "./src/main/drivers/serial_softserial.c"
                                         ;
}
...
void prepareForNextRxByte(softSerial_t *softSerial)
{
    ...
    softSerial->rxBitIndex = 0;
    softSerial->isSearchingForStartBit = 
# 416 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 416 "./src/main/drivers/serial_softserial.c"
                                            ;
...
# 479 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 479 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 479 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 479 "./src/main/drivers/serial_softserial.c"
...
# 492 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 492 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 492 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 492 "./src/main/drivers/serial_softserial.c"
...
# 493 "./src/main/drivers/serial_softserial.c" 3 4
   _Bool 
# 493 "./src/main/drivers/serial_softserial.c"
...
# 518 "./src/main/drivers/serial_softserial.c" 3 4
                                                       0 
# 518 "./src/main/drivers/serial_softserial.c"
                                                                          : 
# 518 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1
# 518 "./src/main/drivers/serial_softserial.c"
...
# 527 "./src/main/drivers/serial_softserial.c" 3 4
                                      0
# 527 "./src/main/drivers/serial_softserial.c"
                                           ;
        return;
    }
    ...
    if (self->rxEdge == TRAILING) {
        self->rxEdge = LEADING;
        timerChConfigIC(self->timerHardware, inverted ? 
# 539 "./src/main/drivers/serial_softserial.c" 3 4
                                                       0 
# 539 "./src/main/drivers/serial_softserial.c"
                                                                          : 
# 539 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1
# 539 "./src/main/drivers/serial_softserial.c"
        ...
        timerChConfigIC(self->timerHardware, inverted ? 
# 542 "./src/main/drivers/serial_softserial.c" 3 4
                                                       1 
# 542 "./src/main/drivers/serial_softserial.c"
                                                                         : 
# 542 "./src/main/drivers/serial_softserial.c" 3 4
                                                                           0
# 542 "./src/main/drivers/serial_softserial.c"
...
# 619 "./src/main/drivers/serial_softserial.c" 3 4
_Bool 
# 619 "./src/main/drivers/serial_softserial.c"
...
static const struct serialPortVTable softSerialVTable = {
    ...
    .isConnected = 
# 632 "./src/main/drivers/serial_softserial.c" 3 4
                  ((void *)0)
# 632 "./src/main/drivers/serial_softserial.c"
                      ,
    .writeBuf = 
# 633 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)
# 633 "./src/main/drivers/serial_softserial.c"
                   ,
    .beginWrite = 
