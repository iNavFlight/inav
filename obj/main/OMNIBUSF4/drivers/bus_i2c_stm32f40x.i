        ...
        case I2C_STATE_R_TRANSFER_EQ1:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x10000040)) != RESET) {
                *i2cBusState->buf++ = I2C_ReceiveData(I2Cx);
                ...
                i2cBusState->txnOk = 
# 314 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                                    1
# 314 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                        ;
                i2cBusState->timeout = currentTicks;
                i2cBusState->state = I2C_STATE_STOPPING;
            }
        ...
        case I2C_STATE_R_TRANSFER_EQ2:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x10000004)) != RESET) {
                ...
                *i2cBusState->buf++ = I2C_ReceiveData(I2Cx);
                ...
                i2cBusState->txnOk = 
# 334 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                                    1
# 334 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                        ;
                i2cBusState->timeout = currentTicks;
                i2cBusState->state = I2C_STATE_STOPPING;
            }
            ...
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x10000004)) != RESET) {
                if (i2cBusState->len == 3) {
                    ...
                    *i2cBusState->buf++ = I2C_ReceiveData(I2Cx);
                    ...
                    i2cBusState->txnOk = 
# 366 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                                        0
# 366 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                             ;
                    i2cBusState->timeout = currentTicks;
                    i2cBusState->state = I2C_STATE_STOPPING;
                }
        ...
        case I2C_STATE_W_TRANSFER:
            if (i2cBusState->len > 0) {
                ...
                i2cBusState->timeout = currentTicks;
                i2cBusState->txnOk = 
# 432 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                                    1
# 432 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                        ;
                i2cBusState->state = I2C_STATE_STOPPING;
            }
            break;
...
uint32_t i2cTimeoutUserCallback(void)
{
    i2cErrorCount++;
    return 
# 456 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
          0
# 456 "./src/main/drivers/bus_i2c_stm32f40x.c"
               ;
}
...
# 517 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                                  1
# 517 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                      ;
...
# 534 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
_Bool 
# 534 "./src/main/drivers/bus_i2c_stm32f40x.c"
    i2cWriteBuffer(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t len, const uint8_t * data)
{

    if (!busState[device].initialized)
        return 
# 538 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
              0
# 538 "./src/main/drivers/bus_i2c_stm32f40x.c"
                   ;
...
# 555 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
_Bool 
# 555 "./src/main/drivers/bus_i2c_stm32f40x.c"
...
# 560 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
_Bool 
# 560 "./src/main/drivers/bus_i2c_stm32f40x.c"
    i2cRead(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t len, uint8_t* buf)
{

    if (!busState[device].initialized)
        return 
# 564 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
              0
# 564 "./src/main/drivers/bus_i2c_stm32f40x.c"
                   ;
