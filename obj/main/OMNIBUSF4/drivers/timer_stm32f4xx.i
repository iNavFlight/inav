# 1 "./src/main/drivers/timer_stm32f4xx.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 9 "./src/main/drivers/timer_stm32f4xx.c" 2
...
# 10 "./src/main/drivers/timer_stm32f4xx.c" 2
...
# 58 "./src/main/platform.h" 2
# 12 "./src/main/drivers/timer_stm32f4xx.c" 2
...
# 14 "./src/main/drivers/timer_stm32f4xx.c" 2
...
# 16 "./src/main/drivers/timer_stm32f4xx.c" 2
...
# 18 "./src/main/drivers/timer_stm32f4xx.c" 2
...
# 19 "./src/main/drivers/timer_stm32f4xx.c" 2
...
# 20 "./src/main/drivers/timer_stm32f4xx.c" 2
...
# 21 "./src/main/drivers/timer_stm32f4xx.c" 2
...
# 142 "./src/main/drivers/timer.h" 3 4
                                                  _Bool 
# 142 "./src/main/drivers/timer.h"
...
void timerPWMConfigChannel(TIM_TypeDef * tim, uint8_t channel, 
...
# 163 "./src/main/drivers/timer.h" 3 4
                                                                               _Bool 
# 163 "./src/main/drivers/timer.h"
                                                                                    inverted, uint16_t value);
void timerPWMStart(TIM_TypeDef * tim, uint8_t channel, 
...
# 22 "./src/main/drivers/timer_stm32f4xx.c" 2
...
extern timerConfig_t * timerConfig[14];

#define _TIM_IRQ_HANDLER2(name,i,j) void name(void) { impl_timerCaptureCompareHandler(TIM ## i, timerConfig[i - 1]); impl_timerCaptureCompareHandler(TIM ## j, timerConfig[j - 1]); } struct dummy
...
#define _TIM_IRQ_HANDLER(name,i) void name(void) { impl_timerCaptureCompareHandler(TIM ## i, timerConfig[i - 1]); } struct dummy
...
void impl_timerChConfigIC(const timerHardware_t *timHw, 
# 58 "./src/main/drivers/timer_impl.h" 3 4
                                                       _Bool 
# 58 "./src/main/drivers/timer_impl.h"
                                                            polarityRising, unsigned inputFilterTicks);
void impl_timerCaptureCompareHandler(TIM_TypeDef *tim, timerConfig_t *timerConfig);
void impl_timerPWMConfigChannel(TIM_TypeDef * tim, uint8_t channel, 
# 60 "./src/main/drivers/timer_impl.h" 3 4
                                                                   _Bool 
# 60 "./src/main/drivers/timer_impl.h"
                                                                        isNChannel, 
# 60 "./src/main/drivers/timer_impl.h" 3 4
                                                                                    _Bool 
# 60 "./src/main/drivers/timer_impl.h"
                                                                                         inverted, uint16_t value);
void impl_timerPWMStart(TIM_TypeDef * tim, unsigned channel, 
# 61 "./src/main/drivers/timer_impl.h" 3 4
                                                            _Bool 
# 61 "./src/main/drivers/timer_impl.h"
                                                                 isNChannel);
uint16_t impl_timerDmaSource(uint8_t channel);
volatile timCCR_t * impl_timerCCR(TIM_TypeDef *tim, uint8_t channel);
# 23 "./src/main/drivers/timer_stm32f4xx.c" 2



const timerDef_t timerDefinitions[14] = {

    [0] = { .tim = ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00000001))>65535L) + (8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/2+1))))), .irq = TIM1_CC_IRQn, .secondIrq = TIM1_UP_TIM10_IRQn },



    [1] = { .tim = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000001))>65535L) + (8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/2+1))))), .irq = TIM2_IRQn},



    [2] = { .tim = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000002))>65535L) + (8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/2+1))))), .irq = TIM3_IRQn},



    [3] = { .tim = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000004))>65535L) + (8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L)) >>8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L)) >>8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255))/2+1))))), .irq = TIM4_IRQn},



    [4] = { .tim = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000008))>65535L) + (8*(((((uint32_t)0x00000008))*1L >>16*((((uint32_t)0x00000008))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000008))*1L >>16*((((uint32_t)0x00000008))>65535L)) >>8*(((((uint32_t)0x00000008))*1L >>16*((((uint32_t)0x00000008))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000008))*1L >>16*((((uint32_t)0x00000008))>65535L)) >>8*(((((uint32_t)0x00000008))*1L >>16*((((uint32_t)0x00000008))>65535L))>255))/2+1))))), .irq = TIM5_IRQn},



    [5] = { .tim = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000010))>65535L) + (8*(((((uint32_t)0x00000010))*1L >>16*((((uint32_t)0x00000010))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000010))*1L >>16*((((uint32_t)0x00000010))>65535L)) >>8*(((((uint32_t)0x00000010))*1L >>16*((((uint32_t)0x00000010))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000010))*1L >>16*((((uint32_t)0x00000010))>65535L)) >>8*(((((uint32_t)0x00000010))*1L >>16*((((uint32_t)0x00000010))>65535L))>255))/2+1))))), .irq = 0},



    [6] = { .tim = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000020))>65535L) + (8*(((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L)) >>8*(((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L)) >>8*(((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L))>255))/2+1))))), .irq = 0},
    ...
    [7] = { .tim = ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00000002))>65535L) + (8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/2+1))))), .irq = TIM8_CC_IRQn, .secondIrq = TIM8_UP_TIM13_IRQn },




    [8] = { .tim = ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00010000))>65535L) + (8*(((((uint32_t)0x00010000))*1L >>16*((((uint32_t)0x00010000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00010000))*1L >>16*((((uint32_t)0x00010000))>65535L)) >>8*(((((uint32_t)0x00010000))*1L >>16*((((uint32_t)0x00010000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00010000))*1L >>16*((((uint32_t)0x00010000))>65535L)) >>8*(((((uint32_t)0x00010000))*1L >>16*((((uint32_t)0x00010000))>65535L))>255))/2+1))))), .irq = TIM1_BRK_TIM9_IRQn},



    [9] = { .tim = ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4400)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00020000))>65535L) + (8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L)) >>8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L)) >>8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255))/2+1))))), .irq = TIM1_UP_TIM10_IRQn},



    [10] = { .tim = ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4800)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00040000))>65535L) + (8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L)) >>8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L)) >>8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255))/2+1))))), .irq = TIM1_TRG_COM_TIM11_IRQn},



    [11] = { .tim = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000040))>65535L) + (8*(((((uint32_t)0x00000040))*1L >>16*((((uint32_t)0x00000040))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000040))*1L >>16*((((uint32_t)0x00000040))>65535L)) >>8*(((((uint32_t)0x00000040))*1L >>16*((((uint32_t)0x00000040))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000040))*1L >>16*((((uint32_t)0x00000040))>65535L)) >>8*(((((uint32_t)0x00000040))*1L >>16*((((uint32_t)0x00000040))>65535L))>255))/2+1))))), .irq = TIM8_BRK_TIM12_IRQn},



    [12] = { .tim = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000080))>65535L) + (8*(((((uint32_t)0x00000080))*1L >>16*((((uint32_t)0x00000080))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000080))*1L >>16*((((uint32_t)0x00000080))>65535L)) >>8*(((((uint32_t)0x00000080))*1L >>16*((((uint32_t)0x00000080))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000080))*1L >>16*((((uint32_t)0x00000080))>65535L)) >>8*(((((uint32_t)0x00000080))*1L >>16*((((uint32_t)0x00000080))>65535L))>255))/2+1))))), .irq = TIM8_UP_TIM13_IRQn},



    [13] = { .tim = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000100))>65535L) + (8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L)) >>8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L)) >>8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255))/2+1))))), .irq = TIM8_TRG_COM_TIM14_IRQn},
...
uint8_t timerClockDivisor(TIM_TypeDef *tim)
{
    ...
    if (tim == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)) || tim == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)) || tim == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)) || tim == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4400)) || tim == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4800))) {
        return 1;
    } else {
        return 2;
    }
...
void TIM1_CC_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)), timerConfig[1 - 1]); } struct dummy;
void TIM1_BRK_TIM9_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)), timerConfig[1 - 1]); impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)), timerConfig[9 - 1]); } struct dummy;
void TIM1_UP_TIM10_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)), timerConfig[1 - 1]); impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4400)), timerConfig[10 - 1]); } struct dummy;
void TIM1_TRG_COM_TIM11_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)), timerConfig[1 - 1]); impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4800)), timerConfig[11 - 1]); } struct dummy;
void TIM2_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), timerConfig[2 - 1]); } struct dummy;
void TIM3_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), timerConfig[3 - 1]); } struct dummy;
void TIM4_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), timerConfig[4 - 1]); } struct dummy;
void TIM5_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), timerConfig[5 - 1]); } struct dummy;


void TIM8_CC_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), timerConfig[8 - 1]); } struct dummy;
void TIM8_UP_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), timerConfig[8 - 1]); } struct dummy;



void TIM8_BRK_TIM12_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), timerConfig[8 - 1]); impl_timerCaptureCompareHandler(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), timerConfig[12 - 1]); } struct dummy;



void TIM8_UP_TIM13_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), timerConfig[8 - 1]); impl_timerCaptureCompareHandler(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)), timerConfig[13 - 1]); } struct dummy;



void TIM8_TRG_COM_TIM14_IRQHandler(void) { impl_timerCaptureCompareHandler(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), timerConfig[8 - 1]); impl_timerCaptureCompareHandler(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), timerConfig[14 - 1]); } struct dummy;
