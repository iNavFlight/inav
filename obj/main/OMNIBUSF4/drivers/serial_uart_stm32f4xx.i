...
# 108 "./src/main/drivers/serial_uart_stm32f4xx.c"
...
# 183 "./src/main/drivers/serial_uart_stm32f4xx.c"
static uartDevice_t uart6 =
{
    .DMAChannel = ((uint32_t)0x0A000000),
    ...
    .dev = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)),
    .rx = ((((2) + 1) << 4) | (7)),
    .tx = ((((2) + 1) << 4) | (6)),
    .af = ((uint8_t)0x08),
...
# 258 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
   ((void *)0)
# 258 "./src/main/drivers/serial_uart_stm32f4xx.c"
       ,
...
# 268 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
   ((void *)0)
# 268 "./src/main/drivers/serial_uart_stm32f4xx.c"
       ,
...
# 273 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
   ((void *)0)
# 273 "./src/main/drivers/serial_uart_stm32f4xx.c"
       ,
...
# 460 "./src/main/drivers/serial_uart_stm32f4xx.c"
uartPort_t *serialUART3(uint32_t baudRate, portMode_t mode, portOptions_t options)
{
...
# 502 "./src/main/drivers/serial_uart_stm32f4xx.c"
uartPort_t *serialUART6(uint32_t baudRate, portMode_t mode, portOptions_t options)
{
