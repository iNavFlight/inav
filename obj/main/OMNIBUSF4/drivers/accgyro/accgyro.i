# 1 "./src/main/drivers/accgyro/accgyro.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/accgyro/accgyro.c"
# 18 "./src/main/drivers/accgyro/accgyro.c"
...
# 19 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 20 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 21 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 22 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 58 "./src/main/platform.h" 2
# 24 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 26 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 27 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 28 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 30 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 31 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 33 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 44 "./src/main/drivers/exti.h"
                             enable);
# 34 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 35 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 37 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 38 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 39 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 40 "./src/main/drivers/accgyro/accgyro.c" 2
...
# 43 "./src/main/drivers/accgyro/accgyro.c" 2
...
const gyroFilterAndRateConfig_t * chooseGyroConfig(uint8_t desiredLpf, uint16_t desiredRateHz, const gyroFilterAndRateConfig_t * configs, int count)
{
    ...
    for (i = 1; i < count; i++) {
        if (( __extension__ ({ __typeof__(desiredLpf - configs[i].gyroLpf) _abs0 = (desiredLpf - configs[i].gyroLpf); _abs0 < 0 ? -_abs0 : _abs0; })) < ( __extension__ ({ __typeof__(desiredLpf - selectedLpf) _abs1 = (desiredLpf - selectedLpf); _abs1 < 0 ? -_abs1 : _abs1; }))) {
    ...
    for (i = 0; i < count; i++) {
        if ((configs[i].gyroLpf == selectedLpf) && (( __extension__ ({ __typeof__(desiredRateHz - candidate->gyroRateHz) _abs2 = (desiredRateHz - candidate->gyroRateHz); _abs2 < 0 ? -_abs2 : _abs2; })) > ( __extension__ ({ __typeof__(desiredRateHz - configs[i].gyroRateHz) _abs3 = (desiredRateHz - configs[i].gyroRateHz); _abs3 < 0 ? -_abs3 : _abs3; })))) {
            candidate = &configs[i];
        }
    }

    debugTracePrintf(
# 65 "./src/main/drivers/accgyro/accgyro.c" 3 4
   0
# 65 "./src/main/drivers/accgyro/accgyro.c"
   , "GYRO CONFIG { %d, %d } -> { %d, %d}; regs 0x%02X, 0x%02X", desiredLpf, desiredRateHz, candidate->gyroLpf, candidate->gyroRateHz, candidate->gyroConfigValues[0], candidate->gyroConfigValues[1])
...
# 79 "./src/main/drivers/accgyro/accgyro.c" 3 4
                     __builtin_offsetof (
# 79 "./src/main/drivers/accgyro/accgyro.c"
                     gyroDev_t
# 79 "./src/main/drivers/accgyro/accgyro.c" 3 4
                     , 
# 79 "./src/main/drivers/accgyro/accgyro.c"
...
# 79 "./src/main/drivers/accgyro/accgyro.c"
    ...
    gyro->dataReady = 
# 80 "./src/main/drivers/accgyro/accgyro.c" 3 4
                     1
# 80 "./src/main/drivers/accgyro/accgyro.c"
                         ;
    if (gyro->updateFn) {
        gyro->updateFn(gyro);
    }
...
# 107 "./src/main/drivers/accgyro/accgyro.c"
    IOInit(gyro->busDev->irqPin, OWNER_MPU, RESOURCE_EXTI, 0);
    IOConfigGPIO(gyro->busDev->irqPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)));

    EXTIHandlerInit(&gyro->exti, gyroIntExtiHandler);
    EXTIConfig(gyro->busDev->irqPin, &gyro->exti, (((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), EXTI_Trigger_Rising);
    EXTIEnable(gyro->busDev->irqPin, 
# 112 "./src/main/drivers/accgyro/accgyro.c" 3 4
                                    1
# 112 "./src/main/drivers/accgyro/accgyro.c"
                                        );
...
# 117 "./src/main/drivers/accgyro/accgyro.c" 3 4
_Bool 
# 117 "./src/main/drivers/accgyro/accgyro.c"
    gyroCheckDataReady(gyroDev_t* gyro)
{
    
# 119 "./src/main/drivers/accgyro/accgyro.c" 3 4
   _Bool 
# 119 "./src/main/drivers/accgyro/accgyro.c"
        ret;
    if (gyro->dataReady) {
        ret = 
# 121 "./src/main/drivers/accgyro/accgyro.c" 3 4
             1
# 121 "./src/main/drivers/accgyro/accgyro.c"
                 ;
        gyro->dataReady = 
# 122 "./src/main/drivers/accgyro/accgyro.c" 3 4
                         0
# 122 "./src/main/drivers/accgyro/accgyro.c"
                              ;
    } else {
        ret = 
# 124 "./src/main/drivers/accgyro/accgyro.c" 3 4
             0
# 124 "./src/main/drivers/accgyro/accgyro.c"
                  ;
    }
    return ret;
}
