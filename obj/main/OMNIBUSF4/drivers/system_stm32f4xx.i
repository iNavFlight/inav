# 1 "./src/main/drivers/system_stm32f4xx.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/system_stm32f4xx.c"
# 18 "./src/main/drivers/system_stm32f4xx.c"
...
# 19 "./src/main/drivers/system_stm32f4xx.c" 2
...
# 20 "./src/main/drivers/system_stm32f4xx.c" 2
...
# 21 "./src/main/drivers/system_stm32f4xx.c" 2
...
# 58 "./src/main/platform.h" 2
# 23 "./src/main/drivers/system_stm32f4xx.c" 2
...
# 44 "./src/main/drivers/exti.h"
                             enable);
# 21 "./src/main/drivers/accgyro/accgyro_mpu.h" 2
...
# 25 "./src/main/drivers/system_stm32f4xx.c" 2
...
# 27 "./src/main/drivers/system_stm32f4xx.c" 2
...
# 28 "./src/main/drivers/system_stm32f4xx.c" 2
...
void enableGPIOPowerUsageAndNoiseReductions(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin &= ~(((uint16_t)0x2000) | ((uint16_t)0x4000));
...
# 147 "./src/main/drivers/system_stm32f4xx.c" 3 4
_Bool 
# 147 "./src/main/drivers/system_stm32f4xx.c"
    isMPUSoftReset(void)
{
    if (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CSR & ((uint32_t)0x10000000))
        return 
# 150 "./src/main/drivers/system_stm32f4xx.c" 3 4
              1
# 150 "./src/main/drivers/system_stm32f4xx.c"
                  ;
    else
        return 
# 152 "./src/main/drivers/system_stm32f4xx.c" 3 4
              0
# 152 "./src/main/drivers/system_stm32f4xx.c"
                   ;
}
...
void systemInit(void)
{
    ...
    cachedRccCsrValue = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CSR;


    extern void *isr_vector_table_base;
    NVIC_SetVectorTable((uint32_t)&isr_vector_table_base, 0x0);
    RCC_AHB2PeriphClockCmd(((uint32_t)0x00000080), DISABLE);
