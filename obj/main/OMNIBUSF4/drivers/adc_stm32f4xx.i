...
static adcDevice_t adcHardware[ADCDEV_COUNT] = {
    { .ADCx = ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), .rccADC = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00000100))>65535L) + (8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L)) >>8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L)) >>8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255))/2+1))))), .rccDMA = (((RCC_AHB1) << 5) | (16*((((uint32_t)0x00400000))>65535L) + (8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L)) >>8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L)) >>8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255))/2+1))))), .DMAy_Streamx = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x070)), .channel = ((uint32_t)0x00000000), .enabled = 
