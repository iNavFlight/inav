...
# 2 "./src/main/sensors/diagnostics.c" 2
...
# 3 "./src/main/sensors/diagnostics.c" 2
...
# 58 "./src/main/platform.h" 2
# 5 "./src/main/sensors/diagnostics.c" 2
...
# 6 "./src/main/sensors/diagnostics.c" 2
...
# 8 "./src/main/sensors/diagnostics.c" 2
...
# 9 "./src/main/sensors/diagnostics.c" 2
...
# 12 "./src/main/sensors/diagnostics.c" 2
...
# 14 "./src/main/sensors/diagnostics.c" 2
...
# 15 "./src/main/sensors/diagnostics.c" 2
...
# 17 "./src/main/sensors/diagnostics.c" 2
...
# 19 "./src/main/sensors/diagnostics.c" 2
...
# 20 "./src/main/sensors/diagnostics.c" 2
...
# 21 "./src/main/sensors/diagnostics.c" 2
...
# 22 "./src/main/sensors/diagnostics.c" 2
...
# 23 "./src/main/sensors/diagnostics.c" 2
...
# 58 "./src/main/sensors/barometer.h"
    baroIsHealthy(void);
# 24 "./src/main/sensors/diagnostics.c" 2
...
# 25 "./src/main/sensors/diagnostics.c" 2
...
# 59 "./src/main/sensors/pitotmeter.h"
    pitotIsHealthy(void);
# 26 "./src/main/sensors/diagnostics.c" 2
...
# 27 "./src/main/sensors/diagnostics.c" 2
...
# 219 "./src/main/sensors/diagnostics.c" 3 4
_Bool 
# 219 "./src/main/sensors/diagnostics.c"
    isHardwareHealthy(void)
{
    ...
    if (gyroStatus == HW_SENSOR_UNAVAILABLE || gyroStatus == HW_SENSOR_UNHEALTHY)
        return 
# 232 "./src/main/sensors/diagnostics.c" 3 4
              0
# 232 "./src/main/sensors/diagnostics.c"
                   ;

    if (accStatus == HW_SENSOR_UNAVAILABLE || accStatus == HW_SENSOR_UNHEALTHY)
        return 
# 235 "./src/main/sensors/diagnostics.c" 3 4
              0
# 235 "./src/main/sensors/diagnostics.c"
                   ;

    if (baroStatus == HW_SENSOR_UNAVAILABLE || baroStatus == HW_SENSOR_UNHEALTHY)
        return 
# 238 "./src/main/sensors/diagnostics.c" 3 4
              0
# 238 "./src/main/sensors/diagnostics.c"
                   ;

    if (magStatus == HW_SENSOR_UNAVAILABLE || magStatus == HW_SENSOR_UNHEALTHY)
        return 
# 241 "./src/main/sensors/diagnostics.c" 3 4
              0
# 241 "./src/main/sensors/diagnostics.c"
                   ;

    if (rangefinderStatus == HW_SENSOR_UNAVAILABLE || rangefinderStatus == HW_SENSOR_UNHEALTHY)
        return 
# 244 "./src/main/sensors/diagnostics.c" 3 4
              0
# 244 "./src/main/sensors/diagnostics.c"
                   ;

    if (pitotStatus == HW_SENSOR_UNAVAILABLE || pitotStatus == HW_SENSOR_UNHEALTHY)
        return 
# 247 "./src/main/sensors/diagnostics.c" 3 4
              0
# 247 "./src/main/sensors/diagnostics.c"
                   ;

    if (gpsStatus == HW_SENSOR_UNAVAILABLE || gpsStatus == HW_SENSOR_UNHEALTHY)
        return 
# 250 "./src/main/sensors/diagnostics.c" 3 4
              0
# 250 "./src/main/sensors/diagnostics.c"
                   ;

    if (opflowStatus == HW_SENSOR_UNAVAILABLE || opflowStatus == HW_SENSOR_UNHEALTHY)
        return 
# 253 "./src/main/sensors/diagnostics.c" 3 4
              0
# 253 "./src/main/sensors/diagnostics.c"
                   ;

    return 
# 255 "./src/main/sensors/diagnostics.c" 3 4
          1
# 255 "./src/main/sensors/diagnostics.c"
              ;
}
