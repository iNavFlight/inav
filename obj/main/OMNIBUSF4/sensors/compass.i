...
# 23 "./src/main/drivers/compass/compass_hmc5883l.h" 3 4
_Bool 
# 23 "./src/main/drivers/compass/compass_hmc5883l.h"
    hmc5883lDetect(magDev_t * mag);
# 37 "./src/main/sensors/compass.c" 2
# 1 "./src/main/drivers/compass/compass_mag3110.h" 1
# 18 "./src/main/drivers/compass/compass_mag3110.h"
       


# 20 "./src/main/drivers/compass/compass_mag3110.h" 3 4
_Bool 
# 20 "./src/main/drivers/compass/compass_mag3110.h"
    mag3110detect(magDev_t *mag);
# 38 "./src/main/sensors/compass.c" 2
# 1 "./src/main/drivers/compass/compass_ist8310.h" 1
# 18 "./src/main/drivers/compass/compass_ist8310.h"
       


# 20 "./src/main/drivers/compass/compass_ist8310.h" 3 4
_Bool 
# 20 "./src/main/drivers/compass/compass_ist8310.h"
    ist8310Detect(magDev_t* mag);
# 39 "./src/main/sensors/compass.c" 2
# 1 "./src/main/drivers/compass/compass_ist8308.h" 1
# 18 "./src/main/drivers/compass/compass_ist8308.h"
       


# 20 "./src/main/drivers/compass/compass_ist8308.h" 3 4
_Bool 
# 20 "./src/main/drivers/compass/compass_ist8308.h"
    ist8308Detect(magDev_t* mag);
...
# 27 "./src/main/drivers/compass/compass_qmc5883l.h" 3 4
_Bool 
# 27 "./src/main/drivers/compass/compass_qmc5883l.h"
    qmc5883Detect(magDev_t *mag);
# 41 "./src/main/sensors/compass.c" 2
# 1 "./src/main/drivers/compass/compass_mpu9250.h" 1
# 18 "./src/main/drivers/compass/compass_mpu9250.h"
       


# 20 "./src/main/drivers/compass/compass_mpu9250.h" 3 4
_Bool 
# 20 "./src/main/drivers/compass/compass_mpu9250.h"
    mpu9250CompassDetect(magDev_t *mag);
# 42 "./src/main/sensors/compass.c" 2
# 1 "./src/main/drivers/compass/compass_lis3mdl.h" 1
# 18 "./src/main/drivers/compass/compass_lis3mdl.h"
...
# 23 "./src/main/drivers/compass/compass_lis3mdl.h" 3 4
_Bool 
# 23 "./src/main/drivers/compass/compass_lis3mdl.h"
    lis3mdlDetect(magDev_t* mag);
...
# 47 "./src/main/sensors/compass.c" 2
...
# 49 "./src/main/sensors/compass.c" 2
...
# 50 "./src/main/sensors/compass.c" 2
...
# 52 "./src/main/sensors/compass.c" 2
...
# 53 "./src/main/sensors/compass.c" 2
...
# 55 "./src/main/sensors/compass.c" 2
...
# 28 "./src/main/sensors/compass.h" 2
...
# 56 "./src/main/sensors/compass.c" 2
...
# 57 "./src/main/sensors/compass.c" 2


mag_t mag;

extern const compassConfig_t pgResetTemplate_compassConfig; compassConfig_t compassConfig_System; compassConfig_t compassConfig_Copy; extern const pgRegistry_t compassConfig_Registry; const pgRegistry_t compassConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 40 | (3 << 12), .size = sizeof(compassConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&compassConfig_System, .copy = (uint8_t*)&compassConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_compassConfig}, };
...
const compassConfig_t pgResetTemplate_compassConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .mag_align = ALIGN_DEFAULT, .mag_hardware = MAG_AUTODETECT, .mag_declination = 0, .mag_to_use = 0, .magCalibrationTimeLimit = 30, .rollDeciDegrees = 0, .pitchDeciDegrees = 0, .yawDeciDegrees = 0, }
# 77 "./src/main/sensors/compass.c"
 ;
...
# 83 "./src/main/sensors/compass.c" 3 4
_Bool 
# 83 "./src/main/sensors/compass.c"
    compassDetect(magDev_t *dev, magSensor_e magHardwareToUse)
{
    magSensor_e magHardware = MAG_NONE;
    requestedSensors[SENSOR_INDEX_MAG] = magHardwareToUse;

    dev->magAlign.useExternal = 
# 88 "./src/main/sensors/compass.c" 3 4
                               0
# 88 "./src/main/sensors/compass.c"
                                    ;
    ...
    case MAG_AK8975:
# 138 "./src/main/sensors/compass.c"
        if (magHardwareToUse != MAG_AUTODETECT) {
            break;
        }
        __attribute__ ((fallthrough));
    ...
    case MAG_AK8963:
# 154 "./src/main/sensors/compass.c"
        if (magHardwareToUse != MAG_AUTODETECT) {
            break;
        }
        __attribute__ ((fallthrough));
    ...
    case MAG_MPU9250:
# 233 "./src/main/sensors/compass.c"
        __attribute__ ((fallthrough));
    ...
    if (magHardware == MAG_NONE) {
        ...
        return 
# 274 "./src/main/sensors/compass.c" 3 4
              0
# 274 "./src/main/sensors/compass.c"
                   ;
    }
    ...
    return 
# 279 "./src/main/sensors/compass.c" 3 4
          1
# 279 "./src/main/sensors/compass.c"
              ;
}


# 282 "./src/main/sensors/compass.c" 3 4
_Bool 
# 282 "./src/main/sensors/compass.c"
    compassInit(void)
{
    ...
    if (!compassDetect(&mag.dev, compassConfig()->mag_hardware)) {
        return 
# 291 "./src/main/sensors/compass.c" 3 4
              0
# 291 "./src/main/sensors/compass.c"
                   ;
    }

    do {} while (0);
    const 
# 295 "./src/main/sensors/compass.c" 3 4
         _Bool 
# 295 "./src/main/sensors/compass.c"
              ret = mag.dev.init(&mag.dev);
    do {} while (0);
    ...
    if (compassConfig()->rollDeciDegrees != 0 ||
        ...
        mag.dev.magAlign.useExternal = 
# 308 "./src/main/sensors/compass.c" 3 4
                                      1
# 308 "./src/main/sensors/compass.c"
                                          ;

        fp_angles_t compassAngles = {
             .angles.roll = (((compassConfig()->rollDeciDegrees) / 10.0f) * (3.14159265358979323846f / 180.0f)),
             .angles.pitch = (((compassConfig()->pitchDeciDegrees) / 10.0f) * (3.14159265358979323846f / 180.0f)),
             .angles.yaw = (((compassConfig()->yawDeciDegrees) / 10.0f) * (3.14159265358979323846f / 180.0f)),
        };
        rotationMatrixFromAngles(&mag.dev.magAlign.externalRotation, &compassAngles);
    } else {
        mag.dev.magAlign.useExternal = 
# 317 "./src/main/sensors/compass.c" 3 4
                                      0
# 317 "./src/main/sensors/compass.c"
                                           ;
...
# 326 "./src/main/sensors/compass.c" 3 4
_Bool 
# 326 "./src/main/sensors/compass.c"
    compassIsHealthy(void)
{
...
# 331 "./src/main/sensors/compass.c" 3 4
_Bool 
# 331 "./src/main/sensors/compass.c"
    compassIsReady(void)
{
