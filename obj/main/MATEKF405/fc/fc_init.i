...
{
    ledSet(1, 
# 156 "./src/main/fc/fc_init.c" 3 4
   1
# 156 "./src/main/fc/fc_init.c"
   );
    ledSet(0, 
# 157 "./src/main/fc/fc_init.c" 3 4
   0
# 157 "./src/main/fc/fc_init.c"
   );
...
# 196 "./src/main/fc/fc_init.c"
    ...
    ledInit(
# 220 "./src/main/fc/fc_init.c" 3 4
           0
# 220 "./src/main/fc/fc_init.c"
                );
...
# 328 "./src/main/fc/fc_init.c" 3 4
                               0
# 328 "./src/main/fc/fc_init.c"
                                    ;
...
# 345 "./src/main/fc/fc_init.c" 3 4
                                    0
# 345 "./src/main/fc/fc_init.c"
                                         ;
    }
...
# 370 "./src/main/fc/fc_init.c"
   };

    beeperInit(&beeperDevConfig);
# 383 "./src/main/fc/fc_init.c"
    busInit();
    ...
    spiInit(SPIDEV_3);
# 431 "./src/main/fc/fc_init.c"
            i2cInit(I2CDEV_1);
# 465 "./src/main/fc/fc_init.c"
    ...
    if (!isMPUSoftReset()) {
        ...
        ledSet(1, 
# 497 "./src/main/fc/fc_init.c" 3 4
       1
# 497 "./src/main/fc/fc_init.c"
       );
        ledSet(0, 
...
# 498 "./src/main/fc/fc_init.c"
        ...
        ledSet(0, 
# 506 "./src/main/fc/fc_init.c" 3 4
       0
# 506 "./src/main/fc/fc_init.c"
       );
        ledSet(1, 
# 507 "./src/main/fc/fc_init.c" 3 4
       0
# 507 "./src/main/fc/fc_init.c"
       );
    }
...
# 554 "./src/main/fc/fc_init.c" 3 4
                                   ((void *)0)
# 554 "./src/main/fc/fc_init.c"
                                       ;
...
# 618 "./src/main/fc/fc_init.c" 3 4
   _Bool 
# 618 "./src/main/fc/fc_init.c"
        sdcardUseDMA = 
# 618 "./src/main/fc/fc_init.c" 3 4
                       0
# 618 "./src/main/fc/fc_init.c"
    ...
    sdcardUseDMA = !feature(FEATURE_LED_STRIP) || ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)) != ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088));
# 637 "./src/main/fc/fc_init.c"
    ...
    latchActiveFeatures();
    motorControlEnable = 
# 689 "./src/main/fc/fc_init.c" 3 4
                        1
# 689 "./src/main/fc/fc_init.c"
                            ;
    fcTasksInit();
