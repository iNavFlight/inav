# 1 "./src/main/uav_interconnect/uav_interconnect_bus.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/uav_interconnect/uav_interconnect_bus.c"
# 27 "./src/main/uav_interconnect/uav_interconnect_bus.c"
...
# 28 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 29 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 30 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 31 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 32 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 58 "./src/main/platform.h" 2
# 34 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 35 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 39 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 41 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 42 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 43 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 44 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 47 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 49 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 50 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2
...
# 52 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2

# 1 "./src/main/uav_interconnect/uav_interconnect.h" 1
# 34 "./src/main/uav_interconnect/uav_interconnect.h"
...
# 35 "./src/main/uav_interconnect/uav_interconnect.h" 2
...
# 54 "./src/main/uav_interconnect/uav_interconnect_bus.c" 2

typedef enum {
    UIB_COMMAND_IDENTIFY = (0x00 << 5),
    UIB_COMMAND_NOTIFY = (0x01 << 5),
    UIB_COMMAND_READ = (0x02 << 5),
    UIB_COMMAND_WRITE = (0x03 << 5),
    UIB_COMMAND_RES_1 = (0x04 << 5),
    UIB_COMMAND_RES_2 = (0x05 << 5),
    UIB_COMMAND_RES_3 = (0x06 << 5),
    UIB_COMMAND_RES_4 = (0x07 << 5),
} uibCommand_e;

typedef enum {
    UIB_FLAG_HAS_READ = (1 << 0),
    UIB_FLAG_HAS_WRITE = (1 << 1),
} uibDeviceFlags_e;
...
#define UIB_DISCOVERY_DELAY_US 2000000
#define UIB_GUARD_INTERVAL_US 1000
#define UIB_REFRESH_INTERVAL_US 200000

typedef struct {
    
# 80 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
   _Bool 
# 80 "./src/main/uav_interconnect/uav_interconnect_bus.c"
               allocated;
    
# 81 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
   _Bool 
# 81 "./src/main/uav_interconnect/uav_interconnect_bus.c"
               activated;
...
static 
# 109 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
      _Bool 
# 109 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                               uibInitialized = 
# 109 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                                                0
# 109 "./src/main/uav_interconnect/uav_interconnect_bus.c"
...
static uavInterconnectSlot_t slots[16];
...
static uint8_t slotDataBuffer[20];
...
static void sendWrite(timeUs_t currentTimeUs, uint8_t slot, uint8_t * data, uint8_t len)
{
    ...
    buf[32 + 2] = crc8_dvb_s2_update(0x00, &buf[0], 32 + 2);
    slotStartTimeUs = currentTimeUs;
    serialWriteBuf(busPort, buf, 32 + 3);
    uibStats.sentCommands++;
}
...
static uavInterconnectSlot_t * findDevice(uint8_t devId)
{
    ...
    return 
# 188 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
          ((void *)0)
# 188 "./src/main/uav_interconnect/uav_interconnect_bus.c"
              ;
}
...
{
    slots[slotId].allocated = 
# 203 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                             1
# 203 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                                 ;
...
static void processSlot(void)
{
    ...
    switch (cmd) {
        ...
        case UIB_COMMAND_READ:
            if ((slotDataBufferCount >= sizeof(uibPktRead_t)) && (slotDataBufferCount == ((unsigned)pkt->read.size + 4)) && (pkt->read.size <= 32)) {
        ...
        case UIB_COMMAND_WRITE:
            if ((slotDataBufferCount >= sizeof(uibPktWrite_t)) && (slotDataBufferCount == ((unsigned)pkt->write.size + 3)) && (pkt->write.size <= 32)) {
...
static void processScheduledTransactions(timeUs_t currentTimeUs)
{
    ...
    if ((currentTimeUs - refreshStartTimeUs) > 200000) {
...
static 
# 414 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
      _Bool 
# 414 "./src/main/uav_interconnect/uav_interconnect_bus.c"
           canSendNewRequest(timeUs_t currentTimeUs)
{
    return ((currentTimeUs - slotLastActivityUs) >= 1000);
}
...
# 425 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
   _Bool 
# 425 "./src/main/uav_interconnect/uav_interconnect_bus.c"
        hasNewBytes = 
# 425 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                      0
# 425 "./src/main/uav_interconnect/uav_interconnect_bus.c"
    ...
    while (serialRxBytesWaiting(busPort) > 0) {
        ...
        if (slotDataBufferCount < (int)(sizeof(slotDataBuffer) / sizeof(slotDataBuffer[0]))) {
            ...
            hasNewBytes = 
# 430 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                         1
# 430 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                             ;
        }
    ...
    if ((currentTimeUs - slotLastActivityUs) >= 1000 && slotDataBufferCount > 0) {
        uibStats.commandTimeouts++;
        slotDataBufferCount = 0;
    }


    if (hasNewBytes && slotDataBufferCount >= 4) {
        processSlot();
    }
    ...
    if (canSendNewRequest(currentTimeUs)) {
        ...
        switch (busState) {
            case STATE_INITIALIZE:
                if ((currentTimeUs - slotStartTimeUs) > 2000000) {
                    discoveryAddress = 0;
...
void uavInterconnectBusInit(void)
{
    for (int i = 0; i < 16; i++) {
        slots[i].allocated = 
# 492 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                            0
# 492 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                                 ;
        slots[i].activated = 
# 493 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                            0
# 493 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                                 ;
    }
    ...
    busPort = openSerialPort(portConfig->identifier, FUNCTION_UAV_INTERCONNECT, 
# 501 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                                                                               ((void *)0)
# 501 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                                                                                   , 
# 501 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                                                                                     ((void *)0)
# 501 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                                                                                         , baudRates[baudRateIndex], MODE_RXTX, (SERIAL_NOT_INVERTED | SERIAL_STOPBITS_1 | SERIAL_PARITY_NO | SERIAL_UNIDIR));
    if (!busPort)
        return;

    slotStartTimeUs = 0;
    uibInitialized = 
# 506 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                    1
# 506 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                        ;
}


# 509 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
_Bool 
# 509 "./src/main/uav_interconnect/uav_interconnect_bus.c"
    uavInterconnectBusIsInitialized(void)
{
...
# 514 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
_Bool 
# 514 "./src/main/uav_interconnect/uav_interconnect_bus.c"
    uibDetectAndActivateDevice(uint8_t devId)
{
    uavInterconnectSlot_t * slot = findDevice(devId);
    if (slot == 
# 517 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
               ((void *)0)
# 517 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   )
        return 
# 518 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
              0
# 518 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   ;


    slot->activated = 
# 521 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                     1
# 521 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                         ;
...
# 526 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
_Bool 
# 526 "./src/main/uav_interconnect/uav_interconnect_bus.c"
    uibRegisterDevice(uint8_t devId)
{
    int slotId = findEmptySlot();
    if (slotId >= 0) {
        registerDeviceSlot(slotId, devId, UIB_FLAG_HAS_WRITE, 0, 
# 530 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                                                                ((void *)0)
# 530 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                                                                    );
        return uibDetectAndActivateDevice(devId);
    }

    return 
# 534 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
          0
# 534 "./src/main/uav_interconnect/uav_interconnect_bus.c"
               ;
}


# 537 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
_Bool 
# 537 "./src/main/uav_interconnect/uav_interconnect_bus.c"
    uibGetDeviceParams(uint8_t devId, uint8_t * params)
{
    uavInterconnectSlot_t * slot = findDevice(devId);
    if (slot == 
# 540 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
               ((void *)0) 
# 540 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                    || params == 
# 540 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
                                 ((void *)0)
# 540 "./src/main/uav_interconnect/uav_interconnect_bus.c"
        ...
        return 
# 541 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
              0
# 541 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   ;
    ...
    return 
# 547 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
          1
# 547 "./src/main/uav_interconnect/uav_interconnect_bus.c"
              ;
}
...
timeUs_t uibGetPollRateUs(uint8_t devId)
{
    uavInterconnectSlot_t * slot = findDevice(devId);
    if (slot == 
# 553 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
               ((void *)0)
# 553 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   )
        return 0;
...
uint32_t uibGetUnansweredRequests(uint8_t devId)
{
    uavInterconnectSlot_t * slot = findDevice(devId);
    if (slot == 
# 562 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
               ((void *)0)
# 562 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   )
        return 0;
...
uint8_t uibDataAvailable(uint8_t devId)
{
    uavInterconnectSlot_t * slot = findDevice(devId);
    if (slot == 
# 571 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
               ((void *)0)
# 571 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   )
        return 0;
...
uint8_t uibRead(uint8_t devId, uint8_t * buffer, uint8_t bufSize)
{
    uavInterconnectSlot_t * slot = findDevice(devId);
    if (slot == 
# 580 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
               ((void *)0)
# 580 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   )
        return 0;
    ...
    if (!(slot->deviceFlags & UIB_FLAG_HAS_READ))
        return 
# 585 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
              0
# 585 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   ;
    ...
    memcpy(buffer, slot->rxPacket, ( __extension__ ({ __typeof__(bytes) _left0 = (bytes); __typeof__(bufSize) _right1 = (bufSize); _left0 < _right1 ? _left0 : _right1; })));
...
static 
# 598 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
      _Bool 
# 598 "./src/main/uav_interconnect/uav_interconnect_bus.c"
           slotCanWrite(const uavInterconnectSlot_t * slot)
{

    if (!(slot->deviceFlags & UIB_FLAG_HAS_WRITE))
        return 
# 602 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
              0
# 602 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   ;


    if (slot->txDataReadySize > 0)
        return 
# 606 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
              0
# 606 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   ;

    return 
# 608 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
          1
# 608 "./src/main/uav_interconnect/uav_interconnect_bus.c"
              ;
}


# 611 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
_Bool 
# 611 "./src/main/uav_interconnect/uav_interconnect_bus.c"
    uibCanWrite(uint8_t devId)
{

    uavInterconnectSlot_t * slot = findDevice(devId);
    if (slot == 
# 615 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
               ((void *)0)
# 615 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   )
        return 
# 616 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
              0
# 616 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   ;
...
# 621 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
_Bool 
# 621 "./src/main/uav_interconnect/uav_interconnect_bus.c"
    uibWrite(uint8_t devId, const uint8_t * buffer, uint8_t len)
{
    uavInterconnectSlot_t * slot = findDevice(devId);
    if (slot == 
# 624 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
               ((void *)0)
# 624 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   )
        return 
# 625 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
              0
# 625 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                   ;
    ...
    if (slotCanWrite(slot)) {
        ...
        return 
# 630 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
              1
# 630 "./src/main/uav_interconnect/uav_interconnect_bus.c"
                  ;
    }

    return 
# 633 "./src/main/uav_interconnect/uav_interconnect_bus.c" 3 4
          0
# 633 "./src/main/uav_interconnect/uav_interconnect_bus.c"
               ;
}
