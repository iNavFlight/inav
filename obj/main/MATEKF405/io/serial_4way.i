...
# 40 "./src/main/io/serial_4way.c" 2
...
# 46 "./src/main/io/serial_4way.c" 2
...
inline 
# 99 "./src/main/io/serial_4way.c" 3 4
      _Bool 
# 99 "./src/main/io/serial_4way.c"
           isMcuConnected(void)
{
...
inline 
# 104 "./src/main/io/serial_4way.c" 3 4
      _Bool 
# 104 "./src/main/io/serial_4way.c"
           isEscHi(uint8_t selEsc)
{
    return (IORead(escHardware[selEsc].io) != Bit_RESET);
}
inline 
# 108 "./src/main/io/serial_4way.c" 3 4
      _Bool 
# 108 "./src/main/io/serial_4way.c"
           isEscLo(uint8_t selEsc)
{
    return (IORead(escHardware[selEsc].io) == Bit_RESET);
}
...
#define ATMEL_DEVICE_MATCH ((pDeviceInfo->words[0] == 0x9307) || (pDeviceInfo->words[0] == 0x930A) || (pDeviceInfo->words[0] == 0x930F) || (pDeviceInfo->words[0] == 0x940B))


#define SILABS_DEVICE_MATCH ((pDeviceInfo->words[0] == 0xF310)||(pDeviceInfo->words[0] ==0xF330) || (pDeviceInfo->words[0] == 0xF410) || (pDeviceInfo->words[0] == 0xF390) || (pDeviceInfo->words[0] == 0xF850) || (pDeviceInfo->words[0] == 0xE8B1) || (pDeviceInfo->words[0] == 0xE8B2))




#define ARM_DEVICE_MATCH ((pDeviceInfo->words[0] == 0x1F06) || (pDeviceInfo->words[0] == 0x3306) || (pDeviceInfo->words[0] == 0x3406) || (pDeviceInfo->words[0] == 0x3506))
...
# 435 "./src/main/io/serial_4way.c" 3 4
   _Bool 
# 435 "./src/main/io/serial_4way.c"
        isExitScheduled = 
# 435 "./src/main/io/serial_4way.c" 3 4
                          0
# 435 "./src/main/io/serial_4way.c"
    ...
    while (1) {
        ...
        ledSet(0, 
# 444 "./src/main/io/serial_4way.c" 3 4
       1
# 444 "./src/main/io/serial_4way.c"
       );
        ...
        ledSet(1, 
# 471 "./src/main/io/serial_4way.c" 3 4
       1
# 471 "./src/main/io/serial_4way.c"
       );
        ...
        if (ACK_OUT == 0x00)
        {
            ...
            switch (CMD) {
                ...
                {
                    isExitScheduled = 
# 541 "./src/main/io/serial_4way.c" 3 4
                                     1
# 541 "./src/main/io/serial_4way.c"
                                         ;
                    break;
                }
                case 0x3F:
        ...
        ledSet(0, 
# 864 "./src/main/io/serial_4way.c" 3 4
       0
# 864 "./src/main/io/serial_4way.c"
       );
        ...
        ledSet(1, 
# 887 "./src/main/io/serial_4way.c" 3 4
       0
# 887 "./src/main/io/serial_4way.c"
       );
        if (isExitScheduled) {
            esc4wayRelease();
            return;
