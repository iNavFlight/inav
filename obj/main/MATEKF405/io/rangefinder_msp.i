# 1 "./src/main/io/rangefinder_msp.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/io/rangefinder_msp.c"
# 25 "./src/main/io/rangefinder_msp.c"
...
# 26 "./src/main/io/rangefinder_msp.c" 2
...
# 27 "./src/main/io/rangefinder_msp.c" 2
...
# 28 "./src/main/io/rangefinder_msp.c" 2
...
# 29 "./src/main/io/rangefinder_msp.c" 2
...
# 58 "./src/main/platform.h" 2
# 31 "./src/main/io/rangefinder_msp.c" 2
...
# 33 "./src/main/io/rangefinder_msp.c" 2
...
# 34 "./src/main/io/rangefinder_msp.c" 2
...
# 36 "./src/main/io/rangefinder_msp.c" 2
...
# 38 "./src/main/io/rangefinder_msp.c" 2
...
# 28 "./src/main/drivers/rangefinder/rangefinder_virtual.h" 2
...
# 41 "./src/main/io/rangefinder_msp.c" 2
...
# 42 "./src/main/io/rangefinder_msp.c" 2
...
static 
# 49 "./src/main/io/rangefinder_msp.c" 3 4
      _Bool 
# 49 "./src/main/io/rangefinder_msp.c"
           hasNewData = 
# 49 "./src/main/io/rangefinder_msp.c" 3 4
                        0
# 49 "./src/main/io/rangefinder_msp.c"
                             ;
static int32_t sensorData = (-3);

static 
# 52 "./src/main/io/rangefinder_msp.c" 3 4
      _Bool 
# 52 "./src/main/io/rangefinder_msp.c"
           mspRangefinderDetect(void)
{

    return 
# 55 "./src/main/io/rangefinder_msp.c" 3 4
          1
# 55 "./src/main/io/rangefinder_msp.c"
              ;
}
...
static int32_t mspRangefinderGetDistance(void)
{
    if (hasNewData) {
        hasNewData = 
# 69 "./src/main/io/rangefinder_msp.c" 3 4
                    0
# 69 "./src/main/io/rangefinder_msp.c"
                         ;
...
void mspRangefinderReceiveNewData(uint8_t * bufferPtr)
{
    ...
    hasNewData = 
# 82 "./src/main/io/rangefinder_msp.c" 3 4
                1
# 82 "./src/main/io/rangefinder_msp.c"
                    ;
}
