...
# 21 "./src/main/io/vtx_control.h" 2
...
# 70 "./src/main/io/vtx_tramp.c" 3 4
                                      ((void *)0)
# 70 "./src/main/io/vtx_tramp.c"
                                          ;
...
static 
# 131 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 131 "./src/main/io/vtx_tramp.c"
...
{
    trampData.setByFreqFlag = 
# 146 "./src/main/io/vtx_tramp.c" 3 4
                             1
# 146 "./src/main/io/vtx_tramp.c"
                                 ;
...
static 
# 155 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 155 "./src/main/io/vtx_tramp.c"
...
{
    trampData.setByFreqFlag = 
# 168 "./src/main/io/vtx_tramp.c" 3 4
                             0
# 168 "./src/main/io/vtx_tramp.c"
                                  ;
...
# 186 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 186 "./src/main/io/vtx_tramp.c"
    trampCommitChanges(void)
{
    if (trampStatus != TRAMP_STATUS_ONLINE) {
        return 
# 189 "./src/main/io/vtx_tramp.c" 3 4
              0
# 189 "./src/main/io/vtx_tramp.c"
                   ;
    }
           ...
           trampDevSetPowerByIndex(uint8_t index)
{
    if (index > 0 && index <= 5) {
        ...
        trampCommitChanges();
        return 
# 202 "./src/main/io/vtx_tramp.c" 3 4
              1
# 202 "./src/main/io/vtx_tramp.c"
                  ;
    }
    return 
# 204 "./src/main/io/vtx_tramp.c" 3 4
          0
# 204 "./src/main/io/vtx_tramp.c"
               ;
}
    ...
    case 'v':
        {
            ...
            if (freq != 0) {
                ...
                if (!vtx58_Freq2Bandchan(trampData.curFreq, &trampData.band, &trampData.channel)) {
                    trampData.setByFreqFlag = 
# 243 "./src/main/io/vtx_tramp.c" 3 4
                                             1
# 243 "./src/main/io/vtx_tramp.c"
                                                 ;
                }
...
static 
# 284 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 284 "./src/main/io/vtx_tramp.c"
           trampIsValidResponseCode(uint8_t code)
{
    if (code == 'r' || code == 'v' || code == 's') {
        return 
# 287 "./src/main/io/vtx_tramp.c" 3 4
              1
# 287 "./src/main/io/vtx_tramp.c"
                  ;
    } else {
        return 
# 289 "./src/main/io/vtx_tramp.c" 3 4
              0
# 289 "./src/main/io/vtx_tramp.c"
                   ;
    }
}
...
static void vtxTrampProcess(vtxDevice_t *vtxDevice, timeUs_t currentTimeUs)
{
    ...
    static 
# 370 "./src/main/io/vtx_tramp.c" 3 4
          _Bool 
# 370 "./src/main/io/vtx_tramp.c"
    ...
    case 'r':
        if (trampStatus <= TRAMP_STATUS_OFFLINE) {
            ...
            if (!initSettingsDoneFlag) {
                initSettingsDoneFlag = 
# 394 "./src/main/io/vtx_tramp.c" 3 4
                                      1
# 394 "./src/main/io/vtx_tramp.c"
                                          ;
...
# 430 "./src/main/io/vtx_tramp.c" 3 4
           _Bool 
# 430 "./src/main/io/vtx_tramp.c"
                done = 
# 430 "./src/main/io/vtx_tramp.c" 3 4
                       1
# 430 "./src/main/io/vtx_tramp.c"
...
# 437 "./src/main/io/vtx_tramp.c" 3 4
                      0
# 437 "./src/main/io/vtx_tramp.c"
                           ;
...
# 444 "./src/main/io/vtx_tramp.c" 3 4
                      0
# 444 "./src/main/io/vtx_tramp.c"
                           ;
            }
...
static 
# 492 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 492 "./src/main/io/vtx_tramp.c"
           vtxTrampIsReady(const vtxDevice_t *vtxDevice)
{
    return vtxDevice!=
# 494 "./src/main/io/vtx_tramp.c" 3 4
                     ((void *)0) 
# 494 "./src/main/io/vtx_tramp.c"
...
static 
# 527 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 527 "./src/main/io/vtx_tramp.c"
           vtxTrampGetBandAndChannel(const vtxDevice_t *vtxDevice, uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxTrampIsReady(vtxDevice)) {
        return 
# 530 "./src/main/io/vtx_tramp.c" 3 4
              0
# 530 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    *pChannel = trampData.channel;
    return 
# 536 "./src/main/io/vtx_tramp.c" 3 4
          1
# 536 "./src/main/io/vtx_tramp.c"
              ;
}

static 
# 539 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 539 "./src/main/io/vtx_tramp.c"
           vtxTrampGetPowerIndex(const vtxDevice_t *vtxDevice, uint8_t *pIndex)
{
    if (!vtxTrampIsReady(vtxDevice)) {
        return 
# 542 "./src/main/io/vtx_tramp.c" 3 4
              0
# 542 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    return 
# 554 "./src/main/io/vtx_tramp.c" 3 4
          1
# 554 "./src/main/io/vtx_tramp.c"
              ;
}

static 
# 557 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 557 "./src/main/io/vtx_tramp.c"
           vtxTrampGetPitMode(const vtxDevice_t *vtxDevice, uint8_t *pOnOff)
{
    if (!vtxTrampIsReady(vtxDevice)) {
        return 
# 560 "./src/main/io/vtx_tramp.c" 3 4
              0
# 560 "./src/main/io/vtx_tramp.c"
                   ;
    }

    *pOnOff = trampData.pitMode;
    return 
# 564 "./src/main/io/vtx_tramp.c" 3 4
          1
# 564 "./src/main/io/vtx_tramp.c"
              ;
}

static 
# 567 "./src/main/io/vtx_tramp.c" 3 4
      _Bool 
# 567 "./src/main/io/vtx_tramp.c"
           vtxTrampGetFreq(const vtxDevice_t *vtxDevice, uint16_t *pFreq)
{
    if (!vtxTrampIsReady(vtxDevice)) {
        return 
# 570 "./src/main/io/vtx_tramp.c" 3 4
              0
# 570 "./src/main/io/vtx_tramp.c"
                   ;
    }

    *pFreq = trampData.curFreq;
    return 
# 574 "./src/main/io/vtx_tramp.c" 3 4
          1
# 574 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 593 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 593 "./src/main/io/vtx_tramp.c"
    vtxTrampInit(void)
{
...
# 605 "./src/main/io/vtx_tramp.c" 3 4
                                                                                    ((void *)0)
# 605 "./src/main/io/vtx_tramp.c"
                                                                                        , 
# 605 "./src/main/io/vtx_tramp.c" 3 4
                                                                                          ((void *)0)
# 605 "./src/main/io/vtx_tramp.c"
    ...
    if (!trampSerialPort) {
        return 
# 609 "./src/main/io/vtx_tramp.c" 3 4
              0
# 609 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    return 
# 616 "./src/main/io/vtx_tramp.c" 3 4
          1
# 616 "./src/main/io/vtx_tramp.c"
              ;
}
