...
#define __TARGET__ "MATEKF405"
#define __REVISION__ "4949244"
# 1 "./src/main/io/osd.c"
...
# 149 "./src/main/target/MATEKF405/target.h"
#define USE_I2C 
...
# 1 "./obj/main/MATEKF405/settings_generated.h" 1
...
# 998 "./src/main/io/osd.c" 3 4
                                                                           ((void *)0)
# 998 "./src/main/io/osd.c"
                                                                               ) && c != 0x20) {
...
# 1032 "./src/main/io/osd.c" 3 4
   _Bool 
# 1032 "./src/main/io/osd.c"
...
# 1069 "./src/main/io/osd.c" 3 4
                                                                                                                            _Bool 
# 1069 "./src/main/io/osd.c"
                                                                                                                                 showDecimal) {
    strcpy(buff, label);
...
static 
# 1139 "./src/main/io/osd.c" 3 4
      _Bool 
# 1139 "./src/main/io/osd.c"
           osdDrawSingleElement(uint8_t item)
{
    uint16_t pos = osdConfig()->item_pos[currentLayout][item];
    if (!((pos) & 0x0800)) {
        return 
# 1143 "./src/main/io/osd.c" 3 4
              0
# 1143 "./src/main/io/osd.c"
                   ;
    }
    ...
    case OSD_MAIN_BATT_VOLTAGE:
        ...
        return 
# 1165 "./src/main/io/osd.c" 3 4
              1
# 1165 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_SAG_COMPENSATED_MAIN_BATT_VOLTAGE:
        ...
        return 
# 1169 "./src/main/io/osd.c" 3 4
              1
# 1169 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_CRUISE_HEADING_ERROR:
        {
            if ((armingFlags & (ARMED)) && !(flightModeFlags & (NAV_CRUISE_MODE))) {
                ...
                return 
# 1318 "./src/main/io/osd.c" 3 4
                      1
# 1318 "./src/main/io/osd.c"
                          ;
            }
    ...
    case OSD_CRUISE_HEADING_ADJUSTMENT:
        {
            ...
            if ((armingFlags & (ARMED)) && ((!(flightModeFlags & (NAV_CRUISE_MODE))) || !(isAdjustingPosition() || isAdjustingHeading() || (heading_adjust != 0)))) {
                displayWrite(osdDisplayPort, elemPosX, elemPosY, "      ");
                return 
# 1344 "./src/main/io/osd.c" 3 4
                      1
# 1344 "./src/main/io/osd.c"
                          ;
            }
    ...
    case OSD_MAP_NORTH:
        {
            ...
            return 
# 1374 "./src/main/io/osd.c" 3 4
                  1
# 1374 "./src/main/io/osd.c"
                      ;
        }
    case OSD_MAP_TAKEOFF:
        {
            ...
            return 
# 1381 "./src/main/io/osd.c" 3 4
                  1
# 1381 "./src/main/io/osd.c"
                      ;
        }
    case OSD_RADAR:
        {
            ...
            return 
# 1398 "./src/main/io/osd.c" 3 4
                  1
# 1398 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_FLYMODE:
        {
            ...
            return 
# 1531 "./src/main/io/osd.c" 3 4
                  1
# 1531 "./src/main/io/osd.c"
                      ;
        }
...
# 1548 "./src/main/io/osd.c" 3 4
                                       0
# 1548 "./src/main/io/osd.c"
                                            , 
# 1548 "./src/main/io/osd.c" 3 4
                                              ((void *)0)
# 1548 "./src/main/io/osd.c"
...
# 1583 "./src/main/io/osd.c" 3 4
                                                 ((void *)0)
# 1583 "./src/main/io/osd.c"
                                                     );
...
# 1631 "./src/main/io/osd.c" 3 4
           _Bool 
# 1631 "./src/main/io/osd.c"
                crosshairsVisible;
...
# 1681 "./src/main/io/osd.c"
            ...
            return 
# 1704 "./src/main/io/osd.c" 3 4
                  1
# 1704 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_HORIZON_SIDEBARS:
        {
            ...
            return 
# 1751 "./src/main/io/osd.c" 3 4
                  1
# 1751 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_VARIO:
        {
            ...
            return 
# 1790 "./src/main/io/osd.c" 3 4
                  1
# 1790 "./src/main/io/osd.c"
                      ;
        }
...
# 1854 "./src/main/io/osd.c"
    ...
    case OSD_BOARD_ALIGN_ROLL:
        ...
        return 
# 1858 "./src/main/io/osd.c" 3 4
              1
# 1858 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_BOARD_ALIGN_PITCH:
        ...
        return 
# 1862 "./src/main/io/osd.c" 3 4
              1
# 1862 "./src/main/io/osd.c"
                  ;
...
# 1866 "./src/main/io/osd.c"
    ...
    case OSD_RC_YAW_EXPO:
        ...
        return 
# 1870 "./src/main/io/osd.c" 3 4
              1
# 1870 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_THROTTLE_EXPO:
        ...
        return 
# 1874 "./src/main/io/osd.c" 3 4
              1
# 1874 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_PITCH_RATE:
        ...
        displayWriteWithAttr(osdDisplayPort, elemPosX + 4, elemPosY, buff, elemAttr);
        return 
# 1884 "./src/main/io/osd.c" 3 4
              1
# 1884 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_ROLL_RATE:
        ...
        displayWriteWithAttr(osdDisplayPort, elemPosX + 4, elemPosY, buff, elemAttr);
        return 
# 1894 "./src/main/io/osd.c" 3 4
              1
# 1894 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_YAW_RATE:
        ...
        return 
# 1898 "./src/main/io/osd.c" 3 4
              1
# 1898 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_RC_EXPO:
        ...
        return 
# 1902 "./src/main/io/osd.c" 3 4
              1
# 1902 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_RC_YAW_EXPO:
        ...
        return 
# 1906 "./src/main/io/osd.c" 3 4
              1
# 1906 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_PITCH_RATE:
        ...
        displayWriteWithAttr(osdDisplayPort, elemPosX + 4, elemPosY, buff, elemAttr);
        return 
# 1916 "./src/main/io/osd.c" 3 4
              1
# 1916 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_ROLL_RATE:
        ...
        displayWriteWithAttr(osdDisplayPort, elemPosX + 4, elemPosY, buff, elemAttr);
        return 
# 1926 "./src/main/io/osd.c" 3 4
              1
# 1926 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_MANUAL_YAW_RATE:
        ...
        return 
# 1930 "./src/main/io/osd.c" 3 4
              1
# 1930 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_NAV_FW_CRUISE_THR:
        ...
        return 
# 1934 "./src/main/io/osd.c" 3 4
              1
# 1934 "./src/main/io/osd.c"
                  ;
    ...
    case OSD_NAV_FW_PITCH2THR:
        ...
        return 
# 1938 "./src/main/io/osd.c" 3 4
              1
# 1938 "./src/main/io/osd.c"
                  ;
...
# 1954 "./src/main/io/osd.c" 3 4
                                                                            1
# 1954 "./src/main/io/osd.c"
                                                                                );
            break;
        }
...
# 1961 "./src/main/io/osd.c" 3 4
                                                                             0
# 1961 "./src/main/io/osd.c"
                                                                                  );
            break;
        }
...
# 1975 "./src/main/io/osd.c"
    ...
    case OSD_MESSAGES:
        {
            const char *message = 
# 2023 "./src/main/io/osd.c" 3 4
                                 ((void *)0)
# 2023 "./src/main/io/osd.c"
                                     ;
    ...
    case OSD_MAIN_BATT_CELL_VOLTAGE:
        {
            ...
            return 
# 2120 "./src/main/io/osd.c" 3 4
                  1
# 2120 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_MAIN_BATT_SAG_COMPENSATED_CELL_VOLTAGE:
        {
            ...
            return 
# 2126 "./src/main/io/osd.c" 3 4
                  1
# 2126 "./src/main/io/osd.c"
                      ;
        }
    ...
    case OSD_THROTTLE_POS_AUTO_THR:
        {
            osdFormatThrottlePosition(buff, 
# 2131 "./src/main/io/osd.c" 3 4
                                           1
# 2131 "./src/main/io/osd.c"
                                               , &elemAttr);
            break;
        }
...
# 2258 "./src/main/io/osd.c" 3 4
           _Bool 
# 2258 "./src/main/io/osd.c"
...
# 2282 "./src/main/io/osd.c" 3 4
           _Bool 
# 2282 "./src/main/io/osd.c"
                valid = isEstimatedWindSpeedValid();
...
static void osdSetNextRefreshIn(uint32_t timeMs) {
    ...
    refreshWaitForResumeCmdRelease = 
# 2503 "./src/main/io/osd.c" 3 4
                                    1
# 2503 "./src/main/io/osd.c"
                                        ;
}
...
static void osdRefresh(timeUs_t currentTimeUs)
{
    ...
    if (resumeRefreshAt) {
        ...
        if (!(checkStickPosition(THR_HI) || checkStickPosition(PIT_HI)))
            refreshWaitForResumeCmdRelease = 
# 2784 "./src/main/io/osd.c" 3 4
                                            0
# 2784 "./src/main/io/osd.c"
                                                 ;
    ...
    if (!displayIsGrabbed(osdDisplayPort)) {
        if (fullRedraw) {
            displayClearScreen(osdDisplayPort);
            fullRedraw = 
# 2799 "./src/main/io/osd.c" 3 4
                        0
# 2799 "./src/main/io/osd.c"
                             ;
        }
        osdDrawNextElement();
        displayHeartbeat(osdDisplayPort);
...
{
    fullRedraw = 
# 2879 "./src/main/io/osd.c" 3 4
                1
# 2879 "./src/main/io/osd.c"
                    ;
}
...
# 2887 "./src/main/io/osd.c" 3 4
_Bool 
# 2887 "./src/main/io/osd.c"
    osdItemIsFixed(osd_items_e item)
{
