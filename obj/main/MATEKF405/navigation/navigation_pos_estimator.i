...
# 19 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 20 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 21 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 22 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 58 "./src/main/platform.h" 2
# 24 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 28 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 29 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 31 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 32 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 35 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 37 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 39 "./src/main/navigation/navigation_pos_estimator.c" 2
...
void imuInit(void);
# 41 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 43 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 45 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 29 "./src/main/navigation/navigation_private.h" 2
...
# 46 "./src/main/navigation/navigation_pos_estimator.c" 2
# 1 "./src/main/navigation/navigation_pos_estimator_private.h" 1
# 26 "./src/main/navigation/navigation_pos_estimator_private.h"
...
# 27 "./src/main/navigation/navigation_pos_estimator_private.h" 2
...
#define INAV_SURFACE_TIMEOUT_MS 300
...
# 59 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
   _Bool 
# 59 "./src/main/navigation/navigation_pos_estimator_private.h"
               glitchDetected;
    
# 60 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
   _Bool 
# 60 "./src/main/navigation/navigation_pos_estimator_private.h"
               glitchRecovery;
...
# 93 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
   _Bool 
# 93 "./src/main/navigation/navigation_pos_estimator_private.h"
               isValid;
    float quality;
    float flowRate[2];
    float bodyRate[2];
...
# 121 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
   _Bool 
# 121 "./src/main/navigation/navigation_pos_estimator_private.h"
...
# 137 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
   _Bool 
# 137 "./src/main/navigation/navigation_pos_estimator_private.h"
               isBaroGroundValid;
...
extern 
# 173 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
      _Bool 
# 173 "./src/main/navigation/navigation_pos_estimator_private.h"
           estimationCalculateCorrection_XY_FLOW(estimationContext_t * ctx);
# 47 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 49 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 58 "./src/main/sensors/barometer.h"
    baroIsHealthy(void);
# 50 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 51 "./src/main/navigation/navigation_pos_estimator.c" 2
...
# 59 "./src/main/sensors/pitotmeter.h"
    pitotIsHealthy(void);
# 52 "./src/main/navigation/navigation_pos_estimator.c" 2
# 1 "./src/main/sensors/opflow.h" 1
# 25 "./src/main/sensors/opflow.h"
       



# 1 "./src/main/drivers/opflow/opflow.h" 1
# 25 "./src/main/drivers/opflow/opflow.h"
...
# 30 "./src/main/sensors/opflow.h" 2
...
extern opticalFlowConfig_t opticalFlowConfig_System; extern opticalFlowConfig_t opticalFlowConfig_Copy; static inline const opticalFlowConfig_t* opticalFlowConfig(void) { return &opticalFlowConfig_System; } static inline opticalFlowConfig_t* opticalFlowConfigMutable(void) { return &opticalFlowConfig_System; } struct _dummy;
...
# 57 "./src/main/sensors/opflow.h" 3 4
   _Bool 
# 57 "./src/main/sensors/opflow.h"
                   isHwHealty;
    float flowRate[2];
    float bodyRate[2];
...
# 70 "./src/main/sensors/opflow.h" 3 4
_Bool 
# 70 "./src/main/sensors/opflow.h"
    opflowInit(void);
void opflowUpdate(timeUs_t currentTimeUs);

# 72 "./src/main/sensors/opflow.h" 3 4
_Bool 
# 72 "./src/main/sensors/opflow.h"
    opflowIsHealthy(void);
# 53 "./src/main/navigation/navigation_pos_estimator.c" 2

navigationPosEstimator_t posEstimator;

extern const positionEstimationConfig_t pgResetTemplate_positionEstimationConfig; positionEstimationConfig_t positionEstimationConfig_System; positionEstimationConfig_t positionEstimationConfig_Copy; extern const pgRegistry_t positionEstimationConfig_Registry; const pgRegistry_t positionEstimationConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 1001 | (3 << 12), .size = sizeof(positionEstimationConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&positionEstimationConfig_System, .copy = (uint8_t*)&positionEstimationConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_positionEstimationConfig}, };

const positionEstimationConfig_t pgResetTemplate_positionEstimationConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .automatic_mag_declination = 1, .reset_altitude_type = NAV_RESET_ON_FIRST_ARM, .reset_home_type = NAV_RESET_ON_EACH_ARM, .gravity_calibration_tolerance = 5, .use_gps_velned = 1, .allow_dead_reckoning = 0, .max_surface_altitude = 200, .w_z_baro_p = 0.35f, .w_z_surface_p = 3.500f, .w_z_surface_v = 6.100f, .w_z_gps_p = 0.2f, .w_z_gps_v = 0.1f, .w_xy_gps_p = 1.0f, .w_xy_gps_v = 2.0f, .w_xy_flow_p = 1.0f, .w_xy_flow_v = 2.0f, .w_z_res_v = 0.5f, .w_xy_res_v = 0.5f, .w_acc_bias = 0.01f, .max_eph_epv = 1000.0f, .baro_epv = 100.0f }
# 90 "./src/main/navigation/navigation_pos_estimator.c"
 ;
...
static 
# 94 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 94 "./src/main/navigation/navigation_pos_estimator.c"
           updateTimer(navigationTimer_t * tim, timeUs_t interval, timeUs_t currentTimeUs)
{
    if ((currentTimeUs - tim->lastTriggeredTime) >= interval) {
        ...
        return 
# 99 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              1
# 99 "./src/main/navigation/navigation_pos_estimator.c"
                  ;
    }
    else {
        return 
# 102 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              0
# 102 "./src/main/navigation/navigation_pos_estimator.c"
                   ;
    }
}

static 
# 106 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 106 "./src/main/navigation/navigation_pos_estimator.c"
           shouldResetReferenceAltitude(void)
{
    switch ((nav_reset_type_e)positionEstimationConfig()->reset_altitude_type) {
        case NAV_RESET_NEVER:
            return 
# 110 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                  0
# 110 "./src/main/navigation/navigation_pos_estimator.c"
                       ;
        case NAV_RESET_ON_FIRST_ARM:
            return !(armingFlags & (ARMED)) && !(armingFlags & (WAS_EVER_ARMED));
        case NAV_RESET_ON_EACH_ARM:
            return !(armingFlags & (ARMED));
    }

    return 
# 117 "./src/main/navigation/navigation_pos_estimator.c" 3 4
          0
# 117 "./src/main/navigation/navigation_pos_estimator.c"
               ;
}
# 127 "./src/main/navigation/navigation_pos_estimator.c"
static timeUs_t getGPSDeltaTimeFilter(timeUs_t dTus)
{
    if (dTus >= 225000 && dTus <= 275000) return (1000000 / (4));
    if (dTus >= 180000 && dTus <= 220000) return (1000000 / (5));
    if (dTus >= 90000 && dTus <= 110000) return (1000000 / (10));
    if (dTus >= 45000 && dTus <= 55000) return (1000000 / (20));
    if (dTus >= 30000 && dTus <= 36000) return (1000000 / (30));
    if (dTus >= 23000 && dTus <= 27000) return (1000000 / (40));
...
static 
# 140 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 140 "./src/main/navigation/navigation_pos_estimator.c"
           detectGPSGlitch(timeUs_t currentTimeUs)
{
...
# 146 "./src/main/navigation/navigation_pos_estimator.c" 3 4
   _Bool 
# 146 "./src/main/navigation/navigation_pos_estimator.c"
        isGlitching = 
# 146 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                      0
# 146 "./src/main/navigation/navigation_pos_estimator.c"
    ...
    if (previousTime == 0) {
        isGlitching = 
# 149 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                     0
# 149 "./src/main/navigation/navigation_pos_estimator.c"
                          ;
    }
    else {
        ...
        gpsDistance = sqrtf(((predictedGpsPosition.x - lastKnownGoodPosition.x)*(predictedGpsPosition.x - lastKnownGoodPosition.x)) + ((predictedGpsPosition.y - lastKnownGoodPosition.y)*(predictedGpsPosition.y - lastKnownGoodPosition.y)));
        if (gpsDistance <= (250.0f + 0.5f * 1000.0f * dT * dT)) {
            isGlitching = 
# 163 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                         0
# 163 "./src/main/navigation/navigation_pos_estimator.c"
                              ;
        }
        else {
            isGlitching = 
# 166 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                         1
# 166 "./src/main/navigation/navigation_pos_estimator.c"
                             ;
        }
    }
...
void onNewGPSData(void)
{
    ...
    static 
# 190 "./src/main/navigation/navigation_pos_estimator.c" 3 4
          _Bool 
# 190 "./src/main/navigation/navigation_pos_estimator.c"
               isFirstGPSUpdate = 
# 190 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                  1
# 190 "./src/main/navigation/navigation_pos_estimator.c"
    ...
    if (sensors(SENSOR_GPS)) {
        if (!(stateFlags & (GPS_FIX))) {
            isFirstGPSUpdate = 
# 201 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                              1
# 201 "./src/main/navigation/navigation_pos_estimator.c"
                                  ;
            return;
        }
        ...
        if ((currentTimeUs - lastGPSNewDataTime) > ((1500) * 1000)) {
            isFirstGPSUpdate = 
# 206 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                              1
# 206 "./src/main/navigation/navigation_pos_estimator.c"
                                  ;
        }
        ...
        static 
# 211 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              _Bool 
# 211 "./src/main/navigation/navigation_pos_estimator.c"
                   magDeclinationSet = 
# 211 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                       0
# 211 "./src/main/navigation/navigation_pos_estimator.c"
        ...
        if (positionEstimationConfig()->automatic_mag_declination && !magDeclinationSet) {
            ...
            magDeclinationSet = 
# 214 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                               1
# 214 "./src/main/navigation/navigation_pos_estimator.c"
                                   ;
        }
        ...
        if (posControl.gpsOrigin.valid) {
            ...
            if (!isFirstGPSUpdate) {
                float dT = ((getGPSDeltaTimeFilter(currentTimeUs - lastGPSNewDataTime)) * 1e-6f);


                float gpsScaleLonDown = constrainf(cos_approx((( __extension__ ({ __typeof__(gpsSol.llh.lat) _abs0 = (gpsSol.llh.lat); _abs0 < 0 ? -_abs0 : _abs0; })) / 10000000.0f) * 0.0174532925f), 0.01f, 1.0f);
                if (positionEstimationConfig()->use_gps_velned && gpsSol.flags.validVelNE) {
                    ...
                    posEstimator.gps.vel.x = (posEstimator.gps.vel.x + (1.113195f * (gpsSol.llh.lat - previousLat) / dT)) / 2.0f;
                    posEstimator.gps.vel.y = (posEstimator.gps.vel.y + (gpsScaleLonDown * 1.113195f * (gpsSol.llh.lon - previousLon) / dT)) / 2.0f;
                }

                if (positionEstimationConfig()->use_gps_velned && gpsSol.flags.validVelD) {
                    posEstimator.gps.vel.z = - gpsSol.velNED[2];
                }
                else {
                ...
                if (detectGPSGlitch(currentTimeUs)) {
                    posEstimator.gps.glitchRecovery = 
# 258 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     0
# 258 "./src/main/navigation/navigation_pos_estimator.c"
                                                          ;
                    posEstimator.gps.glitchDetected = 
# 259 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     1
# 259 "./src/main/navigation/navigation_pos_estimator.c"
                                                         ;
                }
                else {
                    ...
                    posEstimator.gps.glitchDetected = 
# 264 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     0
# 264 "./src/main/navigation/navigation_pos_estimator.c"
                                                          ;
                }
                ...
                if (gpsSol.flags.validEPE) {
                    ...
                    posEstimator.gps.eph = 200.0f;
                    posEstimator.gps.epv = 500.0f;
                }
            ...
            isFirstGPSUpdate = 
# 285 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                              0
# 285 "./src/main/navigation/navigation_pos_estimator.c"
                                   ;
...
static void updatePitotTopic(timeUs_t currentTimeUs)
{
    ...
    if (updateTimer(&pitotUpdateTimer, (1000000 / (10)), currentTimeUs)) {
...
{
    static float calibratedGravityCMSS = 980.665f;
    ...
    if (!isImuReady()) {
        ...
        posEstimator.imu.gravityCalibrationComplete = 
# 359 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     0
# 359 "./src/main/navigation/navigation_pos_estimator.c"
                                                          ;
    }
    else {
        fpVector3_t accelBF;
        ...
        if (!(armingFlags & (ARMED)) && !posEstimator.imu.gravityCalibrationComplete) {
            ...
            if (( __extension__ ({ __typeof__(gravityOffsetError) _abs1 = (gravityOffsetError); _abs1 < 0 ? -_abs1 : _abs1; })) < positionEstimationConfig()->gravity_calibration_tolerance) {
                if ((millis() - gravityCalibrationTimeout) > 250) {
                    posEstimator.imu.gravityCalibrationComplete = 
# 390 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                                 1
# 390 "./src/main/navigation/navigation_pos_estimator.c"
                                                                     ;
                }
            }
            else {
...
static 
# 422 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 422 "./src/main/navigation/navigation_pos_estimator.c"
           navIsAccelerationUsable(void)
{
    return 
# 424 "./src/main/navigation/navigation_pos_estimator.c" 3 4
          1
# 424 "./src/main/navigation/navigation_pos_estimator.c"
              ;
}

static 
# 427 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 427 "./src/main/navigation/navigation_pos_estimator.c"
           navIsHeadingUsable(void)
{
    if (sensors(SENSOR_GPS)) {
...
static uint32_t calculateCurrentValidityFlags(timeUs_t currentTimeUs)
{
    ...
    if (sensors(SENSOR_GPS) && posControl.gpsOrigin.valid &&
        ((currentTimeUs - posEstimator.gps.lastUpdateTime) <= ((1500) * 1000)) &&
    ...
    if (sensors(SENSOR_BARO) && ((currentTimeUs - posEstimator.baro.lastUpdateTime) <= ((200) * 1000))) {
        newFlags |= EST_BARO_VALID;
    }

    if (sensors(SENSOR_RANGEFINDER) && ((currentTimeUs - posEstimator.surface.lastUpdateTime) <= ((300) * 1000))) {
        newFlags |= EST_SURFACE_VALID;
    }

    if (sensors(SENSOR_OPFLOW) && posEstimator.flow.isValid && ((currentTimeUs - posEstimator.flow.lastUpdateTime) <= ((200) * 1000))) {
...
static void estimationPredict(estimationContext_t * ctx)
{
    ...
    if ((ctx->newFlags & EST_Z_VALID)) {
        ...
        posEstimator.est.pos.z += posEstimator.imu.accelNEU.z * ((ctx->dt)*(ctx->dt)) / 2.0f;
    ...
    if ((ctx->newFlags & EST_XY_VALID)) {
        ...
        if (navIsHeadingUsable() && navIsAccelerationUsable()) {
            posEstimator.est.pos.x += posEstimator.imu.accelNEU.x * ((ctx->dt)*(ctx->dt)) / 2.0f;
            posEstimator.est.pos.y += posEstimator.imu.accelNEU.y * ((ctx->dt)*(ctx->dt)) / 2.0f;
...
static 
# 503 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 503 "./src/main/navigation/navigation_pos_estimator.c"
           estimationCalculateCorrection_Z(estimationContext_t * ctx)
{
    if (ctx->newFlags & EST_BARO_VALID) {
        ...
        if (!(armingFlags & (ARMED))) {
            ...
            posEstimator.state.isBaroGroundValid = 
# 510 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                  1
# 510 "./src/main/navigation/navigation_pos_estimator.c"
                                                      ;
            posEstimator.state.baroGroundTimeout = currentTimeUs + 250000;
        }
        else {
            if (posEstimator.est.vel.z > 15) {
                if (currentTimeUs > posEstimator.state.baroGroundTimeout) {
                    posEstimator.state.isBaroGroundValid = 
# 516 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                          0
# 516 "./src/main/navigation/navigation_pos_estimator.c"
                                                               ;
                }
            }
            else {
...
# 525 "./src/main/navigation/navigation_pos_estimator.c" 3 4
       _Bool 
# 525 "./src/main/navigation/navigation_pos_estimator.c"
            isAirCushionEffectDetected = (armingFlags & (ARMED)) &&
        ...
        ctx->estVelCorr.z += baroAltResidual * ((positionEstimationConfig()->w_z_baro_p)*(positionEstimationConfig()->w_z_baro_p)) * ctx->dt;
        ...
        if (!isAirCushionEffectDetected) {
            ctx->accBiasCorr.z -= baroAltResidual * ((positionEstimationConfig()->w_z_baro_p)*(positionEstimationConfig()->w_z_baro_p));
        }

        return 
# 549 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              1
# 549 "./src/main/navigation/navigation_pos_estimator.c"
                  ;
    }
    else if ((stateFlags & (FIXED_WING)) && (ctx->newFlags & EST_GPS_Z_VALID)) {
        ...
        if (!(ctx->newFlags & EST_Z_VALID)) {
            ...
            ctx->estVelCorr.z += gpsAltResudual * ((positionEstimationConfig()->w_z_gps_p)*(positionEstimationConfig()->w_z_gps_p)) * ctx->dt;
            ctx->estVelCorr.z += (posEstimator.gps.vel.z - posEstimator.est.vel.z) * positionEstimationConfig()->w_z_gps_v * ctx->dt;
            ctx->newEPV = updateEPE(posEstimator.est.epv, ctx->dt, ( __extension__ ({ __typeof__(posEstimator.gps.epv) _left2 = (posEstimator.gps.epv); __typeof__(gpsAltResudual) _right3 = (gpsAltResudual); _left2 > _right3 ? _left2 : _right3; })), positionEstimationConfig()->w_z_gps_p);


            ctx->accBiasCorr.z -= gpsAltResudual * ((positionEstimationConfig()->w_z_gps_p)*(positionEstimationConfig()->w_z_gps_p));
        }

        return 
# 572 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              1
# 572 "./src/main/navigation/navigation_pos_estimator.c"
                  ;
    }

    return 
# 575 "./src/main/navigation/navigation_pos_estimator.c" 3 4
          0
# 575 "./src/main/navigation/navigation_pos_estimator.c"
               ;
}

static 
# 578 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 578 "./src/main/navigation/navigation_pos_estimator.c"
           estimationCalculateCorrection_XY_GPS(estimationContext_t * ctx)
{
    if (ctx->newFlags & EST_GPS_XY_VALID) {
        ...
        if (!(ctx->newFlags & EST_XY_VALID)) {
            ...
            const float gpsPosResidualMag = sqrtf(((gpsPosXResidual)*(gpsPosXResidual)) + ((gpsPosYResidual)*(gpsPosYResidual)));


            const float gpsWeightScaler = 1.0f;

            const float w_xy_gps_p = positionEstimationConfig()->w_xy_gps_p * gpsWeightScaler;
            const float w_xy_gps_v = positionEstimationConfig()->w_xy_gps_v * ((gpsWeightScaler)*(gpsWeightScaler));
            ...
            ctx->estVelCorr.x += gpsPosXResidual * ((w_xy_gps_p)*(w_xy_gps_p)) * ctx->dt;
            ctx->estVelCorr.y += gpsPosYResidual * ((w_xy_gps_p)*(w_xy_gps_p)) * ctx->dt;
            ...
            ctx->accBiasCorr.x -= gpsPosXResidual * ((w_xy_gps_p)*(w_xy_gps_p));
            ctx->accBiasCorr.y -= gpsPosYResidual * ((w_xy_gps_p)*(w_xy_gps_p));


            ctx->newEPH = updateEPE(posEstimator.est.eph, ctx->dt, ( __extension__ ({ __typeof__(posEstimator.gps.eph) _left4 = (posEstimator.gps.eph); __typeof__(gpsPosResidualMag) _right5 = (gpsPosResidualMag); _left4 > _right5 ? _left4 : _right5; })), w_xy_gps_p);
        }

        return 
# 622 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              1
# 622 "./src/main/navigation/navigation_pos_estimator.c"
                  ;
    }

    return 
# 625 "./src/main/navigation/navigation_pos_estimator.c" 3 4
          0
# 625 "./src/main/navigation/navigation_pos_estimator.c"
               ;
}
...
static void updateEstimatedTopic(timeUs_t currentTimeUs)
{
    ...
    ctx.dt = ((currentTimeUs - posEstimator.est.lastUpdateTime) * 1e-6f);
    ...
    const 
# 663 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 663 "./src/main/navigation/navigation_pos_estimator.c"
              estZCorrectOk =
    ...
    const 
# 668 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 668 "./src/main/navigation/navigation_pos_estimator.c"
              estXYCorrectOk =
    ...
    if (positionEstimationConfig()->w_acc_bias > 0.0f) {
        const float accelBiasCorrMagnitudeSq = ((ctx.accBiasCorr.x)*(ctx.accBiasCorr.x)) + ((ctx.accBiasCorr.y)*(ctx.accBiasCorr.y)) + ((ctx.accBiasCorr.z)*(ctx.accBiasCorr.z));
        if (accelBiasCorrMagnitudeSq < (((980.665f * 0.25f))*((980.665f * 0.25f)))) {
...
static void publishEstimatedTopic(timeUs_t currentTimeUs)
{
    ...
    updateActualHeading(navIsHeadingUsable(), ((attitude.values.yaw) * 10));


    if (updateTimer(&posPublishTimer, (1000000 / (50)), currentTimeUs)) {

        if (posEstimator.est.eph < positionEstimationConfig()->max_eph_epv) {

            updateActualHorizontalPositionAndVelocity(
# 724 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     1
# 724 "./src/main/navigation/navigation_pos_estimator.c"
                                                         , 
# 724 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                           1
# 724 "./src/main/navigation/navigation_pos_estimator.c"
                                                               , posEstimator.est.pos.x, posEstimator.est.pos.y, posEstimator.est.vel.x, posEstimator.est.vel.y);
        }
        else {
            updateActualHorizontalPositionAndVelocity(
# 727 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     0
# 727 "./src/main/navigation/navigation_pos_estimator.c"
                                                          , 
# 727 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                            0
# 727 "./src/main/navigation/navigation_pos_estimator.c"
                                                                 , posEstimator.est.pos.x, posEstimator.est.pos.y, 0, 0);
        }


        if (posEstimator.est.epv < positionEstimationConfig()->max_eph_epv) {
            navigationEstimateStatus_e aglStatus = (posEstimator.est.aglQual == SURFACE_QUAL_LOW) ? EST_USABLE : EST_TRUSTED;
            updateActualAltitudeAndClimbRate(
# 733 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                            1
# 733 "./src/main/navigation/navigation_pos_estimator.c"
                                                , posEstimator.est.pos.z, posEstimator.est.vel.z, posEstimator.est.aglAlt, posEstimator.est.aglVel, aglStatus);
        }
        else {
            updateActualAltitudeAndClimbRate(
# 736 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                            0
# 736 "./src/main/navigation/navigation_pos_estimator.c"
                                                 , posEstimator.est.pos.z, 0, posEstimator.est.aglAlt, 0, EST_NONE);
        }
...
# 747 "./src/main/navigation/navigation_pos_estimator.c" 3 4
_Bool 
# 747 "./src/main/navigation/navigation_pos_estimator.c"
    isGPSGlitchDetected(void)
{
...
void initializePositionEstimator(void)
{
    ...
    posEstimator.imu.gravityCalibrationComplete = 
# 774 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                 0
# 774 "./src/main/navigation/navigation_pos_estimator.c"
                                                      ;
...
{
    static 
# 789 "./src/main/navigation/navigation_pos_estimator.c" 3 4
          _Bool 
# 789 "./src/main/navigation/navigation_pos_estimator.c"
               isInitialized = 
# 789 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                               0
# 789 "./src/main/navigation/navigation_pos_estimator.c"
    ...
    if (!isInitialized) {
        ...
        isInitialized = 
# 793 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                       1
# 793 "./src/main/navigation/navigation_pos_estimator.c"
                           ;
    }
...
# 813 "./src/main/navigation/navigation_pos_estimator.c" 3 4
_Bool 
# 813 "./src/main/navigation/navigation_pos_estimator.c"
    navIsCalibrationComplete(void)
{
