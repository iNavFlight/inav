# 1 "./src/main/navigation/navigation_pos_estimator_flow.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/navigation/navigation_pos_estimator_flow.c"
# 25 "./src/main/navigation/navigation_pos_estimator_flow.c"
...
# 26 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 27 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 28 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 29 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 58 "./src/main/platform.h" 2
# 31 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 33 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 34 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 38 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 39 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 40 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 23 "./src/main/drivers/rangefinder/rangefinder.h" 2
...
# 42 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 29 "./src/main/drivers/opflow/opflow.h" 2
...
# 43 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
void imuInit(void);
# 45 "./src/main/navigation/navigation_pos_estimator_flow.c" 2
...
# 64 "./src/main/navigation/navigation_pos_estimator_flow.c" 3 4
_Bool 
# 64 "./src/main/navigation/navigation_pos_estimator_flow.c"
    estimationCalculateCorrection_XY_FLOW(estimationContext_t * ctx)
{

    if (!((ctx->newFlags & EST_FLOW_VALID) && (ctx->newFlags & EST_SURFACE_VALID) && (ctx->newFlags & EST_Z_VALID))) {
        return 
# 68 "./src/main/navigation/navigation_pos_estimator_flow.c" 3 4
              0
# 68 "./src/main/navigation/navigation_pos_estimator_flow.c"
                   ;
    }


    const 
# 72 "./src/main/navigation/navigation_pos_estimator_flow.c" 3 4
         _Bool 
# 72 "./src/main/navigation/navigation_pos_estimator_flow.c"
              canUseFlow = (posEstimator.surface.reliability >= (0.33f));

    if (!canUseFlow) {
        return 
# 75 "./src/main/navigation/navigation_pos_estimator_flow.c" 3 4
              0
# 75 "./src/main/navigation/navigation_pos_estimator_flow.c"
                   ;
    }
    ...
    if ((ctx->newFlags & EST_GPS_XY_VALID)) {
        ...
        ctx->newEPH = updateEPE(posEstimator.est.eph, ctx->dt, sqrtf(((flowResidualX)*(flowResidualX)) + ((flowResidualY)*(flowResidualY))), positionEstimationConfig()->w_xy_flow_p);
    }

    {if (debugMode == (DEBUG_FLOW)) {debug[(0)] = (((posEstimator.flow.flowRate[Y]) / (3.14159265358979323846f / 180.0f)));}};
    {if (debugMode == (DEBUG_FLOW)) {debug[(1)] = (((posEstimator.flow.flowRate[X]) / (3.14159265358979323846f / 180.0f)));}};
    {if (debugMode == (DEBUG_FLOW)) {debug[(2)] = (posEstimator.est.flowCoordinates[X]);}};
    {if (debugMode == (DEBUG_FLOW)) {debug[(3)] = (posEstimator.est.flowCoordinates[Y]);}};

    return 
# 120 "./src/main/navigation/navigation_pos_estimator_flow.c" 3 4
          1
# 120 "./src/main/navigation/navigation_pos_estimator_flow.c"
              ;
