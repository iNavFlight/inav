...
# 59 "./src/main/telemetry/hott.c" 2
...
# 67 "./src/main/telemetry/hott.c" 2
...
# 75 "./src/main/telemetry/hott.c" 2
...
typedef struct HOTT_GAM_MSG_s {
    ...
    uint8_t warning_beeps;
# 142 "./src/main/telemetry/hott.h"
    uint8_t sensor_id;
    uint8_t alarm_invers1;
# 153 "./src/main/telemetry/hott.h"
    uint8_t alarm_invers2;
# 164 "./src/main/telemetry/hott.h"
    uint8_t cell1;
    uint8_t cell2;
    uint8_t cell3;
    uint8_t cell4;
...
typedef struct HOTT_EAM_MSG_s {
    ...
    uint8_t warning_beeps;
# 279 "./src/main/telemetry/hott.h"
    uint8_t sensor_id;
    uint8_t alarm_invers1;
# 290 "./src/main/telemetry/hott.h"
    uint8_t alarm_invers2;
# 301 "./src/main/telemetry/hott.h"
    uint8_t cell1_L;
    uint8_t cell2_L;
    uint8_t cell3_L;
    uint8_t cell4_L;
...
static uint8_t *hottTxMsg = 
# 108 "./src/main/telemetry/hott.c" 3 4
                           ((void *)0)
# 108 "./src/main/telemetry/hott.c"
                               ;
...
# 115 "./src/main/telemetry/hott.c" 3 4
                               ((void *)0)
# 115 "./src/main/telemetry/hott.c"
                                   ;
static serialPortConfig_t *portConfig;

static 
# 118 "./src/main/telemetry/hott.c" 3 4
      _Bool 
# 118 "./src/main/telemetry/hott.c"
...
void hottPrepareGPSResponse(HOTT_GPS_MSG_t *hottGPSMessage)
{
    ...
    const int32_t climbrate = ( __extension__ ({ __typeof__(0) _left0 = (0); __typeof__(getEstimatedActualVelocity(Z) + 30000) _right1 = (getEstimatedActualVelocity(Z) + 30000); _left0 > _right1 ? _left0 : _right1; }));
    hottGPSMessage->climbrate_L = climbrate & 0xFF;
    hottGPSMessage->climbrate_H = climbrate >> 8;

    const int32_t climbrate3s = ( __extension__ ({ __typeof__(0) _left2 = (0); __typeof__(3.0f * getEstimatedActualVelocity(Z) / 100 + 120) _right3 = (3.0f * getEstimatedActualVelocity(Z) / 100 + 120); _left2 > _right3 ? _left2 : _right3; }));
    ...
    const uint16_t hottGpsAltitude = (gpsSol.llh.alt / 100) + 500;
...
static inline void updateAlarmBatteryStatus(HOTT_EAM_MSG_t *hottEAMMessage)
{
    ...
    if (((millis() - lastHottAlarmSoundTime) >= (telemetryConfig()->hottAlarmSoundInterval * 1000))){
...
{
    uint8_t vbat_dcv = getBatteryVoltage() / 10;
...
{
    const int32_t alt = ( __extension__ ({ __typeof__(0) _left4 = (0); __typeof__((int32_t)(getEstimatedActualPosition(Z) / 100.0f + 500)) _right5 = ((int32_t)(getEstimatedActualPosition(Z) / 100.0f + 500)); _left4 > _right5 ? _left4 : _right5; }));
    hottEAMMessage->altitude_L = alt & 0xFF;
    hottEAMMessage->altitude_H = alt >> 8;

    const int32_t climbrate = ( __extension__ ({ __typeof__(0) _left6 = (0); __typeof__((int32_t)(getEstimatedActualVelocity(Z) + 30000)) _right7 = ((int32_t)(getEstimatedActualVelocity(Z) + 30000)); _left6 > _right7 ? _left6 : _right7; }));
    hottEAMMessage->climbrate_L = climbrate & 0xFF;
    hottEAMMessage->climbrate_H = climbrate >> 8;

    const int32_t climbrate3s = ( __extension__ ({ __typeof__(0) _left8 = (0); __typeof__((int32_t)(3.0f * getEstimatedActualVelocity(Z) / 100 + 120)) _right9 = ((int32_t)(3.0f * getEstimatedActualVelocity(Z) / 100 + 120)); _left8 > _right9 ? _left8 : _right9; }));
...
void freeHoTTTelemetryPort(void)
{
    ...
    hottPort = 
# 315 "./src/main/telemetry/hott.c" 3 4
              ((void *)0)
# 315 "./src/main/telemetry/hott.c"
                  ;
    hottTelemetryEnabled = 
# 316 "./src/main/telemetry/hott.c" 3 4
                          0
# 316 "./src/main/telemetry/hott.c"
                               ;
}
...
# 333 "./src/main/telemetry/hott.c" 3 4
                                                                                    ((void *)0)
# 333 "./src/main/telemetry/hott.c"
                                                                                        , 19200, MODE_RXTX, SERIAL_NOT_INVERTED);
    ...
    hottTelemetryEnabled = 
# 339 "./src/main/telemetry/hott.c" 3 4
                          1
# 339 "./src/main/telemetry/hott.c"
                              ;
}
...
# 348 "./src/main/telemetry/hott.c"
           processBinaryModeRequest(uint8_t address)
{
    switch (address) {
    ...
    case 0x8A:
        if (sensors(SENSOR_GPS)) {
            ...
            return 
# 356 "./src/main/telemetry/hott.c" 3 4
                  1
# 356 "./src/main/telemetry/hott.c"
                      ;
        }
        break;
    ...
    case 0x8E:
        ...
        return 
# 363 "./src/main/telemetry/hott.c" 3 4
              1
# 363 "./src/main/telemetry/hott.c"
                  ;
    }

    return 
# 366 "./src/main/telemetry/hott.c" 3 4
          0
# 366 "./src/main/telemetry/hott.c"
               ;
}
...
static 
# 376 "./src/main/telemetry/hott.c" 3 4
      _Bool 
# 376 "./src/main/telemetry/hott.c"
           hottSendTelemetryDataByte(timeUs_t currentTimeUs)
{
    static timeUs_t byteSentTimeUs = 0;


    if (currentTimeUs - byteSentTimeUs < 2000) {
        return 
# 382 "./src/main/telemetry/hott.c" 3 4
              0
# 382 "./src/main/telemetry/hott.c"
                   ;
    }
    ...
    if (hottTxMsgSize == 0) {
        ...
        return 
# 388 "./src/main/telemetry/hott.c" 3 4
              1
# 388 "./src/main/telemetry/hott.c"
                  ;
    } else {
        ...
        hottTxMsgSize--;
        return 
# 395 "./src/main/telemetry/hott.c" 3 4
              0
# 395 "./src/main/telemetry/hott.c"
                   ;
    }
}
...
{
    const 
# 401 "./src/main/telemetry/hott.c" 3 4
         _Bool 
# 401 "./src/main/telemetry/hott.c"
...
# 423 "./src/main/telemetry/hott.c" 3 4
   _Bool 
# 423 "./src/main/telemetry/hott.c"
        reprocessState;
    do {
        reprocessState = 
# 425 "./src/main/telemetry/hott.c" 3 4
                        0
# 425 "./src/main/telemetry/hott.c"
                             ;
        ...
        case HOTT_WAITING_FOR_REQUEST:
            if (serialRxBytesWaiting(hottPort)) {
                ...
                reprocessState = 
# 432 "./src/main/telemetry/hott.c" 3 4
                                1
# 432 "./src/main/telemetry/hott.c"
                                    ;
            }
            break;

        case HOTT_RECEIVING_REQUEST:
            if ((currentTimeUs - hottStateChangeUs) >= 4000) {
                ...
                if (hottRequestBufferPtr >= 2) {
                    if ((hottRequestBuffer[0] == 0) || (hottRequestBuffer[0] == 0x80)) {
                    ...
                    else if (hottRequestBuffer[0] == 0x7f) {
                    ...
                    reprocessState = 
# 473 "./src/main/telemetry/hott.c" 3 4
                                    1
# 473 "./src/main/telemetry/hott.c"
                                        ;
                }
            }
            break;
        ...
        case HOTT_WAITING_FOR_TX_WINDOW:
            if ((currentTimeUs - hottStateChangeUs) >= 5000) {
                hottTxMsgCrc = 0;
        ...
        case HOTT_ENDING_TRANSMISSION:
            if ((currentTimeUs - hottStateChangeUs) >= 2000) {
                flushHottRxBuffer();
                hottSwitchState(HOTT_WAITING_FOR_REQUEST, currentTimeUs);
                reprocessState = 
# 495 "./src/main/telemetry/hott.c" 3 4
                                1
# 495 "./src/main/telemetry/hott.c"
                                    ;
            }
            break;
        };
