...
# 28 "./src/main/drivers/compass/compass_ak8975.c" 2
...
# 30 "./src/main/drivers/compass/compass_ak8975.c" 2
...
# 31 "./src/main/drivers/compass/compass_ak8975.c" 2
...
# 32 "./src/main/drivers/compass/compass_ak8975.c" 2
...
# 34 "./src/main/drivers/compass/compass_ak8975.c" 2
...
# 35 "./src/main/drivers/compass/compass_ak8975.c" 2
...
# 37 "./src/main/drivers/compass/compass_ak8975.c" 2
...
# 38 "./src/main/drivers/compass/compass_ak8975.c" 2
...
# 40 "./src/main/drivers/compass/compass_ak8975.c" 2
...
static 
# 64 "./src/main/drivers/compass/compass_ak8975.c" 3 4
      _Bool 
# 64 "./src/main/drivers/compass/compass_ak8975.c"
           ak8975Init(magDev_t * mag)
{
    
# 66 "./src/main/drivers/compass/compass_ak8975.c" 3 4
   _Bool 
# 66 "./src/main/drivers/compass/compass_ak8975.c"
        ack;
    uint8_t buffer[3];
    uint8_t status;
    ...
    ack = busReadBuf(mag->busDev, 0x10, &buffer[0], 3);
    delay(10);
    ...
    ack = busWrite(mag->busDev, 0x0a, 0x01);
    return 
# 90 "./src/main/drivers/compass/compass_ak8975.c" 3 4
          1
# 90 "./src/main/drivers/compass/compass_ak8975.c"
              ;
}
...
static 
# 98 "./src/main/drivers/compass/compass_ak8975.c" 3 4
      _Bool 
# 98 "./src/main/drivers/compass/compass_ak8975.c"
           ak8975Read(magDev_t * mag)
{
    uint8_t status;
    uint8_t buf[6];
...
# 108 "./src/main/drivers/compass/compass_ak8975.c" 3 4
   _Bool 
# 108 "./src/main/drivers/compass/compass_ak8975.c"
        ack = busRead(mag->busDev, 0x02, &status);
    if (!ack || (status & (1 << 0)) == 0) {
        return 
# 110 "./src/main/drivers/compass/compass_ak8975.c" 3 4
              0
# 110 "./src/main/drivers/compass/compass_ak8975.c"
                   ;
    }
    ...
    if (!ack || (status & (1 << 2)) || (status & (1 << 3))) {
        return 
# 117 "./src/main/drivers/compass/compass_ak8975.c" 3 4
              0
# 117 "./src/main/drivers/compass/compass_ak8975.c"
                   ;
    }
    ...
    ack = busWrite(mag->busDev, 0x0a, 0x01);
    return 
# 125 "./src/main/drivers/compass/compass_ak8975.c" 3 4
          1
# 125 "./src/main/drivers/compass/compass_ak8975.c"
              ;
}

#define DETECTION_MAX_RETRY_COUNT 5
static 
# 129 "./src/main/drivers/compass/compass_ak8975.c" 3 4
      _Bool 
# 129 "./src/main/drivers/compass/compass_ak8975.c"
...
# 135 "./src/main/drivers/compass/compass_ak8975.c" 3 4
       _Bool 
# 135 "./src/main/drivers/compass/compass_ak8975.c"
            ack = busRead(mag->busDev, 0x00, &sig);

        if (ack && sig == 0x48) {
            return 
# 138 "./src/main/drivers/compass/compass_ak8975.c" 3 4
                  1
# 138 "./src/main/drivers/compass/compass_ak8975.c"
                      ;
        }
    }

    return 
# 142 "./src/main/drivers/compass/compass_ak8975.c" 3 4
          0
# 142 "./src/main/drivers/compass/compass_ak8975.c"
               ;
}


# 145 "./src/main/drivers/compass/compass_ak8975.c" 3 4
_Bool 
# 145 "./src/main/drivers/compass/compass_ak8975.c"
    ak8975Detect(magDev_t * mag)
{
    mag->busDev = busDeviceInit(BUSTYPE_I2C, DEVHW_AK8975, mag->magSensorToUse, OWNER_COMPASS);
    if (mag->busDev == 
# 148 "./src/main/drivers/compass/compass_ak8975.c" 3 4
                      ((void *)0)
# 148 "./src/main/drivers/compass/compass_ak8975.c"
                          ) {
        return 
# 149 "./src/main/drivers/compass/compass_ak8975.c" 3 4
              0
# 149 "./src/main/drivers/compass/compass_ak8975.c"
                   ;
    }
    ...
    if (!deviceDetect(mag)) {
        ...
        return 
# 154 "./src/main/drivers/compass/compass_ak8975.c" 3 4
              0
# 154 "./src/main/drivers/compass/compass_ak8975.c"
                   ;
    }
    ...
    return 
# 160 "./src/main/drivers/compass/compass_ak8975.c" 3 4
          1
# 160 "./src/main/drivers/compass/compass_ak8975.c"
              ;
}
