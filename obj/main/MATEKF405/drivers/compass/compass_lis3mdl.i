# 1 "./src/main/drivers/compass/compass_lis3mdl.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/compass/compass_lis3mdl.c"
# 18 "./src/main/drivers/compass/compass_lis3mdl.c"
...
# 19 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 20 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 22 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 58 "./src/main/platform.h" 2
# 24 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 28 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 30 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 31 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 33 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 35 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
static 
# 107 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
      _Bool 
# 107 "./src/main/drivers/compass/compass_lis3mdl.c"
           lis3mdlRead(magDev_t * mag)
{
    
# 109 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
   _Bool 
# 109 "./src/main/drivers/compass/compass_lis3mdl.c"
        ack;
 uint8_t status = 0;

 ack = busRead(mag->busDev, 0x27, &status);

 if ( !( ack && ( ( status & 0x08 ) >> 3 ) ) ) {
  return 
# 115 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
        0
# 115 "./src/main/drivers/compass/compass_lis3mdl.c"
             ;
 }

 uint8_t buf[6];

    ack = busReadBuf(mag->busDev, 0x28, buf, 6);
    ...
    if (!ack) {
        ...
        mag->magADCRaw[Z] = 0;
        return 
# 126 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
              0
# 126 "./src/main/drivers/compass/compass_lis3mdl.c"
                   ;
    }
    ...
    return 
# 133 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
          1
# 133 "./src/main/drivers/compass/compass_lis3mdl.c"
              ;
}

#define DETECTION_MAX_RETRY_COUNT 5
static 
# 137 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
      _Bool 
# 137 "./src/main/drivers/compass/compass_lis3mdl.c"
...
# 143 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
       _Bool 
# 143 "./src/main/drivers/compass/compass_lis3mdl.c"
            ack = busRead(mag->busDev, 0x0F, &sig);

        if (ack && sig == 0x3D) {
            return 
# 146 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
                  1
# 146 "./src/main/drivers/compass/compass_lis3mdl.c"
                      ;
        }
    }

    return 
# 150 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
          0
# 150 "./src/main/drivers/compass/compass_lis3mdl.c"
               ;
}

static 
# 153 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
      _Bool 
# 153 "./src/main/drivers/compass/compass_lis3mdl.c"
           lis3mdlInit(magDev_t *mag)
{
 busWrite(mag->busDev, 0x21, 0x00);
    busWrite(mag->busDev, 0x20, 0x80 | 0x60 | 0x1C);
    busWrite(mag->busDev, 0x24, 0x40);
    busWrite(mag->busDev, 0x23, 0x0C);
    busWrite(mag->busDev, 0x22, 0x00);

    return 
# 161 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
          1
# 161 "./src/main/drivers/compass/compass_lis3mdl.c"
              ;
}


# 164 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
_Bool 
# 164 "./src/main/drivers/compass/compass_lis3mdl.c"
    lis3mdlDetect(magDev_t * mag)
{
    mag->busDev = busDeviceInit(BUSTYPE_I2C, DEVHW_LIS3MDL, mag->magSensorToUse, OWNER_COMPASS);
    if (mag->busDev == 
# 167 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
                      ((void *)0)
# 167 "./src/main/drivers/compass/compass_lis3mdl.c"
                          ) {
        return 
# 168 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
              0
# 168 "./src/main/drivers/compass/compass_lis3mdl.c"
                   ;
    }
    ...
    if (!deviceDetect(mag)) {
        ...
        return 
# 175 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
              0
# 175 "./src/main/drivers/compass/compass_lis3mdl.c"
                   ;
    }
    ...
    return 
# 181 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
          1
# 181 "./src/main/drivers/compass/compass_lis3mdl.c"
              ;
}
