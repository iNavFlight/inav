# 1 "./src/main/drivers/compass/compass_ak8963.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/drivers/compass/compass_ak8963.c"
# 18 "./src/main/drivers/compass/compass_ak8963.c"
...
# 19 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 20 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 21 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 23 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 58 "./src/main/platform.h" 2
# 25 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 29 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 31 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 32 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 33 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 35 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 36 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 37 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 39 "./src/main/drivers/compass/compass_ak8963.c" 2
...
# 40 "./src/main/drivers/compass/compass_ak8963.c" 2
...
static 
# 81 "./src/main/drivers/compass/compass_ak8963.c" 3 4
      _Bool 
# 81 "./src/main/drivers/compass/compass_ak8963.c"
           ak8963Init(magDev_t * mag)
{
    
# 83 "./src/main/drivers/compass/compass_ak8963.c" 3 4
   _Bool 
# 83 "./src/main/drivers/compass/compass_ak8963.c"
        ack;
    (void)(ack);
    uint8_t calibration[3];
    uint8_t status;

    ack = busWrite(mag->busDev, 0x0a, 0x00);
    delay(20);

    ack = busWrite(mag->busDev, 0x0a, 0x0F);
    delay(10);

    ack = busReadBuf(mag->busDev, 0x10, calibration, sizeof(calibration));
    delay(10);
    ...
    ack = busRead(mag->busDev, 0x02, &status);
    ack = busRead(mag->busDev, 0x09, &status);

    ack = busWrite(mag->busDev, 0x0a, 0x10 | 0x01);

    return 
# 110 "./src/main/drivers/compass/compass_ak8963.c" 3 4
          1
# 110 "./src/main/drivers/compass/compass_ak8963.c"
              ;
}

static int16_t parseMag(uint8_t *raw, int16_t gain) {
  int ret = (int16_t)(raw[1] << 8 | raw[0]) * gain / 256;
  return constrain(ret, 
# 115 "./src/main/drivers/compass/compass_ak8963.c" 3 4
                       (-0x7fff - 1)
# 115 "./src/main/drivers/compass/compass_ak8963.c"
                                , 
# 115 "./src/main/drivers/compass/compass_ak8963.c" 3 4
                                  (0x7fff)
# 115 "./src/main/drivers/compass/compass_ak8963.c"
...
static 
# 118 "./src/main/drivers/compass/compass_ak8963.c" 3 4
      _Bool 
# 118 "./src/main/drivers/compass/compass_ak8963.c"
           ak8963Read(magDev_t * mag)
{
    
# 120 "./src/main/drivers/compass/compass_ak8963.c" 3 4
   _Bool 
# 120 "./src/main/drivers/compass/compass_ak8963.c"
        ack = 
# 120 "./src/main/drivers/compass/compass_ak8963.c" 3 4
              0
# 120 "./src/main/drivers/compass/compass_ak8963.c"
    ...
    ack = busRead(mag->busDev, 0x02, &buf[0]);

    if (!ack || (buf[0] & 0x01) == 0) {
        return 
# 126 "./src/main/drivers/compass/compass_ak8963.c" 3 4
              0
# 126 "./src/main/drivers/compass/compass_ak8963.c"
                   ;
    }

    ack = busReadBuf(mag->busDev, 0x03, &buf[0], 7);

    if (!ack) {
        return 
# 132 "./src/main/drivers/compass/compass_ak8963.c" 3 4
              0
# 132 "./src/main/drivers/compass/compass_ak8963.c"
                   ;
    }
    ...
    if (buf[6] & 0x08) {
        return 
# 138 "./src/main/drivers/compass/compass_ak8963.c" 3 4
              0
# 138 "./src/main/drivers/compass/compass_ak8963.c"
                   ;
    }
    ...
    return 
# 145 "./src/main/drivers/compass/compass_ak8963.c" 3 4
          1
# 145 "./src/main/drivers/compass/compass_ak8963.c"
              ;
}

#define DETECTION_MAX_RETRY_COUNT 5
static 
# 149 "./src/main/drivers/compass/compass_ak8963.c" 3 4
      _Bool 
# 149 "./src/main/drivers/compass/compass_ak8963.c"
           deviceDetect(magDev_t * mag)
{
...
# 155 "./src/main/drivers/compass/compass_ak8963.c" 3 4
       _Bool 
# 155 "./src/main/drivers/compass/compass_ak8963.c"
            ack = busRead(mag->busDev, 0x00, &sig);

        if (ack && sig == 0x48) {
            return 
# 158 "./src/main/drivers/compass/compass_ak8963.c" 3 4
                  1
# 158 "./src/main/drivers/compass/compass_ak8963.c"
                      ;
        }
    }

    return 
# 162 "./src/main/drivers/compass/compass_ak8963.c" 3 4
          0
# 162 "./src/main/drivers/compass/compass_ak8963.c"
               ;
}


# 165 "./src/main/drivers/compass/compass_ak8963.c" 3 4
_Bool 
# 165 "./src/main/drivers/compass/compass_ak8963.c"
    ak8963Detect(magDev_t * mag)
{
    mag->busDev = busDeviceInit(BUSTYPE_ANY, DEVHW_AK8963, mag->magSensorToUse, OWNER_COMPASS);
    if (mag->busDev == 
# 168 "./src/main/drivers/compass/compass_ak8963.c" 3 4
                      ((void *)0)
# 168 "./src/main/drivers/compass/compass_ak8963.c"
                          ) {
        return 
# 169 "./src/main/drivers/compass/compass_ak8963.c" 3 4
              0
# 169 "./src/main/drivers/compass/compass_ak8963.c"
                   ;
    }
    ...
    if (!deviceDetect(mag)) {
        ...
        return 
# 174 "./src/main/drivers/compass/compass_ak8963.c" 3 4
              0
# 174 "./src/main/drivers/compass/compass_ak8963.c"
                   ;
    }
    ...
    return 
# 180 "./src/main/drivers/compass/compass_ak8963.c" 3 4
          1
# 180 "./src/main/drivers/compass/compass_ak8963.c"
              ;
}
