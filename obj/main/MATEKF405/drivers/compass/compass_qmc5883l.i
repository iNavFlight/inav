...
# 26 "./src/main/drivers/compass/compass_qmc5883l.c" 2
...
# 27 "./src/main/drivers/compass/compass_qmc5883l.c" 2
...
# 29 "./src/main/drivers/compass/compass_qmc5883l.c" 2
...
# 44 "./src/main/drivers/compass/compass_qmc5883l.c" 2
...
# 47 "./src/main/drivers/compass/compass_qmc5883l.c" 2
...
# 50 "./src/main/drivers/compass/compass_qmc5883l.c" 2
...
static 
# 83 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
      _Bool 
# 83 "./src/main/drivers/compass/compass_qmc5883l.c"
           qmc5883Init(magDev_t * mag)
{
    
# 85 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
   _Bool 
# 85 "./src/main/drivers/compass/compass_qmc5883l.c"
        ack = 
# 85 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
              1
# 85 "./src/main/drivers/compass/compass_qmc5883l.c"
    ...
    ack = ack && busWrite(mag->busDev, 0x09, 0x01 | (0x03 << 2) | (0x00 << 6) | (0x01 << 4));

    return ack;
}

static 
# 95 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
      _Bool 
# 95 "./src/main/drivers/compass/compass_qmc5883l.c"
           qmc5883Read(magDev_t * mag)
{
    uint8_t status;
    uint8_t buf[6];
...
# 105 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
   _Bool 
# 105 "./src/main/drivers/compass/compass_qmc5883l.c"
        ack = busRead(mag->busDev, 0x06, &status);
    if (!ack || (status & 0x04) == 0) {
        return 
# 107 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
              0
# 107 "./src/main/drivers/compass/compass_qmc5883l.c"
                   ;
    }

    ack = busReadBuf(mag->busDev, 0x00, buf, 6);
    if (!ack) {
        return 
# 112 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
              0
# 112 "./src/main/drivers/compass/compass_qmc5883l.c"
                   ;
    }
    ...
    return 
# 119 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
          1
# 119 "./src/main/drivers/compass/compass_qmc5883l.c"
              ;
}

#define DETECTION_MAX_RETRY_COUNT 5
static 
# 123 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
      _Bool 
# 123 "./src/main/drivers/compass/compass_qmc5883l.c"
           deviceDetect(magDev_t * mag)
{
    for (int retryCount = 0; retryCount < 5; retryCount++) {

        busWrite(mag->busDev, 0x0A, 0x80);
        delay(30);

        uint8_t sig = 0;
        
# 131 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
       _Bool 
# 131 "./src/main/drivers/compass/compass_qmc5883l.c"
            ack = busRead(mag->busDev, 0x0D, &sig);

        if (ack && sig == 0xFF) {



            ack = busRead(mag->busDev, 0x09, &sig);
            if (ack && sig == 0x00) {
                return 
# 139 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
                      1
# 139 "./src/main/drivers/compass/compass_qmc5883l.c"
                          ;
            }
        }
    }
    ...
    return 
# 144 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
          0
# 144 "./src/main/drivers/compass/compass_qmc5883l.c"
               ;
}


# 147 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
_Bool 
# 147 "./src/main/drivers/compass/compass_qmc5883l.c"
    qmc5883Detect(magDev_t * mag)
{
    mag->busDev = busDeviceInit(BUSTYPE_ANY, DEVHW_QMC5883, mag->magSensorToUse, OWNER_COMPASS);
    if (mag->busDev == 
# 150 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
                      ((void *)0)
# 150 "./src/main/drivers/compass/compass_qmc5883l.c"
                          ) {
        return 
# 151 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
              0
# 151 "./src/main/drivers/compass/compass_qmc5883l.c"
                   ;
    }
    ...
    if (!deviceDetect(mag)) {
        ...
        return 
# 156 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
              0
# 156 "./src/main/drivers/compass/compass_qmc5883l.c"
                   ;
    }
    ...
    return 
# 162 "./src/main/drivers/compass/compass_qmc5883l.c" 3 4
          1
# 162 "./src/main/drivers/compass/compass_qmc5883l.c"
              ;
}
