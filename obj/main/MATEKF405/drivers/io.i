...
# 27 "./src/main/drivers/io.c" 2


struct ioPortDef_s {
    rccPeriphTag_t rcc;
};
# 43 "./src/main/drivers/io.c"
const struct ioPortDef_s ioPortDefs[] = {
    { (((RCC_AHB1) << 5) | (16*((((uint32_t)0x00000001))>65535L) + (8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/2+1))))) },
    { (((RCC_AHB1) << 5) | (16*((((uint32_t)0x00000002))>65535L) + (8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/2+1))))) },
    { (((RCC_AHB1) << 5) | (16*((((uint32_t)0x00000004))>65535L) + (8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L)) >>8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L)) >>8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255))/2+1))))) },
    { (((RCC_AHB1) << 5) | (16*((((uint32_t)0x00000008))>65535L) + (8*(((((uint32_t)0x00000008))*1L >>16*((((uint32_t)0x00000008))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000008))*1L >>16*((((uint32_t)0x00000008))>65535L)) >>8*(((((uint32_t)0x00000008))*1L >>16*((((uint32_t)0x00000008))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000008))*1L >>16*((((uint32_t)0x00000008))>65535L)) >>8*(((((uint32_t)0x00000008))*1L >>16*((((uint32_t)0x00000008))>65535L))>255))/2+1))))) },
    { (((RCC_AHB1) << 5) | (16*((((uint32_t)0x00000010))>65535L) + (8*(((((uint32_t)0x00000010))*1L >>16*((((uint32_t)0x00000010))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000010))*1L >>16*((((uint32_t)0x00000010))>65535L)) >>8*(((((uint32_t)0x00000010))*1L >>16*((((uint32_t)0x00000010))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000010))*1L >>16*((((uint32_t)0x00000010))>65535L)) >>8*(((((uint32_t)0x00000010))*1L >>16*((((uint32_t)0x00000010))>65535L))>255))/2+1))))) },
    { (((RCC_AHB1) << 5) | (16*((((uint32_t)0x00000020))>65535L) + (8*(((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L)) >>8*(((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L)) >>8*(((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L))>255))/2+1))))) },
};
# 62 "./src/main/drivers/io.c"
ioRec_t* IO_Rec(IO_t io)
{
    while (0) { };
    while (0) { };
...
int IO_GPIOPortIdx(IO_t io)
{
    ...
    return (((size_t)IO_GPIO(io) - ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)) >> 10);
}
...
# 137 "./src/main/drivers/io.c" 3 4
_Bool 
# 137 "./src/main/drivers/io.c"
    IORead(IO_t io)
{
    if (!io) {
        return 
# 140 "./src/main/drivers/io.c" 3 4
              0
# 140 "./src/main/drivers/io.c"
                   ;
    }
...
void IOWrite(IO_t io, 
# 149 "./src/main/drivers/io.c" 3 4
                     _Bool 
# 149 "./src/main/drivers/io.c"
                          hi)
{
    if (!io) {
        return;
...
static const uint16_t ioDefUsedMask[4] = { 0xffff,0xffff,0xffff,((1 << (2))) };
static const uint8_t ioDefUsedOffset[4] = { (0),((((((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))+(((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255)),((((((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))+(((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255)+(((((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))+(((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255)),((((((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))+(((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255)+(((((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))+(((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255)+(((((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))+(((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255)) };
    ...
    for (unsigned port = 0; port < (sizeof(ioDefUsedMask) / sizeof((ioDefUsedMask)[0])); port++) {
        for (unsigned pin = 0; pin < sizeof(ioDefUsedMask[0]) * 8; pin++) {
            if (ioDefUsedMask[port] & (1 << pin)) {
                ioRec->gpio = (GPIO_TypeDef *)(((((uint32_t)0x40000000) + 0x00020000) + 0x0000) + (port << 10));
                ioRec->pin = 1 << pin;
                ioRec++;
            }
        }
