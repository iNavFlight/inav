...
# 22 "./src/main/drivers/light_led.c" 2
...
static const IO_t leds[] = {
    ...
    (IO_t)(ioRecs + ((((((0xffff & ((1 << (9)) - 1)) - (((0xffff & ((1 << (9)) - 1))>>1)&0x77777777) - (((0xffff & ((1 << (9)) - 1))>>2)&0x33333333) - (((0xffff & ((1 << (9)) - 1))>>3)&0x11111111))+(((0xffff & ((1 << (9)) - 1)) - (((0xffff & ((1 << (9)) - 1))>>1)&0x77777777) - (((0xffff & ((1 << (9)) - 1))>>2)&0x33333333) - (((0xffff & ((1 << (9)) - 1))>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255) + (((((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))+(((0xffff) - (((0xffff)>>1)&0x77777777) - (((0xffff)>>2)&0x33333333) - (((0xffff)>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255))),




    (IO_t)(ioRecs + ((((((0xffff & ((1 << (14)) - 1)) - (((0xffff & ((1 << (14)) - 1))>>1)&0x77777777) - (((0xffff & ((1 << (14)) - 1))>>2)&0x33333333) - (((0xffff & ((1 << (14)) - 1))>>3)&0x11111111))+(((0xffff & ((1 << (14)) - 1)) - (((0xffff & ((1 << (14)) - 1))>>1)&0x77777777) - (((0xffff & ((1 << (14)) - 1))>>2)&0x33333333) - (((0xffff & ((1 << (14)) - 1))>>3)&0x11111111))>>4)) & 0x0F0F0F0F) % 255) + 0)),
    ...
    (IO_t)
# 39 "./src/main/drivers/light_led.c" 3 4
   ((void *)0)
# 39 "./src/main/drivers/light_led.c"
                 ,
# 58 "./src/main/drivers/light_led.c"
};

uint8_t ledPolarity = 0
# 79 "./src/main/drivers/light_led.c"
    ;

static uint8_t ledOffset = 0;

void ledInit(
# 83 "./src/main/drivers/light_led.c" 3 4
            _Bool 
# 83 "./src/main/drivers/light_led.c"
                 alternative_led)
{
    ...
    ledSet(0, 
# 93 "./src/main/drivers/light_led.c" 3 4
   0
# 93 "./src/main/drivers/light_led.c"
   );
    ledSet(1, 
# 94 "./src/main/drivers/light_led.c" 3 4
   0
# 94 "./src/main/drivers/light_led.c"
   );
    do {} while (0);

    for (int i = 0; i < 3; i++) {
        if (leds[i + ledOffset]) {
            IOInit(leds[i + ledOffset], OWNER_LED, RESOURCE_OUTPUT, (i + 1));
            IOConfigGPIO(leds[i + ledOffset], ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
        }
    }

    ledSet(0, 
# 104 "./src/main/drivers/light_led.c" 3 4
   0
# 104 "./src/main/drivers/light_led.c"
   );
    ledSet(1, 
# 105 "./src/main/drivers/light_led.c" 3 4
   0
# 105 "./src/main/drivers/light_led.c"
   );
    do {} while (0);
}
...
void ledSet(int led, 
# 114 "./src/main/drivers/light_led.c" 3 4
                    _Bool 
# 114 "./src/main/drivers/light_led.c"
                         on)
{
    const 
# 116 "./src/main/drivers/light_led.c" 3 4
         _Bool 
# 116 "./src/main/drivers/light_led.c"
              inverted = (1 << (led + ledOffset)) & ledPolarity;
