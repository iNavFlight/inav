...
# 28 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 32 "./src/main/drivers/serial_usb_vcp.c" 2
# 1 "./src/main/vcpf4/usbd_cdc_vcp.h" 1
# 24 "./src/main/vcpf4/usbd_cdc_vcp.h"
#define __USBD_CDC_VCP_H 


# 1 "./lib/main/STM32F4/Drivers/CMSIS/Device/ST/STM32F4xx/stm32f4xx_conf.h" 1
# 28 "./src/main/vcpf4/usbd_cdc_vcp.h" 2

# 1 "./lib/main/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h" 1
# 31 "./lib/main/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h"
#define __USB_CDC_CORE_H_ 

# 1 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_ioreq.h" 1
# 31 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_ioreq.h"
#define __USBD_IOREQ_H_ 


# 1 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_def.h" 1
# 31 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_def.h"
#define __USBD_DEF_H 


# 1 "./src/main/vcpf4/usbd_conf.h" 1
# 24 "./src/main/vcpf4/usbd_conf.h"
...
# 53 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_def.h"
...
# 122 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_def.h"
...
# 30 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_core.h"
...
uint16_t USBD_GetRxCount (USB_OTG_CORE_HANDLE *pdev ,
                           uint8_t epnum);
# 34 "./lib/main/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h" 2
# 48 "./lib/main/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h"
...
# 74 "./lib/main/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h"
...
#define NO_CMD 0xFF
# 93 "./lib/main/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h"
...
CDC_IF_Prop_TypeDef;
# 120 "./lib/main/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h"
extern USBD_Class_cb_TypeDef USBD_CDC_cb;
# 30 "./src/main/vcpf4/usbd_cdc_vcp.h" 2
# 1 "./src/main/vcpf4/usbd_conf.h" 1
# 31 "./src/main/vcpf4/usbd_cdc_vcp.h" 2


# 1 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_core.h" 1
# 34 "./src/main/vcpf4/usbd_cdc_vcp.h" 2
# 1 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_usr.h" 1
# 30 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_usr.h"
...
# 35 "./src/main/vcpf4/usbd_cdc_vcp.h" 2
# 1 "./src/main/vcpf4/usbd_desc.h" 1
# 25 "./src/main/vcpf4/usbd_desc.h"
#define __USB_DESC_H 


# 1 "./lib/main/STM32_USB_Device_Library/Core/inc/usbd_def.h" 1
# 29 "./src/main/vcpf4/usbd_desc.h" 2
# 42 "./src/main/vcpf4/usbd_desc.h"
#define USB_DEVICE_DESCRIPTOR_TYPE 0x01
#define USB_CONFIGURATION_DESCRIPTOR_TYPE 0x02
#define USB_STRING_DESCRIPTOR_TYPE 0x03
#define USB_INTERFACE_DESCRIPTOR_TYPE 0x04
...
# 36 "./src/main/vcpf4/usbd_cdc_vcp.h" 2
...
# 33 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 34 "./src/main/drivers/serial_usb_vcp.c" 2
# 44 "./src/main/drivers/serial_usb_vcp.c"
...
static 
# 95 "./src/main/drivers/serial_usb_vcp.c" 3 4
      _Bool 
# 95 "./src/main/drivers/serial_usb_vcp.c"
           usbVcpIsConnected(const serialPort_t *instance)
{
    (void)instance;
           ...
           usbVcpFlush(vcpPort_t *port)
{
    ...
    if (count == 0) {
        return 
# 128 "./src/main/drivers/serial_usb_vcp.c" 3 4
              1
# 128 "./src/main/drivers/serial_usb_vcp.c"
                  ;
    }

    if (!usbIsConnected() || !usbIsConfigured()) {
        return 
# 132 "./src/main/drivers/serial_usb_vcp.c" 3 4
              0
# 132 "./src/main/drivers/serial_usb_vcp.c"
                   ;
    }
...
# 151 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 151 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 151 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 151 "./src/main/drivers/serial_usb_vcp.c"
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 161 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 161 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 161 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 161 "./src/main/drivers/serial_usb_vcp.c"
...
# 161 "./src/main/drivers/serial_usb_vcp.c"
    ...
    port->buffering = 
# 162 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     1
# 162 "./src/main/drivers/serial_usb_vcp.c"
                         ;
}
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 173 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 173 "./src/main/drivers/serial_usb_vcp.c"
                     vcpPort_t
# 173 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     , 
# 173 "./src/main/drivers/serial_usb_vcp.c"
...
# 173 "./src/main/drivers/serial_usb_vcp.c"
    ...
    port->buffering = 
# 174 "./src/main/drivers/serial_usb_vcp.c" 3 4
                     0
# 174 "./src/main/drivers/serial_usb_vcp.c"
                          ;
    usbVcpFlush(port);
}
...
void usbVcpInitHardware(void)
{
    ...
    IOInit(IOGetByTag(((((0) + 1) << 4) | (11))), OWNER_USB, RESOURCE_INPUT, 0);
    IOInit(IOGetByTag(((((0) + 1) << 4) | (12))), OWNER_USB, RESOURCE_OUTPUT, 0);
    USBD_Init(&USB_OTG_dev, USB_OTG_FS_CORE_ID, &USR_desc, &USBD_CDC_cb, &USR_cb);
# 224 "./src/main/drivers/serial_usb_vcp.c"
}
