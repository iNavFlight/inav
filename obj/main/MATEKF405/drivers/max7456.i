...
# 22 "./src/main/drivers/max7456.c" 2
...
# 58 "./src/main/platform.h" 2
# 24 "./src/main/drivers/max7456.c" 2
...
# 28 "./src/main/drivers/max7456.c" 2
...
#undef __need___va_list
# 47 "/usr/lib/gcc/arm-none-eabi/7.3.1/include/stdarg.h" 3 4
...
# 105 "/usr/lib/gcc/arm-none-eabi/7.3.1/include/stdarg.h" 3 4
#define _VA_LIST_ 
...
# 30 "./src/main/drivers/max7456.c" 2
...
# 55 "./src/main/drivers/light_led.h"
                         state);
# 33 "./src/main/drivers/max7456.c" 2
...
# 53 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 53 "./src/main/drivers/max7456.h"
       max7456ReadChar(uint8_t x, uint8_t y, uint8_t *c, uint8_t *mode);
...
static uint16_t screenBuffer[480] __attribute__ ((aligned(4)));
static bitarrayElement_t screenIsDirty[(480 + 31) / 32];


#define MAX_CHARS2UPDATE 10
#define BYTES_PER_CHAR2UPDATE 8

static 
# 174 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 174 "./src/main/drivers/max7456.c"
               firstInit = 
# 174 "./src/main/drivers/max7456.c" 3 4
                           1
# 174 "./src/main/drivers/max7456.c"
...
static uint8_t videoSignalReg = 0x40 | 0x08;
static 
# 177 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 177 "./src/main/drivers/max7456.c"
            max7456Lock = 
# 177 "./src/main/drivers/max7456.c" 3 4
                                 0
# 177 "./src/main/drivers/max7456.c"
                                      ;
static 
# 178 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 178 "./src/main/drivers/max7456.c"
           fontIsLoading = 
# 178 "./src/main/drivers/max7456.c" 3 4
                                 0
# 178 "./src/main/drivers/max7456.c"
                                      ;
static busDevice_t * max7456dev = 
# 179 "./src/main/drivers/max7456.c" 3 4
                                 ((void *)0)
# 179 "./src/main/drivers/max7456.c"
                                     ;
...
void max7456ReInit(void)
{
    ...
    if (max7456dev == 
# 212 "./src/main/drivers/max7456.c" 3 4
                     ((void *)0)
# 212 "./src/main/drivers/max7456.c"
                         ) {
        return;
    }
    ...
    switch (videoSignalCfg) {
        ...
        case NTSC:
            ...
            break;
        default:
            busRead(max7456dev, 0xA0, &srdata);
            if ((0x02 & srdata) == 0x02)
                videoSignalReg = 0x00 | 0x08;
    }
    ...
    for (int x = 0; x < maxScreenRows; x++) {
        bufPtr = max7456PrepareBuffer(buf, bufPtr, 0x10 + x, ((0x00 << 2) | 0x01));
    }


    bufPtr = max7456PrepareBuffer(buf, bufPtr, 0x00, videoSignalReg);
    bufPtr = max7456PrepareBuffer(buf, bufPtr, 0x01, 0x00 | 0x0C | (0x04 << 4));
    bufPtr = max7456PrepareBuffer(buf, bufPtr, 0x04, (1 << 2));


    busTransfer(max7456dev, 
# 253 "./src/main/drivers/max7456.c" 3 4
                           ((void *)0)
# 253 "./src/main/drivers/max7456.c"
                               , buf, bufPtr);
    ...
    if (firstInit) {
        max7456RefreshAll();
        firstInit = 
# 259 "./src/main/drivers/max7456.c" 3 4
                   0
# 259 "./src/main/drivers/max7456.c"
                        ;
    }
}
...
void max7456Init(const videoSystem_e videoSystem)
{
    ...
    if (max7456dev == 
# 269 "./src/main/drivers/max7456.c" 3 4
                     ((void *)0)
# 269 "./src/main/drivers/max7456.c"
                         ) {
        return;
    }
    ...
    busWrite(max7456dev, 0x00, 0x02);

    videoSignalCfg = videoSystem;


    for (uint_fast16_t ii = 0; ii < (sizeof(screenBuffer) / sizeof((screenBuffer)[0])); ii++) {
        screenBuffer[ii] = ((((uint16_t)0x20) << 8) | 0);
    }
...
{
    for (uint_fast16_t ii = 0; ii < (sizeof(screenBuffer) / sizeof((screenBuffer)[0])); ii++) {
        if (screenBuffer[ii] != ((((uint16_t)0x20) << 8) | 0)) {
            screenBuffer[ii] = ((((uint16_t)0x20) << 8) | 0);
...
{
    unsigned pos = y * 30 + x;
    uint16_t val = ((((uint16_t)c) << 8) | mode);
...
# 308 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 308 "./src/main/drivers/max7456.c"
    max7456ReadChar(uint8_t x, uint8_t y, uint8_t *c, uint8_t *mode)
{
    unsigned pos = y * 30 + x;
    if (pos < (sizeof(screenBuffer) / sizeof((screenBuffer)[0]))) {
        uint16_t val = screenBuffer[pos];
        *c = val >> 8;
        *mode = val & 0xFF;
        return 
# 315 "./src/main/drivers/max7456.c" 3 4
              1
# 315 "./src/main/drivers/max7456.c"
                  ;
    }
    return 
# 317 "./src/main/drivers/max7456.c" 3 4
          0
# 317 "./src/main/drivers/max7456.c"
               ;
}
...
# 354 "./src/main/drivers/max7456.c"
    ...
    if (!max7456Lock && !fontIsLoading) {
        ...
        max7456Lock = 
# 361 "./src/main/drivers/max7456.c" 3 4
                     1
# 361 "./src/main/drivers/max7456.c"
                         ;


        busRead(max7456dev, 0x00 | 0x80, &stallCheck);
        ...
        if (stallCheck != videoSignalReg) {
            ...
            busRead(max7456dev, 0xA0, &videoSense);
        ...
        uint8_t spiBuff[10 * 8];
        int bufPtr = 0;

        for (pos = 0, updatedCharCount = 0;;) {
            pos = bitArrayFindFirstSet(screenIsDirty, pos, sizeof(screenIsDirty));
            if (pos < 0 || pos >= maxScreenSize) {

                break;
            }

            currentMode = (screenBuffer[pos] & 0xFF);
            ...
            if (setMode != currentMode) {
                ...
                bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x04, currentMode);
            }

            bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x05, pos >> 8);
            bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x06, pos & 0xff);
            bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x07, (screenBuffer[pos] >> 8));

            bitArrayClr(screenIsDirty, pos);
            if (++updatedCharCount == 10) {
                break;
            }
        ...
        if (bufPtr) {
            busTransfer(max7456dev, 
# 430 "./src/main/drivers/max7456.c" 3 4
                                   ((void *)0)
# 430 "./src/main/drivers/max7456.c"
                                       , spiBuff, bufPtr);
        }

        max7456Lock = 
# 433 "./src/main/drivers/max7456.c" 3 4
                     0
# 433 "./src/main/drivers/max7456.c"
                          ;
    }
}
...
void max7456RefreshAll(void)
{
    uint8_t spiBuff[(480 + 4) * 2];
    int bufPtr;


    if (max7456dev == 
# 446 "./src/main/drivers/max7456.c" 3 4
                     ((void *)0)
# 446 "./src/main/drivers/max7456.c"
                         ) {
        return;
    }
    ...
    if (!max7456Lock) {
        uint16_t xx;
        max7456Lock = 
# 452 "./src/main/drivers/max7456.c" 3 4
                     1
# 452 "./src/main/drivers/max7456.c"
                         ;


        bufPtr = 0;
        bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x05, 0);
        bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x06, 0);
        bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x04, (1 << 0));

        for (xx = 0; xx < maxScreenSize; ++xx) {
            bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x07, (screenBuffer[xx] >> 8));
        }


        bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x07, 0xFF);


        busTransfer(max7456dev, 
# 468 "./src/main/drivers/max7456.c" 3 4
                               ((void *)0)
# 468 "./src/main/drivers/max7456.c"
                                   , spiBuff, bufPtr);
        ...
        bufPtr = 0;
        bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x05, 1<<1);
        bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x06, 0);
        bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x04, (1 << 0));

        for (xx = 0; xx < maxScreenSize; ++xx) {
# 491 "./src/main/drivers/max7456.c"
            bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x07, (screenBuffer[xx] & 0xFF) << 2);
        }
        ...
        busTransfer(max7456dev, 
# 498 "./src/main/drivers/max7456.c" 3 4
                               ((void *)0)
# 498 "./src/main/drivers/max7456.c"
                                   , spiBuff, bufPtr);


        memset(screenIsDirty, 0, sizeof(screenIsDirty));
        max7456Lock = 
# 502 "./src/main/drivers/max7456.c" 3 4
                     0
# 502 "./src/main/drivers/max7456.c"
                          ;
    }
}
...
void max7456WriteNvm(uint8_t char_address, const uint8_t *font_data)
{
    ...
    if (max7456dev == 
# 512 "./src/main/drivers/max7456.c" 3 4
                     ((void *)0)
# 512 "./src/main/drivers/max7456.c"
                         ) {
        return;
    }
    ...
    while (max7456Lock);
    max7456Lock = 
# 517 "./src/main/drivers/max7456.c" 3 4
                 1
# 517 "./src/main/drivers/max7456.c"
                     ;


    fontIsLoading = 
# 520 "./src/main/drivers/max7456.c" 3 4
                   1
# 520 "./src/main/drivers/max7456.c"
                       ;

    bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x00, 0);
    bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x09, char_address);

    for (int x = 0; x < 54; x++) {
        bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x0a, x);
        bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x0b, font_data[x]);
    }


    bufPtr = max7456PrepareBuffer(spiBuff, bufPtr, 0x08, 0xA0);

    busTransfer(max7456dev, 
# 533 "./src/main/drivers/max7456.c" 3 4
                           ((void *)0)
# 533 "./src/main/drivers/max7456.c"
                               , spiBuff, bufPtr);

    while (1) {
        uint8_t status;

        busRead(max7456dev, 0xA0, &status);
        if ((status & 0x20) == 0x00) {
            break;
        }
    ...
    max7456Lock = 
# 550 "./src/main/drivers/max7456.c" 3 4
                 0
# 550 "./src/main/drivers/max7456.c"
                      ;
}
