...
# 44 "./src/main/drivers/exti.h"
                             enable);
# 34 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
typedef char assert_failed_busDevice_scratchpad_memory_too_small [(sizeof(mpuContextData_t) < (20)) ? 1 : -1 ] __attribute__((unused));
...
const gyroFilterAndRateConfig_t * mpuChooseGyroConfig(uint8_t desiredLpf, uint16_t desiredRateHz)
{
    return chooseGyroConfig(desiredLpf, desiredRateHz, &mpuGyroConfigs[0], (sizeof(mpuGyroConfigs) / sizeof((mpuGyroConfigs)[0])));
}


# 77 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 77 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuGyroRead(gyroDev_t *gyro)
{
    uint8_t data[6];

    const 
# 81 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 81 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = busReadBuf(gyro->busDev, 0x43, data, 6);
    if (!ack) {
        return 
# 83 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 83 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 90 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 90 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}

static 
# 93 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
      _Bool 
# 93 "./src/main/drivers/accgyro/accgyro_mpu.c"
           mpuUpdateSensorContext(busDevice_t * busDev, mpuContextData_t * ctx)
{
    ctx->lastReadStatus = busReadBuf(busDev, 0x3B, ctx->accRaw, 6 + 2 + 6);
    return ctx->lastReadStatus;
}


# 99 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 99 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuGyroReadScratchpad(gyroDev_t *gyro)
{
    ...
    if (mpuUpdateSensorContext(busDev, ctx)) {
        ...
        return 
# 108 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              1
# 108 "./src/main/drivers/accgyro/accgyro_mpu.c"
                  ;
    }

    return 
# 111 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          0
# 111 "./src/main/drivers/accgyro/accgyro_mpu.c"
               ;
}


# 114 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 114 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuAccReadScratchpad(accDev_t *acc)
{
    ...
    if (ctx->lastReadStatus) {
        ...
        return 
# 122 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              1
# 122 "./src/main/drivers/accgyro/accgyro_mpu.c"
                  ;
    }

    return 
# 125 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          0
# 125 "./src/main/drivers/accgyro/accgyro_mpu.c"
               ;
}


# 128 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 128 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuTemperatureReadScratchpad(gyroDev_t *gyro, int16_t * data)
{
    ...
    if (ctx->lastReadStatus) {
        ...
        *data = (int16_t)((ctx->tempRaw[0] << 8) | ctx->tempRaw[1]) / 34 + 365;
        return 
# 135 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              1
# 135 "./src/main/drivers/accgyro/accgyro_mpu.c"
                  ;
    }

    return 
# 138 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          0
# 138 "./src/main/drivers/accgyro/accgyro_mpu.c"
               ;
}
