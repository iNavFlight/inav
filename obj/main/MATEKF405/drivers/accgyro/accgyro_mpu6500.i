...
# 44 "./src/main/drivers/exti.h"
                             enable);
# 30 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 32 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 33 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 34 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 49 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
_Bool 
# 49 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
    mpu6500AccDetect(accDev_t *acc)
{
    acc->busDev = busDeviceOpen(BUSTYPE_ANY, DEVHW_MPU6500, acc->imuSensorToUse);
    if (acc->busDev == 
# 52 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
                      ((void *)0)
# 52 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                          ) {
        return 
# 53 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
              0
# 53 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                   ;
    }
    ...
    if (ctx->chipMagicNumber != 0x6500) {
        return 
# 58 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
              0
# 58 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                   ;
    }
    ...
    return 
# 64 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
          1
# 64 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
              ;
}
...
static void mpu6500AccAndGyroInit(gyroDev_t *gyro)
{
    ...
    busWrite(dev, 0x6B, (0x80));
    delay(100);

    busWrite(dev, 0x68, 0x07);
    delay(100);

    busWrite(dev, 0x6B, 0);
    delay(100);

    busWrite(dev, 0x6B, INV_CLK_PLL);
    delay(15);

    busWrite(dev, 0x1B, INV_FSR_2000DPS << 3 | FCB_DISABLED);
    delay(15);

    busWrite(dev, 0x1C, INV_FSR_16G << 3);
    delay(15);

    busWrite(dev, 0x1A, config->gyroConfigValues[0]);
    delay(15);

    busWrite(dev, 0x19, config->gyroConfigValues[1]);
    delay(100);


    busWrite(dev, 0x37, 0 << 7 | 0 << 6 | 0 << 5 | 1 << 4 | 0 << 3 | 0 << 2 | 1 << 1 | 0 << 0);
    delay(15);


    busWrite(dev, 0x38, (1 << 0));
    delay(15);
...
static 
# 113 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
      _Bool 
# 113 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
           mpu6500DeviceDetect(busDevice_t * dev)
{
    uint8_t tmp;
    ...
    do {
        ...
        switch (tmp) {
            ...
            case (0x98):
                ...
                return 
# 133 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
                      1
# 133 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                          ;
        ...
        if (!attemptsRemaining) {
            return 
# 141 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
                  0
# 141 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                       ;
        }
    } while (attemptsRemaining--);

    return 
# 145 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
          0
# 145 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
               ;
}


# 148 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
_Bool 
# 148 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
    mpu6500GyroDetect(gyroDev_t *gyro)
{
    gyro->busDev = busDeviceInit(BUSTYPE_ANY, DEVHW_MPU6500, gyro->imuSensorToUse, OWNER_MPU);
    if (gyro->busDev == 
# 151 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
                       ((void *)0)
# 151 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                           ) {
        return 
# 152 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
              0
# 152 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                   ;
    }
    ...
    if (!mpu6500DeviceDetect(gyro->busDev)) {
        ...
        return 
# 157 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
              0
# 157 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                   ;
    }
    ...
    return 
# 170 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
          1
# 170 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
              ;
}
