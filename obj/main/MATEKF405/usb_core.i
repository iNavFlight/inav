# 1 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
# 29 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
# 1 "./lib/main/STM32_USB_OTG_Driver/inc/usb_core.h" 1
# 30 "./lib/main/STM32_USB_OTG_Driver/inc/usb_core.h"
#define __USB_CORE_H__ 


# 1 "./src/main/vcpf4/usb_conf.h" 1
# 24 "./src/main/vcpf4/usb_conf.h"
...
#define USE_ULPI_PHY 
# 70 "./src/main/vcpf4/usb_conf.h"
#define USB_OTG_FS_CORE 
# 163 "./src/main/vcpf4/usb_conf.h"
...
# 226 "./src/main/vcpf4/usb_conf.h"
#define __ALIGN_BEGIN 
#define __ALIGN_END 
# 237 "./src/main/vcpf4/usb_conf.h"
#define __packed __attribute__ ((__packed__))
# 34 "./lib/main/STM32_USB_OTG_Driver/inc/usb_core.h" 2
# 1 "./lib/main/STM32_USB_OTG_Driver/inc/usb_regs.h" 1
# 30 "./lib/main/STM32_USB_OTG_Driver/inc/usb_regs.h"
#define __USB_OTG_REGS_H__ 
# 50 "./lib/main/STM32_USB_OTG_Driver/inc/usb_regs.h"
...
# 30 "./lib/main/STM32_USB_OTG_Driver/inc/usb_defines.h"
#define __USB_DEF_H__ 
# 57 "./lib/main/STM32_USB_OTG_Driver/inc/usb_defines.h"
...
# 75 "./lib/main/STM32_USB_OTG_Driver/inc/usb_defines.h"
...
# 98 "./lib/main/STM32_USB_OTG_Driver/inc/usb_defines.h"
...
#define HOST_MODE 1
#define OTG_MODE 2
# 121 "./lib/main/STM32_USB_OTG_Driver/inc/usb_defines.h"
...
# 159 "./lib/main/STM32_USB_OTG_Driver/inc/usb_defines.h"
...
# 225 "./lib/main/STM32_USB_OTG_Driver/inc/usb_defines.h"
...
# 52 "./lib/main/STM32_USB_OTG_Driver/inc/usb_core.h"
...
# 30 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c" 2
# 1 "./lib/main/STM32_USB_OTG_Driver/inc/usb_bsp.h" 1
# 30 "./lib/main/STM32_USB_OTG_Driver/inc/usb_bsp.h"
#define __USB_BSP__H__ 


# 1 "./lib/main/STM32_USB_OTG_Driver/inc/usb_core.h" 1
# 34 "./lib/main/STM32_USB_OTG_Driver/inc/usb_bsp.h" 2
# 78 "./lib/main/STM32_USB_OTG_Driver/inc/usb_bsp.h"
void BSP_Init(void);
...
# 31 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c" 2
# 95 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
static void USB_OTG_EnableCommonInt(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  (*(volatile uint32_t *)(&pdev->regs.GREGS->GOTGINT) = (0xFFFFFFFF));


  (*(volatile uint32_t *)(&pdev->regs.GREGS->GINTSTS) = (0xBFFFFFFF));
  ...
  (*(volatile uint32_t *)(&pdev->regs.GREGS->GINTMSK) = (int_mask.d32));
}
...
static USB_OTG_STS USB_OTG_CoreReset(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  do
  {
    ...
    greset.d32 = (*(volatile uint32_t *)(&pdev->regs.GREGS->GRSTCTL));
    if (++count > 200000)
    {
      return USB_OTG_OK;
    }
  ...
  count = 0;
  greset.b.csftrst = 1;
  (*(volatile uint32_t *)(&pdev->regs.GREGS->GRSTCTL) = (greset.d32));
  do
  {
    greset.d32 = (*(volatile uint32_t *)(&pdev->regs.GREGS->GRSTCTL));
    if (++count > 200000)
...
# 168 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_WritePacket(USB_OTG_CORE_HANDLE *pdev,
                                uint8_t *src,
                                uint8_t ch_ep_num,
                                uint16_t len)
{
  ...
  if (pdev->cfg.dma_enable == 0)
  {
    ...
    {
      (*(volatile uint32_t *)(fifo) = (*((uint32_t *)src)));
      src+=4;
    }
  }
  return status;
}
# 198 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
void *USB_OTG_ReadPacket(USB_OTG_CORE_HANDLE *pdev,
                         uint8_t *dest,
                         uint16_t len)
{
  ...
  for( i = 0; i < count32b; i++)
  {
    *(uint32_t *)dest = (*(volatile uint32_t *)(fifo));
    dest += 4 ;
  }
  return ((void *)dest);
}
# 222 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_SelectCore(USB_OTG_CORE_HANDLE *pdev,
                               USB_OTG_CORE_ID_TypeDef coreID)
{
  ...
  if (coreID == USB_OTG_FS_CORE_ID)
  {
    ...
    pdev->cfg.phy_itface = 2;
# 251 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
  }
  else if (coreID == USB_OTG_HS_CORE_ID)
  {
    baseAddress = 0x40040000;
    pdev->cfg.coreID = USB_OTG_HS_CORE_ID;
    pdev->cfg.host_channels = 12 ;
    pdev->cfg.dev_endpoints = 6 ;
    pdev->cfg.TotalFifoSize = 1280;
# 280 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
  }
  ...
  pdev->regs.HREGS = (USB_OTG_HREGS *)(baseAddress +
    0x400);
  pdev->regs.HPRT0 = (uint32_t *)(baseAddress + 0x440);
  ...
  for (i = 0; i < pdev->cfg.host_channels; i++)
  {
    pdev->regs.DFIFO[i] = (uint32_t *)(baseAddress + 0x1000 +
      (i * 0x1000));
  }
  pdev->regs.PCGCCTL = (uint32_t *)(baseAddress + 0xE00);

  return status;
}
# 329 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_CoreInit(USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
  ...
  if (pdev->cfg.phy_itface == 1)
  {
    gccfg.d32 = (*(volatile uint32_t *)(&pdev->regs.GREGS->GCCFG));
    gccfg.b.pwdn = 0;
    ...
    (*(volatile uint32_t *)(&pdev->regs.GREGS->GCCFG) = (gccfg.d32));


    usbcfg.d32 = 0;
    usbcfg.d32 = (*(volatile uint32_t *)(&pdev->regs.GREGS->GUSBCFG));
    ...
    (*(volatile uint32_t *)(&pdev->regs.GREGS->GUSBCFG) = (usbcfg.d32));
    ...
    if(pdev->cfg.dma_enable == 1)
    {
      ...
      ahbcfg.b.hburstlen = 5;
      ahbcfg.b.dmaenable = 1;
      (*(volatile uint32_t *)(&pdev->regs.GREGS->GAHBCFG) = (ahbcfg.d32));
  ...
  if(pdev->cfg.dma_enable == 1)
  {
    ...
    ahbcfg.d32 = (*(volatile uint32_t *)(&pdev->regs.GREGS->GAHBCFG));
    ahbcfg.b.hburstlen = 5;
    ahbcfg.b.dmaenable = 1;
    (*(volatile uint32_t *)(&pdev->regs.GREGS->GAHBCFG) = (ahbcfg.d32));

  }
# 436 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
  return status;
}
...
USB_OTG_STS USB_OTG_EnableGlobalInt(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  (*(volatile uint32_t *)((&pdev->regs.GREGS->GAHBCFG)) = (((((*(volatile uint32_t *)(&pdev->regs.GREGS->GAHBCFG))) & ~(0)) | (ahbcfg.d32))));
  return status;
}
# 462 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_DisableGlobalInt(USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
  USB_OTG_GAHBCFG_TypeDef ahbcfg;
  ahbcfg.d32 = 0;
  ahbcfg.b.glblintrmsk = 1;
  (*(volatile uint32_t *)((&pdev->regs.GREGS->GAHBCFG)) = (((((*(volatile uint32_t *)(&pdev->regs.GREGS->GAHBCFG))) & ~(ahbcfg.d32)) | (0))));
  return status;
}
# 479 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_FlushTxFifo (USB_OTG_CORE_HANDLE *pdev , uint32_t num )
{
  USB_OTG_STS status = USB_OTG_OK;
  volatile USB_OTG_GRSTCTL_TypeDef greset;
...
# 539 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
...
uint32_t USB_OTG_GetMode(USB_OTG_CORE_HANDLE *pdev)
{
  return ((*(volatile uint32_t *)(&pdev->regs.GREGS->GINTSTS)) & 0x1);
}
...
{
  uint32_t v = 0;
  v = (*(volatile uint32_t *)(&pdev->regs.GREGS->GINTSTS));
  v &= (*(volatile uint32_t *)(&pdev->regs.GREGS->GINTMSK));
  return v;
}
...
uint32_t USB_OTG_ReadOtgItr (USB_OTG_CORE_HANDLE *pdev)
{
  return ((*(volatile uint32_t *)(&pdev->regs.GREGS->GOTGINT)));
}
# 1208 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
void USB_OTG_InitDevSpeed(USB_OTG_CORE_HANDLE *pdev , uint8_t speed)
{
  USB_OTG_DCFG_TypeDef dcfg;

  dcfg.d32 = (*(volatile uint32_t *)(&pdev->regs.DREGS->DCFG));
  dcfg.b.devspd = speed;
  (*(volatile uint32_t *)(&pdev->regs.DREGS->DCFG) = (dcfg.d32));
}
# 1224 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_CoreInitDev (USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
  ...
  (*(volatile uint32_t *)(pdev->regs.PCGCCTL) = (0));
  ...
  if(pdev->cfg.coreID == USB_OTG_FS_CORE_ID )
  {
    ...
    txfifosize.b.depth = 128;
    (*(volatile uint32_t *)(&pdev->regs.GREGS->DIEPTXF[0]) = (txfifosize.d32));
    ...
    txfifosize.b.startaddr += txfifosize.b.depth;
    txfifosize.b.depth = 0;
    (*(volatile uint32_t *)(&pdev->regs.GREGS->DIEPTXF[2]) = (txfifosize.d32));
  }
# 1336 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
  USB_OTG_FlushTxFifo(pdev , 0x10);
  USB_OTG_FlushRxFifo(pdev);

  (*(volatile uint32_t *)(&pdev->regs.DREGS->DIEPMSK) = (0));
  (*(volatile uint32_t *)(&pdev->regs.DREGS->DOEPMSK) = (0));
  (*(volatile uint32_t *)(&pdev->regs.DREGS->DAINT) = (0xFFFFFFFF));
  (*(volatile uint32_t *)(&pdev->regs.DREGS->DAINTMSK) = (0));

  for (i = 0; i < pdev->cfg.dev_endpoints; i++)
  {
    depctl.d32 = (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[i]->DIEPCTL));
    if (depctl.b.epena)
    {
      depctl.d32 = 0;
      depctl.b.epdis = 1;
    ...
    (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[i]->DIEPCTL) = (depctl.d32));
    (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[i]->DIEPTSIZ) = (0));
    (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[i]->DIEPINT) = (0xFF));
  }
  for (i = 0; i < pdev->cfg.dev_endpoints; i++)
  {
    USB_OTG_DEPCTL_TypeDef depctl;
    depctl.d32 = (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[i]->DOEPCTL));
    if (depctl.b.epena)
    {
      depctl.d32 = 0;
      depctl.b.epdis = 1;
    ...
    (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[i]->DOEPCTL) = (depctl.d32));
    (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[i]->DOEPTSIZ) = (0));
    (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[i]->DOEPINT) = (0xFF));
  }
  msk.d32 = 0;
  msk.b.txfifoundrn = 1;
  (*(volatile uint32_t *)((&pdev->regs.DREGS->DIEPMSK)) = (((((*(volatile uint32_t *)(&pdev->regs.DREGS->DIEPMSK))) & ~(msk.d32)) | (msk.d32))));
  ...
  if (pdev->cfg.dma_enable == 1)
  {
    ...
    (*(volatile uint32_t *)(&pdev->regs.DREGS->DTHRCTL) = (dthrctl.d32));
  }
...
USB_OTG_STS USB_OTG_EnableDevInt(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  (*(volatile uint32_t *)(&pdev->regs.GREGS->GINTMSK) = (0));
  ...
  (*(volatile uint32_t *)((&pdev->regs.GREGS->GINTMSK)) = (((((*(volatile uint32_t *)(&pdev->regs.GREGS->GINTMSK))) & ~(intmsk.d32)) | (intmsk.d32))));
  return status;
}
# 1447 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
enum USB_OTG_SPEED USB_OTG_GetDeviceSpeed (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  dsts.d32 = (*(volatile uint32_t *)(&pdev->regs.DREGS->DSTS));
...
USB_OTG_STS USB_OTG_EP0Activate(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  dsts.d32 = (*(volatile uint32_t *)(&pdev->regs.DREGS->DSTS));
  diepctl.d32 = (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[0]->DIEPCTL));
  ...
  (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[0]->DIEPCTL) = (diepctl.d32));
  dctl.b.cgnpinnak = 1;
  (*(volatile uint32_t *)((&pdev->regs.DREGS->DCTL)) = (((((*(volatile uint32_t *)(&pdev->regs.DREGS->DCTL))) & ~(dctl.d32)) | (dctl.d32))));
  return status;
}
...
USB_OTG_STS USB_OTG_EPActivate(USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep)
{
  ...
  depctl.d32 = (*(volatile uint32_t *)(addr));
  if (!depctl.b.usbactep)
  {
    ...
    depctl.b.setd0pid = 1;
    depctl.b.usbactep = 1;
    (*(volatile uint32_t *)(addr) = (depctl.d32));
  }
# 1561 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
    (*(volatile uint32_t *)((&pdev->regs.DREGS->DAINTMSK)) = (((((*(volatile uint32_t *)(&pdev->regs.DREGS->DAINTMSK))) & ~(0)) | (daintmsk.d32))));
  return status;
}
...
USB_OTG_STS USB_OTG_EPDeactivate(USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep)
{
  ...
  depctl.b.usbactep = 0;
  (*(volatile uint32_t *)(addr) = (depctl.d32));
# 1602 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
    (*(volatile uint32_t *)((&pdev->regs.DREGS->DAINTMSK)) = (((((*(volatile uint32_t *)(&pdev->regs.DREGS->DAINTMSK))) & ~(daintmsk.d32)) | (0))));
  return status;
}
# 1613 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_EPStartXfer(USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep)
{
  USB_OTG_STS status = USB_OTG_OK;
  USB_OTG_DEPCTL_TypeDef depctl;
  ...
  if (ep->is_in == 1)
  {
    depctl.d32 = (*(volatile uint32_t *)(&(pdev->regs.INEP_REGS[ep->num]->DIEPCTL)));
    deptsiz.d32 = (*(volatile uint32_t *)(&(pdev->regs.INEP_REGS[ep->num]->DIEPTSIZ)));
    ...
    (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[ep->num]->DIEPTSIZ) = (deptsiz.d32));

    if (pdev->cfg.dma_enable == 1)
    {
      (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[ep->num]->DIEPDMA) = (ep->dma_addr));
    }
    else
    {
      if (ep->type != 1)
      {
        ...
        if (ep->xfer_len > 0)
        {
          ...
          (*(volatile uint32_t *)((&pdev->regs.DREGS->DIEPEMPMSK)) = (((((*(volatile uint32_t *)(&pdev->regs.DREGS->DIEPEMPMSK))) & ~(0)) | (fifoemptymsk))));
        }
      }
    }
    ...
    depctl.b.cnak = 1;
    depctl.b.epena = 1;
    (*(volatile uint32_t *)(&pdev->regs.INEP_REGS[ep->num]->DIEPCTL) = (depctl.d32));
  ...
  else
  {
    ...
    depctl.d32 = (*(volatile uint32_t *)(&(pdev->regs.OUTEP_REGS[ep->num]->DOEPCTL)));
    deptsiz.d32 = (*(volatile uint32_t *)(&(pdev->regs.OUTEP_REGS[ep->num]->DOEPTSIZ)));
    ...
    (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[ep->num]->DOEPTSIZ) = (deptsiz.d32));

    if (pdev->cfg.dma_enable == 1)
    {
      (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[ep->num]->DOEPDMA) = (ep->dma_addr));
    }
    ...
    depctl.b.cnak = 1;
    depctl.b.epena = 1;
    (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[ep->num]->DOEPCTL) = (depctl.d32));
  }
  return status;
}
# 1746 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_EP0StartXfer(USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep)
{
  USB_OTG_STS status = USB_OTG_OK;
  USB_OTG_DEPCTL_TypeDef depctl;
  ...
  if (ep->is_in == 1)
  {
    ...
    depctl.d32 = (*(volatile uint32_t *)(&in_regs->DIEPCTL));
    deptsiz.d32 = (*(volatile uint32_t *)(&in_regs->DIEPTSIZ));
    ...
    (*(volatile uint32_t *)(&in_regs->DIEPTSIZ) = (deptsiz.d32));
    ...
    depctl.b.cnak = 1;
    depctl.b.epena = 1;
    (*(volatile uint32_t *)(&in_regs->DIEPCTL) = (depctl.d32));
...
USB_OTG_STS USB_OTG_EPSetStall(USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep)
{
  ...
  if (ep->is_in == 1)
  {
    ...
    depctl.d32 = (*(volatile uint32_t *)(depctl_addr));
    ...
    depctl.b.stall = 1;
    (*(volatile uint32_t *)(depctl_addr) = (depctl.d32));
  }
  else
  {
...
{
  uint32_t v;
  v = (*(volatile uint32_t *)(&pdev->regs.DREGS->DAINT));
  v &= (*(volatile uint32_t *)(&pdev->regs.DREGS->DAINTMSK));
  return ((v & 0xffff0000) >> 16);
}
# 1931 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
uint32_t USB_OTG_ReadDevOutEP_itr(USB_OTG_CORE_HANDLE *pdev , uint8_t epnum)
{
  uint32_t v;
  v = (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[epnum]->DOEPINT));
  v &= (*(volatile uint32_t *)(&pdev->regs.DREGS->DOEPMSK));
  return v;
}
...
void USB_OTG_EP0_OutStart(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[0]->DOEPTSIZ) = (doeptsize0.d32));

  if (pdev->cfg.dma_enable == 1)
  {
    USB_OTG_DEPCTL_TypeDef doepctl;
    doepctl.d32 = 0;
    (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[0]->DOEPDMA) = ((uint32_t)&pdev->dev.setup_packet))
                                                          ;


    doepctl.d32 = (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[0]->DOEPCTL));
    doepctl.b.epena = 1;
    doepctl.d32 = 0x80008000;
    (*(volatile uint32_t *)(&pdev->regs.OUTEP_REGS[0]->DOEPCTL) = (doepctl.d32));
  }
}
  ...
  if (pdev->dev.DevRemoteWakeup)
  {
    ...
    if(dsts.b.suspsts == 1)
    {
      if(pdev->cfg.low_power)
      {
        ...
        power.d32 = (*(volatile uint32_t *)(pdev->regs.PCGCCTL));
        power.b.gatehclk = 0;
        power.b.stoppclk = 0;
        (*(volatile uint32_t *)(pdev->regs.PCGCCTL) = (power.d32));
      }

      dctl.d32 = 0;
      dctl.b.rmtwkupsig = 1;
      (*(volatile uint32_t *)((&pdev->regs.DREGS->DCTL)) = (((((*(volatile uint32_t *)(&pdev->regs.DREGS->DCTL))) & ~(0)) | (dctl.d32))));
      USB_OTG_BSP_mDelay(5);
      (*(volatile uint32_t *)((&pdev->regs.DREGS->DCTL)) = (((((*(volatile uint32_t *)(&pdev->regs.DREGS->DCTL))) & ~(dctl.d32)) | (0))));
    }
  }
}
...
# 2079 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
uint32_t USB_OTG_GetEPStatus(USB_OTG_CORE_HANDLE *pdev ,USB_OTG_EP *ep)
{
  USB_OTG_DEPCTL_TypeDef depctl;
  volatile uint32_t *depctl_addr;
...
# 2133 "./lib/main/STM32_USB_OTG_Driver/src/usb_core.c"
void USB_OTG_SetEPStatus (USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep , uint32_t Status)
{
  USB_OTG_DEPCTL_TypeDef depctl;
  volatile uint32_t *depctl_addr;
