# 1 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
# 1 "/home/osboxes/inav//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
# 58 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
# 1 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h" 1
# 31 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
# 39 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h" 2
# 54 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
typedef struct
{
  uint32_t DMA2D_Mode;
...
# 193 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
# 209 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
#define IS_DMA2D_CMODE(MODE_ARGB) (((MODE_ARGB) == DMA2D_ARGB8888) || ((MODE_ARGB) == DMA2D_RGB888) || ((MODE_ARGB) == DMA2D_RGB565) || ((MODE_ARGB) == DMA2D_ARGB1555) || ((MODE_ARGB) == DMA2D_ARGB4444))
# 227 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
# 241 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
#define DMA2D_OUTPUT_OFFSET ((uint32_t)0x00003FFF)

#define IS_DMA2D_OUTPUT_OFFSET(OOFFSET) ((OOFFSET) <= DMA2D_OUTPUT_OFFSET)
# 254 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
#define DMA2D_pixel ((uint32_t)0x00003FFF)
#define DMA2D_Line ((uint32_t)0x0000FFFF)

#define IS_DMA2D_LINE(LINE) ((LINE) <= DMA2D_Line)
#define IS_DMA2D_PIXEL(PIXEL) ((PIXEL) <= DMA2D_pixel)
# 268 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
#define OFFSET ((uint32_t)0x00003FFF)

#define IS_DMA2D_FGO(FGO) ((FGO) <= OFFSET)

#define IS_DMA2D_BGO(BGO) ((BGO) <= OFFSET)
# 283 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
#define IS_DMA2D_FGCM(FGCM) (((FGCM) == CM_ARGB8888) || ((FGCM) == CM_RGB888) || ((FGCM) == CM_RGB565) || ((FGCM) == CM_ARGB1555) || ((FGCM) == CM_ARGB4444) || ((FGCM) == CM_L8) || ((FGCM) == CM_AL44) || ((FGCM) == CM_AL88) || ((FGCM) == CM_L4) || ((FGCM) == CM_A8) || ((FGCM) == CM_A4))
...
#define IS_DMA2D_BGCM(BGCM) (((BGCM) == CM_ARGB8888) || ((BGCM) == CM_RGB888) || ((BGCM) == CM_RGB565) || ((BGCM) == CM_ARGB1555) || ((BGCM) == CM_ARGB4444) || ((BGCM) == CM_L8) || ((BGCM) == CM_AL44) || ((BGCM) == CM_AL88) || ((BGCM) == CM_L4) || ((BGCM) == CM_A8) || ((BGCM) == CM_A4))
# 317 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
# 332 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
# 356 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
#define IS_DMA2D_FG_ALPHA_MODE(FG_ALPHA_MODE) (((FG_ALPHA_MODE) == NO_MODIF_ALPHA_VALUE) || ((FG_ALPHA_MODE) == REPLACE_ALPHA_VALUE) || ((FG_ALPHA_MODE) == COMBINE_ALPHA_VALUE))



#define IS_DMA2D_BG_ALPHA_MODE(BG_ALPHA_MODE) (((BG_ALPHA_MODE) == NO_MODIF_ALPHA_VALUE) || ((BG_ALPHA_MODE) == REPLACE_ALPHA_VALUE) || ((BG_ALPHA_MODE) == COMBINE_ALPHA_VALUE))
# 376 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
#define IS_DMA2D_IT(IT) (((IT) == DMA2D_IT_CTC) || ((IT) == DMA2D_IT_CAE) || ((IT) == DMA2D_IT_TW) || ((IT) == DMA2D_IT_TC) || ((IT) == DMA2D_IT_TE) || ((IT) == DMA2D_IT_CE))
# 395 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
#define IS_DMA2D_GET_FLAG(FLAG) (((FLAG) == DMA2D_FLAG_CTC) || ((FLAG) == DMA2D_FLAG_CAE) || ((FLAG) == DMA2D_FLAG_TW) || ((FLAG) == DMA2D_FLAG_TC) || ((FLAG) == DMA2D_FLAG_TE) || ((FLAG) == DMA2D_FLAG_CE))
# 416 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
# 437 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_dma2d.h"
...
# 59 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c" 2
# 1 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_rcc.h" 1
# 60 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c" 2
# 77 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
#define CR_MASK ((uint32_t)0xFFFCE0FC)
#define PFCCR_MASK ((uint32_t)0x00FC00C0)
#define DEAD_MASK ((uint32_t)0xFFFF00FE)
# 111 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
void DMA2D_DeInit(void)
{
...
# 128 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
void DMA2D_Init(DMA2D_InitTypeDef* DMA2D_InitStruct)
{
...
# 298 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
void DMA2D_FGConfig(DMA2D_FG_InitTypeDef* DMA2D_FG_InitStruct)
{
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->FGPFCCR |= (DMA2D_FG_InitStruct->DMA2D_FGCM | fg_clutcolormode | fg_clutsize |
...
# 395 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
void DMA2D_BGConfig(DMA2D_BG_InitTypeDef* DMA2D_BG_InitStruct)
{
  ...
  ((DMA2D_TypeDef *)((((uint32_t)0x40000000) + 0x00020000) + 0xB000))->BGPFCCR |= (DMA2D_BG_InitStruct->DMA2D_BGCM | bg_clutcolormode | bg_clutsize |
...
# 491 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
void DMA2D_FGStart(FunctionalState NewState)
{
...
# 515 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
void DMA2D_BGStart(FunctionalState NewState)
{
...
# 632 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
void DMA2D_ITConfig(uint32_t DMA2D_IT, FunctionalState NewState)
{
...
# 663 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
FlagStatus DMA2D_GetFlagStatus(uint32_t DMA2D_FLAG)
{
...
# 697 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
void DMA2D_ClearFlag(uint32_t DMA2D_FLAG)
{
...
# 718 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
ITStatus DMA2D_GetITStatus(uint32_t DMA2D_IT)
{
...
# 758 "./lib/main/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_dma2d.c"
void DMA2D_ClearITPendingBit(uint32_t DMA2D_IT)
{
