...
static 
# 65 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 65 "./src/main/rx/ibus.c"
           ibusFrameDone = 
# 65 "./src/main/rx/ibus.c" 3 4
                           0
# 65 "./src/main/rx/ibus.c"
...
static 
# 71 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 71 "./src/main/rx/ibus.c"
...
static void ibusDataReceive(uint16_t c, void *rxCallbackData)
{
    ...
    if (ibusFramePosition == ibusFrameSize - 1) {
        ibusFrameDone = 
# 119 "./src/main/rx/ibus.c" 3 4
                       1
# 119 "./src/main/rx/ibus.c"
                           ;
    } else {
        ibusFramePosition++;
    }
...
static 
# 135 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 135 "./src/main/rx/ibus.c"
...
# 148 "./src/main/rx/ibus.c" 3 4
_Bool 
# 148 "./src/main/rx/ibus.c"
    ibusIsChecksumOkIa6b(const uint8_t *ibusPacket, const uint8_t length)
{
...
static 
# 157 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 157 "./src/main/rx/ibus.c"
           checksumIsOk(void) {
    if (ibusModel == 1 ) {
...
static uint8_t ibusFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    ibusFrameDone = 
# 184 "./src/main/rx/ibus.c" 3 4
                   0
# 184 "./src/main/rx/ibus.c"
                        ;
    ...
    ibusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 222 "./src/main/rx/ibus.c" 3 4
              0
# 222 "./src/main/rx/ibus.c"
                   ;
    }


    
# 226 "./src/main/rx/ibus.c" 3 4
   _Bool 
# 226 "./src/main/rx/ibus.c"
...
# 235 "./src/main/rx/ibus.c"
    ...
    return ibusPort != 
# 247 "./src/main/rx/ibus.c" 3 4
                      ((void *)0)
# 247 "./src/main/rx/ibus.c"
                          ;
}
