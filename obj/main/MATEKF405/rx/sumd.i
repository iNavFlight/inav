...
static 
# 49 "./src/main/rx/sumd.c" 3 4
      _Bool 
# 49 "./src/main/rx/sumd.c"
           sumdFrameDone = 
# 49 "./src/main/rx/sumd.c" 3 4
                           0
# 49 "./src/main/rx/sumd.c"
...
static void sumdDataReceive(uint16_t c, void *rxCallbackData)
{
    ...
    if (sumdIndex == 0) {
        ...
        {
            sumdFrameDone = 
# 91 "./src/main/rx/sumd.c" 3 4
                           0
# 91 "./src/main/rx/sumd.c"
                                ;
            crc = 0;
        }
    }
    ...
    if (sumdIndex < sumdChannelCount * 2 + 4)
        ...
        if (sumdIndex == sumdChannelCount * 2 + 5) {
            sumdIndex = 0;
            sumdFrameDone = 
# 105 "./src/main/rx/sumd.c" 3 4
                           1
# 105 "./src/main/rx/sumd.c"
                               ;
        }
}
...
static uint8_t sumdFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    sumdFrameDone = 
# 129 "./src/main/rx/sumd.c" 3 4
                   0
# 129 "./src/main/rx/sumd.c"
                        ;
...
# 165 "./src/main/rx/sumd.c" 3 4
_Bool 
# 165 "./src/main/rx/sumd.c"
    sumdInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ...
    if (!portConfig) {
        return 
# 177 "./src/main/rx/sumd.c" 3 4
              0
# 177 "./src/main/rx/sumd.c"
                   ;
    }


    
# 181 "./src/main/rx/sumd.c" 3 4
   _Bool 
# 181 "./src/main/rx/sumd.c"
...
# 189 "./src/main/rx/sumd.c" 3 4
       ((void *)0)
# 189 "./src/main/rx/sumd.c"
           ,
        115200,
    ...
    return sumdPort != 
# 201 "./src/main/rx/sumd.c" 3 4
                      ((void *)0)
# 201 "./src/main/rx/sumd.c"
                          ;
}
