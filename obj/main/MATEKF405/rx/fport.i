...
static 
# 115 "./src/main/rx/fport.c" 3 4
      _Bool 
# 115 "./src/main/rx/fport.c"
           telemetryEnabled = 
# 115 "./src/main/rx/fport.c" 3 4
                              0
# 115 "./src/main/rx/fport.c"
...
static volatile 
# 141 "./src/main/rx/fport.c" 3 4
               _Bool 
# 141 "./src/main/rx/fport.c"
                    clearToSend = 
# 141 "./src/main/rx/fport.c" 3 4
                                  0
# 141 "./src/main/rx/fport.c"
...
# 145 "./src/main/rx/fport.c" 3 4
                                       ((void *)0)
# 145 "./src/main/rx/fport.c"
                                           ;
...
static void fportDataReceive(uint16_t c, void *data)
{
    ...
    static 
# 163 "./src/main/rx/fport.c" 3 4
          _Bool 
# 163 "./src/main/rx/fport.c"
               escapedCharacter = 
# 163 "./src/main/rx/fport.c" 3 4
                                  0
# 163 "./src/main/rx/fport.c"
    ...
    static 
# 165 "./src/main/rx/fport.c" 3 4
          _Bool 
# 165 "./src/main/rx/fport.c"
               telemetryFrame = 
# 165 "./src/main/rx/fport.c" 3 4
                                0
# 165 "./src/main/rx/fport.c"
    ...
    clearToSend = 
# 169 "./src/main/rx/fport.c" 3 4
                 0
# 169 "./src/main/rx/fport.c"
                      ;
...
# 188 "./src/main/rx/fport.c"
                ...
                telemetryFrame = 
# 190 "./src/main/rx/fport.c" 3 4
                                0
# 190 "./src/main/rx/fport.c"
                                     ;
            }
            ...
            escapedCharacter = 
# 196 "./src/main/rx/fport.c" 3 4
                              0
# 196 "./src/main/rx/fport.c"
                                   ;
        }
...
# 209 "./src/main/rx/fport.c"
                ...
                escapedCharacter = 
# 211 "./src/main/rx/fport.c" 3 4
                                  1
# 211 "./src/main/rx/fport.c"
                                      ;
            ...
            if (framePosition == 2 && val == FPORT_FRAME_TYPE_TELEMETRY_REQUEST) {
                telemetryFrame = 
# 217 "./src/main/rx/fport.c" 3 4
                                1
# 217 "./src/main/rx/fport.c"
                                    ;
            }
...
static 
# 238 "./src/main/rx/fport.c" 3 4
      _Bool 
# 238 "./src/main/rx/fport.c"
...
static uint8_t fportFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    static 
# 255 "./src/main/rx/fport.c" 3 4
          _Bool 
# 255 "./src/main/rx/fport.c"
               hasTelemetryRequest = 
# 255 "./src/main/rx/fport.c" 3 4
                                     0
# 255 "./src/main/rx/fport.c"
            ...
            if (!checkChecksum(&rxBuffer[rxBufferReadIndex].data[0], bufferLength)) {
                ...
                case FPORT_FRAME_TYPE_CONTROL:
                    if (frameLength != (sizeof(uint8_t) + sizeof(fportControlData_t))) {
                        ...
                        setRSSI(scaleRange(frame->data.controlData.rssi, 0, 100, 0, 1023), RSSI_SOURCE_RX_PROTOCOL, 
# 277 "./src/main/rx/fport.c" 3 4
                                                                                                                             0
# 277 "./src/main/rx/fport.c"
                                                                                                                                  );
                ...
                case FPORT_FRAME_TYPE_TELEMETRY_REQUEST:
                    if (frameLength != (sizeof(uint8_t) + sizeof(smartPortPayload_t))) {
                        ...
                        case FPORT_FRAME_ID_DATA:
                            hasTelemetryRequest = 
# 295 "./src/main/rx/fport.c" 3 4
                                                 1
# 295 "./src/main/rx/fport.c"
                                                     ;
    ...
    if ((mspPayload || hasTelemetryRequest) && cmpTimeUs(micros(), lastTelemetryFrameReceivedUs) >= 500) {
        hasTelemetryRequest = 
# 325 "./src/main/rx/fport.c" 3 4
                             0
# 325 "./src/main/rx/fport.c"
                                  ;
...
# 331 "./src/main/rx/fport.c" 3 4
                                           1
# 331 "./src/main/rx/fport.c"
                                               );
...
static 
# 338 "./src/main/rx/fport.c" 3 4
      _Bool 
# 338 "./src/main/rx/fport.c"
           fportProcessFrame(const rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (cmpTimeUs(currentTimeUs, lastTelemetryFrameReceivedUs) > 2000) {
       clearToSend = 
# 345 "./src/main/rx/fport.c" 3 4
                    0
# 345 "./src/main/rx/fport.c"
                         ;
    }
    ...
    if (clearToSend) {
        ...
        if (*consecutiveSensorCount >= 2 && !smartPortPayloadContainsMSP(mspPayload)) {
...
# 360 "./src/main/rx/fport.c" 3 4
                                                               ((void *)0)
# 360 "./src/main/rx/fport.c"
                                                                   );
        }
        ...
        if (clearToSend) {
            ...
            clearToSend = 
# 366 "./src/main/rx/fport.c" 3 4
                         0
# 366 "./src/main/rx/fport.c"
                              ;
        }
    }

    mspPayload = 
# 370 "./src/main/rx/fport.c" 3 4
                ((void *)0)
# 370 "./src/main/rx/fport.c"
                    ;


    return 
# 373 "./src/main/rx/fport.c" 3 4
          1
# 373 "./src/main/rx/fport.c"
              ;
}


# 376 "./src/main/rx/fport.c" 3 4
_Bool 
# 376 "./src/main/rx/fport.c"
    fportRxInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 392 "./src/main/rx/fport.c" 3 4
              0
# 392 "./src/main/rx/fport.c"
                   ;
    }
...
# 398 "./src/main/rx/fport.c" 3 4
       ((void *)0)
# 398 "./src/main/rx/fport.c"
           ,
        115200,
        MODE_RXTX,
    ...
    return fportPort != 
# 410 "./src/main/rx/fport.c" 3 4
                       ((void *)0)
# 410 "./src/main/rx/fport.c"
                           ;
}
