...
static 
# 49 "./src/main/rx/crsf.c" 3 4
                  _Bool 
# 49 "./src/main/rx/crsf.c"
                       crsfFrameDone = 
# 49 "./src/main/rx/crsf.c" 3 4
                                       0
# 49 "./src/main/rx/crsf.c"
...
static uint32_t crsfChannelData[17];

static serialPort_t *serialPort;
static timeUs_t crsfFrameStartAt = 0;
static uint8_t telemetryBuf[(62 + 4)];
static uint8_t telemetryBufLen = 0;
# 87 "./src/main/rx/crsf.c"
...
static void crsfDataReceive(uint16_t c, void *rxCallbackData)
{
    (void)(rxCallbackData);
...
# 151 "./src/main/rx/crsf.c" 3 4
                                                             0 
# 151 "./src/main/rx/crsf.c"
                                                                   : 
# 151 "./src/main/rx/crsf.c" 3 4
                                                                     1
# 151 "./src/main/rx/crsf.c"
...
static uint8_t crsfFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (crsfFrameDone) {
        crsfFrameDone = 
# 170 "./src/main/rx/crsf.c" 3 4
                       0
# 170 "./src/main/rx/crsf.c"
                            ;
        if (crsfFrame.frame.type == CRSF_FRAMETYPE_RC_CHANNELS_PACKED) {
            ...
            crsfChannelData[16] = scaleRange(constrain(linkStats->uplinkLQ, 0, 100), 0, 100, 191, 1791);
...
{
    (void)(rxRuntimeConfig);
# 229 "./src/main/rx/crsf.c"
    return (crsfChannelData[chan] * 1024 / 1639) + 881;
}

void crsfRxWriteTelemetryData(const void *data, int len)
{
    len = ( __extension__ ({ __typeof__(len) _left0 = (len); __typeof__((int)sizeof(telemetryBuf)) _right1 = ((int)sizeof(telemetryBuf)); _left0 < _right1 ? _left0 : _right1; }));
...
void crsfRxSendTelemetryData(void)
{
    ...
    if (telemetryBufLen > 0) {
        ...
        if ((SERIAL_STOPBITS_1 | SERIAL_PARITY_NO) & SERIAL_BIDIR) {
            const timeDelta_t timeSinceStartOfFrame = cmpTimeUs(micros(), crsfFrameStartAt);
            if ((timeSinceStartOfFrame < 1000) ||
                (timeSinceStartOfFrame > 4000 - 1000)) {
                return;
            }
        }
...
# 257 "./src/main/rx/crsf.c" 3 4
_Bool 
# 257 "./src/main/rx/crsf.c"
    crsfRxInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    for (int ii = 0; ii < 17; ++ii) {
        crsfChannelData[ii] = (16 * (1000 + ((2000 - 1000) / 2))) / 10 - 1408;
    }
    ...
    if (!portConfig) {
        return 
# 271 "./src/main/rx/crsf.c" 3 4
              0
# 271 "./src/main/rx/crsf.c"
                   ;
    }
...
# 277 "./src/main/rx/crsf.c" 3 4
       ((void *)0)
# 277 "./src/main/rx/crsf.c"
           ,
        420000,
        MODE_RXTX,
    ...
    return serialPort != 
# 283 "./src/main/rx/crsf.c" 3 4
                        ((void *)0)
# 283 "./src/main/rx/crsf.c"
                            ;
}


# 286 "./src/main/rx/crsf.c" 3 4
_Bool 
# 286 "./src/main/rx/crsf.c"
    crsfRxIsActive(void)
{
    return serialPort != 
# 288 "./src/main/rx/crsf.c" 3 4
                        ((void *)0)
# 288 "./src/main/rx/crsf.c"
                            ;
}
