...
# 42 "./src/main/rx/sbus.c" 2
# 55 "./src/main/rx/sbus.c"
...
typedef struct sbusFrameData_s {
    ...
    volatile 
# 96 "./src/main/rx/sbus.c" 3 4
            _Bool 
# 96 "./src/main/rx/sbus.c"
                 frameDone;
    uint8_t buffer[(sizeof(sbusChannels_t) + 2)];
    uint8_t position;
    timeUs_t lastActivityTimeUs;
} sbusFrameData_t;

typedef char assert_failed_SBUS_FRAME_SIZE_doesnt_match_sbusFrame_t [((sizeof(sbusChannels_t) + 2) == sizeof(sbusFrame_t)) ? 1 : -1 ] __attribute__((unused));
...
static void sbusDataReceive(uint16_t c, void *data)
{
    ...
    if (sbusFrameData->state == STATE_SBUS_WAIT_SYNC && timeSinceLastByteUs >= rxConfig()->sbusSyncInterval) {
        {if (debugMode == (DEBUG_SBUS)) {debug[(DEBUG_SBUS_INTERFRAME_TIME)] = (timeSinceLastByteUs);}};
...
# 134 "./src/main/rx/sbus.c" 3 4
               _Bool 
# 134 "./src/main/rx/sbus.c"
                    frameValid = 
# 134 "./src/main/rx/sbus.c" 3 4
                                 0
# 134 "./src/main/rx/sbus.c"
...
# 143 "./src/main/rx/sbus.c"
                    ...
                    default:
                        sbusFrameData->state = STATE_SBUS_WAIT_SYNC;
                        sbusDesyncCounter++;
                        {if (debugMode == (DEBUG_SBUS)) {debug[(DEBUG_SBUS_DESYNC_COUNTER)] = (sbusDesyncCounter);}};
                        break;
                }


                if (!sbusFrameData->frameDone && frameValid) {
                    {if (debugMode == (DEBUG_SBUS)) {debug[(DEBUG_SBUS_FRAME_FLAGS)] = (frame->channels.flags);}};

                    memcpy((void *)&sbusFrameData->frame, (void *)&sbusFrameData->buffer[0], (sizeof(sbusChannels_t) + 2));
                    sbusFrameData->frameDone = 
# 159 "./src/main/rx/sbus.c" 3 4
                                              1
# 159 "./src/main/rx/sbus.c"
                                                  ;
                }
            }
            break;
...
static uint8_t sbusFrameStatus(rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    sbusFrameData->frameDone = 
# 182 "./src/main/rx/sbus.c" 3 4
                              0
# 182 "./src/main/rx/sbus.c"
                                   ;
...
# 187 "./src/main/rx/sbus.c" 3 4
_Bool 
# 187 "./src/main/rx/sbus.c"
    sbusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 203 "./src/main/rx/sbus.c" 3 4
              0
# 203 "./src/main/rx/sbus.c"
                   ;
    }


    
# 207 "./src/main/rx/sbus.c" 3 4
   _Bool 
# 207 "./src/main/rx/sbus.c"
    ...
    return sBusPort != 
# 227 "./src/main/rx/sbus.c" 3 4
                      ((void *)0)
# 227 "./src/main/rx/sbus.c"
                          ;
}
