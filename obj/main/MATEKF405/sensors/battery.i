...
const batteryMetersConfig_t pgResetTemplate_batteryMetersConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .voltage_scale = 1100, .current = { .type = CURRENT_SENSOR_ADC, .scale = 179, .offset = 0 }, .voltageSource = BAT_VOLTAGE_RAW, .cruise_power = 0, .idle_power = 0, .rth_energy_margin = 5, .throttle_compensation_weight = 1.0f }
