...
| nav_multi_waypoint_mission_index | 1 |  | 9 | Index of mission selected from multi mission WP entry. 1 is the first WP mission in the entry. If index exceeds number of missions in the entry then no mission is loaded. |
