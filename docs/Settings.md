...
| nav_mission_planner_resume | ON |  |  | When ON waypoint input resumes from last waypoint when Mission Planner mode is restarted. Otherwise WP input restarts from the first waypoint |
