...
| fw_autotune_detect_time | 250 | 50 | 500 | Time [ms] to detect sustained undershoot or overshoot |
...
| fw_autotune_min_stick | 80 | 0 | 100 | Minimum stick input [%] to consider overshoot/undershoot detection |
