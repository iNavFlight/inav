...
| gyro_hardware_lpf | 256HZ | Hardware lowpass filter for gyro. Allowed values depend on the driver - For example MPU6050 allows 10HZ,20HZ,42HZ,98HZ,188HZ,256Hz (8khz mode). If you have to set gyro lpf below 42Hz generally means the frame is vibrating too much, and that should be fixed first. |
...
| pinio_box1 | BOX_PERMANENT_ID_NONE |  |
| pinio_box2 | BOX_PERMANENT_ID_NONE |  |
| pinio_box3 | BOX_PERMANENT_ID_NONE |  |
| pinio_box4 | BOX_PERMANENT_ID_NONE |  |
