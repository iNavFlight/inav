...
| fw_level_pitch_deadband | 5 | Deadband for automatic leveling when AUTOLEVEL mode is used. |
| fw_level_pitch_gain | 5 | I-gain for the pitch trim for self-leveling flight modes. Higher values means that AUTOTRIM will be faster but might introduce oscillations |
