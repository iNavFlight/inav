...
| 160 | OSD_RX_POWER_DOWNLINK                            | 8.0.0  | The element will be hidden unless the RC link reports the transmit power of the receiver. MSP RC links and mLRS as MAVLink receiver report it, INAV does not read it from CRSF links such as ExpressLRS. |
