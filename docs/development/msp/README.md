...
| `activeRX` | `uint8_t` | 1 | [rxLink_e](https://github.com/iNavFlight/inav/wiki/Enums-reference#enum-rxlink_e) | Enum `rxLink_e` Current active receiver link if dual RX activated; otherwise always 0 |
