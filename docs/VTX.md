...
iNAV supports control of VTX modules.  

## VTX Systems

Current support includes 
1. Furious FPV Stealth Long RAnge 2.4 Ghz
2. IRC Tramp
3. TBS Smart Audio
...
As of iNAV 2.4, band/channel and power level information needed to control videotransmitters is no longer hardcoded,
...
The factory flag controls how iNAV communicates with the vtx.

**When the flag is set to `FACTORY`, iNAV sends the vtx a band and channel number.**
...
**When the flag is set to `CUSTOM`, iNAV sends the vtx the frequency it should use.**
...
**Videotransmitters without a built-in table, such as IRC Tramp or FFPV 2.4 Ghz VTX only support `CUSTOM`.**
...
#### Furious FPV 2.4 Ghz VTX should use:
```
...
#### Furious FPV Stealth Long Range 2.4 Ghz
...
vtxtable bands 2
vtxtable channels 8
vtxtable band 1 FFPV_A A CUSTOM 2410 2430 2450 2470 2370 2390 2490 2510
vtxtable band 2 FFPV_B B CUSTOM 2414 2432 2450 2468 2411 2433 2453 2473
vtxtable powerlevels 4
vtxtable powervalues 25 200 500 800
vtxtable powerlabels 25 200 500 800
```
...
iNAV can make the these devices leave pitmode, but not enter it.

Furious FPV 2.4 Ghz devices do not support ultra-low power pitmode.
