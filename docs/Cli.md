...
|  spoileron_throw_offset  | 200 | Defines throw range in us for both ailerons that will be passed to servo mixer via input source 29 (`FEATURE SPOILERS`) when SPOILERON mode is activated. |
