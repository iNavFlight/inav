...
static void smartPortSensorEncodeLegacyFuel(__unused telemetrySensor_t *sensor, smartPortPayload_t *payload)
{
...
static telemetrySensor_t smartportTelemetrySensors[] =
{
        ...
        TLM_SENSOR(BATTERY_LEGACY_FUEL,     0x0600,   100,  3000,   1,  10,   0,    LegacyFuel),
