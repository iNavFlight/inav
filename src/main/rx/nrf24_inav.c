...
void inavNrf24Init(rxRuntimeConfig_t *rxRuntimeConfig)
{
    rxRuntimeConfig->channelCount = RC_CHANNEL_COUNT_MAX;
    inavNrf24Setup((rx_spi_protocol_e)rxSpiConfig()->rx_spi_protocol, &rxConfig->rx_spi_id, rxConfig->rx_spi_rf_channel_count);
}
#endif
