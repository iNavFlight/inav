...
static void resetPidProfile(pidProfile_t *pidProfile)
{
    ...
    pidProfile->P8[PIDPOS] = 30;    // NAV_POS_XY_P * 100
    ...
    pidProfile->D8[PIDPOSR] = 50;   // NAV_VEL_XY_D * 1000
    ...
    pidProfile->P8[PIDVEL] = 100;   // NAV_ACC_Z_P * 100
...
void resetNavProfile(navProfile_t *navProfile)
{
    ...
    navProfile->nav_rth_altitude = 1000;      // 10m
    navProfile->nav_gps_cf = 0.3f;  // GPS INS The LOWER the value the closer to gps speed // Dont go to high here
}
#endif
...
void resetBarometerConfig(barometerConfig_t *barometerConfig)
{
    ...
    barometerConfig->baro_cf_vel = 0.965f;
}
