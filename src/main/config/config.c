...
static void resetPidProfile(pidProfile_t *pidProfile)
{
    ...
    pidProfile->P8[PIDPOS] = 10;    // NAV_POS_XY_P * 100
    pidProfile->I8[PIDPOS] = 0;     // not used
    pidProfile->D8[PIDPOS] = 0;     // not used
    pidProfile->P8[PIDPOSR] = 20;   // NAV_VEL_XY_P * 100
    pidProfile->I8[PIDPOSR] = 5;    // NAV_VEL_XY_I * 100
    pidProfile->D8[PIDPOSR] = 30;   // NAV_VEL_XY_D * 1000
