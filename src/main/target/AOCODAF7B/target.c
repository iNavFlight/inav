...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM8, CH1, PC6, TIM_USE_MC_SERVO | TIM_USE_FW_MOTOR, 0, 0),                     // S1 
    DEF_TIM(TIM8, CH2, PC7, TIM_USE_MC_SERVO | TIM_USE_FW_MOTOR, 0, 0),                     // S2     
    ...
    DEF_TIM(TIM3, CH4, PB1, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),                     // S5   
