...
#ifdef FLYWOOF411_V2
    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 1),      // S1 - D(2,1)
    DEF_TIM(TIM2,  CH2, PB3,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),      // S2 - D(1,6)
    DEF_TIM(TIM2,  CH3, PB10, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),      // S3 - D(1,1)
...
#else
    DEF_TIM(TIM1, CH1, PA8,  TIM_USE_MOTOR | TIM_USE_SERVO,  0, 1), // S1_OUT 2,1
    DEF_TIM(TIM1, CH2, PA9,  TIM_USE_MOTOR | TIM_USE_SERVO,  0, 1), // S2_OUT 2,2
    DEF_TIM(TIM1, CH3, PA10, TIM_USE_MOTOR | TIM_USE_SERVO,  0, 0), // S3_OUT 2,6
