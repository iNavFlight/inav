...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM1, CH1, PA8, TIM_USE_OUTPUT_AUTO,0,1), //S5 DMA2_ST1  T1CH1
    DEF_TIM(TIM1, CH2, PA9, TIM_USE_OUTPUT_AUTO,0,0), //S6 DMA2_ST6  T1CH2 -- uses TIM1's combined CH1/CH2/CH3 DMA request, which S5 (TIM1_CH1) also triggers; no alternative dmavar avoids this. DSHOT does not work on S6
