...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM1, CH1, PE9, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),  // S5
    DEF_TIM(TIM1, CH2, PE11, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0), // S6
    DEF_TIM(TIM1, CH3, PE13, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0), // S7
    DEF_TIM(TIM1, CH4, PE14, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0), // S8
    DEF_TIM(TIM4, CH1, PB6, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),  // S9
    DEF_TIM(TIM4, CH2, PB7, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),  // S10
