...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TMR8, CH3, PC8, TIM_USE_MOTOR | TIM_USE_SERVO | TIM_USE_ANY, 0, 4),  // TMR8_CH3 motor 5
    DEF_TIM(TMR1, CH1, PA8, TIM_USE_MOTOR | TIM_USE_SERVO | TIM_USE_ANY, 0, 5),  // TMR1_CH3 motor 6
