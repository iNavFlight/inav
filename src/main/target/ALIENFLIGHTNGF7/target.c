...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3, CH4,  PB1,  TIM_USE_OUTPUT_AUTO,  0, 0), // PWM9  - DMA1_ST2 -- clash with PWM5, DSHOT does not work
    DEF_TIM(TIM1, CH3N, PB15, TIM_USE_OUTPUT_AUTO,  0, 0), // PWM10 - DMA2_ST6
    DEF_TIM(TIM4, CH3,  PB8,  TIM_USE_OUTPUT_AUTO,  0, 0), // PWM11 - DMA1_ST7 -- clash with PWM4, DSHOT does not work
