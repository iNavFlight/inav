...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4,  CH1, PB6,  TIM_USE_ANY, 0, 0), //  SOFTSERIAL_1_TX_PIN - D(1, 0, 2)
    DEF_TIM(TIM4,  CH2, PB7,  TIM_USE_ANY, 0, 0), //  SOFTSERIAL_1_RX_PIN - D(1, 3, 2)

    DEF_TIM(TIM3,  CH2, PB5,  TIM_USE_LED | TIM_USE_MC_SERVO, 0, 0), //2812LED  D(2,1,6)
