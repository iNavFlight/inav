...
/*
 * Output/timer map is identical to MAMBAF722_2022A — the HGLRC Specter F722 Lite
 * uses the same motor pads (PC8 PC9 PA8 PA9 PB0 PB1 PA10 PB4) and LED strip pad (PB3).
 * TIM_USE_OUTPUT_AUTO lets iNav assign each output as motor OR servo (fixed-wing ready).
 */
