...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM1,   CH2,  PA9,   TIM_USE_OUTPUT_AUTO,  0, 1 ),     // S1 – D(2, 2, 6)
    DEF_TIM(TIM1,   CH1,  PA8,   TIM_USE_OUTPUT_AUTO,  0, 1 ),     // S2 – D(2, 1, 6)
    DEF_TIM(TIM8,   CH4,  PC9,   TIM_USE_OUTPUT_AUTO,  0, 0 ),     // S3 – D(2, 7, 7)
    DEF_TIM(TIM8,   CH3,  PC8,   TIM_USE_OUTPUT_AUTO,  0, 1 ),     // S4 – D(2, 4, 7) (dmavar 1 avoids DMA2 Stream2 collision with S1/TIM1_CH2)
