...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3, CH1, PB4,   TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR, 0, 0),     // S1   D(1, 4, 4)
    DEF_TIM(TIM3, CH2, PB5,   TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR, 0, 0),     // S2   D(1, 5, 4)   
    DEF_TIM(TIM3, CH3, PB0,   TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR, 0, 0),     // S3   D(1, 7, 4)
    DEF_TIM(TIM3, CH4, PB1,   TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR, 0, 0),     // S4   D(1, 2, 2)

    DEF_TIM(TIM8, CH3, PC8,   TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 1),    // S5   D(2, 4, 7)
