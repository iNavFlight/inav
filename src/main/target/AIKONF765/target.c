...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4,  CH1, PD12,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0), // TIM4_CH1
    DEF_TIM(TIM4,  CH2, PD13,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0), // TIM4_CH2
    DEF_TIM(TIM4,  CH3, PD14,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0), // TIM4_CH3
    DEF_TIM(TIM4,  CH4, PD15,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0), // TIM4_CH4
    DEF_TIM(TIM1,  CH1, PA8,   TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0), // TIM1_CH1
    DEF_TIM(TIM3,  CH3, PB0,   TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0), // TIM1_CH2N, TIM3_CH3, TIM8_CH2N

    DEF_TIM(TIM1,  CH1, PE9,   TIM_USE_LED                        , 0, 0), // TIM1_CH1
};
