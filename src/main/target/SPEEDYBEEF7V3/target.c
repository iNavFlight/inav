...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4, CH1, PB6,     TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),  // S1
    DEF_TIM(TIM4, CH2, PB7,     TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),  // S1
    DEF_TIM(TIM3, CH2, PB5,     TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),  // S1
    DEF_TIM(TIM3, CH3, PB0,     TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),  // S1
    DEF_TIM(TIM3, CH4, PB1,     TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),  // S1
