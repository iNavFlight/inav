...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM5, CH1, PA0,     TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 4),   // S1  
    DEF_TIM(TIM5, CH3, PA2,     TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 5),   // S2
    DEF_TIM(TIM8, CH3, PC8,     TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 6),   // S3
    DEF_TIM(TIM8, CH4, PC9,     TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 7),   // S4
