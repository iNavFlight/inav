...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM5, CH1, PA0,     TIM_USE_SERVO | TIM_USE_SERVO, 0, 4),   // S5  
    DEF_TIM(TIM5, CH3, PA2,     TIM_USE_SERVO | TIM_USE_SERVO, 0, 5),   // S6
    DEF_TIM(TIM8, CH3, PC8,     TIM_USE_SERVO | TIM_USE_SERVO, 0, 6),   // S7
    DEF_TIM(TIM8, CH4, PC9,     TIM_USE_SERVO | TIM_USE_SERVO, 0, 7),   // S8
