...
#include "stm32h7a3_impl.h"
#include "stm32h7a3_impl_usb_device.h"
...
void MPU_Config(void)
{
  ...
  */
  ...
  /** Initializes and configures the Region and the memory to be protected ITCM
  */
  MPU_InitStruct.Enable = MPU_REGION_ENABLE;
  ...
  /** Initializes and configures the Region and the memory to be protected DTCM
  */
  MPU_InitStruct.Enable = MPU_REGION_ENABLE;
...
uint8_t readAllFlash(void)
{
    ...
    */
	...
	for(uint8_t *p = FLASH_TEST_START_ADDRESS; p < FLASH_TEST_END_ADDRESS; p++){
		check  = _checksum(check, *p);
	}
