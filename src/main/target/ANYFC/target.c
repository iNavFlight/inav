...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3,  CH4, PB1,  TIM_USE_OUTPUT_AUTO,                  0, 0), // S2_OUT 8 -- clash with S6_OUT, DSHOT does not work
    DEF_TIM(TIM2,  CH4, PA3,  TIM_USE_OUTPUT_AUTO,                  0, 0), // S3_OUT 9 -- clash with S1_OUT, DSHOT does not work
    DEF_TIM(TIM2,  CH3, PA2,  TIM_USE_OUTPUT_AUTO,                  0, 0), // S4_OUT 10
    DEF_TIM(TIM2,  CH1, PA15, TIM_USE_OUTPUT_AUTO,                  0, 0), // S7_OUT 13
    DEF_TIM(TIM3,  CH2, PB5,  TIM_USE_OUTPUT_AUTO,                  0, 0), // S8_OUT 14 -- clash with S7_OUT, DSHOT does not work
    DEF_TIM(TIM3,  CH1, PB4,  TIM_USE_OUTPUT_AUTO,                  0, 0), // S9_OUT 15 -- clash with S5_OUT, DSHOT does not work
};
