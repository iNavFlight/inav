...
/* Includes ------------------------------------------------------------------*/
#include "stm32h7a3_impl_usbd_cdc_if.h"
...
uint32_t rxAvailableHs = 0;
uint8_t* rxBuffPtrHs = NULL;

uint32_t BuffLengthHs;
uint32_t UserTxBufPtrInHs = 0;/* Increment this pointer or roll it back to
                               start address when data are received over USART */
uint32_t UserTxBufPtrOutHs = 0; /* Increment this pointer or roll it back to
