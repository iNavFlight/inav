...
#if defined(MATEKF405TE_SD_S3DSHOT) || defined(MATEKF405TE_S3DSHOT)
    DEF_TIM(TIM12, CH2,  PB15, TIM_USE_MC_MOTOR  | TIM_USE_FW_SERVO,   0, 0), // S3 D(2,6,0) UP256
#else
...
#if defined(MATEKF405TE_SD_S3DSHOT) || defined(MATEKF405TE_S3DSHOT)
    DEF_TIM(TIM12, CH1,  PB14, TIM_USE_MC_MOTOR  | TIM_USE_FW_SERVO,   0, 0), // S9  DMA NONE
#else
