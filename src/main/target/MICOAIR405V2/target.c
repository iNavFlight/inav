...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3,  CH2, PB5,  TIM_USE_OUTPUT_AUTO, 0, 0), // S6  -D(1,5) -- clash with S3, DSHOT does not work
    DEF_TIM(TIM4,  CH3, PB8,  TIM_USE_OUTPUT_AUTO, 0, 0), // S7 -- clash with S1, DSHOT does not work
