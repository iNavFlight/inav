...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM5,  CH4, PA3,  TIM_USE_OUTPUT_AUTO,               0, 1 ), // S4_OUT - DMA1_ST6
    DEF_TIM(TIM3,  CH3, PB0,  TIM_USE_OUTPUT_AUTO,               0, 0 ), // S5_OUT - DMA1_ST7 - LED Control
    DEF_TIM(TIM3,  CH4, PB1,  TIM_USE_OUTPUT_AUTO | TIM_USE_LED, 0, 0 ), // S6_OUT
