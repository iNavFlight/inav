...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM8,  CH2,  PC7,  TIM_USE_OUTPUT_AUTO, 0, 1), // S2 -- dmavar 1: dedicated stream, avoids sharing S1's combined-channel request
    DEF_TIM(TIM8,  CH3,  PC8,  TIM_USE_OUTPUT_AUTO, 0, 1), // S3 -- dmavar 1: dedicated stream, avoids sharing S1's combined-channel request
