...
BUSDEV_REGISTER_SPI_TAG(busdev_icm42688_2,  DEVHW_ICM42605,  IMU2_SPI_BUS,   IMU2_CS_PIN,   NONE,   0,  DEVFLAGS_NONE,  IMU2_ALIGN);
...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM5, CH2, PA1, TIM_USE_OUTPUT_AUTO, 0, 5),   // S6
    DEF_TIM(TIM5, CH3, PA2, TIM_USE_OUTPUT_AUTO, 0, 6),   // S7
    DEF_TIM(TIM5, CH4, PA3, TIM_USE_OUTPUT_AUTO, 0, 7),   // S8
