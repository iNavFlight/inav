...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM8,  IO_TAG(PB0),  TIM_Channel_2, 1, IOCFG_AF_PP | TIMER_OUTPUT_N_CHANNEL, GPIO_AF_4, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO }, // PWM3  - PB0  - *TIM3_CH3, TIM1_CH2N, TIM8_CH2N
    { TIM8,  IO_TAG(PB1),  TIM_Channel_3, 1, IOCFG_AF_PP | TIMER_OUTPUT_N_CHANNEL, GPIO_AF_4, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO }, // PWM4  - PB1  - *TIM3_CH4, TIM1_CH3N, TIM8_CH3N
