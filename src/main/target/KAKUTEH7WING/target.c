...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4, CH3, PD14, TIM_USE_OUTPUT_AUTO, 0, 4),   // S5
    DEF_TIM(TIM4, CH4, PD15, TIM_USE_OUTPUT_AUTO, 0, 0),   // S6 DMA_NONE
    ...
    DEF_TIM(TIM3, CH2, PB5,  TIM_USE_OUTPUT_AUTO, 0, 9),   // S11
    DEF_TIM(TIM3, CH3, PB0,  TIM_USE_OUTPUT_AUTO, 0, 10),   // S12

    DEF_TIM(TIM3, CH4, PB1,  TIM_USE_OUTPUT_AUTO, 0, 11),   // S13
    //DEF_TIM(TIM2, CH1, PA15, TIM_USE_OUTPUT_AUTO, 0, 0),   // S14 / LED_2812

    DEF_TIM(TIM2, CH1, PA15, TIM_USE_LED, 0, 12),   // S14 / LED_2812
