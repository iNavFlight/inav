...
BUSDEV_REGISTER_SPI_TAG(busdev_bmi088_acc,  DEVHW_BMI088_ACC,   BMI088_SPI_BUS,     BMI088_ACC_CS_PIN,   BMI088_ACCEL_EXTI_PIN, 1,  DEVFLAGS_NONE,  IMU_BMI088_ALIGN);
...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM5, CH1, PA0,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 6),   // S7
    DEF_TIM(TIM5, CH2, PA1,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 7),   // S8
    
    DEF_TIM(TIM15,CH1, PE5,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),   // S9
    DEF_TIM(TIM15,CH2, PE6,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),   // S10
