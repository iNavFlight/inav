...
timerHardware_t timerHardware[] = {
    DEF_TIM(TIM8,  CH1,  PC6,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 1),
    DEF_TIM(TIM8,  CH2,  PC7,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 1),
    DEF_TIM(TIM3,  CH3,  PB0,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),
    DEF_TIM(TIM3,  CH4,  PB1,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),

    DEF_TIM(TIM4,  CH1,  PB6,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),
    DEF_TIM(TIM4,  CH3,  PB8,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),
