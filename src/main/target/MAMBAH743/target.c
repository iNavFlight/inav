...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM5, CH1, PA0, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),   // S1  
    DEF_TIM(TIM5, CH2, PA1, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 1),   // S2
    DEF_TIM(TIM5, CH3, PA2, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 2),   // S3
    DEF_TIM(TIM5, CH4, PA3, TIM_USE_MOTOR | TIM_USE_SERVO, 0, 3),   // S4

    DEF_TIM(TIM3, CH3, PB0, TIM_USE_SERVO | TIM_USE_SERVO, 0, 4),   // S5
    DEF_TIM(TIM3, CH4, PB1, TIM_USE_SERVO | TIM_USE_SERVO, 0, 5),   // S6
