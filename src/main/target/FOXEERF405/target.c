...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM8,  CH3, PC8,  TIM_USE_OUTPUT_AUTO,     0, 1),   // S3 (2,4)
    DEF_TIM(TIM8,  CH4, PC9,  TIM_USE_OUTPUT_AUTO,     0, 0),   // S4 (2,7)  
    DEF_TIM(TIM8,  CH1, PC6,  TIM_USE_OUTPUT_AUTO,     0, 1),   // S5 (2,2) 
    DEF_TIM(TIM8,  CH2, PC7,  TIM_USE_OUTPUT_AUTO,     0, 1),   // S6 (2,3)
