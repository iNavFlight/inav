...
BUSDEV_REGISTER_SPI_TAG(busdev_1_lsm6dxx,   DEVHW_LSM6D,    IMU_1_SPI_BUS,  IMU_1_CS_PIN,   NONE,   0,  DEVFLAGS_NONE,  IMU_1_ALIGN);
...
BUSDEV_REGISTER_SPI_TAG(busdev_2_lsm6dxx,   DEVHW_LSM6D ,   IMU_2_SPI_BUS,  IMU_2_CS_PIN,   NONE,   1,  DEVFLAGS_NONE,  IMU_2_ALIGN);
