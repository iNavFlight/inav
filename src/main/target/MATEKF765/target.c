...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4, CH1, PD12,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),   // S7  UP(1,6), D(1,0,2)*
    DEF_TIM(TIM4, CH2, PD13,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),   // S8  UP(1,6), D(1,3,2)
    DEF_TIM(TIM4, CH3, PD14,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),   // S9  UP(1,6), D(1,7,2)**
    DEF_TIM(TIM4, CH4, PD15,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, 0, 0),   // S10 UP(1,6)

    DEF_TIM(TIM9, CH1, PE5,   TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0),   // S11
    DEF_TIM(TIM9, CH2, PE6,   TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0),   // S12
