...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3, CH3,  PB0, TIM_USE_OUTPUT_AUTO, 		0, 0 ), // S5_OUT - DMA1_ST7 -- used to be TIM_USE_LED
    DEF_TIM(TIM3, CH4,  PB1, TIM_USE_OUTPUT_AUTO,               0, 0 ), // S6_OUT - DMA1_ST2 -- clash with S1_OUT, DSHOT does not work
};
