...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM8, CH3, PC8,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 1),  // S1
    DEF_TIM(TIM3, CH1, PC6,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),  // S2
    DEF_TIM(TIM8, CH4, PC9,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),  // S3
    DEF_TIM(TIM3, CH2, PC7,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),  // S4
    DEF_TIM(TIM4, CH1, PB6,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),  // S5
    DEF_TIM(TIM4, CH2, PB7,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),  // S6
    DEF_TIM(TIM3, CH4, PB1,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),  // S7
    DEF_TIM(TIM3, CH3, PB0,  TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),  // S8
