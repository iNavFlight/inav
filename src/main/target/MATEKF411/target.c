...
const timerHardware_t timerHardware[] = {
...
#if defined(MATEKF411_QUAD_S3S6)
    DEF_TIM(TIM3, CH1, PB4,  TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0), // S1  D(1,4,5)
    DEF_TIM(TIM3, CH2, PB5,  TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0), // S2  D(1,5,5)
    ...
    DEF_TIM(TIM2, CH2, PB3,  TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR, 0, 0), // S5  D(1,6,3)
    DEF_TIM(TIM2, CH3, PB10, TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR, 0, 0), // S6  D(1,1,3)
#else
