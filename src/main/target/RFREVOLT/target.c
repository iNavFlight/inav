...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM2,  IO_TAG(PA3),  TIM_Channel_4, 1, IOCFG_AF_PP_PD, GPIO_AF_TIM2,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO }, // S3_OUT
    { TIM2,  IO_TAG(PA2),  TIM_Channel_3, 1, IOCFG_AF_PP_PD, GPIO_AF_TIM2,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO }, // S4_OUT
	{ TIM4,  IO_TAG(PB7),  TIM_Channel_1, 1, IOCFG_AF_PP_PD, GPIO_AF_TIM4,  TIM_USE_MC_SERVO | TIM_USE_FW_SERVO }, // S5_OUT
	{ TIM4,  IO_TAG(PA8),  TIM_Channel_2, 1, IOCFG_AF_PP_PD, GPIO_AF_TIM4,  TIM_USE_MC_SERVO | TIM_USE_FW_SERVO }, // S6_OUT
	{ TIM4,  IO_TAG(PB6),  TIM_Channel_3, 0, IOCFG_AF_PP_PD, GPIO_AF_TIM4,  TIM_USE_LED},
