...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM1, CH2, PE11, TIM_USE_OUTPUT_AUTO, 0, 0), // S6_OUT -- clash with S5_OUT, DSHOT does not work
    DEF_TIM(TIM1, CH3, PE13, TIM_USE_OUTPUT_AUTO, 0, 0), // S7_OUT -- clash with S5_OUT, DSHOT does not work
