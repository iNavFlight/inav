...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3, CH1, PB4,   TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),     // S1   D(1, 4, 5)
    DEF_TIM(TIM3, CH2, PB5,   TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),     // S2   D(1, 5, 4)   
    ...
    DEF_TIM(TIM8, CH3, PC8,   TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),    // S5   D(2, 4, 7)
    DEF_TIM(TIM8, CH4, PC9,   TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),    // S6   D(2, 7, 7)
#else
    DEF_TIM(TIM2, CH2, PB3,   TIM_USE_MOTOR | TIM_USE_SERVO, 0, 0),    // S6   D(1, 6, 3)
#endif
