...
timerHardware_t timerHardware[] = {
   ...
   // DEF_TIM(TMR1, CH3, PA10, TIM_USE_OUTPUT_AUTO, 0,2),   //   motor1    UART1
   // DEF_TIM(TMR1, CH2, PA9,  TIM_USE_OUTPUT_AUTO, 0,9),   //   motor2 -  UART1
 
    DEF_TIM(TMR3, CH4, PB1,  TIM_USE_OUTPUT_AUTO, 0,3),   // PWM  1    
    ...
    DEF_TIM(TMR4, CH4, PB9,  TIM_USE_OUTPUT_AUTO, 0,13),  // PWM  6    UART5
    DEF_TIM(TMR4, CH3, PB8,  TIM_USE_OUTPUT_AUTO, 0,12),  // PWM -7    UART5

    DEF_TIM(TMR4, CH2, PB7,  TIM_USE_OUTPUT_AUTO, 0,10),  // PWM -8    
    DEF_TIM(TMR4, CH1, PB6,  TIM_USE_OUTPUT_AUTO, 0,0),   // PWM  9

    DEF_TIM(TMR1, CH1, PA8,  TIM_USE_LED, 0,2), //WS2812          // PWM1 - LED MCO1 DMA1 CH2
