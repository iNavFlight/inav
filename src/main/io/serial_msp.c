...
static const box_t boxes[CHECKBOX_ITEM_COUNT + 1] = {
    ...
    { BOXNAVALTHOLD, "NAV ALTHOLD;", 27 },
    { BOXNAVPOSHOLD, "NAV POSHOLD;", 28 },
    { BOXNAVRTH, "NAV RTH;", 29 },
    { BOXNAVWP, "NAV WP;", 30 },
...
static bool processOutCommand(uint8_t cmdMSP)
{
    ...
    case MSP_ALTITUDE:
        headSerialReply(6);
#if defined(NAV)
        serialize32(getEstimatedActualPosition(Z));
        serialize16(getEstimatedActualVelocity(Z));
#else
        serialize32(0);
        serialize16(0);
#endif
    ...
    case MSP_WP:
        ...
        serialize32(0);             // lat
        serialize32(0);             // lon
        serialize32(0);             // altitude (cm) will come here -- temporary implementation to test feature with apps
