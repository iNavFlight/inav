...
const clivalue_t valueTable[] = {
    ...
    { "nav_wp_radius",              VAR_UINT16 | PROFILE_VALUE, &masterConfig.profile[0].navProfile.nav_wp_radius, 0, 2000 },
    ...
    { "nav_min_rth_distance",       VAR_UINT16 | PROFILE_VALUE, &masterConfig.profile[0].navProfile.nav_min_rth_distance, 0, 5000 },
