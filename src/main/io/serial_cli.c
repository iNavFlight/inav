...
const clivalue_t valueTable[] = {
    ...
    */
    ...
    { "disable_failsafe_on_throttle_cut", VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP,  &masterConfig.failsafeConfig.disable_failsafe_on_throttle_cut, .config.lookup = { TABLE_OFF_ON }, 0 },
