...
void generateThrottleCurve()
{
    ...
    lookupThrottleRCMid = motorAndServoConfig.minthrottle + (int32_t)(motorAndServoConfig.maxthrottle - motorAndServoConfig.minthrottle) * currentControlRateProfile->thrMid8 / 100; // [MINTHROTTLE;MAXTHROTTLE]
