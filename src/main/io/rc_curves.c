...
void generateThrottleCurve()
{
    ...
    lookupThrottleRCMid = escAndServoConfig.minthrottle + (int32_t)(escAndServoConfig.maxthrottle - escAndServoConfig.minthrottle) * currentControlRateProfile->thrMid8 / 100; // [MINTHROTTLE;MAXTHROTTLE]
