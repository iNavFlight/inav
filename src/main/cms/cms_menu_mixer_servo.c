...
static const OSD_Entry cmsx_menuServoEntries[] =
{
       ...
       OSD_UINT8_CALLBACK_ENTRY("SERVO", cmsx_menuServoIndexOnChange, (&(const OSD_UINT8_t){ &currentServoIndex, 0, MAX_SUPPORTED_SERVOS - 1, 1})),   //MAX_SUPPORTED_SERVOS - 1
...
static const OSD_Entry cmsx_menuServoMixerEntries[] =
{
       ...
       OSD_UINT8_CALLBACK_ENTRY("SERVO MIX", cmsx_menuServoMixerIndexOnChange, (&(const OSD_UINT8_t){ &tmpcurrentServoMixerIndex, 1, MAX_SERVO_RULES-1, 1})),
