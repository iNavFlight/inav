...
static const OSD_Entry menuOsdHud2Entries[] = {
    OSD_LABEL_ENTRY("--- HUD MORE ---"),

    OSD_SETTING_ENTRY("MARGIN HORI.", SETTING_OSD_HUD_MARGIN_H),
    OSD_SETTING_ENTRY("MARGIN VERT.", SETTING_OSD_HUD_MARGIN_V),
    OSD_SETTING_ENTRY("SHOW HOME", SETTING_OSD_HUD_DISP_HOME),
    OSD_SETTING_ENTRY("SHOW MAX RADAR", SETTING_OSD_HUD_DISP_RADAR),    
    OSD_SETTING_ENTRY("SHOW NEXT WPOINT", SETTING_OSD_HUD_DISP_WP),
    OSD_SETTING_ENTRY("MIN DISTANCE", SETTING_OSD_HUD_DISP_MINDIST),
    OSD_SETTING_ENTRY("MAX DISTANCE", SETTING_OSD_HUD_DISP_MAXDIST),
...
static const OSD_Entry menuOsdHudEntries[] = {
    ...
    OSD_SETTING_ENTRY("HUD DISPLAY MODE", SETTING_OSD_HUDMODE),
    OSD_SUBMENU_ENTRY("MORE SETTINGS", &cmsx_menuOsdHud2),
