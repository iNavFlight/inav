...
static const OSD_Entry menuCrsfRxEntries[]=
{
    ...
    OSD_ELEMENT_ENTRY("RX RSSI DBM", OSD_RX_RSSI_DBM),
    OSD_ELEMENT_ENTRY("RX LQ", OSD_RX_LQ),
    OSD_ELEMENT_ENTRY("RX SNR ALARM", OSD_RX_SNR_DB),
    OSD_ELEMENT_ENTRY("RX MODE", OSD_RF_MODE),
    OSD_ELEMENT_ENTRY("TX POWER", OSD_TX_POWER),
