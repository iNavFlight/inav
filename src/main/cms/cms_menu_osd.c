...
static const OSD_Entry menuOsdElemsEntries[] =
{
    ...
    OSD_ELEMENT_ENTRY("CRSF UP RSSI1", OSD_CRSF_UPLINK_RSSI_ANT1),
    OSD_ELEMENT_ENTRY("CRSF UP RSSI2", OSD_CRSF_UPLINK_RSSI_ANT2),
    OSD_ELEMENT_ENTRY("CRSF UP LQ", OSD_CRSF_UPLINK_LQ),
    OSD_ELEMENT_ENTRY("CRSF UP SNR", OSD_CRSF_UPLINK_SNR),
    OSD_ELEMENT_ENTRY("CRSF ANT", OSD_CRSF_ACTIVE_ANTENNA),
    OSD_ELEMENT_ENTRY("CRSF RF MODE", OSD_CRSF_RF_MODE),
    OSD_ELEMENT_ENTRY("CRSF POWER", OSD_CRSF_UPLINK_TX_POWER),
    OSD_ELEMENT_ENTRY("CRSF DOWN RSSI", OSD_CRSF_DOWNLINK_RSSI),
    OSD_ELEMENT_ENTRY("CRSF DOWN LQ", OSD_CRSF_DOWNLINK_LQ),
    OSD_ELEMENT_ENTRY("CRSF DOWN SNR", OSD_CRSF_DOWNLINK_SNR),
