...
static const OSD_Entry menuOsdElemsEntries[] =
{
    ...
    OSD_ELEMENT_ENTRY("RX UP RSSI1", OSD_RX_UPLINK_RSSI_ANT1),
    OSD_ELEMENT_ENTRY("RX UP RSSI2", OSD_RX_UPLINK_RSSI_ANT2),
    OSD_ELEMENT_ENTRY("RX UP LQ", OSD_RX_UPLINK_LQ),
    OSD_ELEMENT_ENTRY("RX UP SNR", OSD_RX_UPLINK_SNR),
    OSD_ELEMENT_ENTRY("RX ANT", OSD_RX_ACTIVE_ANTENNA),
    OSD_ELEMENT_ENTRY("RX RF MODE", OSD_RX_RF_MODE),
    OSD_ELEMENT_ENTRY("RX POWER", OSD_RX_UPLINK_TX_POWER),
    OSD_ELEMENT_ENTRY("RX DOWN RSSI", OSD_RX_DOWNLINK_RSSI),
    OSD_ELEMENT_ENTRY("RX DOWN LQ", OSD_RX_DOWNLINK_LQ),
    OSD_ELEMENT_ENTRY("RX DOWN SNR", OSD_RX_DOWNLINK_SNR),
