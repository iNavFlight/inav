...
static const OSD_Entry menuOsdHud2Entries[] = {
    ...
    OSD_SETTING_ENTRY("RADAR LIST NEAREST", SETTING_OSD_HUD_RADAR_NEAREST),
    OSD_SETTING_ENTRY("RADAR SPEED MS", SETTING_OSD_HUD_RADAR_CYCLE),    
    OSD_BACK_ENTRY,
    OSD_END_ENTRY,
};
...
static const OSD_Entry menuOsdHudEntries[] = {
    ...
    OSD_SETTING_ENTRY("DISPLAY MODE", SETTING_OSD_HUD_MODE),
