...
static const OSD_Entry menuOsdElemsEntries[] =
{
    ...
    OSD_ELEMENT_ENTRY("POSZ P", OSD_POS_Z_P),
    OSD_ELEMENT_ENTRY("VELZ P", OSD_VEL_Z_P),
    OSD_ELEMENT_ENTRY("VELXY PIDS", OSD_VEL_XY_PIDS),
    OSD_ELEMENT_ENTRY("ACCELZ PIDS", OSD_ACCEL_Z_PIDS),
    ...
    OSD_ELEMENT_ENTRY("MC VELZ P OUT", OSD_MC_VEL_Z_P_OUTPUT),
    OSD_ELEMENT_ENTRY("MC ACCZ PID OUT", OSD_MC_ACCEL_Z_PID_OUTPUTS),
