...
#warning format this better - probably in degrees
    OSD_SETTING_ENTRY_STEP("ROLL RATE", SETTING_ROLL_RATE, 10),
    OSD_SETTING_ENTRY_STEP("PITCH RATE", SETTING_PITCH_RATE, 10),
    OSD_SETTING_ENTRY_STEP("YAW RATE", SETTING_YAW_RATE, 10),
