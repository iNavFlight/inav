...
static inline const pidBank_t * pidBank() { return platformUseFwPidController() ? &pidProfile()->bank_fw : &pidProfile()->bank_mc; }
static inline pidBank_t * pidBankMutable() { return platformUseFwPidController() ? &pidProfileMutable()->bank_fw : &pidProfileMutable()->bank_mc; }
