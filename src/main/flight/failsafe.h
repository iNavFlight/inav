...
typedef struct failsafeConfig_s {
    ...
    int16_t failsafe_min_altitude;               // Minimum altitude required for failsafe procedure to be taken. 1 step = 1 centimeter. 0 = Regular failsafe_procedure always active (default)
