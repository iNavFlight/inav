...
typedef enum {
    ...
    ARMING_DISABLED_INVALID_SETTING                 = (1 << 11),
    ARMING_DISABLED_HARDWARE_FAILURE                = (1 << 12),
    ARMING_DISABLED_PWM_OUTPUT_ERROR                = (1 << 13),
    ARMING_DISABLED_COMPASS_NOT_CALIBRATED          = (1 << 14),
    ARMING_DISABLED_ACCELEROMETER_NOT_CALIBRATED    = (1 << 15),
    ARMING_DISABLED_RC_LINK                         = (1 << 16),
    ARMING_DISABLED_NAVIGATION_UNSAFE               = (1 << 17),
    ARMING_DISABLED_ARM_SWITCH                      = (1 << 18),
    ARMING_DISABLED_BOXFAILSAFE                     = (1 << 19),
    ARMING_DISABLED_BOXKILLSWITCH                   = (1 << 20),
    ARMING_DISABLED_THROTTLE                        = (1 << 21),
    ARMING_DISABLED_CLI                             = (1 << 22),
    ARMING_DISABLED_CMS_MENU                        = (1 << 23),
    ARMING_DISABLED_OSD_MENU                        = (1 << 24),
    ARMING_DISABLED_ROLLPITCH_NOT_CENTERED          = (1 << 25),
    ARMING_DISABLED_SERVO_AUTOTRIM                  = (1 << 26),
    ARMING_DISABLED_OOM                             = (1 << 27),
